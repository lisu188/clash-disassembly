...
- The retained mission-loader surface moved again this batch:
  ...
  - the menu-reachable `sub_460360` cases now recovered in `clash95.c` are case `0` (`k_mapa1l.map`), case `1` (`k_mapa2l.map`), case `2` (`k_mapa3l.map`), case `3` (`k_mapa4j.map`), case `4` (`k_mapa5j.map`), case `5` (`k_mapa6j.map`), case `6` (`k_mapa7z.map`), case `7` (`k_mapa8z.map`), case `10` (`p_mapa1z.map`), and case `11` (`p_mapa2z.map`)

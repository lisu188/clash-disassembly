...
The same report is embedded in the generated output CLASH_recovered_manifest.json
by `tools/generate_clash_recovered_constraints.py`. This output is created locally

...
| Mission 04 gate breach | `CLASH95_ENABLE_CAMPAIGN_ROUTE_REGRESSION=1 ctest --test-dir build -R clash95_campaign_route_04_regression --output-on-failure` | `artifacts/campaign-routes/mission-04/20260615T195525Z-133642`, two trace-gated `wall_attack` markers ending with `wall_after=0` | Need post-breach castle capture and mission objective completion. |

...
asset-free gates pass. Separately validated relocation preserves the method
body hash and passes the same checks. All 28 canonical methods now reside in
six class-named files; all 4,157 identities and 147 TUs remain.

...
| function | castle | clash95.c | sub_420FB0 | Castle_PromptDestroyBuilding | high | Presents a confirmation dialog for destroying a castle structure and triggers a castle UI refresh when accepted. |

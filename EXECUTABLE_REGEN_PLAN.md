...
## Immediate frontier update - 2026-04-11
...
- Take the next batch through:
  ...
  5. continue the retained mission-loader widening at the remaining case tranche starting with case `14` / `p_mapa5l.map`, now that `mapK2` / case `1`, `mapK3` / case `2`, `mapK4` / case `3`, `mapK5` / case `4`, `mapK6` / case `5`, `mapK7` / case `6`, `mapK8` / case `7`, `mapK9` / case `8`, `mapK10` / case `9`, `mapP3` / case `12`, and case `13` / `p_mapa4l.map` are materialized in recovered C with their extra post-castle, raw stack, prisoner, camera-side, localized-name, queen-state, treasury-cut, treasure-retraction, direct building-byte, no-castle-lane, and random slot-byte side effects still explicit
...
- The retained `PlayGame_Dispatch` alias/data band is now reduced again:
  ...
  - the surviving mission-loader frontier was then narrowed again: `Scenario_LoadMissionByIndexAndPlay` now threads the selector, `createUnit` / `createCastle` now accept the original sentinel-terminated unit lists, and the menu-reachable `sub_460360` cases (`0`, `1`, `2`, `3`, `4`, `5`, `6`, `7`, `10`, and `11`) are recovered in place
  - the next retained widening should stay on the remaining mission-loader case arms, starting with case `14` / `p_mapa5l.map`, not on a new SDL seam or `src_cpp` abstraction

...
Objectives decoded from `Mission_CheckObjectiveComplete` (src/rules/100_strategic.inc.c),
...
| 09 | 9 | per-player flags at gameData+140024+1423k == 0 (k=1..4) | unclear |
...
| 16 | 10 | castle @(91,43) owned by player 1 (ally) | ally capture (untested) |

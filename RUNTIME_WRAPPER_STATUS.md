...
- The retained executable-regeneration surface was also reduced without changing wrapper policy:
  ...
  - the next retained executable-regeneration blocker is now the remaining mission-loader case recovery itself, starting with `mapK6` / case `5`, not a runtime-wrapper, parser-export, SDL, or C++ seam problem

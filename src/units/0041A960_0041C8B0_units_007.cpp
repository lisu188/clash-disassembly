...
#include "0041A960_0041C8B0_units_007_local.h"
        ...
        int iconSpriteIndex)
{
  ...
  if ( iconSet )
    iconSet = DLXSpriteSet_Load(iconSet, (const void*)(uintptr_t)((char)(intptr_t)unitRecord));
  ...
  if ( animSet )
    animSet = DLXSpriteSet_Load(animSet, (const void*)(uintptr_t)(ownerIndex));
...
CLASH95_LOCAL int Diagnostics_ForceAutoresolveEnabled(void)
{
  static int checked CLASH95_LOCAL_DATA_SYMBOL("checked.1", "Diagnostics_ForceAutoresolveEnabled.checked");
  static int enabled CLASH95_LOCAL_DATA_SYMBOL("enabled.0", "Diagnostics_ForceAutoresolveEnabled.enabled");
  if ( !checked )
  {
...
LABEL_52:
            ...
            if ( !useManualBattle )
            {
              ...
              autoresolveRan = 1;
              CalculateBattleResult((_WORD*)(attackerStack + 3), attackerUnitCount, (_WORD*)(defenderStack + 3), (int)(intptr_t)attackerHasSpecial, (DWORD)(intptr_t)attackerStack, defenderUnitCount, defenderHasSpecialArg, 0, 0);
              Diagnostics_TraceWorldMapActionEvent(
...
LABEL_47:
            ...
            if ( !useManualBattle )
            {
              ...
              CalculateBattleResult((_WORD*)(attackerSlots), autoresolveSquadCount, v45, attackerHasSpecial, (DWORD)(intptr_t)buildingRecord, defenderGarrisonCount, defenderSpecialFlag, defenderBuildingRecord, 0);
              Diagnostics_TraceWorldMapActionEvent(
        ...
        int showThirdOption)
{
  ...
  int (*savedRenderHook)(int, char, DWORD); // [esp+E4h] [ebp-50h]
  ...
  UI_DrawTextFmt(a6, panelTop + 42, panelTop + 166, panelLeft + 85, 3, (const char*)(uintptr_t)(PLAYER_DATA_STRIDE * *(unsigned __int8 *)(uintptr_t)(attackerSlotsBase + 2) + gameData + PLAYER_RUNTIME_STATE_OFFSET + 4));
  UI_DrawTextFmt(a6, panelTop + 395, panelTop + 518, panelLeft + 85, 3, (const char*)(uintptr_t)(PLAYER_DATA_STRIDE * *(unsigned __int8 *)(uintptr_t)(defenderSlotsBase + 2) + gameData + PLAYER_RUNTIME_STATE_OFFSET + 4));
  attackerSlotIndex = 0;
    ...
    do
    {
      if ( UNIT_SLOT_TYPE(attackerSlotPtr) != -1 )
      {
        ...
        if ( *(_DWORD *)(uintptr_t)(gameData + PLAYER_DATA_STRIDE * *(unsigned __int8 *)(uintptr_t)(attackerSlotsBase + 2) + 140051) )
          UI_DrawTextFmt((int)(intptr_t)attackerSlotPtr, attackerCellY, attackerCellY + 32, attackerCellX + 50, 3, (const char*)(uintptr_t)((int)(intptr_t)aD_3));
  ...
  UI_DrawTextFmt((int)(intptr_t)&promptSpriteSet, panelTop + 160, panelTop + 390, panelLeft + 10, 6, (const char*)(uintptr_t)(promptTextByLang[(unsigned __int8)g_LanguageIndex]));

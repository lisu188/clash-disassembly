...
void  Unit_CheckLowMorale(_BYTE *stackPtr, double a2)
{
  ...
  if ( anyDisbanded && *(_DWORD *)(uintptr_t)(gameData + PLAYER_DATA_STRIDE * stack->owner_player_index + 140051) )
  {
    ...
    UI_ShowInfoWindow((const char*)(uintptr_t)(v16[(unsigned __int8)g_LanguageIndex]), 0, 0, (DWORD)(intptr_t)stackPtr, (int)(intptr_t)v17, (int)(intptr_t)&g_Text_UnitDisbandedLowMoraleMessages[3]);
    ...
    if ( v7 + originRow >= 0 )
    {
      ...
      if ( neighborRow < *(_DWORD *)(uintptr_t)(gameData + MAP_WIDTH_TILES_OFFSET) && neighborColumn >= 0 && neighborColumn < *(_DWORD *)(uintptr_t)(gameData + MAP_HEIGHT_TILES_OFFSET) )
      {
        ...
        if ( !Trap_GetTileOwnerMask(neighborRow, neighborColumn, -1) )
        {
          ...
          createSucceeded = Unit_Create((unit_type)UNIT_SLOT_TYPE(sourceSlotsPtr), sourceSlotsPtr[2], v13, (char)(intptr_t)sourceSlots, neighborColumnArg);
          if ( createSucceeded )
            break;
        }
      }

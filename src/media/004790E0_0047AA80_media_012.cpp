...
int  File_SourceScalarDtor(_DWORD *a1, char flags)
{
  ...
  {
    *a1 = ((_DWORD)(uintptr_t)(g_FileSource_VTable));
...
int  File_ResolveCachedPathEntry(_DWORD *fs, _DWORD *path_holder, const char *a3, DWORD heap_ctx)
{
  ...
  while ( cache_node )
  {
    ...
    if ( entry_name && !strcmp_(((_DWORD)(uintptr_t)(path_text)), ((_DWORD)(uintptr_t)(entry_name))) )
...
int  File_ResolveAbsolutePathEntry(const char *path, DWORD heap_ctx)
{
  ...
  File_ResolveCachedPathEntry(((_DWORD*)(v4)), ((_DWORD*)(parent_dir_holder)), v4, heap_ctx);
...
_DWORD * File_OpenNodeByFlags(char flags)
{
  ...
  resolveHolder = 0;
  v18 = ((int (**)())(&g_CompatStringHolder_Vtable));
  Compat_StringHolderDestructor(((_DWORD*)(&resolveHolder)));
  v18 = ((int (**)())(&g_PathEntry_Vtable));
  resolvedEntry = File_ResolvePathByParentAndLeaf(((_DWORD*)(v1)), v1, (DWORD)(intptr_t)&g_PathEntry_Vtable);
  ...
  if ( resolvedEntry )
  {
    if ( (flags & 8) == 0 )
    {
      ...
      if ( result )
      {
        ...
        *result = ((_DWORD)(uintptr_t)(g_FileArchiveEntryStream_VTable));
      }
      return result;
    }
    return 0;
  ...
  if ( ExcString_GetTextPtr(self + 12) && *(_BYTE *)(uintptr_t)ExcString_GetTextPtr(excStringField) )
    return 0;
  parentDirHolder = 0;
  v22 = ((int (**)())(&g_CompatStringHolder_Vtable));
  Compat_StringHolderDestructor(((_DWORD*)(&parentDirHolder)));
  v22 = ((int (**)())(&g_PathEntry_Vtable));
  parentDir = FileSystem_PathTrimToParentDir(parentDirPath);
  parentEntry = (_DWORD *)(uintptr_t)File_ResolveCachedPathEntry(((_DWORD*)(v8)), ((_DWORD*)(parentDir)), v8, (DWORD)(intptr_t)&g_PathEntry_Vtable);
  ...
  fileNameHolder = 0;
  v20 = ((int (**)())(&g_CompatStringHolder_Vtable));
  Compat_StringHolderDestructor(((_DWORD*)(&fileNameHolder)));
  v20 = ((int (**)())(&g_PathEntry_Vtable));
  FileSystem_PathExtractFileName(((_DWORD*)(fileName)));
  ...
  {
    v24 = ((int (**)())(&g_CompatStringHolder_Vtable));
    dirInsertHolder = 0;
    v12 = (_DWORD *)(uintptr_t)(v10 + 12);
    Compat_StringHolderDestructor(((_DWORD*)(&dirInsertHolder)));
    v24 = ((int (**)())(&g_PathEntry_Vtable));
    ...
    if ( dirStream )
    {
      ...
      *dirStream = ((_DWORD)(uintptr_t)(g_FileDirNode_VTable));
    }
...
signed int  File_OpenEntryForWrite(int a1, int access_mode)
{
  ...
  v13 = 0;
  v14 = ((int (**)())(&g_CompatStringHolder_Vtable));
  Compat_StringHolderDestructor(((_DWORD*)(&v13)));
  v14 = ((int (**)())(&g_PathEntry_Vtable));
  parentDirPath = FileSystem_PathTrimToParentDir(parentPath);
  File_ResolveCachedPathEntry(((_DWORD*)(v5)), ((_DWORD*)(parentDirPath)), v5, (DWORD)(intptr_t)&g_PathEntry_Vtable);
  Compat_StringHolderScalarDeletingDtor((int)(intptr_t)parentPath, 1);
  Compat_StringHolderScalarDeletingDtor((int)(intptr_t)&v13, 1);
  v11 = 0;
  v12 = ((int (**)())(&g_CompatStringHolder_Vtable));
  Compat_StringHolderDestructor(((_DWORD*)(&v11)));
  v12 = ((int (**)())(&g_PathEntry_Vtable));
  FileSystem_PathExtractFileName(((_DWORD*)(fileName)));
...
int  File_PrimePathCacheEntry(int a1, DWORD a2)
{
  ...
  v7 = a1;
  v5 = 0;
  v6 = ((int (**)())(&g_CompatStringHolder_Vtable));
  Compat_StringHolderDestructor(((_DWORD*)(&v5)));
  v6 = ((int (**)())(&g_PathEntry_Vtable));
  File_ResolveCachedPathEntry(((_DWORD*)(v2)), (_DWORD *)&v5, v2, a2);
...
{
  *result = ((_DWORD)(uintptr_t)(g_FileCacheNode_VTable));
  return result;
}
...
_DWORD * Compat_QueryConstructDefault(int a1)
{
  ...
  *v1 = 0;
  result = v1 - 3;
  result[4] = ((_DWORD)(uintptr_t)(&g_PathEntry_Vtable));
  result[7] = 0;
  *result = ((_DWORD)(uintptr_t)(g_FileSource_VTable));
  return result;
}
// 50EC94: using guessed type int (*off_50EC94)();
// 510B34: using guessed type int (*off_510B34[4])();
...
signed int __fastcall Rules_PrintFactWithIndex(int logicalName, int fact)
{
  ...
  v7 = logicalName;
  sprintf_(((char*)(buffer)), "f-%-5ld ", *(_DWORD *)(uintptr_t)(fact + 24));
...
signed int __fastcall Rules_PrintFactLabel(int logicalName, int fact)
{
  ...
  v5 = logicalName;
  sprintf_(((char*)(buffer)), "f-%ld", *(_DWORD *)(uintptr_t)(fact + 24));
...
_DWORD * Rules_AssertFactDriver(_DWORD *fact, double a2)
{
  ...
  if ( slot_count > 0 )
  {
    ...
    do
    {
      if ( *(_WORD *)slot_cursor == 105 )
      {
        ...
        *(_DWORD *)(slot_cursor + 2) = ((_DWORD)(uintptr_t)(interned_nil));
      }
      ++slot_index;
      slot_cursor += 6;
    }
  ...
  if ( Rules_AddLogicalDependencyLink((int)(intptr_t)fact, 0) )
  {
    ...
    if ( prev_fact )
      *(_DWORD *)(uintptr_t)(prev_fact + 36) = ((_DWORD)(uintptr_t)(fact));
    else
...
{
  static int initialized CLASH95_LOCAL_DATA_SYMBOL("initialized.0", "Rules_EnsureFactPatternEntityRecord.initialized");
...
_DWORD * Rules_CreateFact(signed int slot_count)
{
  ...
  result[6] = 0;
  result[2] = 0;
  *result = ((_DWORD)(uintptr_t)(g_Rules_FactPatternEntityRecord));
  result[1] = 0;
  result[4] = 0;
  v6 = *((_WORD *)result + 14);
  result[9] = 0;

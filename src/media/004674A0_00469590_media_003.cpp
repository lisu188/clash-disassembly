...
int  CAviDecompressor_PresentFrameForRect(int player, const RECT *destRect)
{
  ...
  sehFrame[0] = ((_DWORD)(uintptr_t)(NtCurrentTeb()->NtTib.ExceptionList));
  sehFrame[1] = ((_DWORD)(uintptr_t)(&j____wcpp_4_fs_handler_rtn_));
  sehFrame[2] = ((_DWORD)(uintptr_t)(&g_AviPresentFrameForRect_EHFrame));
  ehState = 0;
        ...
        __int64 a18)
{
  ...
  *(_DWORD *)((char *)&a17 + 2) = ((_DWORD)(uintptr_t)(NtCurrentTeb()->NtTib.ExceptionList));
  *(_DWORD *)((char *)&a17 + 6) = ((_DWORD)(uintptr_t)(&j____wcpp_4_fs_handler_rtn_));
  *(_DWORD *)((char *)&a17 + 10) = ((_DWORD)(uintptr_t)(&g_AviApplyOpenOptions_EHFrame));
...
int  AviPlayer_CreateSystemMemoryBackSurface(int self, int a2)
{
  ...
  surfaceDesc[180] = ((_DWORD)(uintptr_t)(NtCurrentTeb()->NtTib.ExceptionList));
  surfaceDesc[181] = ((_DWORD)(uintptr_t)(&j____wcpp_4_fs_handler_rtn_));
  surfaceDesc[182] = ((_DWORD)(uintptr_t)(&g_AviPlayerCreateBackSurface_EHScopeTable));
  v9 = 0;
  memset_(a2, 0);
  surfaceDesc[0] = 108;
  ...
  else if ( (***(int (__stdcall ****)(_DWORD, void *, int))(uintptr_t)(self + 2013))(*(_DWORD *)(uintptr_t)(self + 2013), &g_AviQueryInterfaceIid, self + 2017) )
  {
    ...
    ExcString_Ctor();
    v9 = 0;
    surfaceDesc[104] = ((_DWORD)(uintptr_t)(g_AviException_VTable));
    return CRT_ThrowExcStringException();
  }
  else
  {
    ...
    if ( result )
    {
      ...
      v9 = v7;
      ExcString_Ctor();
      surfaceDesc[78] = ((_DWORD)(uintptr_t)(g_AviException_VTable));
      v9 = 0;
      return CRT_ThrowExcStringException();
    }
  }

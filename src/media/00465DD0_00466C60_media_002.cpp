        ...
        int a21)
{
  ...
  *(_DWORD *)((char *)&a17 + 6) = ((_DWORD)(uintptr_t)(NtCurrentTeb()->NtTib.ExceptionList));
  *(_DWORD *)((char *)&a18 + 2) = ((_DWORD)(uintptr_t)(&j____wcpp_4_fs_handler_rtn_));
  *(_DWORD *)((char *)&a18 + 6) = ((_DWORD)(uintptr_t)(&g_AviOpenVideoCodec_EHFrame));
  *(_DWORD *)((char *)&a19 + 2) = 0;
  *(_DWORD *)(uintptr_t)(codecState + 4) = inputFormat;
  ...
  if ( **(_DWORD **)((char *)&a20 + 2) )
  {
    ...
    *(_DWORD *)((char *)&a14 + 6) = srcWidth;
    if ( ICSendMessage(hicHandle, 16444, ((DWORD)(uintptr_t)((char *)&a12 + 2)), 52, v31) )
    {
      if ( ICSendMessage(
             **(_DWORD **)((char *)&a20 + 2),
             16396,
  ...
  while ( *(_BYTE *)(uintptr_t)(self + 2191) )
  {
    if ( AviPlayer_UpdateTargetFrameFromClock(self) && (*(_DWORD *)(uintptr_t)(self + 211) < *(_DWORD *)(uintptr_t)(self + 43) || AviPlayer_QueueBacklogCount(self + 203)) )
    {
      ...
      if ( AviPlayer_CatchUpToTargetFrame(self) )
      {
        ...
        _CHP(((_DWORD)(uintptr_t)(ExceptionList)), ((_DWORD)(uintptr_t)(v6)));
        ...
        __int64 blitScratch)
{
  ...
  int v46 CLASH95_UNUSED; // [esp+222h] [ebp-192h]
  int v47 CLASH95_UNUSED; // [esp+28Ah] [ebp-12Ah]

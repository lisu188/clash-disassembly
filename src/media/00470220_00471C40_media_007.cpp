...
void __thiscall __noreturn CSS_FatalErrorExit(void *this_)
{
  ...
  fputs_(((_DWORD)(uintptr_t)(this_)), ((_DWORD)(uintptr_t)(&g_CRT_StderrOutputStream)));
  fputs_(v1, ((_DWORD)(uintptr_t)(&g_CRT_StderrOutputStream)));
...
int __cdecl CSS_InitMixBuffers(int sample_rate, int channel_count)
{
  ...
  CSS_Mem_TryAlloc(buffer_bytes + 34832, ((_DWORD*)(&g_CSS_MixBufferAllocBase)));
  memset_(v4, 0);
  ...
  CSS_Mem_TryAlloc(160, ((_DWORD*)(&g_CSS_QueuedSoundSlotTable)));
...
int __cdecl CSS_InitMixChannels(int channel_count)
{
  ...
  g_CSS_MixIdleChannelFlag = 0;
  g_CSS_MixSuspendedFlag = 0;
  CSS_Mem_TryAlloc(108 * channel_count, ((_DWORD*)(&g_CssMixChannels)));

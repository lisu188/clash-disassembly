...
signed int Rules_RegisterInstanceFunctions(void)
{
  ...
  Rules_AddFunctionParser(((_BYTE*)(aActiveInitiali)));
  ...
  Rules_AddFunctionParser(((_BYTE*)(aActiveMakeInst)));
  Rules_AddFunctionParser(((_BYTE*)(aInitializeInst)));
  Rules_AddFunctionParser(((_BYTE*)(aMakeInstance)));
...
void  Rules_InstancesCommand(double context)
{
  ...
  if ( !Lexer_ParseValueList(1, temp, 2, context) )
    return;
  if ( !Module_FindByName((_BYTE *)(uintptr_t)*(_DWORD *)(uintptr_t)(v11 + 16)) && strcmp_(moduleName, ((_DWORD)(uintptr_t)(asc_5033CC))) )
  {
  ...
  {
    if ( strcmp_(v6, ((_DWORD)(uintptr_t)(asc_5033CC))) )
    {
...
LABEL_16:
  ...
  {
    if ( strcmp_(keywordArg, ((_DWORD)(uintptr_t)(aInherit))) )
    {
      Lexer_ErrorRecover(1);
...
signed int __thiscall Rules_PPInstanceCommand(void *this_)
{
  ...
  result = MessageHandler_CheckCurrentMessage((int)(intptr_t)this_, 1);
  if ( result )
  {
...
_DWORD * Rules_AssertFact(const char *factString, int a2, double a3)
{
  ...
  if ( result )
  {
    ...
    if ( token_buffer[0] == 100 )
    {
      ...
      Symbol = Rules_MakeSymbol(((_BYTE*)(aMakeInstance)));
      if ( trace_load_save )
  ...
  if ( argExpr )
  {
    while ( 1 )
    {
      ...
      if ( v8[1] == 8 || v8[1] == 2 )
      {
        ...
        if ( !instance && strcmp_(0, ((_DWORD)(uintptr_t)(asc_5033CC))) )
        {
  ...
  *(_DWORD *)(uintptr_t)(returnValue + 8) = g_ClipsFalseSymbol;
  ...
  else
  {
    ...
    if ( result )
    {
      ...
      if ( !theModule && strcmp_(v4, ((_DWORD)(uintptr_t)(asc_5033CC))) )
      {
...
BOOL  Rules_InstancePCommand(int a1, double a2)
{
  ...
  Parser_ParseForm((__int16 *)(uintptr_t)*(_DWORD *)(uintptr_t)(g_ClipsCurrentExpression + 6), ((_DWORD*)(intptr_t)(theResult)), a1, a2);
        ...
        int restrictions)
{
  ...
  *(_DWORD *)(uintptr_t)(host_function_ptr + 0) = ((_DWORD)(uintptr_t)(symbol));
...
int ** Rules_MakeSymbol(_BYTE *functionName)
{
  ...
  interned_name = (int)(intptr_t)Rules_FindSymbolEntry(((_BYTE*)(intptr_t)((int)(intptr_t)functionName)));

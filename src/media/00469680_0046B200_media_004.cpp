...
_DWORD * AviPlayer_CreatePaletteFromBitmap(int self, int ddInterface)
{
  ...
  ehFrame[2] = ((_DWORD)(uintptr_t)(&g_AviPlayerCreatePalette_EHScopeTable));
  ehState = 0;
...
int AviException_CtorFromExceptionList(void)
{
  ...
  *(_DWORD *)(uintptr_t)(result + 100) = ((_DWORD)(uintptr_t)(g_AviException_VTable));
  return result;
}
// 510374: using guessed type int (*off_510374[2])();
...
int  AviException_ScalarDeletingDtor(int self, char dtorFlags)
{
  ...
  if ( (dtorFlags & 4) != 0 )
  {
    _wcpp_4_dtor_array_store__(self, ((_DWORD)(uintptr_t)(&g_AviException_DtorArrayDescriptor)));
    j_j__nfree_();
    return v5;
  }
  else
...
int  AviPlayer_UpdateStreamRectAndSendICDrawBegin(int *codecPtr, int lockedBits, int destHeight, int destWidth, int pitchPixels, int frameData, int frameFlags)
{
  ...
  drawParams[13] = ((_DWORD)(uintptr_t)(NtCurrentTeb()->NtTib.ExceptionList));
  drawParams[14] = ((_DWORD)(uintptr_t)(&j____wcpp_4_fs_handler_rtn_));
  v13 = 0;
  drawParams[15] = ((_DWORD)(uintptr_t)(&g_AviStreamRectDrawBegin_EHFrame));
  ...
  drawParams[3] = ((_DWORD)(uintptr_t)(codecPtr + 2));
  ...
  result = ICSendMessage(hic, 16446, ((DWORD)(uintptr_t)(drawParams)), 52, v11);
  if ( result < 0 )
  {
    ExcString_Ctor();
    v13 = 1;
...
signed int __cdecl Audio_DetectDSoundHardwareAccel(_DWORD *accelFlagOut)
{
  ...
  if ( g_CSS_DSoundAccelDetectEnabled )
  {
    if ( g_AudioWindowHandle )
    {
      ...
      {
        memset_(((_DWORD)(uintptr_t)(&dsCaps)), 0);
        dsCaps = 96;
...
int __thiscall Audio_ComputeBytesPerFrame(void *this_)
{
  ...
  v4 = this_;
  memset_(((_DWORD)(uintptr_t)(this_)), 0);
  dsCaps = 96;
...
signed int Audio_InitDSoundDevice(void)
{
    ...
    || (*(int (__stdcall **)(int, int, int))(uintptr_t)(*(_DWORD *)(uintptr_t)g_DirectSoundDevice + 24))(g_DirectSoundDevice, g_DSoundCoopWindowHandle, 4) )
  {
    if ( !g_CSS_DSoundWritePrimaryMode )
    {
      ...
      if ( hr )
        return Audio_ReturnDSoundError(hr);
      memset_(((_DWORD)(uintptr_t)(&bufferDescSize)), 0);
      bufferBytes = 0;
      formatPtr = 0;
      bufferDescSize = 20;
      bufferDescFlags = 1;
...
int  Audio_ReadWavHeaderFromStream(int fileName, _DWORD *formatOut)
{
  ...
  if ( (*(int (**)(void))(uintptr_t)(*(_DWORD *)(uintptr_t)stream + 16))() == -1
    ...
    || (streamPos = (*(int (**)(void))(uintptr_t)(*(_DWORD *)(uintptr_t)stream + 4))(),
        (*seekFunc)(((_DWORD)(uintptr_t)(seekFunc)), fmtChunkSize + streamPos - 16),

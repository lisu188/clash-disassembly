        ...
        int openFlags)
{
  ...
  instance = *selfPtr;
  surface2Out[0] = 0;
  if ( !(**ddSurface)((_DWORD)(uintptr_t)ddSurface, &g_AviQueryInterfaceIid, surface2Out) )
  {
    *(_DWORD *)(uintptr_t)(instance + 1952) = (_DWORD)(uintptr_t)ddSurface;
...
void __stdcall PlayAvi(char *fileName, IDirectDrawSurface *ddSurface, int x, int y, int (*continueCallback)(void), int openFlags)
{
  ...
  CAviDecompressor_Init(aviHandle, (int (***)(_DWORD, void *, _DWORD *))ddSurface, (int)(intptr_t)fileName, openFlags);
  if ( CAviDecompressor_Initialized(((_DWORD*)(aviHandle))) )
  {
  ...
  CAviDecompressor_dtor(((_DWORD*)(aviHandle)));
}
...
void __stdcall PlayAviStretch(char *fileName, IDirectDrawSurface *ddSurface, tagRECT *destRect, int (*continueCallback)(void), int openFlags)
{
  ...
  CAviDecompressor_ConstructEmpty(aviHandle, 0);
  v10 = 1;
  CAviDecompressor_InitRect(aviHandle, ((_DWORD*)(destRect)));
  CAviDecompressor_Init(aviHandle, (int (***)(_DWORD, void *, _DWORD *))ddSurface, (int)(intptr_t)fileName, openFlags);
  if ( CAviDecompressor_Initialized(((_DWORD*)(aviHandle))) )
  {
    CAviDecompressor_Start(aviHandle);
...
int  CAviDecompressor_ConstructSourceInterface(int self)
{
  ...
  *(_DWORD *)(uintptr_t)(self + 163) = 0;
  fieldPtr = self + 171;
  *(_DWORD *)(uintptr_t)(self + 167) = ((_DWORD)(uintptr_t)(CreateEventA(0, 0, 0, 0)));
  fieldPtr += 4;
  *(_DWORD *)(uintptr_t)(fieldPtr - 4) = ((_DWORD)(uintptr_t)(CreateEventA(0, 0, 0, 0)));
...
char * CAviDecompressor_DestroySourceInterface(int self, char dtorFlags)
{
  ...
  if ( (dtorFlags & 4) != 0 )
  {
    _wcpp_4_dtor_array_store__(self, ((_DWORD)(uintptr_t)(&g_CAviSourceInterface_DtorArrayTag)));
    j_j__nfree_();
    return (char *)(uintptr_t)v6;
  }
  else
  {
    *(_DWORD *)(uintptr_t)(self + 411) = ((_DWORD)(uintptr_t)(&g_CAviSourceInterface_Vtable));
...
int  CAviDecompressor_InitCommon(int self)
{
  ...
  *(_BYTE *)(uintptr_t)(self + 1) = 1;
  *(_DWORD *)(uintptr_t)(self + 167) = ((_DWORD)(uintptr_t)(CreateEventA(0, 0, 0, 0)));
  *(_DWORD *)(uintptr_t)(self + 171) = ((_DWORD)(uintptr_t)(CreateEventA(0, 0, 0, 0)));
  InitializeCriticalSection((LPCRITICAL_SECTION)(uintptr_t)(self + 179));
  *(_DWORD *)(uintptr_t)(self + 387) = ((_DWORD)(uintptr_t)(CreateEventA(0, 0, 0, 0)));
  *(_DWORD *)(uintptr_t)(self + 403) = ((_DWORD)(uintptr_t)(CreateEventA(0, 0, 0, 0)));
  *(_DWORD *)(uintptr_t)(self + 407) = ((_DWORD)(uintptr_t)(CreateEventA(0, 0, 0, 0)));
  *(_DWORD *)(uintptr_t)(self + 411) = ((_DWORD)(uintptr_t)(&g_CAviSourceInterface_Vtable));
  InitializeCriticalSection((LPCRITICAL_SECTION)(uintptr_t)(self + 1989));
  *(_DWORD *)(uintptr_t)(self + 2196) = ((_DWORD)(uintptr_t)(CreateEventA(0, 1, 1, 0)));
  InitializeCriticalSection((LPCRITICAL_SECTION)(uintptr_t)(self + 2204));
  *(_DWORD *)(uintptr_t)(self + 2228) = ((_DWORD)(uintptr_t)(CreateEventA(0, 1, 1, 0)));
  *(_DWORD *)(uintptr_t)(self + 2232) = ((_DWORD)(uintptr_t)(&g_CAviDecompressor_Vtable));
...
int  CAviDecompressor_Destroy(int self, char dtorFlags)
{
  ...
  if ( (dtorFlags & 4) != 0 )
  {
    _wcpp_4_dtor_array_store__(self, ((_DWORD)(uintptr_t)(&g_CAviDecompressor_DtorArrayTag)));
    j_j__nfree_();
    return v11;
  }
  else
...
DWORD __stdcall StartAddress(char *lpThreadParameter)
{
  ...
  if ( !lpThreadParameter[1] )
  {
    ...
    audioSampleQueue = ((_DWORD*)(lpThreadParameter + 391));
          ...
          if ( nextOffset != -1 )
          {
            ...
            AVIStreamRead(
              ...
              *(_DWORD *)(lpThreadParameter + 155),
              ((DWORD)(uintptr_t)(&audioBytesRead)),
              0);
...
LABEL_28:
  ...
  guardPtr = ((_DWORD*)(threadRefCount));
        ...
        __int64 ThreadId_2)
{
  ...
  *(_DWORD *)(&Buffer_30a + 2) = ((_DWORD)(uintptr_t)(NtCurrentTeb()->NtTib.ExceptionList));
  *(_DWORD *)((char *)&a23 + 2) = ((_DWORD)(uintptr_t)(&j____wcpp_4_fs_handler_rtn_));
  *(_DWORD *)((char *)&a23 + 6) = ((_DWORD)(uintptr_t)(&g_AviOpenFileDecodeThread_EHFrame));
  *(_DWORD *)((char *)&a24 + 2) = 0;
  ...
  {
    AVIFileInfoA(*(_DWORD *)(uintptr_t)(self + 3), ((DWORD)(uintptr_t)(fileInfo)), 108);
    ...
    {
      AVIStreamReadFormat(*(_DWORD *)(uintptr_t)(self + 7), 0, 0, ((DWORD)(uintptr_t)((char *)&a25 + 2)));
      *(_DWORD *)(uintptr_t)(self + 151) = j_Mem_Alloc(formatSize);
      AVIStreamReadFormat(*(_DWORD *)(uintptr_t)(self + 7), 0, *(_DWORD *)(uintptr_t)(self + 151), ((DWORD)(uintptr_t)((char *)&a25 + 2)));
...
char  AviPlayer_OpenAndPrepare(unsigned int *self)
{
  ...
  player = self;
  if ( AVIFileGetStream(*(unsigned int *)((char *)self + 3), ((DWORD)(uintptr_t)((char *)self + 215)), 1935963489, 0) )
  {
  ...
  {
    AVIStreamReadFormat(*(unsigned int *)((char *)player + 215), 0, 0, ((DWORD)(uintptr_t)(&formatSize)));
    formatAlloc = j_Mem_Alloc(v2);
    *(_DWORD *)(uintptr_t)(HIDWORD(formatAlloc) + 363) = formatAlloc;
    audioStreamInfo = player;
    AVIStreamReadFormat(*(_DWORD *)(uintptr_t)(HIDWORD(formatAlloc) + 215), 0, *(_DWORD *)(uintptr_t)(HIDWORD(formatAlloc) + 363), ((DWORD)(uintptr_t)(&formatSize)));
    audioStreamInfo = (unsigned int *)((char *)audioStreamInfo + 219);
    AVIStreamInfoA(*(unsigned int *)((char *)player + 215), ((DWORD)(uintptr_t)(audioStreamInfo)), 140);
    ...
    *(_DWORD *)(uintptr_t)(HIDWORD(chunkBufAlloc) + 156) = chunkBufAlloc;
    ...
    frameIndexAlloc = j_Mem_Alloc(((_DWORD)(uintptr_t)(player)));
    ...
    *(_DWORD *)(uintptr_t)(v14 + 379) = frameIndexAlloc;
    while ( 1 )
    {
      ...
      AVIStreamRead(readBlockAlign, bytesForStreamRead % readBlockAlign, *(unsigned int *)((char *)player + 215), sampleCount * (bytesForStreamRead / readBlockAlign), samplesToRead, startSample, destBuffer, ((DWORD)(uintptr_t)(&bytesRead)), 0);
      chunkBytes = bytesRead;
      sampleWriteIndex = audioSampleQueue[2];
      audioSampleQueue[2] = sampleWriteIndex + 1;

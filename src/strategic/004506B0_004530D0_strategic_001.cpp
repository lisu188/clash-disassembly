    ...
    if ( result != -1 )
    {
      if ( PLAYER_QUEEN_RELATIONSHIP_STATE(g_CurrentPlayerIndex) )
      {
        if ( result == QUEEN_RELATIONSHIP_STATE_CHILDBIRTH_PENDING )
        {
          ...
          if ( host_building )
          {
            Building_CreateSpecialPersonageGarrisonUnit(host_building, (unit_type)(unsigned int)(a2), host_building, a2, a4);
            ...
            if ( PLAYER_HAS_HUMAN_CONTROLLER(g_CurrentPlayerIndex) )
            {
              ...
              if ( a2 == 33 )
                sprintf_((char*)(&g_QueenBirthMessageBuffer), (const char *)(uintptr_t)son_birth_texts[(unsigned __int8)g_LanguageIndex], castle_name_ptr);
              else
                sprintf_((char*)(&g_QueenBirthMessageBuffer), (const char *)(uintptr_t)daughter_birth_texts[(unsigned __int8)g_LanguageIndex], castle_name_ptr);
        ...
        if ( GAME_TURN_COUNTER >= *(_WORD *)(uintptr_t)(result + 141445) )
        {
          if ( *(_DWORD *)(uintptr_t)(result + 140051) )
          {
            ...
            if ( Queen_ShowWhimDecisionDialog(
                   (int)(intptr_t)(g_QueenWhimRecords[whim_index].texts[(unsigned __int8)g_LanguageIndex]),
        ...
        if ( result >= 1000 )
        {
          ...
          if ( PLAYER_HAS_HUMAN_CONTROLLER(g_CurrentPlayerIndex) )
          {
            Diagnostics_TraceWorldMapActionEvent(
              ...
              GAME_TURN_COUNTER);
            Win_PlayModeChangeFrameTransition((const char*)(intptr_t)((int)(intptr_t)aP_posla), 1, gameData, a2, (DWORD)(intptr_t)savedregs, a3);
            Diagnostics_TraceWorldMapActionEvent(
      ...
      || (result = UnitStack_HasBuilder(stack_index)) == 0 )
    {
      ...
      if ( result < 10 )
      {
        ...
        if ( human_ally_alive )
        {
          ...
          sprintf_((char*)(message_buffer), notice_format, PLAYER_DATA_STRIDE * v13 + gameData + PLAYER_RUNTIME_STATE_OFFSET + 4);
...
int  Options_RunInGameSettingsDialog(int a1, char a2, DWORD a3)
{
  ...
  int (*prev_render_hook)(int, char, DWORD); // [esp+196h] [ebp-1Ch]

  sprite_set = (_DWORD *)(uintptr_t)Mem_Alloc(4112, a1, a2, a3);
  if ( sprite_set )
    sprite_set = DLXSpriteSet_Load(sprite_set, (const void*)(intptr_t)(a2));
  ...
  *(_DWORD *)&v17[25] = (_DWORD)(uintptr_t)(aStdrh_19);
  ...
  *(_WORD *)copy_dest = *(_WORD *)copy_src;
  ...
  (*(void (__fastcall **)(int, int, int, int, int, int, int, _DWORD, _DWORD))(uintptr_t)(*((_DWORD *)g_RenderDevice + 46) + 52))(
    ...
    0,
    0);
  UIWidgetTable_InitDrawStates((_DWORD*)(widget_table));
  ...
  do
  {
    ...
    UIWidgetTable_PollHoverAndActions((_DWORD*)(widget_table), prev_resource_handle);
    Options_AnimateAllSliderThumbs((_DWORD*)(g_InGameSliderThumbPositions));
  }
  ...
  *(_BYTE *)(uintptr_t)(gameData + 147172) = (unsigned __int16)(16 * g_OptionsInGameSoundVolumeRaw
  ...
  Options_DestroySliderThumbList((_DWORD*)(g_InGameSliderThumbPositions));
  ...
  if ( result )
  {
    ...
    *i = 0;
    ...
    if ( g_CheatTable )
    {
      do
      {
        result = strcmp_(table_offset, (_DWORD)(uintptr_t)(cheat_buffer));
        if ( !result )
...
unsigned int  Rules_CreateArmyFact(clash95_unaligned_int16 *stack_record, int army_id, int a3, int a4_promoted, DWORD a5)
{
  ...
  if ( result <= 0x28 )
  {
    ...
    * (clash95_unaligned_uint32 *)((char *)stack_record + 721) = (_DWORD)(uintptr_t)fact;
    if ( !fact )
      return 0;
...
clash95_unaligned_uint32 * Rules_RetractArmyFact(clash95_unaligned_uint32 *result, int a2, int a3, double a4)
{
  ...
  stack = (clash95_unaligned_int16 *)result;
  v10 = a3;
  v9 = a2;
  if ( *(clash95_unaligned_uint32 *)((char *)result + 721) )
  {
    Rules_RetractFactById(*(clash95_unaligned_uint32 *)((char *)result + 721), a4);
    sprintf_(fact_text, "(usunieto armie %d )", *(unsigned __int16 *)(uintptr_t)(TILE_INDEX(*stack, stack[1])));
    result = Rules_Log(fact_text, 0, a4);
    *(clash95_unaligned_uint32 *)((char *)stack + 721) = 0;
  }
  else
  {
    *(clash95_unaligned_uint32 *)((char *)stack + 721) = 0;

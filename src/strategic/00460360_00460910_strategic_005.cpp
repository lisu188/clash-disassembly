...
#include "00460360_00460910_strategic_005_local.h"
...
void Scenario_LoadMissionByIndex(int mission_index, double a2)
{
  ...
  switch ( mission_index )
  {
    case 0:
      ...
      createCastle(a2, 30, 42, 0, 2, (char*)("Cantbelly"), UNIT_TYPE_BUILDER, UNIT_TYPE_PEASANT, UNIT_TYPE_PEASANT, UNIT_TYPE_PEASANT, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_ARCHER, -1);
    ...
    case 1:
      ...
      MiniMap_CreateSurface(a2);
      createCastle(a2, 44, 46, 0, 2, (char*)("Stormus"), UNIT_TYPE_BUILDER, UNIT_TYPE_PEASANT, UNIT_TYPE_PEASANT, UNIT_TYPE_PEASANT, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_ARCHER, UNIT_TYPE_GORAL, UNIT_TYPE_FORESTER, -1);
      createUnit(a2, 44, 48, 0, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, -1);
      castle_index = createCastle(a2, 1, 23, 1, 2, (char*)("Drakefly"), UNIT_TYPE_BUILDER, UNIT_TYPE_PEASANT, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_FORESTER, UNIT_TYPE_FORESTER, -1);
    ...
    case 2:
      ...
      strcpy((char *)(uintptr_t)(PLAYER_DATA(1) + PLAYER_DISPLAY_NAME_OFFSET), "Bochuwit");
      MiniMap_CreateSurface(a2);
      createUnit(a2, 98, 24, 0, UNIT_TYPE_ARCHER, (unit_type)(unsigned int)(-1));
      ...
      createUnit(a2, 98, 26, 0, UNIT_TYPE_RAM, (unit_type)(unsigned int)(-1));
      castle_index = createCastle(a2, 41, 68, 1, 2, (char*)("Treg Rock"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      *(_WORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 18) = -1;
      Building_OnGarrisonChange(castle_index, 0, a2);
      ...
      createUnit(a2, 91, 6, 1, UNIT_TYPE_ARCHER, (unit_type)(unsigned int)(-1));
      createUnit(a2, 85, 9, 1, UNIT_TYPE_ARCHER, (unit_type)(unsigned int)(-1));
      createUnit(a2, 43, 52, 1, UNIT_TYPE_ARCHER, (unit_type)(unsigned int)(-1));
      createUnit(a2, 68, 68, 1, UNIT_TYPE_LIGHT_INFANTRY, (unit_type)(unsigned int)(-1));
      createUnit(a2, 35, 69, 1, UNIT_TYPE_LIGHT_INFANTRY, (unit_type)(unsigned int)(-1));
    ...
    case 3:
      ...
      MiniMap_CreateSurface(a2);
      castle_index = createCastle(a2, 21, 21, 0, 1, (char*)("Ughuata"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      *(_WORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 18) = -1;
    ...
    case 4:
      ...
      MiniMap_CreateSurface(a2);
      createCastle(a2, 41, 48, 0, 2, (char*)("Totaweon"), UNIT_TYPE_BUILDER, UNIT_TYPE_BUILDER, UNIT_TYPE_BUILDER, UNIT_TYPE_BUILDER, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, UNIT_TYPE_GORAL, UNIT_TYPE_GORAL, UNIT_TYPE_GORAL, -1);
      ...
      castle_index = createCastle(a2, 56, 69, 1, 1, (char*)("Hopenberg"), UNIT_TYPE_BUILDER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, -1);
      ...
      *(_WORD *)(uintptr_t)(building_record + 18) = 9;
      ...
      castle_index = createCastle(a2, 32, 36, 2, 2, (char*)("Jolarion"), UNIT_TYPE_BUILDER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_PEASANT, UNIT_TYPE_PEASANT, UNIT_TYPE_PEASANT, UNIT_TYPE_LIGHT_INFANTRY, -1);
      *(_WORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 18) = -1;
      Building_OnGarrisonChange(castle_index, 0, a2);
      castle_index = createCastle(a2, 50, 23, 2, 2, (char*)("Akserion"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      *(_WORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 18) = -1;
      Building_OnGarrisonChange(castle_index, 0, a2);
      createUnit(a2, 50, 25, 2, UNIT_TYPE_ARCHER, UNIT_TYPE_FORESTER, UNIT_TYPE_LIGHT_CAVALRY, -1);
      castle_index = createCastle(a2, 25, 48, 2, 2, (char*)("Bodeon"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      *(_WORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 18) = -1;
      Building_OnGarrisonChange(castle_index, 0, a2);
    ...
    case 5:
      ...
      *(_BYTE *)(uintptr_t)(gameData + MISSION_FAILURE_FLAG_OFFSET) = 0;
      ...
      MiniMap_CreateSurface(a2);
      castle_index = createCastle(a2, 71, 45, 0, 2, (char*)("Defambrion"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      *(_DWORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 438) += 200;
      ...
      createCastle(a2, 56, 21, 1, 2, (char*)("Histone"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      castle_index = createCastle(a2, 26, 41, 1, 2, (char*)("Katha Gha"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      *(_DWORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 438) = 1000;
      ...
      createCastle(a2, 68, 77, 2, 2, (char*)("Girock"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      castle_index = createCastle(a2, 42, 54, 3, 2, (char*)("Ghih Up"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      *(_WORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 18) = -1;
    ...
    case 6:
      ...
      MiniMap_CreateSurface(a2);
      createUnit(a2, 13, 4, 0, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, (unit_type)(unsigned int)(-1));
      createUnit(a2, 14, 4, 0, UNIT_TYPE_LIGHT_INFANTRY, (unit_type)(unsigned int)(-1));
      createUnit(a2, 14, 3, 0, UNIT_TYPE_CANNON, (unit_type)(unsigned int)(-1));
      createCastle(a2, 30, 23, 1, 2, (char*)("Dragmounth"), UNIT_TYPE_BUILDER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, -1);
      createCastle(a2, 54, 4, 1, 2, (char*)("Akserion"), UNIT_TYPE_BUILDER, UNIT_TYPE_FORESTER, UNIT_TYPE_FORESTER, UNIT_TYPE_FORESTER, UNIT_TYPE_FORESTER, UNIT_TYPE_FORESTER, -1);
      ...
      *(_BYTE *)(uintptr_t)(UNIT_STACK(stack_index) + 251) |= 3u;
      ...
      Rules_SyncArmyFactStrength(
        ...
        200 * UNIT_STACK_TILE_ROW(UNIT_STACK(stack_index)),
        a2);
      castle_index = createCastle(a2, 90, 41, 2, 2, (char*)("Ghettan"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      building_record = BUILDING_RECORD(castle_index);
      BUILDING_PRISONER_TYPE(BUILDING_PRISONER_SLOT(building_record, 0)) = UNIT_TYPE_SPECIAL_MOUNTED_PERSONAGE;
      BUILDING_PRISONER_OWNER(BUILDING_PRISONER_SLOT(building_record, 0)) = 0;
      castle_index = createCastle(a2, 41, 67, 2, 2, (char*)("Bhua Rock"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      *(_DWORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 438) = 1000;
      castle_index = createCastle(a2, 5, 56, 2, 1, (char*)("Jolarion"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
    ...
    case 7:
      ...
      ((void)a2, Rules_RetractTreasureFact(55, 45));
      ((void)a2, Rules_RetractTreasureFact(50, 27));
      ((void)a2, Rules_RetractTreasureFact(35, 63));
      ((void)a2, Rules_RetractTreasureFact(14, 68));
      for ( player_index = 0; player_index < 5; ++player_index )
        Game_ResetPlayerRuntimeStateByIndex(player_index);
      PLAYER_IS_ACTIVE(0) = 1;
      PLAYER_IS_ACTIVE(1) = 1;
      ...
      MiniMap_CreateSurface(a2);
      createCastle(a2, 56, 70, 0, 2, (char*)("Weghetown"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      createCastle(a2, 1, 51, 0, 1, (char*)("Henrion"), UNIT_TYPE_BUILDER, UNIT_TYPE_BUILDER, UNIT_TYPE_BUILDER, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, -1);
      ...
      createCastle(a2, 9, 25, 1, 2, (char*)("Moon Town"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      createCastle(a2, 18, 34, 1, 2, (char*)("Gate Stone"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      createCastle(a2, 43, 21, 2, 2, (char*)("Canoowar"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      createCastle(a2, 54, 31, 2, 1, (char*)("Trungeon"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      createCastle(a2, 77, 39, 3, 2, (char*)("Leweburg"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      createCastle(a2, 75, 67, 3, 1, (char*)("Defambrion"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
    ...
    case 8:
      ...
      MiniMap_CreateSurface(a2);
      createCastle(a2, 8, 27, 0, 2, (char*)("Totaweon"), UNIT_TYPE_BUILDER, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, -1);
      castle_index = createCastle(a2, 30, 23, 0, 2, (char*)("Gordmouth"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      building_record = BUILDING_RECORD(castle_index);
      *(_DWORD *)(uintptr_t)(building_record + 438) -= 100;
      ...
      createUnit(a2, 10, 14, 0, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, (unit_type)(unsigned int)(-1));
      createUnit(a2, 11, 31, 0, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, (unit_type)(unsigned int)(-1));
      createUnit(a2, 22, 29, 0, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, (unit_type)(unsigned int)(-1));
      createUnit(a2, 30, 39, 0, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, (unit_type)(unsigned int)(-1));
      createUnit(a2, 1, 28, 0, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, (unit_type)(unsigned int)(-1));
      createUnit(a2, 8, 50, 0, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, (unit_type)(unsigned int)(-1));
      createUnit(a2, 21, 57, 0, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, (unit_type)(unsigned int)(-1));
      createUnit(a2, 21, 59, 0, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, (unit_type)(unsigned int)(-1));
      createUnit(a2, 28, 57, 0, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, (unit_type)(unsigned int)(-1));
      createCastle(a2, 22, 77, 1, 2, (char*)("Timbran"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      createCastle(a2, 59, 66, 1, 2, (char*)("Ghettan"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      createCastle(a2, 4, 62, 2, 2, (char*)("Hopenberg"), UNIT_TYPE_BUILDER, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, -1);
      createCastle(a2, 84, 64, 2, 2, (char*)("Katha Gha"), UNIT_TYPE_BUILDER, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, -1);
      ...
      createCastle(a2, 96, 86, 3, 2, (char*)("Werneom"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
    ...
    case 9:
      ...
      MiniMap_CreateSurface(a2);
      castle_index = createCastle(a2, 13, 3, 0, 2, (char*)("Gorendberg"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      building_record = BUILDING_RECORD(castle_index);
      *(_DWORD *)(uintptr_t)(building_record + 438) -= 100;
      *(_BYTE *)(uintptr_t)(building_record + 444) = *(_BYTE *)(uintptr_t)(building_record + 444) & 0xF8 | 2;
      castle_index = createCastle(a2, 94, 95, 0, 2, (char*)("Timbran"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      building_record = BUILDING_RECORD(castle_index);
      ...
      *(_BYTE *)(uintptr_t)(building_record + 444) = *(_BYTE *)(uintptr_t)(building_record + 444) & 0xF8 | 2;
      ...
      castle_index = createCastle(a2, 62, 53, 1, 2, (char*)("Ghettan"), UNIT_TYPE_BUILDER, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, -1);
      building_record = BUILDING_RECORD(castle_index);
      *(_DWORD *)(uintptr_t)(building_record + 438) = 3000;
      ...
      castle_index = createCastle(a2, 58, 11, 2, 2, (char*)("Bhua Rock"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      building_record = BUILDING_RECORD(castle_index);
      *(_DWORD *)(uintptr_t)(building_record + 438) = 3000;
      ...
      createCastle(a2, 95, 16, 3, 2, (char*)("Katha Gha"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      createCastle(a2, 11, 41, 3, 2, (char*)("Stormus"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      castle_index = createCastle(a2, 32, 84, 4, 2, (char*)("Guluali"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      building_record = BUILDING_RECORD(castle_index);
      *(_DWORD *)(uintptr_t)(building_record + 438) += 500;
    ...
    case 10:
      ...
      MiniMap_CreateSurface(a2);
      castle_index = createCastle(a2, 15, 31, 1, 2, (char*)("Timbran"), UNIT_TYPE_BUILDER, UNIT_TYPE_PEASANT, UNIT_TYPE_PEASANT, UNIT_TYPE_PEASANT, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_ARCHER, -1);
      building_record = BUILDING_RECORD(castle_index);
      *(_DWORD *)(uintptr_t)(building_record + 438) -= 100;
      ...
      *(_WORD *)(uintptr_t)(building_record + 430) = (building_word & 0xF000) | (((building_word & 0xFFF) - 0x32) & 0xFFF);
      ...
      createUnit(a2, 34, 37, 2, UNIT_TYPE_ARCHER, (unit_type)(unsigned int)(-1));
      createUnit(a2, 11, 13, 2, UNIT_TYPE_ARCHER, (unit_type)(unsigned int)(-1));
      createUnit(a2, 4, 22, 2, UNIT_TYPE_ARCHER, (unit_type)(unsigned int)(-1));
      createUnit(a2, 10, 25, 2, UNIT_TYPE_LIGHT_INFANTRY, (unit_type)(unsigned int)(-1));
      Rules_LogMissionSetupInfo();
      Game_InitPlayerViewState();
      break;
    case 11:
      ...
      MiniMap_CreateSurface(a2);
      createCastle(a2, 22, 13, 1, 2, (char*)("Gatgally"), UNIT_TYPE_BUILDER, UNIT_TYPE_PEASANT, UNIT_TYPE_PEASANT, UNIT_TYPE_PEASANT, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_ARCHER, UNIT_TYPE_GORAL, UNIT_TYPE_GORAL, -1);
      createUnit(a2, 22, 15, 1, UNIT_TYPE_BUILDER, UNIT_TYPE_FORESTER, UNIT_TYPE_FORESTER, UNIT_TYPE_GORAL, UNIT_TYPE_GORAL, -1);
      createCastle(a2, 34, 5, 2, 2, (char*)("Guluali"), UNIT_TYPE_BUILDER, UNIT_TYPE_PEASANT, UNIT_TYPE_PEASANT, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_FORESTER, UNIT_TYPE_FORESTER, -1);
    ...
    case 12:
      ...
      strcpy((char *)(uintptr_t)(PLAYER_DATA(2) + PLAYER_DISPLAY_NAME_OFFSET), "Gaalaad");
      MiniMap_CreateSurface(a2);
      createUnit(a2, 70, 81, 1, UNIT_TYPE_ARCHER, (unit_type)(unsigned int)(-1));
      ...
      createUnit(a2, 71, 83, 1, UNIT_TYPE_RAM, (unit_type)(unsigned int)(-1));
      castle_index = createCastle(a2, 59, 14, 2, 2, (char*)("Sarturia"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      building_record = BUILDING_RECORD(castle_index);
    ...
    case 13:
      ...
      MiniMap_CreateSurface(a2);
      createCastle(a2, 23, 26, 1, 2, (char*)("Ungught"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      createUnit(a2, 25, 25, 1, UNIT_TYPE_GORAL, (unit_type)(unsigned int)(-1));
    ...
    case 14:
      ...
      MiniMap_CreateSurface(a2);
      castle_index = createCastle(a2, 50, 3, 1, 2, (char*)("Weghetown"), UNIT_TYPE_BUILDER, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, -1);
      building_record = BUILDING_RECORD(castle_index);
      building_word = *(_WORD *)(uintptr_t)(building_record + 430);
      *(_WORD *)(uintptr_t)(building_record + 430) = building_word & 0xF000;
      ...
      castle_index = createCastle(a2, 52, 24, 2, 2, (char*)("Timbran"), UNIT_TYPE_BUILDER, UNIT_TYPE_FORESTER, UNIT_TYPE_FORESTER, UNIT_TYPE_FORESTER, UNIT_TYPE_FORESTER, UNIT_TYPE_FORESTER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, UNIT_TYPE_ARCHER, -1);
      building_record = BUILDING_RECORD(castle_index);
      *(_WORD *)(uintptr_t)(building_record + 18) = 0xF;
      ...
      castle_index = createCastle(a2, 39, 18, 3, 2, (char*)("Fraggmeon"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      *(_DWORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 438) += 200;
      castle_index = createCastle(a2, 17, 34, 3, 2, (char*)("Eufurhon"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      *(_DWORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 438) += 200;
    ...
    case 15:
      ...
      *(_BYTE *)(uintptr_t)(gameData + MISSION_FAILURE_FLAG_OFFSET) = 0;
      ...
      MiniMap_CreateSurface(a2);
      castle_index = createCastle(a2, 59, 9, 1, 2, (char*)("Defambrion"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      *(_DWORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 438) += 200;
      createCastle(a2, 50, 96, 1, 1, (char*)("Ghondur"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      createCastle(a2, 86, 55, 2, 2, (char*)("Histone"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      createCastle(a2, 79, 2, 3, 2, (char*)("Girock"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      castle_index = createCastle(a2, 48, 38, 4, 2, (char*)("Ghih Up"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      building_record = BUILDING_RECORD(castle_index);
      ...
      *(_WORD *)(uintptr_t)(building_record + 18) = -1;
      ...
      castle_index = createCastle(a2, 19, 32, 4, 2, (char*)("Guluali"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      *(_DWORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 438) = 2000;
    ...
    case 16:
      ...
      *(_BYTE *)(uintptr_t)(gameData + MISSION_FAILURE_FLAG_OFFSET) = 0;
      ...
      MiniMap_CreateSurface(a2);
      createUnit(a2, 21, 35, 1, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, (unit_type)(unsigned int)(-1));
      createUnit(a2, 20, 36, 1, UNIT_TYPE_LIGHT_INFANTRY, UNIT_TYPE_LIGHT_INFANTRY, -1);
      createUnit(a2, 22, 36, 1, UNIT_TYPE_CANNON, (unit_type)(unsigned int)(-1));
      createUnit(a2, 22, 36, 1, UNIT_TYPE_CANNON, UNIT_TYPE_BUILDER, -1);
      castle_index = createCastle(a2, 91, 43, 2, 2, (char*)("Gwadat"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      building_record = BUILDING_RECORD(castle_index);
      *(_BYTE *)(uintptr_t)(building_record + 444) = *(_BYTE *)(uintptr_t)(building_record + 444) & 0xF8 | 3;
      createCastle(a2, 54, 74, 2, 2, (char*)("Cantown"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      createCastle(a2, 35, 3, 2, 3, (char*)("Thubeos"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      createCastle(a2, 66, 45, 2, 3, (char*)("Akserion"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
    ...
    case 17:
      ...
      *(_BYTE *)(uintptr_t)(gameData + MISSION_FAILURE_FLAG_OFFSET) = 0;
      ((void)a2, Rules_RetractTreasureFact(50, 34));
      ((void)a2, Rules_RetractTreasureFact(51, 73));
      ((void)a2, Rules_RetractTreasureFact(77, 34));
      ((void)a2, Rules_RetractTreasureFact(24, 49));
      for ( player_index = 0; player_index < 5; ++player_index )
        Game_ResetPlayerRuntimeStateByIndex(player_index);
      PLAYER_IS_ACTIVE(1) = 1;
      PLAYER_IS_ACTIVE(2) = 1;
      ...
      MiniMap_CreateSurface(a2);
      createCastle(a2, 11, 45, 1, 2, (char*)("Stormus"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      castle_index = createCastle(a2, 70, 20, 1, 1, (char*)("Dark Town"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      building_record = BUILDING_RECORD(castle_index);
      *(_DWORD *)(uintptr_t)(building_record + 438) -= 100;
      ...
      createCastle(a2, 32, 5, 2, 2, (char*)("Treg Rock"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      createCastle(a2, 42, 27, 2, 2, (char*)("Bodeon"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      createCastle(a2, 25, 38, 3, 2, (char*)("Girock"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      createCastle(a2, 61, 41, 3, 1, (char*)("Bodeon"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      createCastle(a2, 62, 84, 4, 2, (char*)("Leweburg"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      createCastle(a2, 58, 61, 4, 1, (char*)("Defambrion"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
    ...
    case 18:
      ...
      MiniMap_CreateSurface(a2);
      createCastle(a2, 85, 38, 1, 2, (char*)("Cantbelly"), UNIT_TYPE_BUILDER, UNIT_TYPE_BUILDER, UNIT_TYPE_BUILDER, -1);
      castle_index = createCastle(a2, 15, 23, 1, 2, (char*)("Stone Bell"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      building_record = BUILDING_RECORD(castle_index);
      *(_DWORD *)(uintptr_t)(building_record + 438) -= 100;
      ...
      createCastle(a2, 9, 89, 2, 2, (char*)("Timbran"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      createCastle(a2, 6, 5, 3, 2, (char*)("Hopenberg"), UNIT_TYPE_BUILDER, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, -1);
      createCastle(a2, 82, 55, 3, 2, (char*)("Katha Gha"), UNIT_TYPE_BUILDER, UNIT_TYPE_SPECIAL_MOUNTED_PERSONAGE, -1);
      ...
      createCastle(a2, 27, 49, 4, 2, (char*)("Werneom"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      createCastle(a2, 48, 72, 4, 1, (char*)("Bokumia"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      *(_BYTE *)(uintptr_t)(UNIT_STACK_SLOT(UNIT_STACK(stack_index), 2) + 28) |= 2u;
      castle_index = createCastle(a2, 62, 79, 0, 1, (char*)("Fhur Tao"), UNIT_TYPE_BUILDER, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, -1);
      building_record = BUILDING_RECORD(castle_index);
    ...
    case 19:
      ...
      MiniMap_CreateSurface(a2);
      castle_index = createCastle(a2, 83, 15, 1, 2, (char*)("Gorendberg"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      building_record = BUILDING_RECORD(castle_index);
      *(_DWORD *)(uintptr_t)(building_record + 438) -= 100;
      createCastle(a2, 73, 68, 1, 2, (char*)("Timbran"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      castle_index = createCastle(a2, 20, 9, 2, 2, (char*)("Ghettan"), UNIT_TYPE_BUILDER, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, UNIT_TYPE_SPECIAL_FOOT_PERSONAGE, -1);
      *(_DWORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 438) = 600;
      createCastle(a2, 70, 30, 2, 2, (char*)("Drakefly"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      createCastle(a2, 36, 54, 3, 2, (char*)("Bhua Rock"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      ...
      createCastle(a2, 79, 2, 4, 2, (char*)("Katha Gha"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      castle_index = createCastle(a2, 88, 63, 4, 1, (char*)("Stormus"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      *(_DWORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 438) += 300;
      ...
      castle_index = createCastle(a2, 95, 51, 0, 2, (char*)("Guluali"), UNIT_TYPE_BUILDER, (unit_type)(unsigned int)(-1));
      *(_DWORD *)(uintptr_t)(BUILDING_RECORD(castle_index) + 438) += 300;
...
int __thiscall RenderState_ConstructGlobalInstance(void *this_)
{
  ...
  Device_GetParamA((int)(intptr_t)g_RenderState, (int)(intptr_t)this_);
...
CLASH95_TEST_VISIBLE int Compat_MenuProbeTraceEnabled(void)
{
  static int trace_state CLASH95_LOCAL_DATA_SYMBOL("trace_state.1", "Compat_MenuProbeTraceEnabled.trace_state") = -1;
...
CLASH95_INTERNAL void Compat_MenuProbeTraceRenderInput(
        ...
        int extra1)
{
  static unsigned int trace_count CLASH95_LOCAL_DATA_SYMBOL("trace_count.0", "Compat_MenuProbeTraceRenderInput.trace_count");
...
_DWORD * RenderState_ConstructDefault(int render_state, int a2)
{
  ...
  *(_DWORD *)(uintptr_t)(palette_base - 16) = 0;
  ...
  palette_array[258] = 2;
  palette_array[259] = 5;
  palette_array[260] = (_DWORD)(uintptr_t)(g_RenderState_Vtable);
...
int  RenderState_InitCursorResources(int render_state, int a2, char a3, DWORD a4)
{
  ...
  *(_DWORD *)(uintptr_t)(render_state + 64) = (_DWORD)(uintptr_t)(sprite_set);
  ...
  *(_DWORD *)(uintptr_t)(render_state + 8) = (_DWORD)(uintptr_t)(surface);
  surface = (_DWORD *)(uintptr_t)Mem_Alloc(188, 0, a3, a4);
  if ( surface )
    surface = Render_CreateSurface((int)(intptr_t)surface, 64, 64);
  *(_DWORD *)(uintptr_t)(render_state + 12) = (_DWORD)(uintptr_t)(surface);

...
{
  /* 455830 preserves ECX (script argument 4), EBX (argument 3), and ST0;
   * it pushes the original name and force=0 for Building_New. */
  (void)unused_arg1;
  (void)unused_arg2;
  return Building_New(building_type, (DWORD)stack_index, clips_context, castle_name, 0);
}
...
int  Building_OnGarrisonChange(int building_index, int instance_record, double a3)
{
  ...
  {
    moc_value[1] = 1;
    Rules_GetInstanceSlotValue(*(_DWORD *)(uintptr_t)(result + 510137), (_BYTE*)(aMoc_1), building_index, moc_value);

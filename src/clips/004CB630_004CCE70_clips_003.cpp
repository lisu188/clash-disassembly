...
int  Deffunction_WriteConstructCodeFiles(const char *fileName, const char *pathName, int fileID, int headerFP, int maxIndices)
{
  ...
  if ( Enum )
  {
    while ( 1 )
    {
      ...
      moduleFile = Rules_ConstructCodeFileClose(v9, &moduleArrayCount, maxIndices, (_DWORD*)(&moduleArrayVersion), 0, 0);
...
LABEL_6:
    ...
    while ( 1 )
    {
      ...
      codeFP = Rules_ConstructCodeFileClose(v13, &deffunctionArrayCount, maxIndices, (_DWORD*)(&deffunctionArrayVersion), 0, 0);
...
int  Deffunction_ParseConstruct(int readSource)
{
  ...
  if ( !Deffunction_ValidateNewName() )
    return 1;
  parameterList = Parser_ParseProcParameters(readSource, g_Rules_ParsedConstructNameComment, (_DWORD*)(&v9), 0, (_DWORD*)(&minParams), (_DWORD*)(&maxParams), (_DWORD*)(&errorFlag), 0);
  if ( errorFlag )
    return 1;
...
int  Deffunction_AddDeffunction(int name, __int16 *actions, int maxParams, int minParams, int numLocalVars, int headerFlag)
{
  ...
  if ( actions )
  {
    ...
    *(_DWORD *)(uintptr_t)(deffunction + 30) = (_DWORD)(uintptr_t)(actions);
  }
  if ( watchFlag )
    watchValue = 1;
  else
...
signed int __thiscall Deffunction_PrintErrorContext(void *this_)
{
  ...
  Output_Write((int)(intptr_t)g_IO_LogicalNameTable_WError[0], (int)(intptr_t)aDeffunction_9, (int)(intptr_t)this_);
...
{
  return Rules_UndefconstructCommand((int)(intptr_t)this_, g_ClipsDefglobalConstructType);
}
// 54E6B4: using guessed type int dword_54E6B4;
...
{
  return Rules_GetConstructModuleCommand((int)(intptr_t)this_, (const char **)(uintptr_t)g_ClipsDefglobalConstructType);
}
// 54E6B4: using guessed type int dword_54E6B4;
...
{
  return Rules_PPConstructCommand((int)(intptr_t)this_, (const char **)(uintptr_t)g_ClipsDefglobalConstructType);
}
// 54E6B4: using guessed type int dword_54E6B4;
...
int  Defglobal_SetResetGlobalsCommand(int a1, double a2)
{
  ...
  if ( tokenType == -1 )
    return v4;
  Rules_RtnUnknown(1, (_DWORD*)(&v7), a2);
...
int  Defglobal_ParseDefglobalConstruct(int readSource, double a2)
{
  ...
  while ( Lexer_ParseDefglobal(readSource, constructError, (_DWORD*)(&tokenType), tokenPrimed, a2) )
  {
    Rules_FlushPPBuffer();
    IO_OutWriteToken(aDefglobal_5);
...
LABEL_10:
  ...
  if ( strcmp_(v16, (_DWORD)(uintptr_t)(asc_50BC6C)) )
  {
LABEL_16:
    Parser_ReportSyntaxError();
    *errorFlag = 1;
...
char * Defglobal_AddDefglobal(int globalName, int valueData, __int16 *valueExpr)
{
  ...
  foundDefglobal = (int*)(Defglobal_FindNextChanged());
  ...
  *(_DWORD *)(uintptr_t)(v16 + 52) = (_DWORD)(uintptr_t)(v15);
  AST_Free((int)(intptr_t)valueExpr);
  ...
  *v18 = globalName;
  ...
  if ( result != (char *)1 )
  {
    ...
    *(_DWORD *)(uintptr_t)(v21 + 4) = (_DWORD)(uintptr_t)(result);
...
LABEL_6:
    ...
    while ( 1 )
    {
      ...
      ++defglobalArrayCount;
      codeFP = Rules_ConstructCodeFileClose(v13, &defglobalArrayCount, maxIndices, (_DWORD*)(&defglobalArrayVersion), 0, 0);

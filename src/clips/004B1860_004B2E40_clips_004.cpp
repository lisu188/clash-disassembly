...
LABEL_5:
        ...
        Mem_SmallBlockFree((_DWORD*)(slotBitmap), ((int)*slotBitmap >> 3) + 3);
      }
    }
LABEL_6:
    ...
    if ( instance == (uintptr_t)(unsigned int)*(_DWORD *)(node + 4) )
    {
      ...
      if ( change_kind == 2 )
      {
        ...
        *(_DWORD *)node = (int)change_kind;
        if ( bitmap )
        {
          Mem_SmallBlockFree((_DWORD*)((void *)bitmap), (((int)*(unsigned __int16 *)bitmap) >> 3) + 3);
          *(_DWORD *)(node + 8) = 0;
        }
        return result;
      }
...
unsigned __int16 * Rules_GrowSlotBitmapSetBit(unsigned __int16 *oldBitmap, signed int bitIndex)
{
  ...
  else
  {
    ...
    if ( oldBitmap )
    {
      ...
      Mem_SmallBlockFree((_DWORD*)(oldBitmap), old_size);
    }
    *bitmap = bit_capacity;
  }
...
int  Rules_MatchObjectPatternNode(int offset, int patternNode, int endMark, double a4)
{
  ...
  if ( !g_ObjectPatternActiveClassNode )
  {
    ...
    if ( !*(_DWORD *)(uintptr_t)(patternNode + 32) )
      return (int)(intptr_t)(Rules_TraverseObjectPatternNetwork((_DWORD*)(intptr_t)(offset), (_DWORD*)(uintptr_t)(*(_DWORD *)(uintptr_t)(patternNode + 16)), endMark, a4));
  ...
  if ( (*(_BYTE *)(uintptr_t)patternNode & 2) != 0 )
  {
    ...
    *newMarker = whichField;
    ...
    if ( g_ObjectPatternMarkerListHead )
      *(_DWORD *)(uintptr_t)(endMark + 16) = (_DWORD)(uintptr_t)(newMarker);
    else
    ...
    if ( (*(_BYTE *)(uintptr_t)patternNode & 4) != 0 )
    {
      ...
      if ( !*(_DWORD *)(uintptr_t)(patternNode + 12) || Rules_EvaluatePatternConstraint(fieldPosition, (int)(intptr_t)newMarker, (_BYTE *)(uintptr_t)patternNode, *(_DWORD *)(uintptr_t)(patternNode + 12), a4) )
      {
        ...
        Rules_TraverseObjectPatternNetwork(0, (_DWORD*)(uintptr_t)(*(_DWORD *)(uintptr_t)(patternNode + 16)), (int)(intptr_t)theMarker, a4);
      }
    }
    else
    {
      ...
      for ( i = savedFieldCount - markerPosition - (*(_DWORD *)(uintptr_t)patternNode << 13 >> 24) + 2; i > 0; ++theMarker[3] )
      {
        if ( !*(_DWORD *)(uintptr_t)(patternNode + 12) || Rules_EvaluatePatternConstraint(fieldPosition, (int)(intptr_t)theMarker, (_BYTE *)(uintptr_t)patternNode, *(_DWORD *)(uintptr_t)(patternNode + 12), a4) )
        {
          if ( *(_DWORD *)(uintptr_t)(patternNode + 32) )
            Rules_AssertObjectPatternMatch((int *)(uintptr_t)*(_DWORD *)(uintptr_t)(patternNode + 32), a4);
          Rules_TraverseObjectPatternNetwork((_DWORD*)(uintptr_t)(offset + theMarker[3] - fieldPosition), (_DWORD*)(uintptr_t)(*(_DWORD *)(uintptr_t)(patternNode + 16)), (int)(intptr_t)theMarker, a4);
          g_ObjectPatternMatchFieldCount = savedFieldCount;
          g_ObjectPatternActiveClassNode = savedSlotNode;
        }
        --i;
...
int  Rules_EvaluatePatternConstraint(int objectSlotField, int selfSlotMarker, _BYTE *patternNode, int theTest, double a5)
{
  ...
  else
  {
    ...
    if ( testHead == g_ClipsSymbolOr )
    {
      ...
      if ( orClause )
      {
        while ( !Rules_EvaluatePatternConstraint(objectSlotFieldCopy, selfSlotMarker, (_BYTE*)(intptr_t)((int)(intptr_t)patternNode), orClause, a5) )
        {
          *patternNode &= ~1u;
    ...
    else if ( testHead == g_Clips_SymbolAnd )
    {
      ...
      if ( andClause )
      {
        while ( 1 )
        {
          result = Rules_EvaluatePatternConstraint(objectSlotFieldCopy, selfSlotMarker, (_BYTE*)(intptr_t)((int)(intptr_t)patternNode), andClause, a5);
          if ( !result )
            break;
          *patternNode &= ~1u;
...
int  Rules_PrintObjectPatternErrorDetail(int result, int *patternNode, int j)
{
  ...
  for ( i = patternNode; i; i = (int *)(uintptr_t)i[7] )
  {
    ...
    result = Rules_PrintObjectPatternErrorDetail(0, (int*)(intptr_t)(i[4]), j);
    if ( stopAfterFirst )
      break;
  }
  return result;

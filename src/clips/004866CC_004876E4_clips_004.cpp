...
void CRT_InitializeThreadAndFileHandleHooks(void)
{
  ...
  g_CRT_LockInitCriticalSection = (int)(intptr_t)CRT_AllocateLockSlot((void *)(uintptr_t)(CRT_LockLeave));
  ...
  ((void)CRT_ConstructThreadDataBlock, (void)lpTlsValue, _AddThreadData_());
...
int __thiscall CRT_ShutdownThreadAndFileHandleHooks(void *this_)
{
  ...
  g_CRT_LockSlotResetHook((_DWORD)(uintptr_t)(this_), (_DWORD)(uintptr_t)(&g_CRT_FileHandleLockSlots));
  v3 = v1 + 256;
  do
...
int  Surface_BuildPaletteFromBitmap(int pdd, const CHAR *bitmapName)
{
  ...
  if ( bitmapName && (ResourceA = FindResourceA(0, bitmapName, (LPCSTR)2)) != 0 )
  {
    ...
    bitmapInfo = (_DWORD*)(LockResource(Resource));
    if ( !bitmapInfo )
      OutputDebugStringA(aLockResourceFa);
    rgbQuads = (_BYTE*)((char *)bitmapInfo + *bitmapInfo);
...
int  CRT_PrintfFormatEngine(int stream, _BYTE *format, void (*outputFn)(void), int *argList)
{
  ...
  while ( *format_ptr )
  {
    ...
    {
      argCursor = *argList;
      spec_ptr = CRT_ParseWidthPrecisionSpec((char*)(format_ptr + 1), &argCursor, (int)(intptr_t)&outputStream);
      *argList = argCursor;
      specChar = *spec_ptr;
      conversion_char = specChar;
      format_ptr = (_BYTE*)(spec_ptr + 1);
      if ( !specChar )
        return char_count;
      if ( specChar == 110 )
      {
        ...
        int spec)
{
  ...
  {
    result = (unsigned __int16 *)(uintptr_t)wctomb_((_DWORD)(uintptr_t)(a3), *widePtr++);
    ...
    if ( result != (unsigned __int16 *)-1 )
    {
      ...
      while ( --mbLength != -1 )
      {
        ...
        *(_DWORD *)(uintptr_t)(spec + 40) = (_DWORD)(uintptr_t)(result);
      }
    }
  }
  return result;

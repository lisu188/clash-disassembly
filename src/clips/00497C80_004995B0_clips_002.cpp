...
int * Defgeneric_GetMethodRestrictionsCommand(_DWORD *returnValue, int a2, double context)
{
  ...
  {
    return (int*)(Rules_SetMultifieldErrorValue((int)(intptr_t)returnValue));
  }
}
  ...
  if ( theMethod[2] > 0 )
  {
    ...
    do
    {
      ...
      *((_WORD *)restrictionCellPtr + 7) = 1;
      fieldIndexValue = (int*)(intptr_t)(Rules_AddIntegerValue(fieldIndex));
      *(_DWORD *)(uintptr_t)(v19 + 16) = (_DWORD)(uintptr_t)(fieldIndexValue);
      ...
      *((_WORD *)multifieldPtr + 3 * v18 + 7) = 1;
      result = (int*)(intptr_t)(Rules_AddIntegerValue(restriction[2]));
      *(_DWORD *)(uintptr_t)(v21 + 16) = (_DWORD)(uintptr_t)(result);
      fieldIndex = v22 + 1;
      typeIndex = 0;
      if ( restriction[2] )
      {
        ...
        do
        {
          ...
          *((_DWORD *)typeValueCell + 4) = (_DWORD)(uintptr_t)(Str_Intern(className, v28));
          fieldIndex = v29 + 1;
...
{
  return Rules_UndefconstructCommand((int)(intptr_t)this_, g_ClipsDeffunctionConstructType);
}
// 54E6AC: using guessed type int dword_54E6AC;
...
{
  return Rules_GetConstructModuleCommand((int)(intptr_t)this_, (const char **)(uintptr_t)g_ClipsDeffunctionConstructType);
}
// 54E6AC: using guessed type int dword_54E6AC;
...
{
  return Rules_PPConstructCommand((int)(intptr_t)this_, (const char **)(uintptr_t)g_ClipsDeffunctionConstructType);
}
// 54E6AC: using guessed type int dword_54E6AC;
...
signed int  Mem_CopyDataObjectRecord(_DWORD *src, _DWORD *dst)
{
  ...
  if ( valueType == 4 )
  {
    ...
    *(_DWORD *)(uintptr_t)(v6 + 8) = (_DWORD)(uintptr_t)(newMultifield);
    qmemcpy(

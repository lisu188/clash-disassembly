...
double  Rules_DivFunction(double result)
{
  ...
  if ( theExpression )
  {
    result = Rules_CoerceFormToNumericArg((__int16 *)(uintptr_t)theExpression, 0, (_DWORD*)(&theArgument), result, 1);
    if ( firstParseOk )
  ...
  while ( theExpression )
  {
    result = Rules_CoerceFormToNumericArg((__int16 *)(uintptr_t)theExpression, 0, (_DWORD*)(&theArgument), result, argIndex);
    if ( parseOk )
      theExpression = *(_DWORD *)(uintptr_t)(theExpression + 10);
    else
      theExpression = 0;
...
int  Rules_SetAutoFloatDividendCommand(int returnValue, double a2)
{
  ...
  {
    Rules_RtnUnknown(1, (_DWORD*)(&theValue), a2);
...
signed int Rules_RegisterMultifieldFunctions(void)
{
  ...
  Rules_AddFunctionParser((_BYTE*)(aProgn_0));
  Rules_SetFunctionSeqOverloadFlags((_BYTE*)(aProgn_0), 0);
...
LABEL_9:
  ...
  *(writePtr - 1) = 0;
  ...
  Mem_SmallBlockFree((_DWORD*)(retStr), totalSize);
...
_DWORD * Rules_SubseqFunction(_DWORD *subValue, double a2)
{
  ...
  subValue[4] = (_DWORD)(uintptr_t)(result);
      ...
      if ( result )
      {
        ...
        if ( result )
        {
          *(_DWORD *)(uintptr_t)(returnValue + 4) = 1;
          result = (int*)(intptr_t)(Rules_AddIntegerValue((signed int)(intptr_t)result));
          *(_DWORD *)(uintptr_t)(returnValue + 8) = (_DWORD)(uintptr_t)(result);
        }
      }
    }

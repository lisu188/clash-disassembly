...
int * InstanceQuery_FindAllInstances(_DWORD *returnValue, double a2)
{
  ...
  returnValue[3] = 0;
  returnValue[4] = -1;
  restrictionList = InstanceQuery_ParseRestrictions(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(g_ClipsCurrentExpression + 6) + 10), (int)(intptr_t)aFindAllInstanc, (_DWORD*)(&varCount), a2);
  if ( restrictionList )
  {
    ...
    *v4 = (_DWORD)(uintptr_t)(Mem_SmallBlockAlloc(4 * varCount));
    ...
    *(_DWORD *)(uintptr_t)(g_ClipsQueryCore + 24) = 0;
    ...
    returnValue[2] = (_DWORD)(uintptr_t)(Rules_CreateEphemeralMultifield(varCount * *(_DWORD *)(uintptr_t)(g_ClipsQueryCore + 24)));
      ...
      if ( varCount > 0 )
      {
        ...
        do
        {
          *(_WORD *)(uintptr_t)(v9 + returnValue[2] + 14) = 8;
          ...
          instanceIndex = v12 + 1;
          ++fieldPos;
          *(_DWORD *)(uintptr_t)(v11 + returnValue[2] + 16) = (_DWORD)(uintptr_t)(instanceName);
          v9 = v11 + 6;
        }
...
int * InstanceQuery_DoForInstance(int returnValue, int a2, double a3)
{
  ...
  *(_DWORD *)(uintptr_t)(returnValue + 8) = g_ClipsFalseSymbol;
  ...
  if ( result )
  {
    ...
    *v6 = (_DWORD)(uintptr_t)(Mem_SmallBlockAlloc(4 * varCount[0]));
    *(_DWORD *)(uintptr_t)(g_ClipsQueryCore + 4) = *(_DWORD *)(uintptr_t)(g_ClipsCurrentExpression + 6);
...
int * InstanceQuery_DelayedDoForAllInstances(_DWORD *returnValue, double a2)
{
  ...
  result = InstanceQuery_ParseRestrictions(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(g_ClipsCurrentExpression + 6) + 10) + 10), (int)(intptr_t)aDelayedDoForAl, (_DWORD*)(varCount), a2);
  restrictionList = result;
  if ( result )
  {
    InstanceQuery_PushQueryFrame();
...
LABEL_6:
  ...
  if ( classNode )
  {
    if ( classListHead )
    {
      ...
      {
        *(_DWORD *)(uintptr_t)(v8 + 8) = (_DWORD)(uintptr_t)(classNode);
      }
    }
    else
    {
  ...
  *(_BYTE *)(uintptr_t)(traversalByte + 108) |= traversalMask;
  ...
  while ( 1 )
  {
    *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)g_ClipsQueryCore + 4 * queryIndex) = i;
    ...
    ++*(_DWORD *)(uintptr_t)(i + 40);
    if ( InstanceQuery_TestClassRestriction((int*)(uintptr_t)(*(_DWORD *)(uintptr_t)(restriction + 12)), queryIndex + 1, a5) == 1 )
      break;
    --*(_DWORD *)(uintptr_t)(i + 40);
    if ( g_ClipsHaltExecution == 1 || g_InstanceQuery_AbortFlag == 1 )
      goto LABEL_9;
...
LABEL_15:
        ...
        ++*(_DWORD *)(uintptr_t)(i + 40);
        InstanceQuery_ForEachClassRestriction((int*)(uintptr_t)(*(_DWORD *)(uintptr_t)(restriction + 12)), queryIndex + 1, a5);
        --*(_DWORD *)(uintptr_t)(i + 40);
        if ( g_ClipsHaltExecution == 1 )
          goto LABEL_7;
...
int InstanceQuery_EnqueueDelayedBinding(void)
{
  ...
  *v2 = (_DWORD)(uintptr_t)(valuesArray);
  copyIndex = 0;
  copyOffset = 0;
  ...
  if ( *(_DWORD *)(uintptr_t)(g_ClipsQueryCore + 12) )
    *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(g_ClipsQueryCore + 16) + 4) = (_DWORD)(uintptr_t)(bindingNode);
  else
    *(_DWORD *)(uintptr_t)(g_ClipsQueryCore + 12) = (_DWORD)(uintptr_t)(bindingNode);
  *(_DWORD *)(uintptr_t)(g_ClipsQueryCore + 16) = (_DWORD)(uintptr_t)(bindingNode);
  result = g_ClipsQueryCore;
      ...
      if ( v13 )
      {
        if ( ObjectsCompiler_WriteSlotNameRecords(fileName, pathName, fileNameBuffer, fileIDCopy, maxIndices, &version) )
        {
          for ( i = Module_NextEnum(0); i; ++moduleFileCount )
          {
            ...
            moduleFile = Rules_ConstructCodeFileClose(moduleFile, &moduleFileCount, maxIndices, (_DWORD*)(&v50), (_DWORD*)(&v42), (int)(intptr_t)v18);
            for ( j = (_DWORD *)(uintptr_t)Class_GetNextRecord(0); j; j = (_DWORD *)(uintptr_t)Class_GetNextRecord((int)(intptr_t)j) )
            {
              ...
              ++classFileCount;
              classFile = Rules_ConstructCodeFileClose(classFile, &classFileCount, maxIndices, (_DWORD*)(&v51), (_DWORD*)(&v43), (int)(intptr_t)v19);
...
LABEL_20:
          ObjectsCompiler_CloseConstructFileGroup(&moduleFile, (_DWORD*)(&v42), maxIndices, (int)(intptr_t)v18);
        }
      }
    }
  }

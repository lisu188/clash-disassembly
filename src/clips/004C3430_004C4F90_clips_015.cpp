...
__int16 * Rules_UnionNumericExpressions(__int16 *result, int constraint2, int range, int newConstraint)
{
  ...
  if ( theMinList )
  {
    if ( rangeFlag )
    {
      ...
      *(_DWORD *)(uintptr_t)(newConstraint + 10) = (_DWORD)(uintptr_t)(theMinList);
      result = theMaxList;
      *(_DWORD *)(uintptr_t)(newConstraint + 14) = (_DWORD)(uintptr_t)(theMaxList);
    }
    else
    {
      AST_Free(*(_DWORD *)(uintptr_t)(newConstraint + 18));
      AST_Free(*(_DWORD *)(uintptr_t)(newConstraint + 22));
      *(_DWORD *)(uintptr_t)(newConstraint + 18) = (_DWORD)(uintptr_t)(theMinList);
      result = theMaxList;
      *(_DWORD *)(uintptr_t)(newConstraint + 22) = (_DWORD)(uintptr_t)(theMaxList);
    }
  }
  else if ( rangeFlag )
  {
  ...
  if ( *theMinList )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !cmaxmin )
      {
        ...
        *(_DWORD *)(uintptr_t)(newMinNode + 10) = (_DWORD)(uintptr_t)(*theMinList);
        *(_DWORD *)(result + 5) = (_DWORD)(uintptr_t)(*theMaxList);
...
__int16 * Rules_UnionAllowedValueExpressions(int constraint1, int constraint2, int newConstraint)
{
  ...
  *(_DWORD *)(uintptr_t)(v7 + 6) = (_DWORD)(uintptr_t)(result);
  return result;
}
...
LABEL_8:
      if ( Rules_RestrictionOnType(*theItem, theConstraint) )
      {
        ...
        *(_DWORD *)(result + 5) = (_DWORD)(uintptr_t)(theHead);
        theHead = result;
  ...
  if ( theConstraint )
  {
    ...
    *(_DWORD *)(uintptr_t)(theConstraint + 6) = 0;
    while ( theList )
    {
      ...
      {
        if ( lastOne )
          *(_DWORD *)(lastOne + 5) = (_DWORD)(uintptr_t)(theList);
        else
          *(_DWORD *)(uintptr_t)(theConstraint + 6) = (_DWORD)(uintptr_t)(theList);
        lastOne = theList;
...
int  Rules_BsaveDefglobals(int fp)
{
  ...
  if ( result )
  {
    Rules_ConstructQueuePop((_DWORD*)(&g_DefglobalModuleItemCount));
    return Rules_ConstructQueuePop((_DWORD*)(&g_Defglobal_Count));
  }
  return result;
}
...
int  Defgeneric_BsaveWriteConstructs(int fp, int a2)
{
  ...
  if ( result )
  {
    Rules_ConstructQueuePop((_DWORD*)(&g_DefgenericBloadCount));
    Rules_ConstructQueuePop((_DWORD*)(&g_Defgeneric_MethodRecordCount));
    Rules_ConstructQueuePop((_DWORD*)(&g_Defgeneric_RestrictionRecordCount));
    Rules_ConstructQueuePop((_DWORD*)(&g_Defgeneric_RestrictionTypeCount));
    return Rules_ConstructQueuePop((_DWORD*)(&g_Defgeneric_PackedExpressionCount));
  }
  return result;
}
...
_DWORD * Defgeneric_BsaveWriteMethodRecord(_DWORD *result, int fp)
{
  ...
  if ( result[8] )
  {
    ...
    do
    {
      ...
      result = (_DWORD *)(Rules_BsaveWriteBlock(32, fp, dummyMethod));
      ++methodIndex;
      methodOffset = v7 + 40;
    }
    while ( methodIndex < *(_DWORD *)(uintptr_t)(theDefgeneric + 32) );
...
int __thiscall Defgeneric_BloadRefreshConstructs(void *this_)
{
  ...
  space[2] = (_DWORD)(uintptr_t)(this_);
  result = Rules_BloadReadBlock((uintptr_t)space, 4u);

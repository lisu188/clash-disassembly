...
__int16 * Rules_BindFunction(_DWORD *returnValue, double context)
{
  ...
  if ( valueExpr )
  {
    v15 = (__int16 *)(uintptr_t)*(_DWORD *)(uintptr_t)(v7 + 10);
...
LABEL_21:
    ...
    *newBinding = variableSymbol;
    if ( prevBinding )
      prevBinding[5] = (_DWORD)(uintptr_t)(newBinding);
    else
...
int  Rules_PrognFunction(_DWORD *returnValue, double context)
{
  ...
  if ( !v3 )
    goto LABEL_8;
  /* 49D043: `mov ecx,1` ... 49D06E: `inc ecx; cmp ecx,esi; jle` - ecx is the
     1-based argument index; IDA dropped its initialisation and increment,
     leaving the undefined temps v5/v6 and a garbage argument position. */
  argIndex = 1;
  if ( v3 >= 1 )
  {
    do
    {
      if ( Rules_GetEvaluationErrorFlag() == 1 )
        break;
      Rules_RtnUnknown(argIndex, returnValue, context);
...
int  Rules_SwitchFunction(_DWORD *returnValue, int a2, double context)
{
  int result; // eax
  int caseExpr; // ecx
  _DWORD caseData[6]; // [esp-4h] [ebp-40h] BYREF
  /* stack alias of caseData[1] */
  /* stack alias of caseData[2]: the DATA_OBJECT value slot */
  _DWORD switchData[6]; // [esp+14h] [ebp-28h] BYREF
  /* stack alias of switchData[1] */
  /* stack alias of switchData[2]: the DATA_OBJECT value slot */
  int v13 CLASH95_UNUSED; // [esp+34h] [ebp-8h]

  v13 = a2;
  returnValue[1] = 2;
  returnValue[2] = g_ClipsFalseSymbol;
  result = Parser_ParseForm((__int16 *)(uintptr_t)*(_DWORD *)(uintptr_t)(g_ClipsCurrentExpression + 6), switchData, a2, context);
    ...
    if ( caseExpr )
    {
      while ( *(_WORD *)(uintptr_t)caseExpr != 105 )
      {
        ...
        if ( g_ClipsEvaluationError )
          return result;
        result = switchData[1];
        if ( switchData[1] == caseData[1] )
        {
          result = caseData[1] == 4 ? Rules_MultifieldRangesEqual(switchData, caseData) : switchData[2] == caseData[2];
          if ( result )
            break;
        }
      ...
      return Parser_ParseForm((__int16 *)(uintptr_t)*(_DWORD *)(uintptr_t)(caseExpr + 10), returnValue, caseExpr, context);
    }
  }
  return result;
}
...
signed int Rules_RegisterMiscFunctions(void)
{
  ...
  Rules_SetFunctionSeqOverloadFlags((_BYTE*)(aExpand), 0);
...
signed int  Rules_SetGenFunction(int a1, double context)
{
  ...
  _DWORD argData[6]; // [esp-8h] [ebp-24h] BYREF
  /* stack alias of argData[2]: the DATA_OBJECT value slot */
  int v5 CLASH95_UNUSED; // [esp+14h] [ebp-8h]

  v5 = a1;
  if ( Lexer_TokenExpect((int)(intptr_t)aSetgen, 0, 1) == -1 || !Lexer_ParseValueList(1, argData, 1, context) )
    return g_ClipsGensymCounter;
  result = *(_DWORD *)(uintptr_t)(argData[2] + 16);
  if ( result < 1 )
  {
  ...
  {
    g_ClipsGensymCounter = *(_DWORD *)(uintptr_t)(argData[2] + 16);
  }
  return result;
}
...
signed int *__fastcall Rules_GensymFunction(int a1, int a2 CLASH95_UNUSED)
{
  ...
  v4 = a1;
  Lexer_TokenExpect((int)(intptr_t)aGensym, 0, 0);
...
signed int *__thiscall Rules_GensymStarFunction(void *this_)
{
  ...
  v4 = this_;
  Lexer_TokenExpect((int)(intptr_t)aGensym_0, 0, 0);
  do
  {
    sprintf_(symbolBuffer, "gen%ld", g_ClipsGensymCounter);
    ++g_ClipsGensymCounter;
  }
  while ( Rules_FindSymbolEntry((_BYTE*)(symbolBuffer)) );
...
{
  Lexer_TokenExpect((int)(intptr_t)aRandom, 0, 0);
  return j_rand_();
}
...
int  Rules_HostSeed(int a1, double context)
{
  ...
  argData[7] = a1;
  result = Lexer_TokenExpect((int)(intptr_t)aSeed, 0, 1);
  if ( result != -1 )
  {
...
int  Rules_HostLength(double context)
{
  int result; // eax
  int v2; // edx
  _DWORD argData[6]; // [esp-4h] [ebp-20h] BYREF
  /* stack alias of argData[1] */
  /* stack alias of argData[2]: the DATA_OBJECT value slot */
  /* stack alias of argData[3] */
  /* stack alias of argData[4] */

  result = Lexer_TokenExpect((int)(intptr_t)aLength_0, 0, 1);
  if ( result != -1 )
  {
    Rules_RtnUnknown(1, argData, context);
    if ( argData[1] == 3 || argData[1] == 2 )
    {
      return strlen((const char *)(uintptr_t)*(_DWORD *)(uintptr_t)(argData[2] + 16));
    }
    else if ( argData[1] == 4 )
    {
      return argData[4] - argData[3] + 1;
    }
    else
    {
      Lexer_ErrorRecover(1);
      Rules_ReportSymbolTypeError((_BYTE*)(aLength_0), v2);
      return -1;
    }
  }
  return result;
...
int Rules_HostReleaseMem(void)
{
  ...
  if ( Lexer_TokenExpect((int)(intptr_t)aReleaseMem, 0, 0) == -1 )
    return 0;
  else
...
int  Rules_HostConserveMem(int a1, double context)
{
  ...
  argData[7] = a1;
  result = Lexer_TokenExpect((int)(intptr_t)aConserveMem, 0, 1);
  if ( result != -1 )
  {
    result = Lexer_ParseValueList(1, argData, 2, context);
    if ( result )
    {
      if ( !strcmp_(*(_DWORD *)(uintptr_t)(argData[2] + 16), (_DWORD)(uintptr_t)(aOn_0)) || !strcmp_(v4, (_DWORD)(uintptr_t)(aOff_0)) )
...
{
  if ( Lexer_TokenExpect((int)(intptr_t)aMemUsed, 0, 0) == -1 )
    return 0;
  else
...
{
  if ( Lexer_TokenExpect((int)(intptr_t)aMemRequests, 0, 0) == -1 )
    return 0;
  else
...
int ** Rules_HostApropos(double context)
{
  ...
  result = (int **)(uintptr_t)Lexer_TokenExpect((int)(intptr_t)aApropos, 0, 1);
  symbolEntry = 0;
  if ( result != (int **)-1 )
  {
    ...
    if ( result )
    {
      searchString = (char *)(uintptr_t)*(_DWORD *)(uintptr_t)(argData[2] + 16);
...
int Rules_HostOptionsCommand(void)
{
  ...
  result = Lexer_TokenExpect((int)(intptr_t)aOptions, 0, 0);
  if ( result != -1 )
  {
...
int  Rules_HostExpansionCall(int returnValue, double context)
{
  ...
  Symbol = Rules_MakeSymbol((_BYTE*)(aExpand));
  ...
  *(_WORD *)(uintptr_t)newExpr = *(_WORD *)(uintptr_t)*(_DWORD *)(uintptr_t)(g_ClipsCurrentExpression + 6);
  ...
  *(_DWORD *)(uintptr_t)(newExpr + 6) = v15[0];
  if ( exprType == 10 )
  {
    ...
    if ( !Rules_CheckFunctionArgCount(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)theFunction + 16), (_BYTE *)(uintptr_t)*(_DWORD *)(uintptr_t)(theFunction + 17), argCount) )
    {
  ...
  if ( theExp )
  {
    while ( 1 )
    {
      while ( v12 != *(_DWORD *)((char *)exprCursor + 2) )
      {
        ...
        if ( expandFuncSymbol )
          Rules_ExpandFuncCallForm((int**)(intptr_t)((int)(intptr_t)returnValue), (_DWORD*)(uintptr_t)(*(_DWORD *)((char *)exprCursor + 6)), v12, (int*)(intptr_t)((int)(intptr_t)exprCursor + 6), context);
        result = (int **)((char *)exprCursor + 10);
        stoPtr = (int*)((_DWORD *)((char *)exprCursor + 10));
        exprCursor = *(_DWORD **)((char *)exprCursor + 10);
        if ( !exprCursor )
          return result;
      }
      Parser_ParseForm(*(__int16 **)((char *)exprCursor + 6), (_DWORD*)(returnValue), expandFuncSymbol, context);
      ...
      if ( newListHead )
      {
        ...
        *(_DWORD *)(uintptr_t)(g_ClipsMemoryTable + 56) = g_ClipsMemFreeListTemp;
        ...
        exprCursor = (_DWORD *)(uintptr_t)*(_DWORD *)(uintptr_t)(lastNode + 10);
    ...
    *(_DWORD *)((char *)exprCursor + 6) = 0;
    if ( !g_ClipsEvaluationError && returnValue[1] != (int *)4 )
      Rules_ReportSymbolTypeError((_BYTE*)(aExpand), 1);
    result = Rules_MakeSymbol((_BYTE*)(aSetEvaluationE));
    *(_DWORD *)((char *)exprCursor + 2) = (_DWORD)(uintptr_t)(result);
...
signed int * Rules_HostGetFunctionRestrictions(int returnValue, double context)
{
  ...
  Symbol = Rules_MakeSymbol((_BYTE *)(uintptr_t)*(_DWORD *)(uintptr_t)(argData[2] + 16));
  if ( !Symbol )
  {
    Rules_ReportCantFindItem(v3, *(_DWORD *)(uintptr_t)(argData[2] + 16));
    Lexer_ErrorRecover(1);
    restrictionString = (char *)&g_Rules_HostFunctionErrorFallbackString;
    return Str_Intern(restrictionString, v3);
  }
...
int  Rules_HostPrintout(int returnValue, double context)
{
  ...
  _DWORD argData[6]; // [esp-4h] [ebp-2Ch] BYREF
  /* stack alias of argData[1] */
  /* stack alias of argData[2]: the DATA_OBJECT value slot */
  int v13 CLASH95_UNUSED; // [esp+20h] [ebp-8h]

  v13 = returnValue;
  result = Lexer_TokenExpect((int)(intptr_t)aPrintout, 1, 1);
  argCount = result;
  lastArgIndex = result;
  if ( result != -1 )
  {
...
LABEL_26:
        ...
        {
          if ( strcmp_(argString, (_DWORD)(uintptr_t)(aCrlf)) )
          {
            if ( !strcmp_(argString, (_DWORD)(uintptr_t)(aTab)) )
            {
              outputString = asc_5069C0;
              goto LABEL_11;
            }
            if ( !strcmp_(argString, (_DWORD)(uintptr_t)(aVtab)) )
            {
              outputString = asc_5069CC;
              goto LABEL_11;
            }
            if ( !strcmp_(argString, (_DWORD)(uintptr_t)(aFf)) )
            {
              outputString = (char *)&g_Rules_PrintoutFormFeedChar;
              goto LABEL_11;
            }
            if ( strcmp_(argString, (_DWORD)(uintptr_t)(&g_Rules_PrintoutCrlfAliasName)) )
            {
LABEL_17:
              v9 = argString;
              outputString = (char *)(uintptr_t)*(_DWORD *)(uintptr_t)(argData[2] + 16);
              goto LABEL_12;
            }
          }
...
signed int * Rules_HostRead(int returnValue, double context)
{
  ...
  v16 = returnValue;
  argCount = Lexer_TokenExpect((int)(intptr_t)aRead, 2, 1);
  logicalName = 0;
  if ( argCount == -1 )
    goto LABEL_14;
  if ( argCount )
  ...
  if ( !strcmp_(v6, (_DWORD)(uintptr_t)(aStdin)) )
    Rules_ReadStdinLineToken((_DWORD*)(&theToken), v7);
  else
  ...
  *(_DWORD *)(uintptr_t)(v4 + 4) = theToken;
  switch ( tokenType )
  {
    ...
    case 1:
      result = tokenValue;
      *(_DWORD *)(uintptr_t)(v4 + 8) = (_DWORD)(uintptr_t)(tokenValue);
      break;
    case 102:
      *(_DWORD *)(uintptr_t)(v4 + 4) = 2;
      result = Str_Intern(aEof, v4);
      *(_DWORD *)(uintptr_t)(v11 + 8) = (_DWORD)(uintptr_t)(result);
      break;
    case 103:
LABEL_14:
      *(_DWORD *)(uintptr_t)(v4 + 4) = 3;
      result = Str_Intern(aReadError, v4);
      *(_DWORD *)(uintptr_t)(v10 + 8) = (_DWORD)(uintptr_t)(result);
      return result;
    default:
      *(_DWORD *)(uintptr_t)(v4 + 4) = 3;
      result = Str_Intern(tokenString, v4);
      *(_DWORD *)(uintptr_t)(v12 + 8) = (_DWORD)(uintptr_t)(result);
      break;
  }
  return result;
}
...
const CHAR * Rules_HostOpen(double context)
{
  ...
  argCount = Rules_ArgRangeCheck((int)(intptr_t)aOpen, 2, 3);
  if ( argCount == -1 )
    return 0;
  ...
  if ( result )
  {
    ...
    else if ( argCount == 3 )
    {
      ...
      if ( !result )
        return result;
      accessMode = (char *)(uintptr_t)*(_DWORD *)(uintptr_t)(argData[2] + 16);
    }
    if ( !strcmp_((_DWORD)(uintptr_t)(accessMode), (_DWORD)(uintptr_t)(aR_3)) || !strcmp_((_DWORD)(uintptr_t)(v7), (_DWORD)(uintptr_t)(aR_4)) || !strcmp_((_DWORD)(uintptr_t)(v7), (_DWORD)(uintptr_t)(aW_4)) || !strcmp_((_DWORD)(uintptr_t)(v7), (_DWORD)(uintptr_t)(aA_2)) )
    {
...
signed int  Rules_HostClose(double context)
{
  ...
  argCount = Lexer_TokenExpect((int)(intptr_t)aClose, 2, 1);
  if ( argCount == -1 )
    return 0;
  if ( !argCount )
...
int  Rules_HostRemoveFile(double context)
{
  ...
  if ( Lexer_TokenExpect((int)(intptr_t)aRemove, 0, 1) == -1 )
    return 0;
...
const CHAR * Rules_HostRenameFile(double context)
{
  ...
  if ( Lexer_TokenExpect((int)(intptr_t)aRename, 0, 2) == -1 )
    return 0;

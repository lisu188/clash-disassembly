...
BOOL  Parser_ParseSlotDefaultOrRestriction(int mfp, int theExp, _DWORD *val, double a4)
{
  ...
  {
    val[2] = (_DWORD)(uintptr_t)(Rules_CreateEphemeralMultifield(0));
    return 1;
  }
}
...
LABEL_10:
  ...
  while ( 1 )
  {
    ...
    result = (_DWORD *)Instance_FindInSubclasses((int)(intptr_t)importedModule, (_DWORD*)(intptr_t)((int)(intptr_t)startInstance));
    if ( result )
      return result;

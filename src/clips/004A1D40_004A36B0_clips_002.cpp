...
int  Rules_RewritePrognFieldRefs(int fieldVar, int theExp, signed int depth)
{
  ...
  if ( theExp )
  {
    ...
    {
      result = strncmp_(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(currentExp + 2) + 16), *(_DWORD *)(uintptr_t)(fieldVar + 16), flen) == 0;
      if ( !result )
        break;
      if ( *(_BYTE *)(uintptr_t)(flen + *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(currentExp + 2) + 16)) )
      {
        result = strcmp_(flen + *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(currentExp + 2) + 16), (_DWORD)(uintptr_t)(aIndex));
        if ( result )
        {
LABEL_9:
        ...
        else
        {
          ...
          *(_DWORD *)(uintptr_t)(currentExp + 2) = (_DWORD)(uintptr_t)(Rules_MakeSymbol((_BYTE*)(aGetPrognIndex)));
          indexDepthConstant = (int*)(intptr_t)(Rules_AddIntegerValue(depth));
      ...
      {
        *(_WORD *)(uintptr_t)currentExp = 10;
        *(_DWORD *)(uintptr_t)(currentExp + 2) = (_DWORD)(uintptr_t)(Rules_MakeSymbol((_BYTE*)(aGetPrognField)));
        fieldDepthConstant = (int*)(intptr_t)(Rules_AddIntegerValue(depth));
    ...
    {
      if ( *(_WORD *)(uintptr_t)currentExp == 10 && Rules_MakeSymbol((_BYTE*)(aProgn_0)) == *(int ***)(uintptr_t)(currentExp + 2) )
      {
        ...
        int functionName CLASH95_UNUSED)
{
  ...
  else
  {
    ...
    dst[3] = 0;
    dstByteOffset = 0;
    dst[2] = (_DWORD)(uintptr_t)(Rules_CreateEphemeralMultifield(combinedLength - replaceCount));
    dst[4] = dstLength - 1;
...
signed int  Rules_MultifieldInsertRange(_DWORD *dst, _DWORD *src, _DWORD *theField, int theIndex, int functionName CLASH95_UNUSED)
{
  ...
  else
  {
    ...
    if ( src )
    {
      ...
      dst[2] = (_DWORD)(uintptr_t)(Rules_CreateEphemeralMultifield(dstLength));
    ...
    {
      dst[2] = (_DWORD)(uintptr_t)(Rules_CreateEphemeralMultifield(0));
      dst[4] = 0;
      dstMultifield = dst[2];
...
signed int  Rules_MultifieldDeleteRange(_DWORD *dst, _DWORD *src, int rangeEnd, int rangeBegin, int functionName CLASH95_UNUSED)
{
  ...
  if ( !srcLength )
  {
    ...
    dst[4] = -1;
    resultFlag = 1;
    dst[2] = (_DWORD)(uintptr_t)(emptyMultifield);
    return resultFlag;
  }
...
signed int  Rules_ConcatBuiltinCore(int returnValue, int returnType, int a3, double a4)
{
  ...
  *(_DWORD *)(uintptr_t)(v5 + 8) = (_DWORD)(uintptr_t)(v4);
...
LABEL_11:
    ...
    *(_DWORD *)(uintptr_t)(v21 + 8) = (_DWORD)(uintptr_t)(v20);
    Mem_SmallBlockFree((_DWORD*)(theString), totalSize);
  }
  else
  {
...
LABEL_8:
  ...
  return Mem_SmallBlockFree((_DWORD *)(arrayOfStrings), 4 * numArgs);
}
  ...
  else
  {
    ...
    if ( slen > 0 )
    {
      ...
      do
      {
        ...
        {
          ch = toupper_((_DWORD)(uintptr_t)(writePtr));
          item[6] = ch;
        }
        *writePtr++ = ch;
        ++charIndex;
    ...
    *(_DWORD *)(uintptr_t)(returnValue + 8) = (_DWORD)(uintptr_t)(Str_Intern(newString, (int)(intptr_t)writePtr));
    return (signed int *)(uintptr_t)Mem_SmallBlockFree((_DWORD*)(newString), v10);
  }
  return result;
}
  ...
  else
  {
    ...
    if ( slen > 0 )
    {
      ...
      do
      {
        ...
        {
          ch = tolower_((_DWORD)(uintptr_t)(writePtr), (_DWORD)(uintptr_t)(osptr));
          item[6] = ch;
        }
        else
        {
...
signed int  Rules_StrCompareBuiltin(int returnValue, double a2)
{
  ...
  _DWORD arg1[6]; // [esp+14h] [ebp-44h] BYREF
    ...
    if ( result )
    {
      if ( numArgs == 3 )
      {
        ...
        else
        {
          ...
          _CHP((_DWORD)(uintptr_t)(arg3), arg3[1]);
          maxChars = (int)maxCharsFloat;
        }
        result = strncmp_(*(_DWORD *)(uintptr_t)(arg1[2] + 16), *(_DWORD *)(uintptr_t)(arg2[2] + 16), (unsigned int)maxChars);
      }
      else
      {
        result = strcmp_(*(_DWORD *)(uintptr_t)(arg1[2] + 16), *(_DWORD *)(uintptr_t)(arg2[2] + 16));
      }
      if ( result < 0 )
      {
        return -1;
...
signed int * Rules_SubStringBuiltin(double a1)
{
  ...
  else
  {
    ...
    _CHP((_DWORD)(uintptr_t)(theArgument), theArgument[1]);
    startRaw = (int)a1;
  }
  start = startRaw - 1;
  ...
  *(_BYTE *)tempPtr = 0;
  ...
  Mem_SmallBlockFree((_DWORD*)(returnString), v9 - start + 2);
    ...
    if ( result )
    {
      ...
      if ( result )
      {
        ...
        if ( strlen(strg1) )
        {
          ...
          if ( *strg2 )
          {
            ...
            *(_DWORD *)(uintptr_t)(v17 + 4) = 1;
            result = (int*)(intptr_t)(Rules_AddIntegerValue(position));
        ...
        else
        {
          ...
          *(_DWORD *)(uintptr_t)(v17 + 4) = 1;
          result = (int*)(intptr_t)(Rules_AddIntegerValue(strlen(searchString) + 1));
...
BOOL __fastcall Rules_EvalStringCore(_DWORD theString CLASH95_UNUSED, _DWORD *returnValue)
{
  ...
  v3 = sprintf_((char*)(logicalNameBuffer), "Eval-%d", ++g_EvalStringRouterCounter);

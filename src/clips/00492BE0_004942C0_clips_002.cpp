...
int **Rules_CacheConnectiveSymbols(void)
{
  ...
  g_Clips_SymbolAnd = (int)(intptr_t)Rules_MakeSymbol((_BYTE*)(aAnd));
  g_ClipsSymbolOr = (int)(intptr_t)Rules_MakeSymbol((_BYTE*)(aOr));
  g_ClipsSymbolEq = (int)(intptr_t)Rules_MakeSymbol((_BYTE*)(aEq));
  g_ClipsSymbolNeq = (int)(intptr_t)Rules_MakeSymbol((_BYTE*)(aNeq));
  result = Rules_MakeSymbol((_BYTE*)(aNot));
  ...
  if ( !g_Clips_SymbolAnd || !g_ClipsSymbolOr || !g_ClipsSymbolEq || !g_ClipsSymbolNeq || !result )
  {
    ...
    return (int **)(uintptr_t)IO_RunRouterExitCallbacks(4);
  }
  return result;
}
...
int AST_FreeNode(int result)
{
  int node;
  int owner;
  int (__thiscall *cleanup_fn)(void *this_, int);
  ...
  if ( *(_DWORD *)(uintptr_t)(node + 60) )
  {
    ...
    if ( owner )
    {
      cleanup_fn = *(int (__thiscall **)(void *this_, int))(uintptr_t)(owner + 64);
      if ( cleanup_fn )
...
unsigned int  AST_HashNodeChain(__int16 *theExp)
{
  ...
  tally = 269;
  if ( argList )
    tally = 257 * AST_HashNodeChain((short int*)(intptr_t)(argList)) + 269;
  while ( currentExpr )
  {
...
__int16 * AST_AddHashedNodeChain(__int16 *result, int a2, int a3)
{
  ...
  if ( result )
  {
    ...
    else
    {
      ...
      *(_DWORD *)(uintptr_t)(v8 + 8) = (_DWORD)(uintptr_t)(packedChain);
      AST_InstallNodeChain(packedChain);
      hashEntry[3] = *(_DWORD *)(uintptr_t)(g_ExpressionHashTable + 4 * *hashEntry);
      *(_DWORD *)(uintptr_t)(g_ExpressionHashTable + 4 * *hashEntry) = (_DWORD)(uintptr_t)(hashEntry);
      hashEntry[4] = 0;
...
signed int  AST_GetHashedNodeIndex(__int16 *theExpression)
{
  ...
  if ( !theExpression )
    return -1;
  hashEntry = AST_FindHashedNodeChain(theExpression, (_DWORD*)(&hashInfo));
  if ( hashEntry )
...
char * Parser_NextToken(int readSource, int theToken)
{
  ...
  *(_DWORD *)(uintptr_t)(theToken + 8) = (_DWORD)(uintptr_t)(aUnknown);
  g_TokenCap = 0;
  g_TokenLen = 0;
  ...
  if ( (charType & 0xC0) != 0 )
  {
    ...
    *(_DWORD *)(uintptr_t)theToken = 2;
    ...
    count = 0;
LABEL_12:
    tokenSymbol = (signed int *)(uintptr_t)(unsigned int)(uintptr_t)Lexer_ReadToken(lexerSource, count, (_DWORD*)(&scannedType), v7);
...
LABEL_14:
  ...
  if ( i >= 41 )
  {
    if ( i <= 41 )
    {
      ...
      *(_DWORD *)(uintptr_t)(theToken + 8) = (_DWORD)(uintptr_t)(asc_504D38);
      *(_DWORD *)(uintptr_t)(theToken + 4) = (_DWORD)(uintptr_t)(rparenSymbol);
      goto LABEL_15;
    }
    if ( i >= 60 )
    {
      ...
      if ( i >= 124 )
      {
        if ( i <= 124 )
        {
          ...
          *(_DWORD *)(uintptr_t)(theToken + 8) = (_DWORD)(uintptr_t)(asc_504D40);
          *(_DWORD *)(uintptr_t)(theToken + 4) = (_DWORD)(uintptr_t)(orSymbol);
          goto LABEL_15;
        }
        if ( i == 126 )
        {
          ...
          *(_DWORD *)(uintptr_t)(theToken + 8) = (_DWORD)(uintptr_t)(asc_504D3C);
          *(_DWORD *)(uintptr_t)(theToken + 4) = (_DWORD)(uintptr_t)(tildeSymbol);
          goto LABEL_15;
        }
      }
      else if ( i == 63 )
      {
        ...
        if ( (IsTable[(unsigned __int8)(i + 1)] & 0xC0) != 0 || i == 42 )
        {
          ...
          *(_DWORD *)(uintptr_t)(theToken + 4) = (_DWORD)(uintptr_t)(Lexer_ReadToken(readSource, 0, (_DWORD*)(&scannedType), v16));
          ...
          *(_DWORD *)(uintptr_t)(theToken + 4) = (_DWORD)(uintptr_t)(Str_Intern((char *)(uintptr_t)(g_TokenBuf + 1), sfBufferLength - 1));
          *(_BYTE *)(uintptr_t)(g_TokenBuf + v23 - 1) = i;
        }
        else
        {
          *(_DWORD *)(uintptr_t)theToken = 17;
          *(_DWORD *)(uintptr_t)(theToken + 4) = (_DWORD)(uintptr_t)(Str_Intern(aQuestion_LexerSingleFieldVarPrefix, nextChar));
          Lexer_SkipChar(v39, readSource, v39);
          *(_DWORD *)(uintptr_t)(theToken + 8) = (_DWORD)(uintptr_t)(aQuestion_LexerSingleFieldVarPrefix);
        }
        goto LABEL_15;
      }
      goto LABEL_30;
...
LABEL_66:
      ...
      *(_DWORD *)(uintptr_t)(theToken + 8) = (_DWORD)(uintptr_t)(g_Lexer_EmptyQuotedStringBuffer);
      *(_DWORD *)(uintptr_t)(theToken + 4) = (_DWORD)(uintptr_t)(eofSymbol);
      goto LABEL_15;
    }
    if ( i == -1 )
      goto LABEL_66;
LABEL_30:
    ...
    {
      Lexer_SkipChar(i, readSource, v4);
      *(_DWORD *)(uintptr_t)(theToken + 4) = (_DWORD)(uintptr_t)(Lexer_ReadToken(readSource, 0, (_DWORD*)(&scannedType), v47));
      *(_DWORD *)(uintptr_t)theToken = scannedType;
      tokenSymbol = (signed int *)(uintptr_t)(unsigned int)*(_DWORD *)(uintptr_t)(theToken + 4);
      goto LABEL_13;
    }
    *(_DWORD *)(uintptr_t)(theToken + 8) = (_DWORD)(uintptr_t)(aUnprintableCha);
    goto LABEL_15;
  }
  if ( i <= 34 )
  {
    *(_DWORD *)(uintptr_t)(theToken + 4) = (_DWORD)(uintptr_t)(Lexer_ReadQuotedString(readSource, v4));
  ...
  if ( i >= 38 )
  {
    if ( i <= 38 )
    {
      ...
      *(_DWORD *)(uintptr_t)(theToken + 8) = (_DWORD)(uintptr_t)(asc_504D44);
      *(_DWORD *)(uintptr_t)(theToken + 4) = (_DWORD)(uintptr_t)(ampersandSymbol);
      goto LABEL_15;
    }
    if ( i == 40 )
    {
      ...
      *(_DWORD *)(uintptr_t)(theToken + 8) = (_DWORD)(uintptr_t)(asc_504D34);
      *(_DWORD *)(uintptr_t)(theToken + 4) = (_DWORD)(uintptr_t)(lparenSymbol);
      goto LABEL_15;
    }
    goto LABEL_30;
  }
  ...
  if ( (IsTable[(unsigned __int8)(i + 1)] & 0xC0) != 0 || i == 42 )
  {
    ...
    *(_DWORD *)(uintptr_t)(theToken + 4) = (_DWORD)(uintptr_t)(Lexer_ReadToken(readSource, 0, (_DWORD*)(&scannedType), v27));
    ...
    *(_DWORD *)(uintptr_t)(theToken + 4) = (_DWORD)(uintptr_t)(Str_Intern((char *)(uintptr_t)(g_TokenBuf + 1), mfBufferLength - 1));
    *(_BYTE *)(uintptr_t)(v34 + g_TokenBuf - 1) = i;
  }
  else
  {
    *(_DWORD *)(uintptr_t)theToken = 18;
    *(_DWORD *)(uintptr_t)(theToken + 4) = (_DWORD)(uintptr_t)(Str_Intern(aQuestion_LexerMultiFieldVarPrefix, v26));
    v40 = i;
    *(_DWORD *)(uintptr_t)(theToken + 8) = (_DWORD)(uintptr_t)(aQuestion_LexerMultiFieldVarPrefix);
...
signed int * Lexer_ReadQuotedString(int logicalName, unsigned int a2)
{
  ...
  Mem_SmallBlockFree((_DWORD*)(appended), stringLength[0]);
...
LABEL_18:
          ...
          if ( digitFound )
          {
            ...
            else
            {
              ...
              *tokenOut = 1;
              integerValue = (int*)(intptr_t)(Rules_AddIntegerValue(longValue));
              *(_DWORD *)((uintptr_t)tokenOut + 4) = (_DWORD)(uintptr_t)(integerValue);
          ...
          else
          {
            ...
            *(_DWORD *)((uintptr_t)tokenOut + 4) = (_DWORD)(uintptr_t)(symbolValue);
...
LABEL_33:
  ...
  scannedSymbol = Lexer_ReadToken(readSource, symbolCount, (_DWORD*)(&scannedType), v23);
  v25 = tokenOut;
  tokenOut[1] = (_DWORD)(uintptr_t)(scannedSymbol);
  *v25 = scannedType;
...
signed int  Rules_ExpressionConstraintsCompatible(__int16 *theExpression)
{
  ...
  AST_DecrementNodeRefCount((_DWORD*)(rv));
...
int  AST_NodeListsEqual(__int16 *firstList, __int16 *secondList)
{
  ...
  for ( i = firstList; i; secondList = *(__int16 **)(secondList + 5) )
  {
    ...
    if ( *i != *secondList || *(_DWORD *)(i + 1) != *(_DWORD *)(secondList + 1) )
      return 0;
    result = AST_NodeListsEqual((short int*)(uintptr_t)(*(_DWORD *)(i + 3)), (short int*)(uintptr_t)(*(_DWORD *)(secondList + 3)));
    if ( !result )
      return result;

...
signed int  Parser_ValidateFunctionCallArgs(int theExpression, int restrictions, int functionName)
{
  ...
  {
    minArgs = atoi_((const char*)(intptr_t)(argCount));
  }
  else
  {
  ...
  maxArgs = atoi_((const char*)(intptr_t)(argCount));
LABEL_9:
  if ( minArgs == maxArgs )
  {
    if ( argCount == maxArgs )
...
int  Parser_ParseProgram(int readSource, unsigned int *theToken, signed int readFirstToken)
{
  ...
  Symbol = Rules_MakeSymbol((_BYTE*)(aProgn_2));
  lastNode = 0;
...
LABEL_10:
  ...
  v14 = Rules_MakeSymbol((_BYTE*)(aExpansionCal_0));
...
{
  if ( !Parser_AddFunctionParser((_BYTE*)(aBind), (int)(intptr_t)Parser_ParseBind) )
    return 0;
  if ( !Parser_AddFunctionParser((_BYTE*)(aProgn), (int)(intptr_t)Parser_ParseProgn) )
    return 0;
  if ( !Parser_AddFunctionParser((_BYTE*)(aIf), (int)(intptr_t)Parser_ParseIf) )
    return 0;
  if ( !Parser_AddFunctionParser((_BYTE*)(aWhile), (int)(intptr_t)Parser_ParseWhile) )
    return 0;
  if ( !Parser_AddFunctionParser((_BYTE*)(aLoopForCount), (int)(intptr_t)Parser_ParseLoopForCount) )
    return 0;
  if ( !Parser_AddFunctionParser((_BYTE*)(aReturn), (int)(intptr_t)Parser_ParseReturn) )
    return 0;
  if ( !Parser_AddFunctionParser((_BYTE*)(aBreak), (int)(intptr_t)Parser_ParseBreak) )
    return 0;
  return Parser_AddFunctionParser((_BYTE*)(aSwitch), (int)(intptr_t)Parser_ParseSwitch);
}
...
int  Parser_ParseWhile(int topNode, int readSource)
{
  ...
  *(_DWORD *)(uintptr_t)(topNode + 6) = testExpr;
  if ( !testExpr )
    goto LABEL_10;
  Parser_NextToken(readSource, (int)(intptr_t)&token);
  if ( token == 2 && !strcmp_(v6, (_DWORD)(uintptr_t)(aDo)) )
  {
    IO_OutNewline();
    IO_OutWriteToken(asc_50A54C);
...
int  Parser_ParseLoopForCount(int topNode, int readSource)
{
  ...
  if ( token == 100 )
  {
    ...
    if ( token == 15 )
    {
      ...
      *(_DWORD *)(uintptr_t)(topNode + 6) = (_DWORD)(uintptr_t)(rangeExpr);
      if ( !rangeExpr )
        goto LABEL_23;
      ...
      if ( token == 101 )
      {
        ...
        IO_OutNewline();
        IO_OutWriteToken(indentToken);
        lowerBoundValue = (int*)(intptr_t)(Rules_AddIntegerValue(1));
    ...
    if ( token != 2 )
      goto LABEL_18;
    v14 = (int*)(intptr_t)(Rules_AddIntegerValue(1));
...
LABEL_23:
  ...
  defaultLowerBound = (int*)(intptr_t)(Rules_AddIntegerValue(1));
...
LABEL_3:
  if ( Rules_ExpressionConstraintsCompatible((__int16 *)(uintptr_t)*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(topNode + 6) + 10)) )
    goto LABEL_18;
  Parser_NextToken(readSource, (int)(intptr_t)&token);
  if ( token == 2 && !strcmp_(v8, (_DWORD)(uintptr_t)(aDo)) )
  {
    IO_OutNewline();
    IO_OutWriteToken(asc_50A54C);
    IO_OutWriteToken(indentToken);
    ...
    do
    {
      if ( *(_WORD *)(uintptr_t)currentNode == 15 && (result = strcmp_(currentNode, *(_DWORD *)(uintptr_t)(loopVar + 16)) == 0) != 0 )
      {
        *(_WORD *)(uintptr_t)currentNode = 10;
        Symbol = Rules_MakeSymbol((_BYTE*)(aGetLoopCount_0));
        *(_DWORD *)(uintptr_t)(v9 + 2) = (_DWORD)(uintptr_t)(Symbol);
        v10 = (int*)(intptr_t)(Rules_AddIntegerValue(depth));
        result = AST_NewNode(1, (int)(intptr_t)v10);
        *(_DWORD *)(uintptr_t)(currentNode + 6) = result;
      }
      else if ( *(_DWORD *)(uintptr_t)(currentNode + 6) )
      {
        if ( *(_WORD *)(uintptr_t)currentNode == 10 && (v11 = Rules_MakeSymbol((_BYTE*)(aLoopForCount_0)), v11 == *(int ***)(uintptr_t)(currentNode + 2)) )
...
int  Parser_ParseIf(int topNode, int readSource)
{
  ...
  *(_DWORD *)(uintptr_t)(topNode + 6) = testExpr;
  ...
  if ( token[0] != 2 || strcmp_(v9, (_DWORD)(uintptr_t)(aThen)) )
    goto LABEL_14;
  AST_Append(v11, v10);
  if ( *(_DWORD *)(uintptr_t)g_ClipsParseContextSaveStack == 1 )
    g_ClipsParseReturnContext = 1;
  ...
  *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(topNode + 6) + 10) = Parser_ParseProgram(readSource, token, 1);
  ...
  {
    if ( token[0] != 2 || strcmp_(v12, (_DWORD)(uintptr_t)(aElse_0)) )
      goto LABEL_14;
    AST_Append(v14, v13);
...
int  Parser_ParseBind(int topNode, int readSource)
{
  ...
  *(_DWORD *)(uintptr_t)(topNode + 6) = AST_NewNode(2, varSymbol);
  boundVar = varSymbol;
  if ( tokenType == 13 && (v6 = Rules_FindImportExportConstruct(aDefglobal_4, (_DWORD*)(&v14), (_BYTE *)(uintptr_t)*(_DWORD *)(uintptr_t)(varSymbol + 16), 1, 0)) != 0 )
  {
...
LABEL_19:
  ...
  *(_DWORD *)(uintptr_t)(g_ClipsMemoryTable + 56) = g_ClipsMemFreeListTemp;
  ...
  if ( *(_WORD *)(uintptr_t)varNode != 60 )
  {
    ...
    Rules_PushNamedContextEntry(boundVar, (_DWORD*)(varConstraint));
  }
  return topNode;
}
...
int  Parser_ParseSwitch(int topNode, int readSource)
{
  ...
  *(_DWORD *)(uintptr_t)(switchNode + 6) = caseNode;
  ...
  while ( token != 101 )
  {
    ...
    Parser_NextToken(readSource, (int)(intptr_t)&token);
    IO_OutWriteToken(asc_50A54C);
    if ( token == 2 && !strcmp_(v10, (_DWORD)(uintptr_t)(aCase)) )
    {
      if ( sawDefault )
        goto LABEL_4;
...
LABEL_15:
      Parser_NextToken(readSource, (int)(intptr_t)&token);
      if ( token != 2 || strcmp_(v14, (_DWORD)(uintptr_t)(aThen)) )
        goto LABEL_4;
      ++caseCount;
    }
    else
    {
      if ( token != 2 || strcmp_(2, (_DWORD)(uintptr_t)(aDefault_1)) || caseCount < v22 || sawDefault )
        goto LABEL_4;
...
LABEL_7:
    ...
    *newEntry = contextName;
    newEntry[1] = (_DWORD)(uintptr_t)(constraint);
    if ( prevEntry )
      prevEntry[2] = (_DWORD)(uintptr_t)(newEntry);
    else

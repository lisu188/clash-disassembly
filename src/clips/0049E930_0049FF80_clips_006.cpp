...
signed int * Rules_HostFormat(double context)
{
  ...
  if ( logicalName )
  {
    if ( !strcmp_(logicalName, (_DWORD)(uintptr_t)(aNil_0)) || IO_QueryRouters(logicalName) )
    {
      ...
      if ( formatString )
      {
        while ( 1 )
        {
          ...
          if ( formatChar == 37 )
          {
            ...
            LOBYTE(v14) = Rules_FormatParseFlag(formatString, &formatIndex, (_DWORD*)(&longFlag), (_BYTE*)(flagBuffer));
            BYTE1(v14) = v14;
            if ( (_BYTE)v14 == 32 )
            {
              outputString = Str_Append(flagBuffer, outputString, (unsigned int *)&outputCapacity, (_DWORD*)(&outputLength));
              if ( !outputString )
            ...
            else
            {
              ...
              {
                if ( outputString )
                  Mem_SmallBlockFree((_DWORD*)(outputString), outputCapacity);
                return fallbackResult;
              }
              outputString = Str_Append(convertedString, outputString, (unsigned int *)&outputCapacity, (_DWORD*)(&outputLength));
              if ( !outputString )
                return fallbackResult;
              ++argIndex;
            }
          ...
          else
          {
            ...
            outputString = Str_AppendBounded(segmentStart + formatString, outputString, (_DWORD*)(&outputLength), formatIndex - segmentStart, (unsigned int *)&outputCapacity);
          }
        }
        if ( outputString )
        {
          v20 = Str_Intern(outputString, v7);
          if ( strcmp_((_DWORD)(uintptr_t)(v20), v21) )
...
signed int  Rules_FormatCountConversionSpecs(int argCount, double context)
{
  ...
  if ( result )
  {
    ...
    while ( 1 )
    {
      ...
      {
        ++formatIndex[0];
        if ( Rules_FormatParseFlag(formatString, formatIndex, (_DWORD*)(&longFlag), flagBuffer) != 32 )
          ++specCount;
      }
      else
      {
...
char  Rules_FormatParseFlag(int formatString, int *formatIndex, _DWORD *longFlagOut, _BYTE *flagBuffer)
{
  ...
  *longFlagOut = 0;
  ...
  {
    case 'n':
      sprintf_((char*)(flagBuffer), asc_5069B8);
      result = 32;
      ++*v11;
      break;
    case 'r':
      sprintf_((char*)(flagBuffer), asc_506A6C);
      result = 32;
      ++*v12;
      break;
    case 't':
      sprintf_((char*)(flagBuffer), asc_5069C0);
      result = 32;
      ++*v13;
      break;
    case 'v':
      sprintf_((char*)(flagBuffer), asc_5069CC);
      result = 32;
      ++*v14;
      break;
    case '%':
      sprintf_((char*)(flagBuffer), asc_506A70);
      result = 32;
      ++*v15;
      break;
    default:
  ...
  if ( conversionChar >= 0x67 )
  {
    ...
    if ( conversionChar >= 0x73 )
    {
      if ( conversionChar <= 0x73 )
      {
        ...
        sprintf_((char*)(stringBuffer), formatSpec, *(_DWORD *)(uintptr_t)(argData[2] + 16));
        goto LABEL_6;
      }
...
LABEL_11:
    ...
    if ( argData[1] )
    {
      sprintf_((char*)(numberBuffer), formatSpec, *(_DWORD *)(uintptr_t)(argData[2] + 16));
    }
    else
    {
      intValue = (int)*(double *)(uintptr_t)(argData[2] + 16);
      sprintf_((char*)(intptr_t)(v17), formatSpec, intValue);
    }
LABEL_6:
  ...
  if ( conversionChar < 0x64 )
  {
    if ( conversionChar == 99 )
    {
      ...
      sprintf_((char*)(charBuffer), formatSpec, *(unsigned __int8 *)(uintptr_t)*(_DWORD *)(uintptr_t)(argData[2] + 16));
      goto LABEL_6;
    }
LABEL_17:
...
LABEL_19:
  ...
  if ( result )
  {
    ...
    if ( argData[1] )
    {
      ...
      sprintf_((char*)(floatBuffer), formatSpec, floatValue);
    }
    else
    {
      sprintf_((char*)(floatBuffer), formatSpec, *(double *)(uintptr_t)(argData[2] + 16));
    }
    goto LABEL_6;
  }
  return result;
...
LABEL_8:
  ...
  if ( !IO_QueryRouters((int)(intptr_t)logicalName) )
  {
    ...
    *(_DWORD *)(uintptr_t)(v14 + 8) = (_DWORD)(uintptr_t)(result);
    return result;
  }
  ...
  if ( !Rules_GetEvaluationErrorFlag() )
  {
    if ( lineBuffer )
    {
      ...
      *(_DWORD *)(uintptr_t)(v17 + 8) = (_DWORD)(uintptr_t)(v16);
      return (signed int *)(uintptr_t)Mem_SmallBlockFree((_DWORD*)(lineBuffer), bufferSize[0]);
    }
  ...
  *(_DWORD *)(uintptr_t)(v15 + 8) = (_DWORD)(uintptr_t)(result);
  if ( lineBuffer )
    return (signed int *)(uintptr_t)Mem_SmallBlockFree((_DWORD*)(lineBuffer), bufferSize[0]);
  return result;
}
...
BOOL  Rules_HostLexemep(double context)
{
  ...
  {
    Rules_RtnUnknown(1, (_DWORD*)(intptr_t)(argData), context);

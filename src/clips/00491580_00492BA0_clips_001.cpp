...
int Module_CreateMainModule(void)
{
  ...
  *(_DWORD *)(uintptr_t)module = (_DWORD)(uintptr_t)(module_name);
  ++module_name[1];
  ...
  *(_DWORD *)(uintptr_t)(module + 24) = 0;
  ...
  {
    *(_DWORD *)(uintptr_t)(module + 8) = (_DWORD)(uintptr_t)(Mem_SmallBlockAlloc(4 * g_ClipsModuleItemCount));
    index = 0;
...
int  IO_StringRouterPrint(int logicalName, const char *str)
{
  ...
  strncpy_(currentPosition, (_DWORD)(uintptr_t)(str));
...
int  Rules_ParseAssertCommand(int logicalName, _DWORD *theToken, int atLeastOne, int *error, int readFirstParen, int a6 CLASH95_UNUSED)
{
  ...
  *error = 0;
  ...
  while ( 1 )
  {
    ...
    Symbol = Rules_MakeSymbol((_BYTE*)(aAssert_1));
  ...
  else
  {
    ...
    {
      prognSymbol = Rules_MakeSymbol((_BYTE*)(aProgn_3));
...
LABEL_20:
  ...
  foundConstruct = Rules_FindImportExportConstruct(aDeftemplate, (_DWORD*)(&count), templateNameString, 1, 0);
  ...
  if ( (*(_BYTE *)(uintptr_t)(theDeftemplate + 24) & 1) != 0 )
  {
    ...
    while ( 1 )
    {
      ...
      nextOne = Rules_ParseAssertArgument(logicalName, (unsigned int *)(uintptr_t)(unsigned int)theToken, (_DWORD*)(error), endType, constantsOnlyFlag, (_DWORD*)(&printError));
      if ( !nextOne )
        break;
      if ( argHead )
...
signed int * Rules_ExtractModuleName(signed int thePosition)
{
  ...
  Mem_SmallBlockFree((_DWORD*)(newString), v7);
  return returnValue;
}
...
signed int * Rules_ExtractConstructName(int thePosition, char *theString, int a3)
{
  ...
  strncpy_((_DWORD)(uintptr_t)(newString), v7);

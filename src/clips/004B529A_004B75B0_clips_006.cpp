...
LPTOP_LEVEL_EXCEPTION_FILTER  CRT_InstallUnhandledExceptionFilter(int a1, int a2)
{
  ...
  *(_DWORD *)(v3 + 84) = HIDWORD(v3);
  v5 = g_CrtThreadDataAccessor(v4, (_DWORD)(uintptr_t)(NtCurrentTeb()->NtTib.ExceptionList));
  **(_DWORD **)(v5 + 84) = HIDWORD(v5);
  *(_DWORD *)(uintptr_t)(*(_DWORD *)(g_CrtThreadDataAccessor(v6, HIDWORD(v5)) + 84) + 4) = (_DWORD)(uintptr_t)(CRT_FpuExceptionFrameHandler);
...
int __thiscall IO_FindOpenFileByLogicalName(void *this_)
{
  ...
  result = strcmp_((_DWORD)(uintptr_t)(this_), (_DWORD)(uintptr_t)(aStdout_1));
  if ( result )
  {
    result = strcmp_(v2, (_DWORD)(uintptr_t)(aStdin_0));
    if ( result )
    {
      result = strcmp_(v3, (_DWORD)(uintptr_t)(g_IO_LogicalNameTable_WTrace[0]));
      if ( result )
      {
        result = strcmp_(v4, (_DWORD)(uintptr_t)(g_IO_LogicalNameTable_WDialog[0]));
        if ( result )
        {
          result = strcmp_(v5, (_DWORD)(uintptr_t)(g_IO_LogicalNameTable_WClips[0]));
          if ( result )
          {
            result = strcmp_(v6, (_DWORD)(uintptr_t)(g_IO_LogicalName_WDisplay));
            if ( result )
            {
              result = strcmp_(v7, (_DWORD)(uintptr_t)(g_IO_LogicalNameTable_WError[0]));
              if ( result )
              {
                result = strcmp_(v8, (_DWORD)(uintptr_t)(g_IO_LogicalNameTable_WWarning[0]));
                if ( result )
                {
                  ...
                  if ( g_IO_LogicalNameFileListHead )
                  {
                    do
                    {
                      if ( !strcmp_((_DWORD)(uintptr_t)(fileListCursor), *fileListCursor) )
                        break;
...
int __thiscall IO_FileIOGetcCallback(void *this_)
{
  ...
  LODWORD(v2) = IO_FindOpenFileByLogicalName(this_);
  v1 = *(_DWORD *)(v2 + 4);
  HIDWORD(v2) = v2;
  if ( v1 > 0 && (v1 = **(unsigned __int8 **)v2 - 13, (unsigned int)v1 > 0xFD) )
  {
    ...
    --*(_DWORD *)(v2 + 4);
    *(_DWORD *)v2 = (_DWORD)(uintptr_t)(bufferPtr + 1);
        ...
        DWORD a5)
{
  ...
  if ( result )
  {
    ...
    nameCopy = (_BYTE*)(Mem_SmallBlockAlloc(strlen(logicalName) + 1));
    *fileEntry = (_DWORD)(uintptr_t)(nameCopy);
    do
    {
      curByte = *nameCursor;
      *nameCopy = *nameCursor;
...
signed int __thiscall IO_CloseAllNamedFiles(void *this_)
{
  ...
  do
  {
    fclose_((_DWORD)(uintptr_t)(this_));
    Mem_SmallBlockFree(*fileEntry, strlen((const char *)*fileEntry) + 1);
    currentEntry = (_DWORD*)(fileEntry);
...
int  CRT_TzRuleDayOfYear(_DWORD *tzRule, int year)
{
  ...
  else
  {
    ...
    timeFields[5] = v4;
    timeFields[8] = 0;
    CRT_MkTime((_DWORD*)(intptr_t)((int)(intptr_t)timeFields));
...
int  CRT_IsDaylightTime(_DWORD *timeFields)
{
  ...
  if ( startsInDst )
  {
    ...
    secondRule = (int*)(g_CRT_TzDstStartRule);
  }
  else
  {
    firstRule = (int*)(g_CRT_TzDstStartRule);
...
LABEL_27:
            inDaylight = CRT_CompareTzTransitionDate(tmFields, (_DWORD*)(firstRule)) == 0;
        }
      }
      else
      {
...
LABEL_28:
  ...
  if ( secondRuleWeek != 5 )
  {
    ...
    if ( secondRuleCandidateDayPrev >= secondRuleWeekStartDom )
      goto LABEL_52;
LABEL_51:
    inDaylight = CRT_CompareTzTransitionDate(tmFields, (_DWORD*)(secondRule));
    goto LABEL_52;
  }
...
void __thiscall CRT_TzSetFromSystemInfo(int this_)
{
  ...
  if ( (g_TzInitFlags & 1) == 0 || (g_TzInitFlags & 2) == 0 )
  {
    ...
    if ( TimeZoneInformation )
    {
      ...
      if ( wcstombs_(v4, (_DWORD)(uintptr_t)(v6.StandardName)) == -1 )
        g_TzStandardNameBuffer = 0;
      else
        g_CRT_TzStandardNameBufEnd = 0;
      if ( wcstombs_(v5, (_DWORD)(uintptr_t)(v6.DaylightName)) == -1 )
        g_TzDaylightName = 0;
      else
...
void CRT_TzSet(void)
{
  ...
  if ( tzEnvString )
  {
    ...
    dstOffset[4] = v1;
    g_TzDaylightFlag = 0;
    afterStdName = CRT_ParseTzNameAndOffset(tzEnvString, &g_TzStandardNameBuffer, (_DWORD*)(&g_CRT_TimezoneSeconds));
    if ( *afterStdName )
    {
      g_TzDaylightFlag = 1;
      dstOffset[0] = g_CRT_TimezoneSeconds - 3600;
      afterDstName = CRT_ParseTzNameAndOffset(afterStdName, &g_TzDaylightName, (_DWORD*)(dstOffset));
      v5 = dstOffset[0];
...
signed int  Rules_BuildFieldIndexConstraintNode(int fieldDescriptor)
{
  ...
  if ( (*(_BYTE *)(uintptr_t)(fieldDescriptor + 9) & 0x40) != 0 )
  {
    ...
    {
      Mem_AllocArray((_BYTE*)(bitmapData), 4);
      ...
      bitmapData[0] |= v4;
      bitmapValue = Rules_AddBitmapValue((_BYTE*)(bitmapData), 4);
  ...
  {
    Mem_AllocArray((_BYTE*)(&bitmapWord), 4);
    ...
    bitmapWord |= 2 * v10;
    indexBitmapValue = Rules_AddBitmapValue((_BYTE*)(&bitmapWord), 4);
...
signed int  PP_ShouldEmit(int fieldDescriptor)
{
  ...
  v3 = Rules_AddBitmapValue((_BYTE*)(bitmapData), 4);
...
signed int __fastcall PP_MakeConst25(int a1, int a2 CLASH95_UNUSED)
{
  ...
  v5[2] = a1;
  Mem_AllocArray((_BYTE*)(v5), 4);
  v5[0] = ((unsigned __int8)(v2 - 1) << 9) | v5[0] & 0xFFFE01FF;
  LOBYTE(v5[0]) = 0;
  BYTE1(v5[0]) |= 1u;
  v3 = Rules_AddBitmapValue((_BYTE*)(v5), 4);
  return AST_NewNode(25, v3);
}
...
int PP_BuildDefault(void)
{
  ...
  return Rules_AddBitmapValue((_BYTE*)(v5), 4);
}
...
int __fastcall PP_MakeConst31(int a1, int a2 CLASH95_UNUSED)
{
  ...
  return Rules_AddBitmapValue((_BYTE*)(v6), 4);
}
...
int __fastcall PP_MakeConst30(int a1, int a2 CLASH95_UNUSED)
{
  ...
  if ( *node == 17 || *node == 15 )
  {
    ...
    return Rules_AddBitmapValue((_BYTE*)(bitmapData), 4);
  }
  else
  {

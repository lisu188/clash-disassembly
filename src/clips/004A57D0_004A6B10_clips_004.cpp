...
signed int  Help_InsertEntryIntoTopicTree(int fileRecord, _DWORD *entry, int errorBuffer, signed int errorBufferSize, int lineNumber)
{
  ...
  {
    *(_DWORD *)(uintptr_t)(fileRecord + 80) = (_DWORD)(uintptr_t)(entry);
    goto LABEL_6;
  }
  ...
  if ( *entry > *(_DWORD *)(uintptr_t)g_ClipsHelpCurrentTopicNode )
  {
    if ( *(_DWORD *)(uintptr_t)(g_ClipsHelpCurrentTopicNode + 4) != -45 )
    {
      ...
      if ( errorBufferSize >= 60 )
        sprintf_((char*)(intptr_t)(errorBuffer), "Line %d : Non-menu entries cannot have subtopics.", lineNumber);
      return 0;
    }
  ...
  if ( g_ClipsHelpCurrentTopicNode )
  {
    if ( *(_DWORD *)(uintptr_t)g_ClipsHelpCurrentTopicNode < *entry )
    {
      ...
      currentTopic = g_ClipsHelpCurrentTopicNode;
LABEL_5:
      *(_DWORD *)(uintptr_t)(currentTopic + 92) = (_DWORD)(uintptr_t)(entry);
LABEL_6:
      v8 = 1;
...
LABEL_13:
    ...
    *(_DWORD *)(uintptr_t)(g_ClipsHelpCurrentTopicNode + 100) = (_DWORD)(uintptr_t)(entry);
    g_ClipsHelpCurrentTopicNode = (int)(intptr_t)entry;
    return 1;
  }
  entry[24] = 0;
...
_DWORD * Help_FreeTopicTree(_DWORD *result)
{
  ...
  {
    if ( i[23] )
      Help_FreeTopicTree((_DWORD*)(uintptr_t)(i[23]));
  }
  return result;
}
...
signed int  Help_RunInteractiveHelpBrowser(int a1, DWORD a2, double a3)
{
  ...
  if ( !g_HelpSystemInitialized )
  {
    if ( !g_ClipsHelpFilePath )
    {
      ...
      helpPathDst = (_BYTE*)(Mem_SmallBlockAlloc(strlen(aClips_hlp) + 1));
  ...
  topicNameDst = (_BYTE*)(Mem_SmallBlockAlloc(0x58u));
  ...
  *(_DWORD *)(uintptr_t)(topicNode + 84) = (_DWORD)(uintptr_t)(argTopicList);
  Output_Write((int)(intptr_t)aWhelp, (int)(intptr_t)asc_50797C, v13);
  while ( 1 )
  {
    locatedFp = Rules_HelpLocateTopicEntry((const CHAR *)(uintptr_t)g_ClipsHelpFilePath, topicList, (_DWORD*)(&status), (_DWORD*)(menu));
    fp = locatedFp;
    if ( status == (_DWORD *)-10 )
      break;
    if ( status == (_DWORD *)-30 )
...
LABEL_43:
    ...
    if ( g_ClipsHaltExecution )
    {
      ...
      {
        if ( Help_OpenFileAtNavigatedTopic((const CHAR *)(uintptr_t)g_ClipsHelpFilePath, (_DWORD*)(menu), (_DWORD*)(&status), 0) )
          fclose_(v35);
      }
    }
    if ( status == (_DWORD *)-30 )
...
signed int  Help_SetHelpFilePathCommand(int a1, double a2)
{
  ...
  if ( Rules_RtnArgCount() )
  {
    ...
    if ( result )
    {
      ...
      srcPtr = newPath;
      dstPtr = (_BYTE*)(Mem_SmallBlockAlloc(strlen(newPath) + 1));
  ...
  if ( result )
  {
    ...
    if ( entryCount )
    {
      *(_DWORD *)(uintptr_t)(returnValue + 4) = 1;
      result = (int*)(intptr_t)(Rules_AddIntegerValue((signed int)(intptr_t)entryCount));
...
int  Help_PrintRegionCommand(double a1)
{
  ...
  fp = Rules_HelpLocateTopicEntry((const CHAR *)(uintptr_t)topicList[21], *(_DWORD *)(uintptr_t)(topicList[21] + 84), statusBuf, (_DWORD*)(&menuBuf));
  ...
  {
    if ( !strcmp_(fp, (_DWORD)(uintptr_t)(aT_1)) )
    {
      srcPtr = aStdout_3;
      do
      {
...
{
  return strcmp_((_DWORD)(uintptr_t)(this_), (_DWORD)(uintptr_t)(aWhelp)) == 0;
}
// 476330: using guessed type int __fastcall strcmp_(_DWORD, _DWORD);
...
{
  return Lexer_PeekChar((int)(intptr_t)aStdin_3, (unsigned int)(intptr_t)this_);
}
...
_DWORD * Rules_HelpBuildTopicListFromArgs(double a1)
{
  ...
  if ( numArgs >= 1 )
  {
    do
    {
      ...
      strncpy_(v5, (_DWORD)(uintptr_t)(topicName));
      theTopic[21] = 0;
      theTopic[20] = 0;
      if ( head )
      {
        for ( i = head; i[21]; i = (_DWORD *)(uintptr_t)i[21] )
          ;
        i[21] = (_DWORD)(uintptr_t)(theTopic);
      }
      else
      {
        head = theTopic;
            ...
            *((_DWORD *)newTopic + 20) = wordLength;
            if ( tailNode )
            {
              for ( ; *(_DWORD *)(uintptr_t)(tailNode + 84); tailNode = *(_DWORD *)(uintptr_t)(tailNode + 84) )
                ;
              *(_DWORD *)(uintptr_t)(tailNode + 84) = (_DWORD)(uintptr_t)(newTopicPtr);
            }
            else
            {
...
int  Rules_HelpLocateTopicEntry(const CHAR *fileName, int topicList, _DWORD *statusOut, _DWORD *entryTitleOut)
{
  ...
  if ( topicList != listEnd )
  {
    ...
    {
      if ( result )
        fclose_((_DWORD)(uintptr_t)(statusOut));
      if ( !strcmp_((_DWORD)(uintptr_t)(statusOut), (_DWORD)(uintptr_t)(asc_507B10)) )
        break;
      if ( strcmp_(v8, (_DWORD)(uintptr_t)(aQuestionMark_507B14)) || listEnd != *(_DWORD *)(uintptr_t)(topicNode + 84) )
      {
        v9 = entryTitleOut;
        v10 = statusPtr;

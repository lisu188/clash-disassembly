      ...
      if ( (*(_BYTE *)(uintptr_t)(theDeftemplate + 24) & 1) == 0 )
      {
        ...
        if ( slotPtr )
        {
          while ( 1 )
          {
            ...
            result = Rules_CheckFieldAgainstConstraint((_DWORD*)(&dataObject), *(_DWORD *)(uintptr_t)(slotPtr + 8));
          ...
          sprintf_((char*)(factIdBuffer), "fact f-%-5ld ", *(_DWORD *)(uintptr_t)(theFact + 24));
  ...
  *(_DWORD *)(uintptr_t)(newMark + 16) = 0;
  ...
  if ( (*(_BYTE *)(uintptr_t)(theNode + 12) & 0x40) != 0 )
  {
    ...
    if ( !*(_DWORD *)(uintptr_t)(theNode + 24) || Rules_EvaluatePatternNetworkTest(theNode, *(_DWORD *)(uintptr_t)(theNode + 24), endMark, a5) )
    {
      ...
      Rules_MatchFactAgainstPatternNetwork(g_CurrentPatternFact, *(_DWORD *)(uintptr_t)(theNode + 28), (_DWORD*)(intptr_t)(g_ClipsFactMatchMarkerList), 0, a5, (int)(intptr_t)theMark);
    }
  ...
  if ( repeatCount >= 0 )
  {
    ...
    do
    {
      ...
      if ( !theTest || Rules_EvaluatePatternNetworkTest(theNode, theTest, offset, a5) )
        Rules_MatchFactAgainstPatternNetwork(g_CurrentPatternFact, *(_DWORD *)(uintptr_t)(theNode + 28), (_DWORD*)(intptr_t)(g_ClipsFactMatchMarkerList), newOffset, a5, (int)(intptr_t)theMark);
      --repeatCount;
      --newOffset;
    }
    while ( repeatCount >= 0 );
...
signed int  Rules_ReportPatternNetworkError(signed int patternPtr)
{
  ...
  if ( (*(_BYTE *)(uintptr_t)(theDeftemplate + 24) & 1) != 0 )
  {
    sprintf_((char*)(messageBuffer), "   Problem resides in field #%d\n", (unsigned __int8)*(_DWORD *)(uintptr_t)(patternPtr + 20));
  }
  else
  {
    v14 = v6;
    ...
    for ( i = 0; i < *(_DWORD *)(uintptr_t)(patternPtr + 20) << 16 >> 24; ++i )
      slotPtr = (_DWORD *)(uintptr_t)slotPtr[4];
    sprintf_((char*)(messageBuffer), "   Problem resides in slot %s\n", (const char *)(uintptr_t)*(_DWORD *)(uintptr_t)(*slotPtr + 16));
    v10 = v14;
  }
  ...
  for ( i = result; i; i = *(_DWORD *)(uintptr_t)(i + 40) )
  {
    if ( (*(_BYTE *)(uintptr_t)(i + 12) & 4) != 0 )
    {
      for ( j = *(_DWORD *)(uintptr_t)(i + 8); j; j = *(_DWORD *)(uintptr_t)(j + 32) )
      {
        ...
        sprintf_((char*)(messageBuffer), "      Of pattern #%d in rule(s):\n", patternCount);
...
int * Rules_DriveJoinNetwork(int *result, char *join, int operation, double a4)
{
  ...
  if ( !operation )
  {
    ...
    {
      result = (int *)(uintptr_t)Rules_MultifieldAppendValue((_DWORD*)(result), 0, *(_DWORD *)join << 30 >> 31, *((_DWORD *)join + 9) != 0);
      *(_BYTE *)result |= 0x30u;
      result[1] = *((_DWORD *)join + 2);
      binds = result;
      *((_DWORD *)join + 2) = (_DWORD)(uintptr_t)(result);
    }
  }
  v9 = *join;
  if ( (*join & 1) != 0 )
    return (int*)(Rules_AddJoinLeftMemoryEntry((int)(intptr_t)join, binds, resetInProgress, a4));
  if ( operation )
  {
    if ( operation == 1 )
    {
    ...
    else
    {
      ...
      result = (int *)(uintptr_t)IO_RunRouterExitCallbacks(5);
    }
  }
  else
  {
...
LABEL_33:
      if ( *((_DWORD *)join + 3) )
      {
        result = (int *)(uintptr_t)Rules_EvaluateJoinExpression((__int16 *)(uintptr_t)(unsigned int)*(_DWORD *)(join + 12), (_WORD*)(lhsBinds), (_BYTE *)join, (int)(intptr_t)rhsBinds, a4);
      ...
      if ( exprResult )
      {
        if ( (*join & 8) != 0 || (*join & 4) != 0 )
        {
          if ( operation == 1 )
          {
            result = (int *)(uintptr_t)Rules_ProcessJoinMemoryMatches((int)(intptr_t)join, (_BYTE*)(oppositeBinds), (int)(intptr_t)rhsBinds, a4);
            oppositeBinds = (int *)(uintptr_t)(unsigned int)oppositeBinds[1];
          }
          else
          {
        ...
        {
          result = (int*)(Rules_CreateJoinPartialMatch((_DWORD*)(lhsBinds), (_DWORD*)(rhsBinds), (_DWORD*)(join), a4));
          oppositeBinds = (int *)(uintptr_t)(unsigned int)oppositeBinds[1];
        }
      }
      else
...
LABEL_31:
  ...
  if ( ((*join & 8) != 0 || (BYTE1(result) & 4) != 0) && !operation )
  {
    result = &binds[(unsigned int)(*binds << 17) >> 23];
    if ( !result[1] )
      return (int*)(Rules_AddJoinRightMemoryEntry((int)(intptr_t)join, (_BYTE*)(binds), a4));
  }
  return result;
}
...
_DWORD * Rules_CreateJoinPartialMatch(_DWORD *lhsBinds, _DWORD *rhsBinds, _DWORD *theJoin, double unused_fp)
{
  ...
  result = (_DWORD*)(Rules_MergeMultifieldValues(lhsBinds, rhsBinds, *theJoin << 30 >> 31, theJoin[9] != 0));
  result[1] = theJoin[2];
  partial_match = (int)(uintptr_t)result;
  action = theJoin[9];
  theJoin[2] = (_DWORD)(uintptr_t)(result);
  if ( action )
...
_DWORD * Rules_AddJoinLeftMemoryEntry(int theJoin, int *rhsBinds, int a3, double a4)
{
        ...
        result) )
  {
    ...
    *(_DWORD *)(uintptr_t)(theJoin + 8) = (_DWORD)(uintptr_t)(result);
    if ( ruleToActivate )
...
int  Rules_AddLogicalDependencyLink(int theEntity, int existingEntity)
{
  ...
  if ( result )
  {
    ...
    *newDependency = v3;
    ...
    theBind[(*theBind << 29 >> 31) + 2 + (*theBind << 17 >> 23)] = (_DWORD)(uintptr_t)(newDependency);
    ...
    *newDependent = (_DWORD)(uintptr_t)(theBind);
    newDependent[1] = *(_DWORD *)(uintptr_t)(v3 + 4);
    *(_DWORD *)(uintptr_t)(v3 + 4) = (_DWORD)(uintptr_t)(newDependent);
    return 1;
  }
  return result;
}

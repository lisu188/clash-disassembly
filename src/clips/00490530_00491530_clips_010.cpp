...
signed int __thiscall Rules_PrintPrompt(void *this_)
{
  ...
  result = Output_Write((int)(intptr_t)g_IO_LogicalNameTable_WClips[0], (int)(intptr_t)aClips, (int)(intptr_t)this_);
...
BOOL __thiscall Lexer_ClassifyNextStdinChar(void *this_)
{
  ...
  readChar = Lexer_PeekChar((int)(intptr_t)aStdin_1, (unsigned int)(intptr_t)this_);
  inchar = readChar;
  if ( readChar == -1 )
    inchar = 10;
...
LABEL_10:
  ...
  {
    zeroInteger = (int*)(intptr_t)(Rules_AddIntegerValue(0));
    v8 = (int)(intptr_t)constraints;
...
LABEL_11:
    ...
    if ( v16 > 0 )
    {
      ...
      do
      {
        *(_WORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(v17 + 8) + result + 14) = fieldType;
        result -= 6;
        --v16;
        *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(v17 + 8) + result + 22) = (_DWORD)(uintptr_t)(theValue);
      }
      while ( result > -6 );
    }
  }
  else
  {
    ...
    defaultObj[2] = (_DWORD)(uintptr_t)(theValue);
...
LABEL_11:
        ...
        _CHP(v8, a4);
        return (int*)(intptr_t)(Rules_AddIntegerValue((int)theValue));
      }
...
LABEL_28:
    ...
    {
      theConstraint = (char*)(Rules_BuildLHSNodeFromToken((__int16 *)(uintptr_t)defaultList));
...
LABEL_47:
  ...
  if ( !strcmp_((_DWORD)(uintptr_t)(v13), (_DWORD)(uintptr_t)(aNone_0)) )
  {
    defaultKind = 0;
  }
  else if ( !strcmp_(v14, (_DWORD)(uintptr_t)(aDerive)) )
  {
    defaultKind = 1;
  }
  else
...
int  Module_RegisterItem(int theItem, int allocateFunction, int bloadModuleReference, int freeFunction, int constructsToCModuleReference, int findFunction)
{
  ...
  *newModuleItem = theItem;
  ...
  if ( g_Module_ItemListTail )
    *(_DWORD *)(uintptr_t)(g_Module_ItemListTail + 28) = (_DWORD)(uintptr_t)(newModuleItem);
  else

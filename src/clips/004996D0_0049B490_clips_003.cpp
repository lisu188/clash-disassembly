...
int  Class_CreateSystemClass(char *className, int superclass, int a3)
{
  ...
  *(_DWORD *)(uintptr_t)(g_DefclassHashTable + 4 * *(_DWORD *)(uintptr_t)(class_record + 30)) = class_record;
  class_bitmap = (_BYTE*)(Mem_SmallBlockAlloc(1));
...
signed int Class_RefreshWatchExpressions(void)
{
  ...
  bitmapBuffer = (_BYTE*)(Mem_SmallBlockAlloc(bitmapSize));
  bucketOffset = 0;
  ...
  do
  {
    ...
    if ( theClass )
    {
      ...
      do
      {
        ...
        if ( (theClass[5] & 2) != 0 || Rules_FindImportExportConstruct(aDefclass, (_DWORD*)(&v9), className, 1, 0) )
  ...
  return Mem_SmallBlockFree((_DWORD*)(bitmapBuffer), bitmapSize);
}
    ...
    if ( *(_WORD *)(uintptr_t)actionExpr == 15 )
    {
      ...
      if ( paramIndex || v9 )
      {
        if ( paramIndex <= 0 || bindIndex )
        {
          ...
          *(_DWORD *)(uintptr_t)(actionExpr + 2) = Rules_AddBitmapValue((_BYTE*)(&bitmapData), 4);
          v18 = AST_NewNode(2, v17);
          v19 = savedVarNode;
          *(_DWORD *)(uintptr_t)(actionExpr + 6) = v18;
          *(_DWORD *)(uintptr_t)(v18 + 10) = (_DWORD)(uintptr_t)(v19);
        }
        else
        {
          *(_WORD *)(uintptr_t)actionExpr = (v10 == savedWildcard) + 65;
          *(_DWORD *)(uintptr_t)(actionExpr + 2) = Rules_AddBitmapValue((_BYTE*)(&paramIndex), 4);
        }
      }
...
LABEL_6:
  ...
  if ( !Parser_ReplaceProcVars(savedBodyType, wildcardSymbol, savedWildcard, savedParamList, altVarFunc, specData) )
  {
    if ( Rules_MakeSymbol((_BYTE*)(aBind_1)) == *(int ***)(uintptr_t)(actionExpr + 2) && *(_WORD *)(uintptr_t)*(_DWORD *)(uintptr_t)(actionExpr + 6) == 2 )
    {
      ...
      *(_DWORD *)(uintptr_t)(actionExpr + 2) = Rules_AddBitmapValue((_BYTE*)(&bindIndex), v23);
        ...
        int (*a6)(void)))(void)
{
  ...
  *v8 = g_ClipsProcParamArray;
  ...
  v8[4] = (_DWORD)(uintptr_t)(g_ProcParam_ErrorContextCallback);
  v8[5] = g_ProcParamSavedFrameStack;
  g_ProcParamSavedFrameStack = (int)(intptr_t)v8;
  ProcParam_EvaluateArgumentExpressions((uintptr_t)(uintptr_t)(a1), a2, a3, a4, a5);
...
__int16 * ProcParam_BuildWildcardMultifield(_DWORD *returnValue, int theIndex)
{
  ...
  if ( size <= 0 )
  {
    ...
    *(_DWORD *)(uintptr_t)(g_ClipsProcParamWildcardValue + 8) = (_DWORD)(uintptr_t)(emptyMultifield);
    returnValue[2] = (_DWORD)(uintptr_t)(emptyMultifield);
  ...
  else
  {
    ...
    *(_DWORD *)(uintptr_t)(g_ClipsProcParamWildcardValue + 8) = (_DWORD)(uintptr_t)(theMultifield);
    paramIndex = theIndex - 1;
    returnValue[2] = (_DWORD)(uintptr_t)(theMultifield);
    destFieldIndex = 1;
    if ( theIndex - 1 < g_ClipsProcParamCount )
    {
...
signed int  Parser_ScanBindStatementsForSymbol(int actions, int (*altBindFunc)(void), int userBuffer)
{
  ...
  do
  {
    while ( 1 )
    {
      ...
      {
        if ( Parser_ScanBindStatementsForSymbol(*(_DWORD *)(uintptr_t)(exprCursor + 6), altBindFunc, userBuffer) )
          return 1;
        Symbol = Rules_MakeSymbol((_BYTE*)(aBind_1));
...
BOOL  Dribble_QueryRouter(int logicalName)
{
  ...
  return !strcmp_(logicalName, (_DWORD)(uintptr_t)(aStdout_2))
      || !strcmp_(v1, (_DWORD)(uintptr_t)(aStdin_2))
      || !strcmp_(v3, (_DWORD)(uintptr_t)(g_IO_LogicalNameTable_WClips[0]))
      || !strcmp_(v4, (_DWORD)(uintptr_t)(g_IO_LogicalNameTable_WTrace[0]))
      || !strcmp_(v5, (_DWORD)(uintptr_t)(g_IO_LogicalNameTable_WError[0]))
      || !strcmp_(v6, (_DWORD)(uintptr_t)(g_IO_LogicalNameTable_WWarning[0]))
      || !strcmp_(v7, (_DWORD)(uintptr_t)(g_IO_LogicalName_WDisplay))
      || !strcmp_(v8, (_DWORD)(uintptr_t)(g_IO_LogicalNameTable_WDialog[0]));
}

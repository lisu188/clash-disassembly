...
_DWORD * Rules_CreateDeftemplateSlot(int *fieldNode, int precedingSlot, char withinMultifield, int lastSlot)
{
  ...
  *(_DWORD *)(uintptr_t)(v12 + 12) |= (withinMultifield & 1) << 6;
  ...
  slotRecord[6] = (_DWORD)(uintptr_t)(slotNameChain);
  slotRecord[8] = lastSlot;
  if ( !precedingSlot )
  {
    if ( lastSlot )
    {
      *(_DWORD *)(uintptr_t)(lastSlot + 28) = (_DWORD)(uintptr_t)(slotRecord);
      return slotRecord;
    }
LABEL_11:
    *(_DWORD *)(uintptr_t)(g_ClipsDeftemplateBeingParsedPtr + 32) = (_DWORD)(uintptr_t)(slotRecord);
    return slotRecord;
  }
  if ( lastSlot )
  {
    ...
    if ( prevChild )
      *(_DWORD *)(uintptr_t)(prevChild + 36) = (_DWORD)(uintptr_t)(slotRecord);
    *(_DWORD *)(uintptr_t)(lastSlot + 28) = (_DWORD)(uintptr_t)(slotRecord);
    return slotRecord;
  }
  else
  {
    ...
    if ( !existingHeadSlot )
      goto LABEL_11;
    *(_DWORD *)(uintptr_t)(existingHeadSlot + 36) = (_DWORD)(uintptr_t)(slotRecord);
    *(_DWORD *)(uintptr_t)(g_ClipsDeftemplateBeingParsedPtr + 32) = (_DWORD)(uintptr_t)(slotRecord);
    return slotRecord;
  }
}
...
signed int  Rules_InsertPriorityCallbackByRef(int name, int theFunction, int *listHead, int priority)
{
  ...
  *newNode = name;
  ...
  v9[3] = currentNode;
  *(_DWORD *)(uintptr_t)(lastNode + 12) = (_DWORD)(uintptr_t)(v9);
  return 1;
}
...
signed int __fastcall Rules_RemoveNamedCallListEntry(int name CLASH95_UNUSED, _DWORD *listHead)
{
  ...
  if ( !*listHead )
    return 0;
  while ( strcmp_((_DWORD)(uintptr_t)(currentNode), *currentNode) )
  {
...
int  Str_Concat(const char *string1, const char *string2, unsigned int a3)
{
  ...
  position = 0;
  bufferMax[0] = 0;
  buffer = Str_Append(string1, 0, bufferMax, (_DWORD*)(&position));
  appendedBuffer = Str_Append(string2, buffer, bufferMax, (_DWORD*)(&position));
...
char * Str_AppendBounded(int appendStr, char *oldStr, _DWORD *oldPos, int length, unsigned int *oldMax)
{
  ...
  if ( !theString )
    return 0;
  strncpy_((_DWORD)(uintptr_t)(oldPos), appendStr);
  ...
  *result = name;
  if ( listHead )
  {
    ...
    if ( lastNode )
    {
      ...
      *(_DWORD *)(uintptr_t)(lastNode + 12) = (_DWORD)(uintptr_t)(newNode);
...
int __thiscall Rules_InternInitialFactSymbol(void *this_)
{
  ...
  initialFactSymbol = Str_Intern(aInitialFact_2, (int)(intptr_t)this_);
...
{
  return Rules_UndefconstructCommand((int)(intptr_t)this_, g_DeftemplateConstructType);
}
// 54E650: using guessed type int dword_54E650;
...
{
  return Rules_GetConstructModuleCommand((int)(intptr_t)this_, (const char **)(uintptr_t)g_DeftemplateConstructType);
}
// 54E650: using guessed type int dword_54E650;
...
{
  return Rules_PPConstructCommand((int)(intptr_t)this_, (const char **)(uintptr_t)g_DeftemplateConstructType);
}
// 54E650: using guessed type int dword_54E650;
...
signed int  Rules_SetWatchItemState(unsigned int newState, int itemName, int argExprs)
{
  ...
  if ( newState >= 2 )
    return 0;
  if ( !strcmp_(itemName, (_DWORD)(uintptr_t)(aAll_1)) )
  {
  ...
  else
  {
    ...
    if ( !g_WatchItemListHead )
      return 0;
    while ( strcmp_((_DWORD)(uintptr_t)(namedItem), *namedItem) )
    {
...
int __fastcall Rules_FindWatchItem(int itemName, _DWORD *recognized)
{
  ...
  *recognized = 1;
  result = strcmp_(itemName, (_DWORD)(uintptr_t)(aAll_1));
  if ( result )
  {
    currentItem = (_DWORD *)(uintptr_t)g_WatchItemListHead;
    if ( g_WatchItemListHead )
    {
      while ( strcmp_((_DWORD)(uintptr_t)(currentItem), *currentItem) )
      {
...
{
  return strcmp_((_DWORD)(uintptr_t)(this_), (_DWORD)(uintptr_t)(g_IO_LogicalNameTable_WTrace[0])) == 0;
}
// 476330: using guessed type int __fastcall strcmp_(_DWORD, _DWORD);
// 51A618: using guessed type char *off_51A618[4];

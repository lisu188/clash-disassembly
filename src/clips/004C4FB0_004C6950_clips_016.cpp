...
int  Deffunction_BsaveWriteConstructs(int fp, int a2)
{
  ...
  if ( result )
  {
    Rules_ConstructQueuePop((_DWORD*)(&g_Clips_DeffunctionCount));
    return Rules_ConstructQueuePop((_DWORD*)(&g_Deffunction_Count));
  }
  return result;
}
...
const void * Class_BsaveWriteData(int fp)
{
  ...
  if ( g_ClipsBloadDefclassCount || g_ClipsBloadSlotRecordCount )
  {
    ...
    if ( result )
    {
      Rules_ConstructQueuePop((_DWORD*)(&g_DefclassNameTableCount));
      Rules_ConstructQueuePop((_DWORD*)(&g_ClipsBloadDefclassCount));
      Rules_ConstructQueuePop((_DWORD*)(&g_ClipsBloadClassLinkCount));
      Rules_ConstructQueuePop((_DWORD*)(&g_ClipsDefclassBsaveHandlerCount));
      Rules_ConstructQueuePop((_DWORD*)(&g_Defclass_SlotRecordCount));
      Rules_ConstructQueuePop((_DWORD*)(&g_Defclass_SlotNameLinkCount));
      Rules_ConstructQueuePop((_DWORD*)(&g_ClipsDefclassBsaveIndexArrayCount));
      return (const void *)(uintptr_t)Rules_ConstructQueuePop((_DWORD*)(&g_ClipsBloadSlotRecordCount));
    }
  }
  else
  {
...
_DWORD * Class_BsaveWriteSlotNameTable(_DWORD *result, int fp)
{
  ...
  if ( result[18] )
  {
    ...
    do
    {
      ...
      ++linkIndex;
      result = (_DWORD *)(Rules_BsaveWriteBlock(4, fp, indexBuffer));
      linkOffset = v8 + 4;
    }
...
_DWORD * Class_BsaveWriteSlotRecords(_DWORD *result, int fp)
{
  ...
  if ( result[24] )
  {
    ...
    do
    {
      ...
      result = (_DWORD *)(Rules_BsaveWriteBlock(28, fp, dummyHandler));
      ++handlerIndex;
...
_DWORD *__thiscall Class_BloadStorage(void *this_)
{
  ...
  {
    Rules_ReportSystemError((int)(intptr_t)this_, 1);

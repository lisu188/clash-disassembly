...
int PP_MakeConst26(void)
{
  ...
  Mem_AllocArray((_BYTE*)(bitmap), 4);
  if ( *(int *)(uintptr_t)(v0 + 40) <= 0 )
  {
    LOBYTE(bitmap[0]) |= 1u;
    bitmap[0] &= 0xFFFC0001;
    return Rules_AddBitmapValue((_BYTE*)(bitmap), 4);
  }
  packedWord = bitmap[0];
...
signed int __fastcall Rules_BuildFieldRangeConstraintNode(int firstField CLASH95_UNUSED, int secondField)
{
  ...
  else
  {
    ...
    v6 = Rules_AddBitmapValue((_BYTE*)(bitmapData), 4);
...
signed int  Rules_BuildFieldRangeOrValueConstraintNode(int firstField, int secondField)
{
    ...
    || *(int *)(uintptr_t)(secondField + 40) <= 0 )
  {
    ...
    {
      Mem_AllocArray((_BYTE*)(&rangeBitmapData), 8);
      ...
      rangeBitmapValue = Rules_AddBitmapValue((_BYTE*)(&rangeBitmapData), 8);
  ...
  else
  {
    ...
    if ( (*(_BYTE *)(uintptr_t)(v4 + 8) & 1) != 0 )
      ...
      LOBYTE(bitmapData[0]) |= 1u;
    valueBitmapValue = Rules_AddBitmapValue((_BYTE*)(bitmapData), 4);
...
int  Rules_ParseOrderedFactPattern(int readSource, int theToken)
{
  ...
  *(_DWORD *)(uintptr_t)(patternNode + 68) = (_DWORD)(uintptr_t)(relationNode);
  *relationNode = 2;
  ...
  *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(patternNode + 68) + 4) = *(_DWORD *)(uintptr_t)(theToken + 4);
  ...
  else
  {
    ...
    if ( fieldList )
    {
      *(_DWORD *)(uintptr_t)(patternNode + 64) = (_DWORD)(uintptr_t)(fieldList);
...
int __fastcall Rules_CreateInitialFactPatternNode(int a1, int a2 CLASH95_UNUSED)
{
  ...
  v17[2] = a1;
  if ( !Rules_FindImportExportConstruct(aDeftemplate_7, v17, (_BYTE*)(aInitialFact), 1, 0) )
  {
  ...
  *patternNode = 17;
  ...
  patternNode[10] = 1;
  relationNode = (_DWORD *)(uintptr_t)AST_AllocNode();
  *(_DWORD *)(uintptr_t)(v4 + 68) = (_DWORD)(uintptr_t)(relationNode);
  *relationNode = 2;
  initialFactSymbol = Str_Intern(aInitialFact, v5);
  *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(v7 + 68) + 4) = (_DWORD)(uintptr_t)(initialFactSymbol);
  return v7;
}
...
int  Rules_FindPatternParser(_DWORD *parserCursor, _DWORD *entityPtr)
{
  ...
  if ( current )
  {
    ...
    {
      Rules_ReportSystemError((int)(intptr_t)(parserCursor), 1);
      result = IO_RunRouterExitCallbacks(4);
    }
  }
  else
  {
...
LABEL_33:
      if ( multifieldMode )
      {
        ...
        *(_DWORD *)(uintptr_t)(wrapperNode + 16) = (_DWORD)(uintptr_t)(slotConstraint);
        *(_BYTE *)(uintptr_t)(wrapperNode + 8) = nodeFlags | 4;
        *(_DWORD *)(uintptr_t)(wrapperNode + 68) = (_DWORD)(uintptr_t)(fieldList);
...
LABEL_30:
        ...
        if ( nodeType == 18 || nodeType == 16 )
        {
          ...
          *(_DWORD *)(uintptr_t)(node + 16) = v20;
          if ( g_ClipsPositiveInfinitySymbol != *(_DWORD *)(uintptr_t)(*(int *)((char *)slotConstraint + 22) + 2) )
          {
            ...
            v21 = (int*)(intptr_t)(Rules_AddIntegerValue(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(*(int *)((char *)slotConstraint + 22) + 2) + 16) - singleFieldCount));
          ...
          if ( multiFieldCount == 1 && g_Clips_NegativeInfinitySymbol != *(_DWORD *)(uintptr_t)(*(int *)((char *)slotConstraint + 18) + 2) )
          {
            ...
            v24 = (int*)(intptr_t)(Rules_AddIntegerValue(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(*(int *)((char *)slotConstraint + 18) + 2) + 16) - singleFieldCount));
  ...
  while ( 1 )
  {
    ...
    {
      fieldNode = Rules_ParseConnectedConstraint(readSource, (_DWORD*)(&errorFlag));
      if ( !fieldNode )
      {
    ...
    if ( !multifieldMode )
      break;
    if ( lastField )
      *(_DWORD *)(uintptr_t)(lastField + 64) = (_DWORD)(uintptr_t)(fieldNode);
    else
      fieldList = fieldNode;
    if ( *theToken == 101 )
      goto LABEL_24;
...
unsigned int * Rules_ParseConnectedConstraint(int readSource, _DWORD *errorFlag)
{
  ...
  if ( *andChain != 15 && *andChain != 16 || (v8 = *((_BYTE *)andChain + 8), (v8 & 1) != 0) || *token == 92 )
  {
    ...
    *(_DWORD *)(uintptr_t)(v11 + 68) = (_DWORD)(uintptr_t)(andChain);
    ...
    do
    {
      ...
      if ( *term == 94 )
      {
        ...
        if ( (char)v6[1] < 0 )
        {
          v9 = 1;
LABEL_22:
          AST_DecrementNodeRefCount((_DWORD*)(v6));
          goto LABEL_7;
        }
        v10 = 1;
        AST_DecrementNodeRefCount((_DWORD*)(v6));
...
unsigned int * Rules_ParseSingleFieldConstraintTerm(int readSource, _DWORD *errorFlag)
{
  ...
  *node = *token;
  if ( tokenType == 2 )
  {
    if ( !strcmp_((_DWORD)(uintptr_t)(token), (_DWORD)(uintptr_t)(asc_50A08C)) )
    {
    ...
    {
      if ( strcmp_(v11, (_DWORD)(uintptr_t)(asc_50A090)) )
      {
LABEL_5:
        node[1] = token[1];
        return node;
...
int * Rules_BuildConjunctionFromPatternList(int patternList)
{
  ...
  *v2 = 81;
    ...
    for ( i = (_DWORD *)(uintptr_t)fullyNormalized[16]; i; i = (_DWORD *)(uintptr_t)i[17] )
    {
      if ( *i != 81 )
      {
        ...
        *(_DWORD *)(uintptr_t)(v12 + 68) = 0;
        if ( v11 )
          *(_DWORD *)(uintptr_t)(v11 + 68) = (_DWORD)(uintptr_t)(newAndNode);
        else
  ...
  Rules_FinalizeConjunctionChain((_DWORD*)(node));
  if ( *node == 82 )

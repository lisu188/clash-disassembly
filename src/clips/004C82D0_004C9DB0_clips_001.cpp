...
_DWORD * Defgeneric_AppendMethodSignatureText(char *buf, int bufMax, int a3, int theMethod)
{
  ...
  *buf = 0;
  if ( (*(_BYTE *)(uintptr_t)(theMethod + 24) & 1) != 0 )
    strncpy_(a3, (_DWORD)(uintptr_t)(aSys));
...
int  Defgeneric_DefgenericsToCode(const char *fileName, const char *pathName, int imageID, int headerFP, int maxIndices)
{
  ...
  if ( Enum )
  {
    while ( 1 )
    {
      ...
      moduleFile = Rules_ConstructCodeFileClose(moduleFile, &moduleCount, maxIndices, (_DWORD*)(&moduleArrayVersion), (_DWORD*)(&moduleReopen), (int)(intptr_t)moduleNameBuf);
      for ( i = Defgeneric_GetNextInModule(0); i; i = Defgeneric_GetNextInModule(i) )
      {
        ...
        ++genericCount;
        genericFile = Rules_ConstructCodeFileClose(genericFile, &genericCount, maxIndices, (_DWORD*)(&genericArrayVersion), (_DWORD*)(&genericReopen), (int)(intptr_t)genericNameBuf);
        if ( *(_DWORD *)(uintptr_t)(i + 32) )
        {
          ...
          if ( numMethods )
          {
            ...
            do
            {
              ...
              if ( *(int *)(uintptr_t)(methodPtr + 8) > 0 )
              {
                ...
                if ( numRestrictions )
                {
                  ...
                  do
                  {
                    ...
                    if ( restrictionPtr[2] )
                    {
                      ...
                      typeFile = Rules_ConstructCodeFileClose(typeFile, (int *)&typeCount, maxIndices, (_DWORD*)(&typeArrayVersion), (_DWORD*)(&typeReopen), (int)(intptr_t)typeNameBuf);
                    }
                ...
                restrictionFile = Rules_ConstructCodeFileClose(restrictionFile, &restrictionCount, maxIndices, (_DWORD*)(&restrictionArrayVersion), (_DWORD*)(&restrictionReopen), (int)(intptr_t)restrictionNameBuf);
              }
              v11 = methodOffset + 40;
          ...
          methodFile = Rules_ConstructCodeFileClose(methodFile, &methodCount, maxIndices, (_DWORD*)(&methodArrayVersion), (_DWORD*)(&methodReopen), (int)(intptr_t)methodNameBuf);
        }
      }
...
LABEL_34:
    Defgeneric_CloseCodeFiles(&moduleFile, (_DWORD*)(&moduleReopen), maxIndices, (int)(intptr_t)moduleNameBuf);
    return 0;
  }
  else
  {
...
int  Defgeneric_CloseCodeFiles(int *fileHandles, _DWORD *versions, int a3, int a4)
{
  ...
  do
  {
    v9 = a3;
    v7 = *fileHandles++;
    *(fileHandles - 1) = Rules_ConstructCodeFileClose(v7, (int*)(intptr_t)(v9), a3, (_DWORD*)(&v9b), versionPtr, offset);
    result = offset + 12;
    ++versionPtr;
    offset += 12;
  }
...
signed int  Defgeneric_ParseDefmethod(int readSource)
{
  ...
  if ( !Method_ParseIndexModifier(readSource2, &methodIndex) || !Defgeneric_ParseDeclaration() )
    return 1;
  addedGeneric = Defgeneric_AddConstruct(genericNameToken, (_DWORD*)(&isNewGeneric));
  ...
  *((_BYTE *)methodSlot + 24) &= ~1u;
  ...
  if ( insertIndex != -1 )
  {
    ...
    if ( restrictionCount )
    {
      ...
      *(_DWORD *)(uintptr_t)(v15 + 28) = (_DWORD)(uintptr_t)(restrictionArray);
    }
    else
    {
      methodSlot[7] = 0;
    ...
    if ( restrictionCount > 0 )
    {
      ...
      do
      {
        ...
        *(_DWORD *)(uintptr_t)(restrictionPtr + 4) = (_DWORD)(uintptr_t)(AST_PackNodeChain((_DWORD *)(uintptr_t)*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(restrictions + 6) + 4)));
        ...
        *(_DWORD *)(uintptr_t)(restrictionPtr + 8) = typeCount;
        if ( copyRestrictions )
        {
          if ( *sourceRestriction )
          {
            ...
            *(_DWORD *)(uintptr_t)restrictionPtr = (_DWORD)(uintptr_t)(typeArray);
...
int  Method_PackRestrictionTypes(_DWORD *restriction, int typeList)
{
  ...
  {
    typeArray = Mem_SmallBlockAlloc(4 * typeCount);
    *restr = (_DWORD)(uintptr_t)(typeArray);
  }
  else
  {
    *restr = 0;
...
signed int  Defgeneric_CreateDefaultPPForm(int gfunc)
{
  ...
  sprintf_((char*)(ppForm), "(defgeneric %s::%s)\n", Name, v6);

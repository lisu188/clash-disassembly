...
int  Rules_RemoveEntityDependencies(_DWORD *theBinds)
{
  ...
  if ( dependencyPtr )
  {
    do
    {
      ...
      *(_DWORD *)(uintptr_t)(theBind + 4) = (_DWORD)(uintptr_t)(Rules_RemoveDependencyLink((_DWORD *)(uintptr_t)*(_DWORD *)(uintptr_t)(*dependencyPtr + 4), (int)(intptr_t)theBinds));
  ...
  if ( (*(_BYTE *)(uintptr_t)result & 8) != 0 )
  {
    ...
    if ( dependencyPtr )
    {
      do
      {
        ...
        *(_DWORD *)(uintptr_t)(theBind + 4) = (_DWORD)(uintptr_t)(updatedList);
        if ( updatedList )
        {
...
signed int  Rules_PrintDependentList(int theEntity, int a2)
{
  ...
  entityPtr = 0;
  traversalBuffer[0] = 0;
  Rules_FindPatternParser(traversalBuffer, (_DWORD*)(&entityPtr));
  found = 0;
  while ( entityPtr )
  {
...
_DWORD * Rules_Dependencies(double a1)
{
  ...
  if ( result != (_DWORD *)-1 )
  {
    result = Rules_ResolveFactOrInstanceArg((_DWORD*)(&itemBuffer), (_BYTE*)(aDependencies_0), v2, a1);
    if ( result )
...
_DWORD * Rules_Dependents(double a1)
{
  ...
  if ( result != (_DWORD *)-1 )
  {
    result = Rules_ResolveFactOrInstanceArg((_DWORD*)(&itemBuffer), (_BYTE*)(aDependents_0), v2, a1);
    if ( result )
...
_DWORD * Rules_ResolveFactOrInstanceArg(_DWORD *item, _BYTE *functionName, int a3, double a4)
{
  ...
  if ( theType == 1 )
  {
    ...
    if ( foundEntity )
      return foundEntity;
    sprintf_((char*)(numberBuffer), "f-%ld", *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(v11 + 8) + 16));
      ...
      case 10:
        ...
        switch ( *(_BYTE *)(uintptr_t)(theFunction + 8) )
        {
          ...
          case 'l':
            ...
            theValue = (void*)(intptr_t)(Rules_AddIntegerValue((int)(intptr_t)(longResult)));
            goto LABEL_10;
          case 'j':
          case 'k':
          case 'm':
...
int  Rules_RegisterEvaluationHandler(int result, int whichPosition)
{
  ...
  if ( g_Clips_PrimitiveEntityTable[whichPosition] )
  {
    ...
    result = IO_RunRouterExitCallbacks(7);
...
signed int  AST_BuildExpressionFromValue(_DWORD *theValue)
{
  ...
  if ( topNode )
    return topNode;
  Symbol = Rules_MakeSymbol((_BYTE*)(aCreate_1));
...
_DWORD * Rules_UpdateBetaMemoryOnRetract(_DWORD *result, int theBind, int deferJoinDrive, double a4)
{
  ...
  if ( currentMatch )
  {
    while ( 1 )
    {
      ...
      *result = 0;
      result[1] = 0;
      *(_DWORD *)(uintptr_t)(currentMatch + 4 * (*(_DWORD *)(uintptr_t)currentMatch << 17 >> 23) + 4) = (_DWORD)(uintptr_t)(result);
      ...
      {
        result = (_DWORD *)Rules_DriveJoinNetwork((int*)(intptr_t)(currentMatch), (char*)(uintptr_t)(*(_DWORD *)(uintptr_t)(theJoin + 20)), 1, a4);
      ...
      else
      {
        while ( childJoin )
        {
          result = (_DWORD *)Rules_DriveJoinNetwork((int*)(intptr_t)(currentMatch), (char*)(intptr_t)(childJoin), 0, a4);

...
#include "0048773C_0048A4A0_clips_005_local.h"
...
LABEL_116:
            ...
            _clib_ulltoa_(ctx, (_DWORD)(uintptr_t)(&outputBuffer[*(_DWORD *)(uintptr_t)(ctx + 32)]));
          ...
          else
          {
            if ( !*(_DWORD *)(uintptr_t)(ctx + 8) && !HIDWORD(value64) )
              goto LABEL_108;
            CRT_SignedLongToDecimalString(ctx, (_DWORD)(uintptr_t)(&outputBuffer[*(_DWORD *)(uintptr_t)(ctx + 32)]));
            if ( *(_BYTE *)(uintptr_t)(v41 + 21) == 88 )
LABEL_114:
...
unsigned int  CRT_CreateFileHandleFromPath(const CHAR *fileName, int openMode, int extraOpenFlags, DWORD retryDisposition)
{
  ...
  if ( _NTAtMaxFiles_() )
    goto LABEL_2;
  access_bits = v5 & 7;
  CRT_MapAccessModeToCreateFileFlags(access_bits, &dwDesiredAccess, (_DWORD*)(&v18));
  file_attributes = 128;
  ...
  if ( g_CRT_ConsoleOpenHook && !stricmp_((_DWORD)(uintptr_t)(v9), (_DWORD)(uintptr_t)(aCon_0)) )
  {
    _NTGetFakeHandle_(
      SecurityAttributes.nLength,
      (_DWORD)(uintptr_t)(SecurityAttributes.lpSecurityDescriptor),
...
LABEL_2:
  ...
  isatty_((_DWORD)(uintptr_t)(v14), 0);
LABEL_26:
  _SetIOMode_(SecurityAttributes.nLength, (_DWORD)(uintptr_t)(SecurityAttributes.lpSecurityDescriptor), SecurityAttributes.bInheritHandle);
...
signed int  CRT_MkTime(_DWORD *brokenDownTime)
{
  ...
  for ( i = 60 * (60 * brokenDownTime[2] + brokenDownTime[1]) + *brokenDownTime; i < 0; i += 86400 )
    --dayCount;
  _brktime_((_DWORD)(uintptr_t)(brokenDownTime), i);
  CRT_TzSet();
...
signed int  CRT_FlushBufferAndPutChar(signed int result, int lockKey)
{
  ...
  if ( result != -1 )
  {
    ...
    if ( v6 != (unsigned __int8 *)1 )
    {
      ...
      {
LABEL_4:
        g_CRT_FileHandleLockReleaseHook((_DWORD)(uintptr_t)(v6), (_DWORD)(uintptr_t)(stream));
        return -1;
      }
...
_DWORD * IO_StreambufAlloc(int a1, char a2, DWORD a3)
{
  ...
  if ( result )
    *result = (_DWORD)(uintptr_t)(g_IOStreambuf_VTable);
  return result;
}
...
_DWORD * IO_StreambufAllocDerived(int a1, char a2, DWORD a3)
{
  ...
  result = (_DWORD *)(uintptr_t)Mem_Alloc(4, a1, a2, a3);
  if ( result )
    *result = (_DWORD)(uintptr_t)(g_FuncTable_511094);
  return result;
}
...
int  Rules_ConstructHandleVectorDtor(int result, char dtorFlags)
{
  ...
  if ( (dtorFlags & 4) != 0 )
  {
    _wcpp_4_dtor_array_store__(result, (_DWORD)(uintptr_t)(&g_RulesHandleVector_DtorArrayDescriptor));
    j_j__nfree_();
    return v3;
  }
...
int  Rules_ConstructRecordVectorDtor(int result, char dtorFlags)
{
  ...
  if ( (dtorFlags & 4) != 0 )
  {
    _wcpp_4_dtor_array_store__(result, (_DWORD)(uintptr_t)(&g_RulesRecordArrayDtorSlot));
    j_j__nfree_();
    return v3;
  }
  else if ( (dtorFlags & 2) != 0 )
...
_DWORD * Rules_ParseDeftemplateSlotList(int thePattern, _DWORD *theSlot)
{
  ...
  *(_DWORD *)(uintptr_t)(thePattern + 64) = prunedTree;
  ...
  g_ClipsDeftemplateBeingParsedPtr = Rules_FindImportExportConstruct(aDeftemplate_5, (_DWORD*)(&count), deftemplateName, 1, 0);
  lastSlot = 0;
...
LABEL_41:
      ...
      *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(v11 + 68) + 52) = (_DWORD)(uintptr_t)(v10);

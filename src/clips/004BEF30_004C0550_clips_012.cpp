  ...
  if ( result )
  {
    do
    {
      if ( result == theJoin )
      {
        ...
        if ( prevLink )
          *(_DWORD *)(uintptr_t)(prevLink + 32) = (_DWORD)(uintptr_t)(result);
        else
...
signed int  Rules_ParseDefrule(int readSource, double a2)
{
  ...
  if ( theLHS )
  {
    ...
    if ( theActions )
    {
      Rules_BuildDefruleDisjunctChain((_DWORD*)(theLHS), theActions, v7);
      AST_Free(rhsActions);
      Parser_FreeLoopContextStack();
      ...
      if ( v9 )
      {
        ...
        else
        {
          ...
          *(_DWORD *)(uintptr_t)(v19 + 4) = (_DWORD)(uintptr_t)(v18);
        }
...
int  Rules_BuildDefruleDisjunctChain(_DWORD *theLHS, signed int actions, int ruleName)
{
  ...
  while ( 1 )
  {
    ...
    packPtr = AST_PackNodeChain((_DWORD*)(newActions));
    ...
    if ( topDisjunct )
    {
      lastDisjunct[12] = (_DWORD)(uintptr_t)(currentDisjunct);
    }
    else
    {
...
_DWORD * Rules_AllocDefruleDisjunct(int ruleName, int localVarCnt, __int16 complexity, int theActions, int logicalJoin, int lastJoin)
{
  ...
  *(_DWORD *)(uintptr_t)(newDisjunct + 24) = localVarCnt;
  ...
  theJoin = lastJoin;
  *(_DWORD *)(uintptr_t)(lastJoin + 36) = (_DWORD)(uintptr_t)(disjunctPtr);
...
int  Rules_ReplaceRHSModifyDuplicateVar(__int16 *nodePtr, _DWORD *theLHS, int a3)
{
  ...
  if ( *nodePtr == 10 )
  {
    Symbol = Rules_MakeSymbol((_BYTE*)(aModify_0));
    ...
    {
      duplicateSymbol = Rules_MakeSymbol((_BYTE*)(aDuplicate_0));
  ...
  do
  {
    while ( 1 )
    {
      if ( *exprPtr == 10 )
      {
        ...
        {
          argComplexity = Rules_ComputeExpressionComplexity((short int*)(uintptr_t)(*(_DWORD *)(exprPtr + 3)));
...
_DWORD * Rules_AddConstructToModuleList(_DWORD *result)
{
  ...
  if ( *(_DWORD *)(uintptr_t)(moduleHeader + 8) )
  {
    ...
    do
    {
      result[4] = (_DWORD)(uintptr_t)(theConstruct);
      result = (_DWORD *)(uintptr_t)result[12];
    }
    while ( result );
    *(_DWORD *)(uintptr_t)(moduleHeader + 8) = (_DWORD)(uintptr_t)(theConstruct);
  }
  else
  {
    *(_DWORD *)(uintptr_t)(moduleHeader + 4) = (_DWORD)(uintptr_t)(result);
    *(_DWORD *)(uintptr_t)(moduleHeader + 8) = (_DWORD)(uintptr_t)(result);
  }
  return result;
}
...
int Rules_PrepareDefrulesForCodeGen(void)
{
  ...
  return Rules_JoinNetworkAssignCodeGenIds((_DWORD*)(&v3), &v4, v5);
}
...
LABEL_16:
  ...
  while ( 1 )
  {
    ...
    moduleFile = Rules_ConstructCodeFileClose(moduleFileHandle, &moduleArrayCount, maxIndices, (_DWORD*)(&moduleArrayVersion), 0, 0);
...
LABEL_15:
  ...
  while ( 1 )
  {
    ...
    closedDefruleFile = Rules_ConstructCodeFileClose(v10, &defruleArrayCount, maxIndices, (_DWORD*)(&defruleArrayVersion), 0, 0);
...
LABEL_9:
  ...
  if ( joinFileOpenResult )
  {
    ...
    ++joinArrayCount;
    joinFile = Rules_ConstructCodeFileClose(joinFileHandle, &joinArrayCount, maxIndices, (_DWORD*)(&joinArrayVersion), 0, 0);
    goto LABEL_9;
  }

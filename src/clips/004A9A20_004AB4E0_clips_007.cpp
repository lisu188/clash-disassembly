...
_DWORD * Instance_BuildInstance(int instanceName, int theDefclass, int initMessage, double a4)
{
  ...
  existingInstance = Instance_FindHashEntryForBuild(theDefclass, (int)(intptr_t)nameSymbol, (_DWORD*)(&prevInstance), (_DWORD*)(&hashBucket));
...
LABEL_14:
    ...
    {
      *(_DWORD *)(uintptr_t)(g_ClipsInstanceUnderConstruction + 28) = (_DWORD)(uintptr_t)(nameSymbol);
...
int __fastcall Rules_ParseObjectInstanceFunctionCall(int top, int readSource)
{
  ...
  errorFlag[3] = top;
  Symbol = Rules_MakeSymbol((_BYTE*)(aMakeInstance_0));
  if ( Symbol == *(int ***)(uintptr_t)(v4 + 2) || (v11 = Rules_MakeSymbol((_BYTE*)(aActiveMakeIn_0)), v11 == *(int ***)(uintptr_t)(v12 + 2)) )
  {
    callType = 0;
  }
  else
  {
    v13 = Rules_MakeSymbol((_BYTE*)(aInitializeIn_1));
    if ( v13 == *(int ***)(uintptr_t)(v14 + 2) || (v15 = Rules_MakeSymbol((_BYTE*)(aActiveInitia_0)), v15 == *(int ***)(uintptr_t)(v16 + 2)) )
    {
      callType = 1;
    }
    else
    {
      v17 = Rules_MakeSymbol((_BYTE*)(aModifyInstan_0));
      if ( v17 == *(int ***)(uintptr_t)(v18 + 2)
        || (v19 = Rules_MakeSymbol((_BYTE*)(aActiveModify_0)), v19 == *(int ***)(uintptr_t)(v20 + 2))
        || (v21 = Rules_MakeSymbol((_BYTE*)(aMessageModif_0)), v21 == *(int ***)(uintptr_t)(v22 + 2))
        || (v23 = Rules_MakeSymbol((_BYTE*)(aActiveMessag_0)), v23 == *(int ***)(uintptr_t)(v24 + 2)) )
      {
        callType = 2;
      }
      else
  ...
  *(_DWORD *)(uintptr_t)(v8 + 6) = v7;
  ...
  if ( !callType )
  {
    if ( *(_WORD *)(uintptr_t)*(_DWORD *)(uintptr_t)(v26 + 6) == 2 && !strcmp_(v26, (_DWORD)(uintptr_t)(aOf_0)) )
    {
      ...
      *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(v28 + 6) + 10) = v32;
      ...
      if ( !parsedArgNode )
        goto LABEL_7;
      if ( *parsedArgNode != 2 || strcmp_(v28, (_DWORD)(uintptr_t)(aOf_0)) )
      {
        *(_WORD *)(uintptr_t)*(_DWORD *)(uintptr_t)(v28 + 6) = 10;
        v34 = Rules_MakeSymbol((_BYTE*)(aGensym_1));
        *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(v30 + 6) + 2) = (_DWORD)(uintptr_t)(v34);
LABEL_33:
...
LABEL_8:
  ...
  if ( callType == 3 )
  {
    if ( g_ParserCurrentTokenType != 2 || strcmp_(v41, (_DWORD)(uintptr_t)(aTo_2)) )
    {
      v42 = Rules_MakeSymbol((_BYTE*)(aGensym_1));
    ...
    *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(slot_override_parent + 10) + 10) = AST_NewNode(2, g_ClipsTrueSymbol);
    ...
    while ( g_ParserCurrentTokenType != 101 )
    {
      if ( g_ParserCurrentTokenType == 100 )
      {
        ...
        if ( g_ParserCurrentTokenType != 101 )
          goto SLOT_OVERRIDE_ERROR;
        create_symbol = (int)(intptr_t)Rules_MakeSymbol((_BYTE*)(aCreate_0));
...
signed int  Rules_ResolveClassNameNode(int theExpression)
{
  ...
  if ( class_record )
  {
    ...
    *(_DWORD *)(uintptr_t)(theExpression + 2) = (_DWORD)(uintptr_t)(class_record);
    return 1;
  }
  if ( trace_load_save )
    fprintf(
...
signed int Instance_RegisterModifyAndDuplicateFunctions(void)
{
  ...
  Rules_AddFunctionParser((_BYTE*)(aActiveModifyIn));
  ...
  Rules_AddFunctionParser((_BYTE*)(aActiveMessageM));
  ...
  Rules_AddFunctionParser((_BYTE*)(aActiveDuplicat));
  ...
  Rules_AddFunctionParser((_BYTE*)(aActiveMessageD));
  ...
  Rules_AddFunctionParser((_BYTE*)(aModifyInstance));
  Rules_AddFunctionParser((_BYTE*)(aMessageModifyI));
  Rules_AddFunctionParser((_BYTE*)(aDuplicateInsta));
  return Rules_AddFunctionParser((_BYTE*)(aMessageDuplica));
}
...
_DWORD * Instance_ActiveModifyInstanceFunction(int *returnValue, double a2)
{
  ...
  overrides = (_DWORD *)(uintptr_t)Instance_ParseSlotOverrideArgs(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(g_ClipsCurrentExpression + 6) + 10), (_DWORD*)(&overrideCount), errorFlag, a2);
  if ( errorFlag[0] )
  {
    returnValue[1] = 2;
  ...
  else
  {
    if ( Instance_ResolveArgumentToInstance(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)*(_DWORD *)(uintptr_t)(g_ClipsCurrentExpression + 2) + 16), v3, a2) )
    {
      ...
      messageSymbol = Rules_FindSymbolEntry((_BYTE*)(aDirectModify_0));
...
_DWORD * Instance_ActiveMessageModifyInstanceFunction(int *returnValue, double a2)
{
  ...
  else
  {
    if ( Instance_ResolveArgumentToInstance(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)*(_DWORD *)(uintptr_t)(g_ClipsCurrentExpression + 2) + 16), v3, a2) )
    {
      savedGuardState = g_InstanceDirectMessageGuardActive;
      g_InstanceDirectMessageGuardActive = 1;
      messageSymbol = Rules_FindSymbolEntry((_BYTE*)(aMessageModif_1));
      MessageHandler_SendToInstanceAddress((int)(intptr_t)messageSymbol, v8, v9, returnValue, a2);
      g_InstanceDirectMessageGuardActive = savedGuardState;
    }
    else
...
_DWORD * Instance_ActiveDuplicateInstanceFunction(int *returnValue, double a2)
{
  ...
  else if ( Instance_ResolveArgumentToInstance(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)*(_DWORD *)(uintptr_t)(g_ClipsCurrentExpression + 2) + 16), v3, a2) && Lexer_ParseValueList(2, (_DWORD*)(&newNameValue), 8, a2) )
  {
    savedGuardState = g_InstanceDirectMessageGuardActive;
    g_InstanceDirectMessageGuardActive = 1;
    messageSymbol = Rules_FindSymbolEntry((_BYTE*)(aDirectDuplic_0));

...
LABEL_6:
    ...
    while ( 1 )
    {
      ...
      Rules_FindImportExportConstruct((char *)(uintptr_t)*(_DWORD *)(uintptr_t)thePCItem, (_DWORD*)(&count), (_BYTE *)(uintptr_t)*(_DWORD *)(uintptr_t)(theCItem + 16), 0, 0);
      if ( count > 1 )
        break;
      Module_SetCurrent(Enum);
      if ( !(*(int (**)(void))(uintptr_t)(theConstruct + 28))() )
...
int  Rules_ParseAssertTemplate(int readSource, int theToken, int endType, int *error, int constantsOnly, int theDeftemplate)
{
  ...
  for ( i = 0; ; i = v16 )
  {
    slotPtr = (int*)(Rules_ParseSlotLabel(readSource, theToken, (_DWORD*)(error), theDeftemplate, endType));
    if ( !slotPtr )
      break;
    tempSlot = firstSlot;
    if ( firstSlot )
...
LABEL_12:
  ...
  {
    Rules_ReorderAssertSlotValues((_DWORD *)(uintptr_t)*(_DWORD *)(uintptr_t)(theDeftemplate + 20), firstSlot, (_DWORD*)(error));
    AST_Free(firstSlot);
    return v14;
  }
}
...
signed int  Rules_ParseAssertSlotValues(int readSource, int theToken, int *error, int *slotPtr, int constantsOnly)
{
  ...
  {
    IO_OutWriteToken(asc_50AD10);
    newField = Rules_ParseAssertArgument(readSource, (unsigned int *)(uintptr_t)(unsigned int)theToken, (_DWORD*)(error), 101, constantsOnly, (_DWORD*)(&printError));
    if ( *error )
    {
LABEL_3:
      if ( printError )
...
LABEL_11:
  ...
  firstField = Rules_ParseAssertArgument(readSource, (unsigned int *)(uintptr_t)(unsigned int)theToken, (_DWORD*)(error), 101, constantsOnly, (_DWORD*)(&printError));
  errorFlag = *error;
  ...
  while ( 1 )
  {
    ...
    IO_OutWriteToken(asc_50AD10);
    IO_OutWriteToken((char *)(uintptr_t)*(_DWORD *)(uintptr_t)(theToken + 8));
    nextField = Rules_ParseAssertArgument(readSource, (unsigned int *)(uintptr_t)(unsigned int)theToken, (_DWORD*)(error), 101, constantsOnly, (_DWORD*)(&printError));
    if ( *error )
      break;
...
signed int Rules_RegisterModifyDuplicateFunctions(void)
{
  ...
  Rules_AddFunctionParser((_BYTE*)(aModify));
  Rules_AddFunctionParser((_BYTE*)(aDuplicate));
  Rules_SetFunctionSeqOverloadFlags((_BYTE*)(aModify), 0);
  return Rules_SetFunctionSeqOverloadFlags((_BYTE*)(aDuplicate), 0);
}
...
_DWORD * Rules_ModifyOrDuplicateFact(int retractIt, int returnValue, double a3)
{
  ...
  *(_DWORD *)(uintptr_t)(returnValue + 8) = g_ClipsFalseSymbol;
  result = (_DWORD *)(uintptr_t)Parser_ParseForm((__int16 *)(uintptr_t)*(_DWORD *)(uintptr_t)(g_ClipsCurrentExpression + 6), (_DWORD*)(&computeResult), *(_DWORD *)(uintptr_t)(g_ClipsCurrentExpression + 6), a3);
  if ( resultType != 1 )
  {
    if ( resultType == 6 )
    {
...
LABEL_32:
    Rules_ReportSymbolTypeError((_BYTE*)(functionName), 1);
  ...
  if ( !i )
  {
    sprintf_((char*)(tempBuffer), "f-%ld", factNum);
...
LABEL_46:
      ...
      {
        Rules_StoreEvaluatedNodesAsMultifield((_DWORD*)(&computeResult), *(_DWORD *)(uintptr_t)(j + 6), 0, a3);
      ...
      else
      {
        ...
        Parser_ParseForm((__int16 *)(uintptr_t)*(_DWORD *)(uintptr_t)(j + 6), (_DWORD*)(&computeResult), j, a3);
        Lexer_ErrorRecover(0);
        if ( resultType == 4 )
        {
      ...
      *((_DWORD *)newFactField + 14) = (_DWORD)(uintptr_t)(evalValue);
    }
    copyIndex = 0;
    if ( *(int *)((char *)i + 46) > 0 )
    {
      ...
      do
      {
        if ( *((_WORD *)newField + 27) == 4 && !newField[14] )
        {
          ...
          newField[14] = (_DWORD)(uintptr_t)(copiedMultifield);
        }
        ++copyIndex;
    ...
    if ( result )
    {
      ...
      *(_DWORD *)(uintptr_t)(v26 + 8) = (_DWORD)(uintptr_t)(result);
...
signed int  Lexer_ValidateMessageHandler(int top, int name, int theLHS)
{
  ...
  while ( 1 )
  {
    ...
    *(_WORD *)(uintptr_t)v14 = 1;
    ...
    indexValue = (int*)(intptr_t)(Rules_AddIntegerValue(slotPosition - 1));
    *(_DWORD *)(uintptr_t)(v18 + 2) = (_DWORD)(uintptr_t)(indexValue);
...
{
  return Lexer_ParseModifyOrDuplicate(top, logicalName, (_BYTE*)(aModify));
}

//----- (004C28A0) --------------------------------------------------------
int  Rules_ParseDuplicate(int top, int logicalName)
{
  return Lexer_ParseModifyOrDuplicate(top, logicalName, (_BYTE*)(aDuplicate));
}
...
LABEL_12:
    ...
    *(_DWORD *)(uintptr_t)(nextAdd + 10) = newField;
    ...
    if ( theToken != 101 )
    {
      ...
      {
        IO_OutWriteToken(asc_50ADC8);
        theField = Rules_ParseAssertArgument(logicalName, &theToken, (_DWORD*)(&error), 101, 0, (_DWORD*)(&printError));
        if ( error )
          break;
        if ( lastField )
...
LABEL_16:
  ...
  if ( *(char *)(uintptr_t)(theConstraint + 1) < 0 )
  {
    ...
    *(_DWORD *)(uintptr_t)(theConstraint + 26) = (_DWORD)(uintptr_t)(multifieldIntersection);
...
int  Rules_IntersectAllowedValueExpressions(int constraint1, int constraint2, int newConstraint)
{
  ...
  for ( i = 0; theList1; theList1 = *(__int16 **)(theList1 + 5) )
  {
    if ( Method_QueryRestrictionAllowsType(*theList1, *(_DWORD *)(theList1 + 1), constraint1) && Method_QueryRestrictionAllowsType(*theList1, *(_DWORD *)(theList1 + 1), constraint2) )
    {
      ...
      *(_DWORD *)(uintptr_t)(tmpExpr + 10) = (_DWORD)(uintptr_t)(i);
  ...
  for ( j = (__int16 *)(uintptr_t)*(_DWORD *)(uintptr_t)(constraint2 + 6); j; j = *(__int16 **)(j + 5) )
  {
      ...
      && Method_QueryRestrictionAllowsType(*j, *(_DWORD *)(j + 1), constraint2) )
    {
      ...
      *(_DWORD *)(uintptr_t)(tmpExpr2 + 10) = (_DWORD)(uintptr_t)(i);
      i = (__int16 *)(uintptr_t)tmpExpr2;
    }
  }
  result = newConstraint;
  *(_DWORD *)(uintptr_t)(newConstraint + 6) = (_DWORD)(uintptr_t)(i);
  return result;
}

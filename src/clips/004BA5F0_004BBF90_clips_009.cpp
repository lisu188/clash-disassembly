...
int  Rules_DeftemplateGenerateCode(const char *fileName, const char *fileNameBuffer, int pathName, int headerFP, int maxIndices)
{
  ...
  if ( Enum )
  {
    while ( 1 )
    {
      ...
      moduleFile = Rules_ConstructCodeFileClose(moduleFilePtr, &moduleArrayCount, maxIndices, (_DWORD*)(&moduleArrayVersion), 0, 0);
...
LABEL_9:
    ...
    while ( 1 )
    {
      ...
      ++recordArrayCount;
      v15 = theDeftemplate;
      v16 = Rules_ConstructCodeFileClose(v14, &recordArrayCount, maxIndices, (_DWORD*)(&recordArrayVersion), 0, 0);
...
LABEL_8:
    ...
    while ( 1 )
    {
      ...
      ++slotArrayCount;
      v20 = Rules_ConstructCodeFileClose(slotFilePtr, &slotArrayCount, maxIndices, (_DWORD*)(&slotArrayVersion), 0, 0);
...
int Rules_DefruleBsaveFind(void)
{
  ...
  Rules_JoinNetworkAssignCodeGenIds((_DWORD*)(&g_DefruleModuleBloadCount), &g_RuleJoinNodeBsaveCount, &g_Clips_JoinTestCount);
...
int  Rules_DefruleBsaveWriteData(const void *filePtr, int a2)
{
  ...
  if ( result )
  {
    Rules_ConstructQueuePop((_DWORD*)(&g_DefruleModuleBloadCount));
    Rules_ConstructQueuePop((_DWORD*)(&g_RuleJoinNodeBsaveCount));
    return Rules_ConstructQueuePop((_DWORD*)(&g_Clips_JoinTestCount));
  }
  return result;
}
...
int  Rules_ParseDeftemplate(char *readSource, double a2)
{
  ...
  else
  {
    ...
    else
    {
      ...
      *(_DWORD *)(uintptr_t)(newDeftemplate + 20) = (_DWORD)(uintptr_t)(slotList);
      *(_BYTE *)(uintptr_t)(newDeftemplate + 24) = v11 | 4;
      ...
      else
      {
        ...
        *(_DWORD *)(uintptr_t)(v14 + 4) = (_DWORD)(uintptr_t)(v16);
      }
...
_DWORD * Rules_DeftemplateInstallSlots(_DWORD *result, int a2)
{
  ...
  for ( i = (__int16 **)(uintptr_t)result[5]; i; i = *(__int16 ***)(uintptr_t)(v7 + 16) )
  {
    ...
    *(_DWORD *)(uintptr_t)(v7 + 8) = (_DWORD)(uintptr_t)(result);
  }
  return result;
}

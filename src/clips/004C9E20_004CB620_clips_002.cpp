  ...
  *paramsOut = 0;
  ...
  while ( g_ClipsMethodParserToken != 101 )
  {
    ...
    if ( g_ClipsMethodParserToken == 15 || g_ClipsMethodParserToken == 16 )
    {
      ...
      if ( Method_CheckDuplicateParameterName(paramList, (_DWORD*)(&lastParam), g_Clips_CurrentTokenValue) )
        goto LABEL_18;
...
int ** Method_ReplaceCurrentArgumentRefs(int **result)
{
  ...
  if ( result )
  {
    do
    {
      if ( *(_WORD *)node == 15 )
      {
        result = (int **)(strcmp_(node, (_DWORD)(uintptr_t)(aCurrentArgumen)) == 0);
        if ( result )
        {
          *(_WORD *)node = 10;
          result = Rules_MakeSymbol((_BYTE*)(aGnrcCurrentA_0));
          *(_DWORD *)(node + 2) = (_DWORD)(uintptr_t)(result);
        }
      }
      if ( *(_DWORD *)(node + 6) )
        result = (int **)Method_ReplaceCurrentArgumentRefs((int**)(uintptr_t)(*(_DWORD *)(node + 6)));
      node = *(_DWORD *)(node + 10);
    }
    while ( node );
  }
...
_DWORD * Defgeneric_InsertMethodSlot(_DWORD *gfunc, int position, unsigned int methodIndex)
{
  ...
  *((_BYTE *)slot + 24) = v12 & 0xFE;
  ...
  ++gfunc[8];
  gfunc[7] = (_DWORD)(uintptr_t)(newMethods);
...
signed int __thiscall Method_PrintCallErrorBanner(void *this_)
{
  ...
  Output_Write((int)(intptr_t)g_IO_LogicalNameTable_WError[0], (int)(intptr_t)aGenericFunct_5, (int)(intptr_t)this_);
...
LABEL_7:
      if ( *(_DWORD *)(uintptr_t)(restriction + 4) )
      {
        ...
        Parser_ParseForm((__int16 *)(uintptr_t)*(_DWORD *)(uintptr_t)(restriction + 4), (_DWORD*)(&v11), v2, a2);

...
LABEL_6:
      ...
      if ( *(_DWORD *)(exprNode + 3) )
      {
        ...
        result = (__int16 *)Rules_WriteExpressionNodeToCode((short int*)(uintptr_t)(*(_DWORD *)(exprNode + 3)), v17);
      }
...
int  Rules_AddCodeGeneratorItem(int itemName, int priority, int initFunction, int beforeFunction, int generateFunction, int arrayCount)
{
  ...
  *newItem = itemName;
  ...
  if ( construct_code_count )
  {
    ...
    *(_DWORD *)(uintptr_t)(newItemPtr + 20) = (_DWORD)(uintptr_t)(Mem_SmallBlockAlloc(4 * construct_code_count));
    if ( construct_code_count > 0 )
    {
      ...
      do
      {
        ...
        *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(newItemPtr + 20) + slot_offset) = (_DWORD)(uintptr_t)(nameCopy);
...
signed int  Rules_AppendExpressionValueNode(int theValue, _DWORD *theExpression, signed int *theList)
{
  ...
  *v10 = theValue;
  if ( theExpression )
  {
    ...
    *(_DWORD *)(uintptr_t)(v13 + 4) = (_DWORD)(uintptr_t)(exprCopy);
  }
  else
  {
    v10[1] = 0;
  }
  *(_DWORD *)(uintptr_t)(newNode + 8) = (_DWORD)(uintptr_t)(valueEntry);
  listTail = theList[1];
  if ( listTail )

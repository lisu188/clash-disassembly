  ...
  if ( result )
  {
    ...
    if ( result )
    {
      ...
      if ( Rules_RtnArgCount() != 3 )
      {
        ...
        return MessageHandler_UndefineForClassOrAll(classPtr, v7, v8, (int)(intptr_t)typeName);
      }
    ...
    if ( result )
    {
      ...
      if ( Rules_RtnArgCount() != 3 || (result = Lexer_ParseValueList(3, parseBuffer, 2, a1)) != 0 )
      {
        ...
        else
        {
          ...
          if ( classPtr && handlerNameSymbol && (handler = Class_FindMessageHandler(classPtr, (int)(intptr_t)handlerNameSymbol, handlerType), result = handler == 0, handler) )
          {
            if ( handler[8] )
...
int * MessageHandler_ListCommand(double a1)
{
  ...
  result = Class_ParseClassNameAndInheritFlag((int)(intptr_t)aListDefmessage, classArg, a1);
  if ( result )
...
int  MessageHandler_CountAndPrintHandlers(int logicalName, unsigned __int16 *classArray, int a3, unsigned int classIndex)
{
  ...
  if ( classIndex < (unsigned int)*classArray - 1 )
    totalCount += MessageHandler_CountAndPrintHandlers(logicalName, (int)(intptr_t)classArray, a3, classIndex + 1);
  handlerIndex = 0;
  for ( i = 0; ; i += 36 )
  {
...
{
  return Rules_UndefconstructCommand((int)(intptr_t)this, g_ClipsDefinstancesConstructType);
}
// 54E8F4: using guessed type int dword_54E8F4;
...
{
  return Rules_GetConstructModuleCommand((int)(intptr_t)this, (const char **)(uintptr_t)g_ClipsDefinstancesConstructType);
}
// 54E8F4: using guessed type int dword_54E8F4;
...
{
  return Rules_PPConstructCommand((int)(intptr_t)this, (const char **)(uintptr_t)g_ClipsDefinstancesConstructType);
}
// 54E8F4: using guessed type int dword_54E8F4;
...
LABEL_13:
    if ( g_ParserCurrentTokenType == 101 )
    {
      ...
      *(_DWORD *)(uintptr_t)(v16 + 24) = packedActions;
      AST_Free(v17);
...
int Definstances_CreateDefaultRecord(void)
{
  ...
  *(_DWORD *)(uintptr_t)(definstances_record + 24) = rhs_copy;
...
signed int __thiscall InstanceQuery_SetupFunctions(void *this)
{
  ...
  g_InternedSym_Qds = (int)(intptr_t)Str_Intern(aQds, (int)(intptr_t)this);
...
int * InstanceQuery_FindInstance(_DWORD *returnValue, double a2)
{
  ...
  returnValue[3] = 0;
  returnValue[4] = -1;
  restrictionList = InstanceQuery_ParseRestrictions(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(g_ClipsCurrentExpression + 6) + 10), (int)(intptr_t)aFindInstance, varCount, a2);
  if ( restrictionList )
  {
    InstanceQuery_PushQueryFrame();
      ...
      if ( varCount[0] >= 1 )
      {
        ...
        do
        {
          *(_WORD *)(uintptr_t)(v8 + returnValue[2] + 14) = 8;
          ...
          coreOffset += 4;
          *(_DWORD *)(uintptr_t)(v10 + returnValue[2] + 16) = instanceName;
          instanceIndex = v11 + 1;
          v8 = v10 + 6;
        }

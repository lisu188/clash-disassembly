...
int * Rules_NormalizeNestedConnectives(int *ceNode, _DWORD *changedFlagPtr, int mode)
{
  ...
  *changedFlagPtr = 0;
  do
  {
    ...
    {
      if ( mode == 1 )
        v5 = Rules_CENormalizeAndOr((_DWORD*)(ceNode), (_DWORD*)(&v14));
      else
        v5 = (_DWORD *)(uintptr_t)Rules_CECollapseNotWrapper((int)(intptr_t)ceNode, (_DWORD*)(&v14));
      if ( v14 )
      {
        changed = 1;
        *outChangedFlag = 1;
      }
      ceNode = (int *)(uintptr_t)Rules_CEMergeRedundantNodes((int)(intptr_t)v5, (_DWORD*)(&v14));
      if ( v14 )
      {
        changed = 1;
        *outChangedFlag = 1;
    ...
    if ( child )
    {
      do
      {
        ...
        if ( *child == 81 || v8 == 83 || v8 == 82 )
        {
          ...
          if ( prevChild )
          {
            v12 = (int)(intptr_t)(Rules_NormalizeNestedConnectives((int*)(intptr_t)((int)(intptr_t)child), (_DWORD*)(intptr_t)((int)(intptr_t)&v14), mode));
            *(_DWORD *)(uintptr_t)(v13 + 68) = v12;
            *(_DWORD *)(uintptr_t)(v12 + 68) = (_DWORD)(uintptr_t)(nextChild);
            prevChild = (_DWORD *)(uintptr_t)*(_DWORD *)(uintptr_t)(v13 + 68);
          }
          else
          {
            v10 = (int)(intptr_t)(Rules_NormalizeNestedConnectives((int*)(intptr_t)((int)(intptr_t)child), (_DWORD*)(intptr_t)((int)(intptr_t)&v14), mode));
            ceNode[16] = v10;
            *(_DWORD *)(uintptr_t)(v10 + 68) = (_DWORD)(uintptr_t)(nextChild);
...
_DWORD * Rules_FinalizeConjunctionChain(_DWORD *result)
{
  ...
  if ( *result == 82 )
  {
    for ( i = result[16]; i; i = *(_DWORD *)(uintptr_t)(i + 68) )
      result = (_DWORD *)Rules_FinalizeConjunctionChain((_DWORD*)(intptr_t)(i));
  }
  else
  {
    ...
    while ( i )
    {
      ...
      else
      {
        if ( *(_DWORD *)(uintptr_t)ceNode == 83 && *(_DWORD *)(uintptr_t)i == 84 )
        {
          ...
          *(_DWORD *)(uintptr_t)(ceNode + 56) = (_DWORD)(uintptr_t)(Rules_CECloneRestrictionExpr((__int16 *)(uintptr_t)notNode));
          ...
          && v10 == *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(i + 68) + 44) )
        {
          ...
          *(_DWORD *)(uintptr_t)(v22 + 56) = (_DWORD)(uintptr_t)(newRestriction);
          AST_Free(v23);
...
int  Rules_CECloneNode(_DWORD *node)
{
  ...
  *(_DWORD *)(uintptr_t)(clone + 64) = Rules_CECloneNode((_DWORD*)(uintptr_t)(*(_DWORD *)(uintptr_t)(v4 + 64)));
  *(_DWORD *)(uintptr_t)(clone + 68) = Rules_CECloneNode((_DWORD*)(uintptr_t)(*(_DWORD *)(uintptr_t)(v5 + 68)));
  return clone;
}
  ...
  *(_DWORD *)(uintptr_t)(dest + 48) = src[12];
  if ( deepCopy )
  {
    ...
    *(_DWORD *)(uintptr_t)(v18 + 52) = clonedNodeList;
    ...
    clonedNode = Rules_CECloneNode((_DWORD*)(uintptr_t)(v17[14]));
...
__int16 * Rules_CECloneRestrictionExpr(__int16 *result)
{
  ...
  if ( result )
  {
    ...
    *clone = *srcExpr;
    ...
    v3 = (int)(intptr_t)(Rules_CECloneRestrictionExpr((short int*)(uintptr_t)(*(_DWORD *)(srcExpr + 5))));
    *(_DWORD *)(uintptr_t)(v4 + 64) = v3;
    v5 = (int)(intptr_t)(Rules_CECloneRestrictionExpr((short int*)(uintptr_t)(*(_DWORD *)(srcExpr + 3))));
    v7 = *cloneNode;
    cloneNode[17] = v5;
    if ( v7 == 10 )
    {
      ...
      for ( i = v5; i; ++v8 )
      {
        if ( *(_DWORD *)(uintptr_t)i == 15 )
        {
          ...
          *(_DWORD *)(uintptr_t)(i + 16) = (_DWORD)(uintptr_t)(v11);
    ...
    while ( 1 )
    {
      ...
      if ( nodeType == 81 || nodeType == 83 )
      {
        if ( isTail )
          ...
          v5 = 0;
        result = (int *)Rules_CECountPatternNodes((int*)(intptr_t)(node[16]), v5);
...
_DWORD * Rules_CEAssignJoinDepth(_DWORD *ceNode, int joinDepth)
{
  ...
  while ( 1 )
  {
    ...
    {
      result = (_DWORD *)Rules_CEAssignJoinDepth((_DWORD*)(intptr_t)((int)(intptr_t)node), joinDepth);
      node = result;
      if ( result[12] < v5 )
        return result;
      ++joinDepth;
...
int  Rules_DeftemplateBsaveWriteData(int fileID)
{
  ...
  if ( result )
  {
    Rules_ConstructQueuePop((_DWORD*)(&g_DeftemplateBsaveCount));
    Rules_ConstructQueuePop((_DWORD*)(&g_Deftemplate_SlotCount));
    return Rules_ConstructQueuePop((_DWORD*)(&g_DeftemplateModuleItemCount));
  }
  return result;
}
...
int __thiscall Rules_DeftemplateBloadStorage(void *this_)
{
  ...
  sizeBuffer[2] = (_DWORD)(uintptr_t)(this_);

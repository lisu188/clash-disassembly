...
LABEL_12:
      ...
      IO_OutWriteToken(asc_50E3F8);
      classExp = Parser_ParseArgument(v13, ((_DWORD*)(&parseError)), v13);
      ...
      while ( 1 )
      {
        nextClassExp = Parser_ParseArgument(v16, ((_DWORD*)(&parseError)), v16);
        if ( !nextClassExp )
          break;
...
signed int  Rules_ReplaceClassNameWithClassReference(int theExp)
{
  ...
  if ( theDefclass )
  {
    ...
    *(_DWORD *)(uintptr_t)(theExp + 2) = ((_DWORD)(uintptr_t)(theDefclass));
    return 1;
  }
  else
  {
...
char * Parser_ReplaceInstanceQuerySlotReferences(char *varList, int bodyExp, signed int ndepth, int sdirect)
{
  ...
  Symbol = Rules_MakeSymbol(((_BYTE*)(aQueryInstanc_0)));
  result = (char *)Rules_MakeSymbol(((_BYTE*)(aQueryInstanc_1)));
  ...
  if ( v9 )
  {
    ...
    do
    {
      if ( *(_WORD *)(uintptr_t)bodyExp == 15 )
      {
        ...
        if ( result )
        {
          *(_DWORD *)(uintptr_t)(bodyExp + 2) = ((_DWORD)(uintptr_t)(Symbol));
          *(_WORD *)(uintptr_t)bodyExp = 10;
          depthValue = ((int*)(intptr_t)(Rules_AddIntegerValue(ndepth)));
          depthExpr = AST_NewNode(1, (int)(intptr_t)depthValue);
          posnValue = ((int*)(intptr_t)(Rules_AddIntegerValue(v13)));
          result = (char *)(uintptr_t)AST_NewNode(1, (int)(intptr_t)posnValue);
          *(_DWORD *)(uintptr_t)(depthExpr + 10) = ((_DWORD)(uintptr_t)(result));
      ...
      if ( *(_DWORD *)(uintptr_t)(bodyExp + 6) )
      {
        ...
        result = (char *)Parser_ReplaceInstanceQuerySlotReferences(((char*)(intptr_t)((int)(intptr_t)varList)), *(_DWORD *)(uintptr_t)(bodyExp + 6), childDepth, childSdirect);
      }
...
const char * Parser_ResolveInstanceQuerySlotReference(int varList, int theExp, signed int ndepth, int querySlotSymbol)
{
  ...
  if ( (int)(nameLen - 1) >= 3 )
  {
    ...
    if ( (int)(nameLen - 3) >= 1 )
    {
      for ( i = &varName[colonIndex]; ; --i )
      {
        ...
        if ( *i == 58 )
        {
          ...
          if ( colonIndex >= 1 )
          {
            ...
            for ( j = 0; varNode; ++j )
            {
              result = (const char *)(strncmp_(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(varNode + 2) + 16), (_DWORD)(uintptr_t)varName, (unsigned int)colonIndex) != 0);
              if ( !result )
                break;
      ...
      IO_OpenStringSource((int)(uintptr_t)aQueryVar, &varName[colonIndex + 1], 0);
      Rules_GetPPBufferStatus();
      Rules_SetPPBufferStatus(0);
      Parser_NextToken((int)(uintptr_t)aQueryVar, v10);
      Rules_SetPPBufferStatus(v11);
      IO_CloseStringRouter((int)(uintptr_t)aQueryVar);
      *(_WORD *)theExp = 10;
      *(_DWORD *)(theExp + 2) = querySlotSymbol;
      depthValue = ((int*)(intptr_t)(Rules_AddIntegerValue(ndepth)));
      *(_DWORD *)(theExp + 6) = AST_NewNode(1, (int)(uintptr_t)depthValue);
      posnValue = ((int*)(intptr_t)(Rules_AddIntegerValue(j)));
      *(_DWORD *)(*(_DWORD *)(theExp + 6) + 10) = AST_NewNode(1, (int)(uintptr_t)posnValue);
      result = (const char *)AST_NewNode(tokenType, tokenValue);
      *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(theExp + 6) + 10) + 10) = ((_DWORD)(uintptr_t)(result));
    }
  }
  return result;
}
...
signed int Rules_BuildMultifieldIndexTestNode(void)
{
  ...
  Mem_AllocArray(((_BYTE*)(bitmapBuffer)), 4);
    ...
    || *(_DWORD *)(uintptr_t)(slotNode + 40) < 2u )
  {
    ...
    eqBitmapValue = Rules_AddBitmapValue(((_BYTE*)(bitmapBuffer)), 4);
  ...
  else
  {
    ...
    bitmapValue = Rules_AddBitmapValue(((_BYTE*)(bitmapBuffer)), 4);
...
_DWORD * Rules_AppendFieldCardinalityBitmapTest(_DWORD *result)
{
  ...
  if ( (result[3] & 0x3F80) != 0 || *result == 15 || *result == 17 )
  {
    ...
    *(_DWORD *)(uintptr_t)(v6 + 52) = ((_DWORD)(uintptr_t)(result));
  }
  return result;
}
...
_DWORD *__fastcall Rules_AppendMultifieldWildcardBitmapTest(int a1, int a2 CLASH95_UNUSED)
{
  ...
  v8 = a1;
  Mem_AllocArray(((_BYTE*)(matchLengthBitmap)), 4);
  HIBYTE(matchLengthBitmap[0]) |= 0x80u;
  matchLengthBitmap[0] &= 0x8000u;
  bitmapValue = Rules_AddBitmapValue(((_BYTE*)(matchLengthBitmap)), 4);
...
int  Rules_BuildSlotConstraintBitmapTestNode(int joinTest, int theNode)
{
  ...
  Mem_AllocArray(((_BYTE*)(&matchVar1Bitmap)), 8);
  Mem_AllocArray(((_BYTE*)(&matchVar2Bitmap)), 8);
  if ( joinTest )
  {
...
LABEL_11:
    *v3 = var1NodeType;
    result = Rules_AddBitmapValue(((_BYTE*)(&matchVar1Bitmap)), 8);
...
LABEL_22:
  *v3 = var2NodeType;
  result = Rules_AddBitmapValue(((_BYTE*)(&matchVar2Bitmap)), 8);

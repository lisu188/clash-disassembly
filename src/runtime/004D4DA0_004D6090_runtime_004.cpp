        ...
        int theDefclass)
{
  ...
  sprintf_(((char*)(buf)), slotNamePrintFormat, aSlots_0);
  v8 = v7;
  nameLen = strlen(v7) + 1;
  ...
  sprintf_(((char*)(buf)), overrideMessagePrintFormat, aOvrdMsg);
  ...
  if ( *(_DWORD *)(uintptr_t)(theDefclass + 72) )
  {
    ...
    do
    {
      ...
      sprintf_(((char*)(buf)), slotNamePrintFormat, *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(slotDesc + 8) + 12) + 16));
      ...
      sprintf_(((char*)(buf)), overrideMessagePrintFormat, overrideMessage);
...
signed int  Class_PrintSlotSourceClasses(int logicalName, int slotName, int classIndex, unsigned __int16 *precedenceList, int a5 CLASH95_UNUSED)
{
  ...
  if ( (*slotDesc & 4) != 0 )
  {
    if ( Class_PrintSlotSourceClasses(logicalName, slotName, classIndex + 1, ((short unsigned int*)(intptr_t)((int)(intptr_t)precedenceList)), 0) )
...
LABEL_10:
    ...
    v19 = Class_ConstraintTypeMarker(((_BYTE*)(theConstraint)), *(_DWORD *)theConstraint << 30 >> 31, *(_DWORD *)theConstraint << 21 >> 31);
    ...
    while ( v22 );
    v23 = Class_ConstraintTypeMarker(((_BYTE*)(theConstraint)), *(_DWORD *)theConstraint << 29 >> 31, *(_DWORD *)theConstraint << 20 >> 31);
    ...
    while ( v26 );
    v27 = Class_ConstraintTypeMarker(((_BYTE*)(theConstraint)), *(_DWORD *)theConstraint << 26 >> 31, *(_DWORD *)theConstraint << 17 >> 31);
    ...
    while ( v30 );
    v31 = Class_ConstraintTypeMarker(((_BYTE*)(theConstraint)), *(_DWORD *)theConstraint << 25 >> 31, 0);
    ...
    while ( v34 );
    v35 = Class_ConstraintTypeMarker(((_BYTE*)(theConstraint)), *(_DWORD *)theConstraint << 24 >> 31, 0);
    ...
    while ( v38 );
    v39 = Class_ConstraintTypeMarker(((_BYTE*)(theConstraint)), *(_DWORD *)theConstraint << 23 >> 31, 0);
    ...
    while ( v42 );
    v43 = Class_ConstraintTypeMarker(((_BYTE*)(theConstraint)), *(_DWORD *)theConstraint << 27 >> 31, *(_DWORD *)theConstraint << 18 >> 31);
    ...
    while ( v46 );
    v47 = Class_ConstraintTypeMarker(((_BYTE*)(theConstraint)), *(_DWORD *)theConstraint << 28 >> 31, *(_DWORD *)theConstraint << 19 >> 31);
    ...
    if ( result )
    {
      ...
      if ( theDefclass )
      {
        if ( Rules_RtnArgCount() == 2 )
        {
          ...
          if ( result )
          {
            if ( !strcmp_(secondArgValue, ((_DWORD)(uintptr_t)(aInherit_1))) )
            {
              *inheritFlag = 1;
              return theDefclass;
            }
...
__int16  Class_ClassSuperclassesCommand(int a1, double a2)
{
  ...
  v5[2] = a1;
  theDefclass = Class_ParseClassNameAndInheritFlag((int)(intptr_t)aClassSupercl_0, ((_DWORD*)(v5)), a2);
  if ( theDefclass )
...
void  Class_ClassSubclassesCommand(int a1, double a2)
{
  ...
  v4[2] = a1;
  theDefclass = Class_ParseClassNameAndInheritFlag((int)(intptr_t)aClassSubclas_0, ((_DWORD*)(v4)), a2);
  if ( theDefclass )
...
_DWORD * Class_GetDefmessageHandlerListCommand(int a1, double a2)
{
  ...
  theDefclass = Class_ParseClassNameAndInheritFlag((int)(intptr_t)aGetDefmessag_0, ((_DWORD*)(v6)), a2);
  if ( theDefclass )
...
_DWORD * Class_SlotsFunction(int theDefclass, _DWORD *returnValue, unsigned int inheritFlag)
{
  ...
  *(_DWORD *)(uintptr_t)(returnObj + 8) = ((_DWORD)(uintptr_t)(result));
  if ( slotCount )
  {
    if ( v3 )
    {
...
int  Class_MessageHandlerListFunction(int theDefclass, int inheritFlag)
{
  ...
  *(_DWORD *)(uintptr_t)(v12 + 8) = ((_DWORD)(uintptr_t)(multifield));
  result = firstClass;
  fieldsFilled = 0;
        ...
        if ( *(_DWORD *)(uintptr_t)(sourceClass + 96) )
        {
          ...
          do
          {
            ...
            *(_WORD *)(uintptr_t)(6 * (v22 + 1) + *(_DWORD *)(uintptr_t)(v21 + 8) + 14) = 2;
            ...
            ++handlerIndex;
            handlerOffset += 36;
            *(_DWORD *)(uintptr_t)(6 * (v24 - 1) + *(_DWORD *)(uintptr_t)(v12 + 8) + 16) = ((_DWORD)(uintptr_t)(handlerTypeSymbol));
            fieldIndex = v24 + 1;
          }
    ...
    if ( linkIndex < *classLinks )
    {
      do
      {
        *(_WORD *)(uintptr_t)(fieldOffset + result[2] + 14) = 2;
        ...
        fieldOffset = v13 + 6;
        *(_DWORD *)(uintptr_t)(fieldAddr + 16) = ((_DWORD)(uintptr_t)(v7));
        LOWORD(v7) = *classLinks;
      }
...
void  Class_SubclassesFunction(int theDefclass, int inheritFlag)
{
  ...
  if ( traversalID != -1 )
  {
    ...
    *(_DWORD *)(uintptr_t)(v7 + 8) = ((_DWORD)(uintptr_t)(multifield));
    if ( v8 )
    {
...
signed int * Class_SlotFacetsQuery(int theDefclass, _BYTE *slotName, int returnValue)
{
  ...
  if ( result )
  {
    ...
    *(_DWORD *)(uintptr_t)(returnValue + 8) = ((_DWORD)(uintptr_t)(Rules_CreateEphemeralMultifield(10)));
    ...
    *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(returnValue + 8) + 16) = ((_DWORD)(uintptr_t)(Str_Intern(cardinalityStr, (int)(intptr_t)slotDesc)));
    if ( (v7[1] & 1) != 0 )
    {
    ...
    *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(returnValue + 8) + 22) = ((_DWORD)(uintptr_t)(Str_Intern(defaultModeStr, (int)(intptr_t)v7)));
    if ( (*v9 & 8) != 0 )
      inheritStr = aNil_7;
    else
      inheritStr = aInh_0;
    *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(returnValue + 8) + 28) = ((_DWORD)(uintptr_t)(Str_Intern(inheritStr, (int)(intptr_t)v9)));
    if ( (*v11 & 0x20) != 0 )
    {
      accessStr = aInt_1;
    }
    ...
    *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(returnValue + 8) + 34) = ((_DWORD)(uintptr_t)(Str_Intern(accessStr, (int)(intptr_t)v11)));
    if ( (*v13 & 1) != 0 )
      sharingStr = aShr_0;
    else
      sharingStr = aLcl_0;
    *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(returnValue + 8) + 40) = ((_DWORD)(uintptr_t)(Str_Intern(sharingStr, (int)(intptr_t)v13)));
    if ( (*(_BYTE *)(uintptr_t)(v15 + 1) & 2) != 0 )
      reactiveStr = aRct_0;
    else
      reactiveStr = aNil_7;
    *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(returnValue + 8) + 46) = ((_DWORD)(uintptr_t)(Str_Intern(reactiveStr, v15)));
    if ( (*v17 & 4) != 0 )
      compositeStr = aCmpFacet;
    else
      compositeStr = aExcFacet;
    *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(returnValue + 8) + 52) = ((_DWORD)(uintptr_t)(Str_Intern(compositeStr, (int)(intptr_t)v17)));
    if ( (*(_BYTE *)(uintptr_t)(v19 + 1) & 4) != 0 )
      visibilityStr = aPubFacet;
    else
      visibilityStr = aPrvFacet;
    *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(returnValue + 8) + 58) = ((_DWORD)(uintptr_t)(Str_Intern(visibilityStr, v19)));
    accessorStr = Class_SlotAccessModeString(v21);
    *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(returnValue + 8) + 64) = ((_DWORD)(uintptr_t)(Str_Intern(accessorStr, v23)));
    if ( (*(_BYTE *)(uintptr_t)v24 & 0x10) != 0 )
      result = Str_Intern(aNil_7, v24);
    else
      result = *(signed int **)(uintptr_t)(v24 + 12);
    *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(returnValue + 8) + 70) = ((_DWORD)(uintptr_t)(result));
  }
  return result;
}
...
_DWORD * Class_SlotSourcesQuery(int theDefclass, _BYTE *slotName, int a3)
{
  ...
  if ( result )
  {
    ...
    *(_DWORD *)(uintptr_t)(v18 + 8) = ((_DWORD)(uintptr_t)(multifield));
    if ( nameList )
    {
      fieldOffset = 0;
      do
    ...
    return Mem_ReturnListToFreePool(((_DWORD*)(nameList)));
  }
  return result;
}

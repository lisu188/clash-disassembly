        ...
        int allowMixing)
{
  ...
  if ( fieldList )
  {
    while ( 1 )
    {
      ...
      if ( testExpression )
      {
        Rules_CEFindBoundVariableOccurrence(testExpression, theType, ((int*)(intptr_t)((int)(intptr_t)theReference)), theVariable, nandDepth, assignReference, 1);
      }
      else
      {
        if ( (*(_DWORD *)(uintptr_t)theField == 15 || *(_DWORD *)(uintptr_t)theField == 16) && theVariable == *(_DWORD *)(uintptr_t)(theField + 4) )
        {
          ...
          if ( theReference[4] && (*(_BYTE *)(uintptr_t)(theField + 8) & 1) == 0 )
          {
            ...
            *(_DWORD *)(uintptr_t)(theField + 16) = ((_DWORD)(uintptr_t)(newConstraints));
            if ( (nodeFlags & 0x10) != 0 )
        ...
        *(_DWORD *)(uintptr_t)(theField + 20) = ((_DWORD)(uintptr_t)(theReference));
      }
LABEL_18:
      rightField = *(_DWORD *)(uintptr_t)(theField + 64);
      if ( rightField && Rules_CEFindBoundVariableOccurrence(rightField, theType, ((int*)(intptr_t)((int)(intptr_t)theReference)), theVariable, nandDepth, assignReference, allowMixing) )
        return 1;
...
int  Rules_CEFindUnboundVariableReference(int exprPtr, int theExpression, int slotName, int whichCE, int theField)
{
  ...
  while ( 1 )
  {
    ...
    {
      if ( !Rules_FindImportExportConstruct(aDefglobal_6, ((_DWORD*)(&count)), (_BYTE *)(uintptr_t)*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(currentExpr + 4) + 16), 1, 0) )
        break;
    }
...
LABEL_22:
  ...
  minValue = ((int*)(intptr_t)(Rules_AddIntegerValue(v8)));
  *(_DWORD *)((char *)newConstraint + 18) = AST_NewNode(1, (int)(intptr_t)minValue);
  ...
  {
    maxValueNode = ((int*)(intptr_t)(Rules_AddIntegerValue(maxFields)));
    maxType = 1;
  }
  ...
  do
  {
    ...
    do
    {
      ...
      if ( Rules_TagIsConstantType(*(_DWORD *)(uintptr_t)andField) )
      {
        ...
        AST_DecrementNodeRefCount(((_DWORD*)(constantConstraint)));
...
LABEL_7:
        AST_DecrementNodeRefCount(((_DWORD*)(returnConstraint)));
      }
LABEL_8:
...
LABEL_5:
      if ( !tempList )
      {
        theItem[16] = ((_DWORD)(uintptr_t)(theList));
        theList = theItem;
      }
      theItem = nextItem;
    }
...
_DWORD * Rules_ClonePatternPositionConstraintList(int *theExpression)
{
  ...
  for ( i = 0; expPtr; expPtr = (int *)(uintptr_t)expPtr[17] )
  {
    if ( expPtr[16] )
    {
      tmpList = (_DWORD *)Rules_ClonePatternPositionConstraintList(((int*)(intptr_t)(expPtr[16])));
...
signed int  Rules_CheckFieldRestrictionAgainstRHSAction(int theExpression, int lastOne, int theFunction, int argNumber, int theLHS CLASH95_UNUSED)
{
  ...
  constraint4 = ((char*)(Rules_IntersectConstraints((int)(intptr_t)constraint3, (int)(intptr_t)constraint1)));
  ...
  AST_DecrementNodeRefCount(((_DWORD*)(constraint1)));
  AST_DecrementNodeRefCount(v23);
  AST_DecrementNodeRefCount(constraint3);
  AST_DecrementNodeRefCount(((_DWORD*)(constraint4)));
  return errorFlag;
}
  ...
  for ( i = result; i; i = (_DWORD *)(uintptr_t)i[17] )
  {
    ...
    while ( scanNode )
    {
      ...
      else
      {
        ...
        {
          i[13] = ((_DWORD)(uintptr_t)(AST_MergeFieldAccessNodes((_DWORD *)(uintptr_t)i[13], (_DWORD *)(uintptr_t)*(_DWORD *)(uintptr_t)(scanNode + 52))));
          testCE[13] = 0;
          v5 = testCE[17];
          testCE[17] = 0;
          lastNode[17] = v5;
        ...
        else
        {
          ...
          result = (_DWORD *)(uintptr_t)IO_RunRouterExitCallbacks(4);
        }
      }
    }
  }
...
int  Rules_InternJoinTestNode(int joinTest, _DWORD *lhsEntry, int joinFromTheRight, int rhsEntry, char negatedRHS)
{
  ...
  {
    newJoin = Mem_HeapAllocWithRetry(((_DWORD*)(intptr_t)(40)));
  }
  ...
  *(_DWORD *)(uintptr_t)(joinNodeInit + 36) = 0;
  hashedJoinTest = (int)(uintptr_t)AST_AddHashedNodeChain((short *)(intptr_t)joinTest, joinNodeInit, v11);
  *(_DWORD *)(uintptr_t)(joinNode + 12) = hashedJoinTest;
  *(_DWORD *)(uintptr_t)(joinNode + 24) = ((_DWORD)(uintptr_t)(lhsEntry));
  if ( lhsEntry )
  {
...
int ** Defgeneric_InitializeFromRestrictionString(int theDefgeneric, int a2)
{
  ...
  if ( result )
  {
    ...
    v7 = 0;
    v6 = 0;
    return (int **)(uintptr_t)Method_ParseWildcardRestrictionString(v3, *(char **)((char *)result + 17), (int)(intptr_t)v3, ((_DWORD*)(&actionExpr)));
  }
  return result;
}

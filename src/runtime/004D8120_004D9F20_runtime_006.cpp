  ...
  if ( result )
  {
    ...
    if ( Enum )
    {
      while ( 1 )
      {
        ...
        ++itemsInFile;
        itemFile = Rules_ConstructCodeFileClose(itemFile, &itemsInFile, maxIndices, ((_DWORD*)(&arrayVersion)), 0, 0);
        Enum = (int *)(uintptr_t)Module_NextEnum((int)(intptr_t)Enum);
        if ( !Enum )
          goto LABEL_23;
      }
      itemsInFile = maxIndices;
      Rules_ConstructCodeFileClose(0, &itemsInFile, maxIndices, ((_DWORD*)(&arrayVersion)), 0, 0);
      fclose_(v26);
      return 0;
    }
    else
...
LABEL_23:
      itemsInFile = maxIndices;
      Rules_ConstructCodeFileClose(itemFile, &itemsInFile, maxIndices, ((_DWORD*)(&arrayVersion)), 0, 0);
        ...
        int *fileVersion)
{
  ...
  arrayVersion = 1;
  fp = 0;
  thePortItem = (int *)(uintptr_t)Module_NextPortItemEnum(&theDefmodule, (int *)&thePortItem, ((_DWORD*)(&exportChecked)), ((_DWORD*)(&importChecked)));
  if ( thePortItem )
  {
    while ( 1 )
    {
      ...
      ++count;
      Rules_ConstructCodeFileClose(fp, &count, maxIndices, ((_DWORD*)(&arrayVersion)), 0, 0);
      thePortItem = (int *)(uintptr_t)Module_NextPortItemEnum(&theDefmodule, (int *)&thePortItem, ((_DWORD*)(&exportChecked)), ((_DWORD*)(&importChecked)));
      if ( !thePortItem )
        goto LABEL_6;
    }
    count = maxIndices;
    Rules_ConstructCodeFileClose(0, &count, maxIndices, ((_DWORD*)(&arrayVersion)), 0, 0);
    return 0;
  }
  else
  {
...
unsigned int  Rules_EvalObjectSlotBoundVariableEqual(int theValue, _DWORD *theResult, int a3, double a4)
{
  ...
  if ( (*(_BYTE *)(uintptr_t)(compareInfo + 1) & 2) != 0 )
  {
    ...
    Parser_ParseForm((__int16 *)(uintptr_t)*(_DWORD *)(uintptr_t)(g_ClipsCurrentExpression + 6), ((_DWORD*)(&v12)), compareInfo, a4);
...
signed int  Rules_FetchJoinObjectSlotFieldSimple(int theValue, int theResult)
{
  ...
  Rules_ResolveJoinBindingRecord((unsigned __int8)*(_DWORD *)(uintptr_t)(matchVar + 4) - 1, ((_DWORD*)(&theInstance)), v6);
...
unsigned int  Rules_EvalJoinObjectSlotFieldsEqual(int theValue, _DWORD *theResult, int theBinds)
{
  ...
  compareInfo = (unsigned int *)(uintptr_t)*(_DWORD *)(uintptr_t)(theValue + 16);
  Rules_ResolveJoinBindingRecord((unsigned __int8)compareInfo[1] - 1, ((_DWORD*)(&firstInstance)), marksBuffer);
  firstSlot = *(_DWORD *)(uintptr_t)(4 * *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(firstInstance + 44) + 60) + 4 * (*compareInfo & 0x7FFF))
                 ...
                 - 4);
  Rules_ResolveJoinBindingRecord((compareInfo[1] << 16 >> 24) - 1, ((_DWORD*)(&secondInstance)), marksBuffer);
...
_DWORD * Rules_FetchObjectSlotFieldRecordCore(_DWORD *returnValue, _DWORD *theInstance, int matchVar, _DWORD *extentMarks)
{
  ...
  {
    returnValue[1] = 7;
    returnValue[2] = ((_DWORD)(uintptr_t)(theInstance));
  }
    ...
    else
    {
      ...
      if ( (*(_BYTE *)(uintptr_t)(matchVar + 4) & 1) != 0 )
      {
        ...
        if ( fieldType == 4 )
        {
          ...
          returnValue[4] = ((_DWORD)(uintptr_t)(result));
        }
      }
      else
      {
...
int  Rules_ParseDeftemplateFactPattern(int readSource, _DWORD *theDeftemplate)
{
  ...
  else
  {
    ...
    *(_DWORD *)(uintptr_t)(topNode + 68) = ((_DWORD)(uintptr_t)(nameNode));
    *nameNode = 2;
...
LABEL_12:
    ...
    slotPtr = Lexer_FindTemplateSlot(deftemplate, theToken[1], ((_DWORD*)(&position)));
    if ( !slotPtr )
    {
      v13 = deftemplate;
      *errorPtr = 1;
...
_DWORD * Lexer_ParseRuleLHSPatterns(int readSource, _DWORD *theToken, int *error, int ruleName, double a5)
{
  ...
  *error = 0;
  if ( *theToken == 2 && !strcmp_(((_DWORD)(uintptr_t)(error)), ((_DWORD)(uintptr_t)(Lexer_Token_Arrow))) )
    return 0;
  ...
  {
    AST_Append(*error, v9);
    result = (_DWORD *)(uintptr_t)Lexer_ParsePatternCEList(2, ((_DWORD*)(error)), Lexer_Token_Arrow, readSource, a5);
    if ( *error == 1 )
    {
      AST_FreeNode(v10);
      return 0;
    ...
    {
      *(_DWORD *)(uintptr_t)(v10 + 68) = ((_DWORD)(uintptr_t)(result));
      return v12;
    }
  }
  return result;

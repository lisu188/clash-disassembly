...
signed int  Rules_BuildDualSlotConstraintBitmapTestNode(int joinTest, int selfNode, int referringNode)
{
  ...
  if ( Rules_IsMultiplyConstrainedSlot(selfNode) && Rules_IsMultiplyConstrainedSlot(referringNode) )
  {
    ...
    {
      Mem_AllocArray(((_BYTE*)(pnVars1)), 4);
      Mem_AllocArray(((_BYTE*)(&jnVars1)), 8);
      ...
      if ( joinTest )
      {
        ...
        v18 = Rules_AddBitmapValue(((_BYTE*)(&jnVars1)), 8);
        return AST_NewNode(52, v18);
      }
      else
      {
        v19 = Rules_AddBitmapValue(((_BYTE*)(pnVars1)), 4);
        return AST_NewNode(51, v19);
      }
    }
    if ( (*(_BYTE *)(uintptr_t)(v5 + 9) & 0x40) == 0 || (*(_BYTE *)(uintptr_t)(referringNode + 9) & 0x40) == 0 )
    {
      Mem_AllocArray(((_BYTE*)(&pnVars2)), 8);
      Mem_AllocArray(((_BYTE*)(&jnVars2)), 8);
...
LABEL_25:
          if ( joinTest )
          {
            v31 = Rules_AddBitmapValue(((_BYTE*)(&jnVars2)), 8);
            return AST_NewNode(54, v31);
          }
          else
          {
            v36 = Rules_AddBitmapValue(((_BYTE*)(&pnVars2)), 8);
...
LABEL_24:
    ...
    Mem_AllocArray(((_BYTE*)(&pnVars3)), 8);
    Mem_AllocArray(((_BYTE*)(&jnVars3)), 8);
    ...
    if ( joinTest )
    {
      ...
      v49 = Rules_AddBitmapValue(((_BYTE*)(&jnVars3)), 8);
      return AST_NewNode(56, v49);
    }
    else
    {
      v50 = Rules_AddBitmapValue(((_BYTE*)(&pnVars3)), 8);
...
const void * Rules_BsaveObjectPatternNetworkRecords(int outFile)
{
  ...
  if ( result )
  {
    Rules_ConstructQueuePop(((_DWORD*)(&g_ReactiveRuleBloadCount)));
    return (const void *)(uintptr_t)Rules_ConstructQueuePop(((_DWORD*)(&g_ObjectPatternNetworkBloadCount)));
  }
  return result;
}
      ...
      if ( linkHead )
      {
        ...
        if ( freeNode )
        {
          ...
          *(_DWORD *)(uintptr_t)(g_ClipsMemoryTable + 24) = *freeNode;
          Class_PackClassLinkList(g_ClipsMemFreeListTemp, ((_DWORD*)(linkHead)));
        }
        else
        {
          packedLinks = Mem_HeapAllocWithRetry((_DWORD *)6);
          Class_PackClassLinkList(packedLinks, ((_DWORD*)(linkHead)));
        }
        return plinks;
      }
      else
    ...
    else
    {
      while ( 1 )
      {
        if ( g_ParserCurrentTokenType != 2 )
        {
          ...
          Mem_ReturnListToFreePool(((_DWORD*)(linkHead)));
          return 0;
        }
...
int  Class_BuildPrecedenceList(int theClass, unsigned __int16 *superclassLinks)
{
  ...
  if ( theClass )
  {
    ...
    classOrderNode[1] = 0;
    classOrderNode[2] = 0;
    classOrderNode[3] = ((_DWORD)(uintptr_t)(partialOrderList));
  ...
  if ( partialOrderList )
  {
    ...
    Mem_ReturnListToFreePool(((_DWORD*)(precedenceList)));
    return 0;
  }
  else
  {
    if ( !theClass )
    {
      ...
      *(_DWORD *)(uintptr_t)(sentinelNode + 4) = ((_DWORD)(uintptr_t)(oldListHead));
    }
    *precedenceList = 0;
    ...
    Class_PackClassLinkList(packedLinksMem, ((_DWORD*)(precedenceList)));
    return v30;
  }
}
...
_DWORD * Class_PackClassLinkList(int packedLinks, _DWORD *linkList)
{
  ...
  if ( i )
    *(_DWORD *)(uintptr_t)(packedLinks + 2) = ((_DWORD)(uintptr_t)(Mem_SmallBlockAlloc(4 * i)));
  else
...
_DWORD * Class_CollectAllSuperclasses(_DWORD *orderList, unsigned __int16 *superclasses)
{
  ...
  while ( *superclasses > superIndex )
  {
    ...
    else
    {
      ...
      *newOrder = superclass;
      if ( i )
        i[3] = ((_DWORD)(uintptr_t)(newOrder));
      else
        orderList = newOrder;
      orderList = (_DWORD *)Class_CollectAllSuperclasses(((_DWORD*)(intptr_t)((int)(intptr_t)orderList)), ((short unsigned int*)(uintptr_t)(*(_DWORD *)(uintptr_t)(linkOffset + *(_DWORD *)(superclasses + 1)) + 34)));
      linkOffset += 4;
      ++superIndex;
    }
  }
...
__int16  Class_AddPrecedenceDependency(_DWORD *classList, int theClass, unsigned int startIndex, unsigned __int16 *superclassLinks)
{
  ...
  for ( i = 4 * v7; ; i += 4 )
  {
    ...
    *newDependency = ((_DWORD)(uintptr_t)(superNode));
    newDependency[1] = classNode[2];
    classNode[2] = ((_DWORD)(uintptr_t)(newDependency));
    ++startIndex;
...
signed int  Class_ReportPrecedenceLoop(_DWORD *orderList)
{
  ...
  for ( j = i; j; j = (_DWORD *)(uintptr_t)j[3] )
  {
    ...
    while ( supportList )
    {
      ...
      if ( !supportedOrder[1] )
      {
        ...
        *newLink = ((_DWORD)(uintptr_t)(j));
        newLink[1] = supportedOrder[2];
        supportedOrder[1] = 1;
        supportedOrder[2] = ((_DWORD)(uintptr_t)(newLink));
      }
  ...
  for ( k = i; k; k = (_DWORD *)(uintptr_t)k[3] )
    k[1] = 0;
  for ( m = ((int*)(i)); !m[1]; m = (int *)(uintptr_t)*(_DWORD *)(uintptr_t)m[2] )
    m[1] = 1;

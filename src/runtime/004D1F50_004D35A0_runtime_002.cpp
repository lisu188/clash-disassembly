  ...
  *newNode = (4 * (v12 & 1)) | flagsWord;
  if ( nodeSlotGroup )
  {
    ...
    if ( curNode )
    {
      ...
      if ( prevSibling )
      {
        *(_DWORD *)(uintptr_t)(prevSibling + 28) = ((_DWORD)(uintptr_t)(newNode));
      }
      else
      {
        parentNode = curNode[5];
        if ( parentNode )
          *(_DWORD *)(uintptr_t)(parentNode + 16) = ((_DWORD)(uintptr_t)(newNode));
        else
          Rules_SetObjectPatternNetworkRoot((int)(intptr_t)newNode);
      }
      curNode[6] = ((_DWORD)(uintptr_t)(newNode));
      return newNode;
    }
    else
    {
      newNode[6] = (int)(intptr_t)prevNode;
      prevNode[7] = ((_DWORD)(uintptr_t)(newNode));
      return newNode;
    }
  }
  else
  {
    if ( upperLevel )
    {
      ...
      *(_DWORD *)(uintptr_t)(upperLevel + 16) = ((_DWORD)(uintptr_t)(newNode));
    }
    else
    {
    ...
    nextNode = newNode[7];
    if ( nextNode )
      *(_DWORD *)(uintptr_t)(nextNode + 24) = ((_DWORD)(uintptr_t)(newNode));
    return newNode;
  }
}
...
unsigned int * Rules_ParseObjectPatternClassRestriction(int readSource, int theToken)
{
  ...
  *(_BYTE *)newNode = v5 | 2;
  ...
  if ( !result )
  {
    v9 = newNode;
LABEL_7:
    AST_DecrementNodeRefCount(((_DWORD*)(v9)));
    return 0;
  }
...
unsigned int * Rules_ParseObjectPatternSlotRestriction(int readSource, int theToken, int multiSlot, int *slotConstraints)
{
  ...
  if ( result )
  {
    ...
    else
    {
      ...
      Parser_ReportSyntaxError();
      AST_FreeNode(v13);
      AST_DecrementNodeRefCount(((_DWORD*)(slotConstraints)));
      return 0;
    }
  }
  else
...
int  Rules_AllocateClassBitmap(int maxClassID, int set)
{
  ...
  if ( maxClassID == -1 )
    clampedMaxClassID = 0;
  bitmapMem = ((_BYTE*)(Mem_SmallBlockAlloc(((clampedMaxClassID - (__CFSHL__(clampedMaxClassID >> 31, 3) + 8 * (clampedMaxClassID >> 31))) >> 3) + 3)));
    ...
    if ( chkNode )
    {
      ...
      do
      {
        if ( *chkNode == 2 )
        {
          ...
          *(_DWORD *)(uintptr_t)(v15 + 4) = ((_DWORD)(uintptr_t)(theDefclass));
          if ( !theDefclass )
          {
            ...
            Mem_SmallBlockFree(((_DWORD*)(tmpset1)), ((int)*tmpset1 >> 3) + 3);
            Mem_SmallBlockFree(((_DWORD*)(tmpset2)), ((int)*tmpset2 >> 3) + 3);
            return 0;
          }
...
int  Rules_ExtractObjectPatternRestrictionNodes(int a1, int restrictionList, _DWORD *isaNodeOut, int endNodeOut, int *nameNodeOut)
{
  ...
  *(_DWORD *)(uintptr_t)endNodeOut = ((_DWORD)(uintptr_t)(newNode));
  *newNode = 17;
...
int  Rules_BuildAttributeIndexBitmap(int thePattern)
{
  ...
  theBitmap = ((_BYTE*)(Mem_SmallBlockAlloc(bitmapSize)));
  ...
  *v5 = i;
  ...
  Mem_SmallBlockFree(((_DWORD*)(theBitmap)), bitmapSize);
  return bitmapValue;
}
...
LABEL_44:
      ...
      childList = Rules_PruneEmptyObjectPatternNodes(*(_DWORD *)(uintptr_t)(v9 + 68), ((_DWORD*)(intptr_t)((int)(intptr_t)classBitmapOut)));
...
int Rules_CreateDefaultObjectPatternRestriction(void)
{
  ...
  LOWORD(classID) = *((_WORD *)Class_LookupInScope(((_BYTE*)(aInitialObjec_2))) + 12);
  ...
  bitmapValue = Rules_AddBitmapValue(((_BYTE*)(packedBitmap)), v5 / 8 + 3);
  *(_DWORD *)(uintptr_t)(v7 + 60) = bitmapValue;
  ++*(_DWORD *)(uintptr_t)(bitmapValue + 4);
  Mem_SmallBlockFree(((_DWORD*)(packedBitmap)), (unsigned __int16)*packedBitmap / 8 + 3);
  *topNode = 17;
  topNode[8] = 1;
  ...
  *(_DWORD *)(uintptr_t)(v11 + 68) = ((_DWORD)(uintptr_t)(valueNode));
  *valueNode = 8;

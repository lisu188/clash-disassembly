...
LABEL_5:
      ...
      if ( !strcmp_(v8, ((_DWORD)(uintptr_t)(aSalience))) )
      {
        if ( salienceParsed )
          goto LABEL_18;
      ...
      {
        if ( strcmp_(v10, ((_DWORD)(uintptr_t)(aAutoFocus))) )
          goto LABEL_3;
        if ( autoFocusParsed )
        {
LABEL_18:
...
int  Lexer_ParseAutoFocusOption(int readSource)
{
  ...
  if ( tokenType != 2 )
    goto LABEL_5;
  result = strcmp_(v3, ((_DWORD)(uintptr_t)(aTrue_0)));
  if ( result )
  {
    result = strcmp_(v5, ((_DWORD)(uintptr_t)(aFalse_0)));
    if ( !result )
    {
...
LABEL_33:
    ...
    if ( terminator == theToken && !strcmp_(((_DWORD)(uintptr_t)(v9)), terminatorString) )
      return 0;
LABEL_15:
    Parser_ReportSyntaxError();
    *v14 = 1;
  ...
  if ( theToken != 2 )
    goto LABEL_15;
  if ( allowDeclaration && !strcmp_(((_DWORD)(uintptr_t)(v12)), ((_DWORD)(uintptr_t)(aDeclare))) )
  {
    if ( !ruleName )
  ...
  else if ( !strcmp_(((_DWORD)(uintptr_t)(v12)), ((_DWORD)(uintptr_t)(aTest_0))) )
  {
    result = (_DWORD *)(uintptr_t)Lexer_ParseTestCE(readSource, v15, (int)(intptr_t)v15);
    if ( *v16 == 1 )
      goto LABEL_33;
  }
  else if ( !strcmp_(((_DWORD)(uintptr_t)(v15)), ((_DWORD)(uintptr_t)(aAnd_1)))
         || !strcmp_(((_DWORD)(uintptr_t)(v17)), ((_DWORD)(uintptr_t)(aLogical_0)))
         || !strcmp_(((_DWORD)(uintptr_t)(v17)), ((_DWORD)(uintptr_t)(aNot_1)))
         || !strcmp_(((_DWORD)(uintptr_t)(v17)), ((_DWORD)(uintptr_t)(aExists_0)))
         || !strcmp_(((_DWORD)(uintptr_t)(v17)), ((_DWORD)(uintptr_t)(aForall_0)))
         || !strcmp_(((_DWORD)(uintptr_t)(v17)), ((_DWORD)(uintptr_t)(aOr_1))) )
  {
  ...
  {
    result = Rules_DispatchPatternTypeParser(((_DWORD*)(&theToken)), (int)(intptr_t)v17, v17);
    if ( *v19 == 1 )
      goto LABEL_33;
  }
  return result;
...
signed int  Lexer_ParseConnectiveCE(_DWORD *error, int readSource, double a3)
{
  ...
  connectorValue = 0;
  logicalCE = 0;
  if ( !strcmp_(v4, ((_DWORD)(uintptr_t)(aOr_1))) )
  {
    connectorValue = 82;
    connectorString = asc_50D870;
    goto LABEL_4;
  }
  if ( !strcmp_(v5, ((_DWORD)(uintptr_t)(aAnd_1))) )
  {
    connectorValue = 81;
...
LABEL_4:
  ...
  if ( !strcmp_(v6, ((_DWORD)(uintptr_t)(aNot_1))) )
  {
    connectorValue = 83;
    connectorString = asc_50D764;
    goto LABEL_4;
  }
  if ( !strcmp_(v15, ((_DWORD)(uintptr_t)(aExists_0))) )
  {
    AST_Append(v17, v16);
    connectorValue = 86;
  }
  else if ( !strcmp_(v17, ((_DWORD)(uintptr_t)(aForall_0))) )
  {
    AST_Append(v19, v18);
    connectorValue = 87;
  }
  else if ( !strcmp_(v19, ((_DWORD)(uintptr_t)(aLogical_0))) )
  {
    AST_Append(v21, v20);
    connectorValue = 81;
    logicalCE = 1;
...
LABEL_5:
  ...
  *(_DWORD *)(uintptr_t)(v10 + 8) |= logicalBits;
  ...
  if ( connectorValue != 86 )
  {
    if ( connectorValue == 87 )
    {
      ...
      *(_DWORD *)(uintptr_t)(v26 + 64) = ((_DWORD)(uintptr_t)(v25));
      *v25 = 81;
      ...
      *(_DWORD *)(uintptr_t)(v32 + 8) |= logicalBits;
      ...
      if ( v33 )
      {
        ...
        *(_DWORD *)(uintptr_t)(v34 + 64) = ((_DWORD)(uintptr_t)(v43));
        *v43 = 81;
  ...
  *(_DWORD *)(uintptr_t)(v36 + 64) = ((_DWORD)(uintptr_t)(v35));
  *v35 = 83;
...
int  Lexer_ParsePatternCEList(int terminator, _DWORD *error, char *terminatorString, int readSource, double a5)
{
  ...
  while ( 1 )
  {
    newNode = ((int)(uintptr_t)(Lexer_ParsePatternCE(readSource, terminator, (int)(intptr_t)terminatorString, a5, 0, 0, 0)));
    if ( *error )
    {
      AST_FreeNode(head);
      return 0;
...
int  Lexer_ParseTestCE(int readSource, _DWORD *error, int a3)
{
  ...
  *(_DWORD *)(uintptr_t)(v8 + 56) = ((_DWORD)(uintptr_t)(expressionCopy));
  AST_Free(v9);
...
int  Lexer_ParsePatternBinding(int readSource, _DWORD *error)
{
  ...
  else
  {
    ...
    if ( tokenType == 2 && !strcmp_(v5, ((_DWORD)(uintptr_t)(asc_50D9B0))) )
    {
      IO_OutWriteToken(asc_50D764);
...
_DWORD * Rules_DispatchPatternTypeParser(_DWORD *theToken, int a2, _DWORD *error)
{
  ...
  if ( *theToken != 2 || !strcmp_(a2, ((_DWORD)(uintptr_t)(asc_50D9C8))) || !strcmp_(v5, ((_DWORD)(uintptr_t)(asc_50D9CC))) )
  {
    Parser_ReportSyntaxError();
    *error = 1;
    return 0;
...
_DWORD * AST_PropagateDepthTag(_DWORD *result, int depth)
{
  ...
  for ( i = result; i; i = (_DWORD *)(uintptr_t)i[17] )
  {
    ...
    i[6] = depth;
    if ( childNode )
      result = (_DWORD *)AST_PropagateDepthTag(((_DWORD*)(intptr_t)(childNode)), depth);
    if ( i[14] )
      result = (_DWORD *)AST_PropagateDepthTag(((_DWORD*)(uintptr_t)(i[14])), depth);
  }
  return result;
}
...
int  Module_BsaveWriteModuleRecords(int filePtr)
{
  ...
  if ( result )
  {
    Rules_ConstructQueuePop(((_DWORD*)(&g_ClipsBsaveModuleCount)));
    return Rules_ConstructQueuePop(((_DWORD*)(&g_ClipsBloadPortItemCount)));
  }
  return result;
}
...
int  Module_BloadFixupModuleRecord(_DWORD *bsaveModule, int moduleIndex)
{
  ...
  *(_DWORD *)(uintptr_t)(module + 8) = ((_DWORD)(uintptr_t)(Mem_SmallBlockAlloc(4 * Module_GetItemCount())));
...
BOOL  Rules_IsConstraintAttributeKeyword(int constraintName)
{
  ...
  return !strcmp_(constraintName, ((_DWORD)(uintptr_t)(aType_0)))
      || !strcmp_(v1, ((_DWORD)(uintptr_t)(aRange_0)))
      || !strcmp_(v3, ((_DWORD)(uintptr_t)(aCardinality)))
      || !strcmp_(v4, ((_DWORD)(uintptr_t)(aAllowedSymbols)))
      || !strcmp_(v5, ((_DWORD)(uintptr_t)(aAllowedStrings)))
      || !strcmp_(v6, ((_DWORD)(uintptr_t)(aAllowedLexemes)))
      || !strcmp_(v7, ((_DWORD)(uintptr_t)(aAllowedInteg_0)))
      || !strcmp_(v8, ((_DWORD)(uintptr_t)(aAllowedFloats)))
      || !strcmp_(v9, ((_DWORD)(uintptr_t)(aAllowedNumbers)))
      || !strcmp_(v10, ((_DWORD)(uintptr_t)(aAllowedInstanc)))
      || !strcmp_(v11, ((_DWORD)(uintptr_t)(aAllowedValues)));
}

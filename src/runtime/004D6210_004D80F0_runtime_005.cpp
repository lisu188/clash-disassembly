...
_DWORD * Class_SlotTypesQuery(int theDefclass, _BYTE *slotName, int a3)
{
  ...
  if ( result )
  {
    ...
    *(_DWORD *)(uintptr_t)(a3 + 8) = ((_DWORD)(uintptr_t)(result));
    if ( v8 >= 1 )
    {
      typeIndex = 0;
      fieldOffset = 0;
      ...
      do
      {
        ...
        if ( ((unsigned __int8)(1 << (bitIndex % 8)) & (unsigned __int8)(intptr_t)result) != 0 )
        {
          ...
          *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(a3 + 8) + fieldOffset + 10) = ((_DWORD)(uintptr_t)(result));
        }
        ++typeIndex;
        ++bitIndex;
      }
...
int  Class_SlotAllowedValuesQuery(int theDefclass, _BYTE *slotName, _DWORD *a3)
{
  ...
  if ( result )
  {
    ...
    if ( theConstraint && (v5 = *(_DWORD *)(uintptr_t)(result + 20), *(_DWORD *)(uintptr_t)(theConstraint + 6)) )
    {
      ...
      a3[4] = valueCount - 1;
      a3[2] = ((_DWORD)(uintptr_t)(Rules_CreateEphemeralMultifield(valueCount)));
...
int  Class_SlotRangeQuery(int theDefclass, _BYTE *slotName, _DWORD *a3)
{
  ...
  if ( result )
  {
    ...
    {
      a3[4] = 1;
      a3[2] = ((_DWORD)(uintptr_t)(Rules_CreateEphemeralMultifield(2)));
...
_DWORD * Class_SlotCardinalityQuery(int theDefclass, _BYTE *slotName, int a3)
{
  ...
  if ( result )
  {
    if ( (*(_BYTE *)result & 2) != 0 )
    {
      ...
      *(_DWORD *)(uintptr_t)(a3 + 8) = ((_DWORD)(uintptr_t)(theMultifield));
      ...
      if ( theConstraint )
      {
        ...
        *(_DWORD *)(uintptr_t)(*(_DWORD *)(uintptr_t)(a3 + 8) + 22) = ((_DWORD)(uintptr_t)(result));
      }
      else
      {
...
int  Compiler_WriteEscapedStringLiteral(int fp, int a2, int a3, char a4)
{
  ...
  if ( (int)(lengthPlusOne - 1) > 0 )
  {
    ...
    do
    {
      ...
      {
        CRT_PutcToStream(((_DWORD)(uintptr_t)(charPtr)), fp);
      }
      ...
      v10 = fp;
LABEL_6:
      CRT_PutcToStream(((_DWORD)(uintptr_t)(charPtr)), v10);
      ++charIndex;

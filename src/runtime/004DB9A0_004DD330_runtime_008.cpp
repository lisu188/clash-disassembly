...
int  Rules_ParseStandardConstraintAttribute(char *readSource, const char *constraintName, _BYTE *parsedConstraints, int constraints, int multipleValuesAllowed)
{
  ...
  if ( Rules_TestConstraintAttributeParsedFlag((int)(intptr_t)constraintName, ((_DWORD*)(parsedConstraints))) )
  {
  ...
  {
    if ( !strcmp_(0, ((_DWORD)(uintptr_t)(aRange_0))) || !strcmp_(v8, ((_DWORD)(uintptr_t)(aCardinality))) )
    {
    ...
    else if ( !strcmp_(v10, ((_DWORD)(uintptr_t)(aType_0))) )
    {
      Rules_ParseTypeAttribute((int)(intptr_t)readSource, v11);
    }
    else if ( !strcmp_(v11, ((_DWORD)(uintptr_t)(aAllowedSymbols)))
           || !strcmp_(v12, ((_DWORD)(uintptr_t)(aAllowedStrings)))
           || !strcmp_(v13, ((_DWORD)(uintptr_t)(aAllowedLexemes)))
           || !strcmp_(v14, ((_DWORD)(uintptr_t)(aAllowedInteg_0)))
           || !strcmp_(v15, ((_DWORD)(uintptr_t)(aAllowedFloats)))
           || !strcmp_(v16, ((_DWORD)(uintptr_t)(aAllowedNumbers)))
           || !strcmp_(v17, ((_DWORD)(uintptr_t)(aAllowedInstanc)))
           || !strcmp_(v18, ((_DWORD)(uintptr_t)(aAllowedValues))) )
    {
...
signed int  Rules_ParseAllowedValuesAttribute(int readSource, const char *constraintName, int parsedConstraints, int constraints)
{
  ...
  constantParsed = 0;
  variableParsed = 0;
  if ( !strcmp_(parsedConstraints, ((_DWORD)(uintptr_t)(aAllowedValues))) )
  {
    v8 = *v5;
    if ( (*v5 & 4) != 0
      || (v8 & 8) != 0
  ...
  if ( (!strcmp_(((_DWORD)(uintptr_t)(v5)), ((_DWORD)(uintptr_t)(aAllowedValues)))
     || !strcmp_(((_DWORD)(uintptr_t)(v11)), ((_DWORD)(uintptr_t)(aAllowedNumbers)))
     || !strcmp_(((_DWORD)(uintptr_t)(v11)), ((_DWORD)(uintptr_t)(aAllowedInteg_0)))
     || !strcmp_(((_DWORD)(uintptr_t)(v11)), ((_DWORD)(uintptr_t)(aAllowedFloats))))
    && (*v11 & 2) != 0 )
  {
    Rules_ReportAttributeCannotCombine((int)(intptr_t)v11, (int)(intptr_t)aRange_0);
    return 0;
  }
  if ( strcmp_(((_DWORD)(uintptr_t)(v11)), ((_DWORD)(uintptr_t)(aAllowedValues))) && (*(_BYTE *)(uintptr_t)(v12 + 1) & 1) != 0 )
  {
    Rules_ReportAttributeCannotCombine(v12, (int)(intptr_t)aAllowedValues);
    return 0;
  }
  if ( !strcmp_(v12, ((_DWORD)(uintptr_t)(aAllowedNumbers))) && ((*v13 & 0x20) != 0 || (*v13 & 0x40) != 0) )
  {
    if ( (*v13 & 0x20) != 0 )
...
LABEL_20:
  ...
  if ( (!strcmp_(((_DWORD)(uintptr_t)(v13)), ((_DWORD)(uintptr_t)(aAllowedInteg_0))) || !strcmp_(((_DWORD)(uintptr_t)(v15)), ((_DWORD)(uintptr_t)(aAllowedFloats)))) && *v15 < 0 )
  {
    Rules_ReportAttributeCannotCombine((int)(intptr_t)v15, (int)(intptr_t)aAllowedNumber);
    return 0;
  }
  if ( !strcmp_(((_DWORD)(uintptr_t)(v15)), ((_DWORD)(uintptr_t)(aAllowedLexemes))) && ((*v13 & 4) != 0 || (*v13 & 8) != 0) )
  {
    if ( (*v13 & 4) != 0 )
  ...
  if ( (!strcmp_(((_DWORD)(uintptr_t)(v13)), ((_DWORD)(uintptr_t)(aAllowedSymbols))) || !strcmp_(((_DWORD)(uintptr_t)(v16)), ((_DWORD)(uintptr_t)(aAllowedStrings)))) && (*v16 & 0x10) != 0 )
  {
...
LABEL_101:
      ...
      if ( strcmp_(v21, ((_DWORD)(uintptr_t)(a_variable))) )
      {
...
signed int  Rules_ParseTypeAttribute(int readSource, int constraints)
{
  ...
  while ( theToken[0] != 101 )
  {
    ...
    {
      if ( theToken[0] != 15 || strcmp_(v6, ((_DWORD)(uintptr_t)(a_variable))) || typeParsed || variableParsed )
        goto LABEL_11;
      variableParsed = 1;
    }
    Parser_NextToken(readSource, (int)(intptr_t)theToken);
        ...
        int multipleValuesAllowed)
{
  ...
  if ( !strcmp_(((_DWORD)(uintptr_t)(constraintName)), ((_DWORD)(uintptr_t)(aRange_0))) )
  {
    v8 = 1;
  ...
  else if ( tokenType != 15 || strcmp_(v11, ((_DWORD)(uintptr_t)(a_variable))) )
  {
    sprintf_(((char*)(minMsgBuffer)), "%s attribute", tempName);
    Parser_ReportSyntaxError();
    return 0;
  }
  IO_OutWriteToken(asc_50DB38);
  ...
  else if ( tokenType != 15 || strcmp_(v13, ((_DWORD)(uintptr_t)(a_variable))) )
  {
    sprintf_(((char*)(maxMsgBuffer)), "%s attribute", tempName);
    Parser_ReportSyntaxError();
    return 0;
  }
...
int  Rules_GetAllowedAttributeTokenCode(int constraintName)
{
  ...
  if ( !strcmp_(constraintName, ((_DWORD)(uintptr_t)(aAllowedValues))) )
    return 103;
  if ( !strcmp_(v1, ((_DWORD)(uintptr_t)(aAllowedSymbols))) )
    return 2;
  if ( !strcmp_(v3, ((_DWORD)(uintptr_t)(aAllowedStrings))) )
    return 3;
  if ( !strcmp_(v4, ((_DWORD)(uintptr_t)(aAllowedLexemes))) )
    return 111;
  if ( !strcmp_(v5, ((_DWORD)(uintptr_t)(aAllowedInteg_0))) )
    return 1;
  if ( !strcmp_(v6, ((_DWORD)(uintptr_t)(aAllowedNumbers))) )
    return 110;
  if ( !strcmp_(v7, ((_DWORD)(uintptr_t)(aAllowedInstanc))) )
    return 8;
  result = strcmp_(v8, ((_DWORD)(uintptr_t)(aAllowedFloats)));
  if ( result )
    return -1;
  return result;
}
...
int  Rules_GetTypeNameTokenCode(int typeName)
{
  ...
  if ( !strcmp_(typeName, ((_DWORD)(uintptr_t)(aSymbol_7))) )
    return 2;
  if ( !strcmp_(v1, ((_DWORD)(uintptr_t)(aString_3))) )
    return 3;
  if ( !strcmp_(v3, ((_DWORD)(uintptr_t)(aLexeme_1))) )
    return 111;
  if ( !strcmp_(v4, ((_DWORD)(uintptr_t)(aInteger_4))) )
    return 1;
  result = strcmp_(v5, ((_DWORD)(uintptr_t)(aFloat_4)));
  if ( result )
  {
    if ( !strcmp_(v6, ((_DWORD)(uintptr_t)(aNumber_2))) )
    {
      return 110;
    }
    else if ( !strcmp_(v7, ((_DWORD)(uintptr_t)(aInstanceName_4))) )
    {
      return 8;
    }
    else if ( !strcmp_(v8, ((_DWORD)(uintptr_t)(aInstanceAddr_8))) )
    {
      return 7;
    }
    else if ( !strcmp_(v9, ((_DWORD)(uintptr_t)(aInstance_6))) )
    {
      return 112;
    }
    else if ( !strcmp_(v10, ((_DWORD)(uintptr_t)(aExternalAddr_1))) )
    {
      return 5;
    }
    else if ( !strcmp_(v11, ((_DWORD)(uintptr_t)(aFactAddress_2))) )
    {
      return 6;
    }
    else
...
int  Rules_TestConstraintAttributeParsedFlag(int constraintName, _DWORD *parsedConstraints)
{
  ...
  if ( !strcmp_(constraintName, ((_DWORD)(uintptr_t)(aType_0))) )
    return *parsedConstraints & 1;
  if ( !strcmp_(v3, ((_DWORD)(uintptr_t)(aRange_0))) )
    return *parsedConstraints << 30 >> 31;
  if ( !strcmp_(v5, ((_DWORD)(uintptr_t)(aCardinality))) )
    return *parsedConstraints << 21 >> 31;
  if ( !strcmp_(v6, ((_DWORD)(uintptr_t)(aAllowedValues))) )
    return *parsedConstraints << 23 >> 31;
  if ( !strcmp_(v7, ((_DWORD)(uintptr_t)(aAllowedSymbols))) )
    return *parsedConstraints << 29 >> 31;
  if ( !strcmp_(v8, ((_DWORD)(uintptr_t)(aAllowedStrings))) )
    return *parsedConstraints << 28 >> 31;
  if ( !strcmp_(v9, ((_DWORD)(uintptr_t)(aAllowedLexemes))) )
    return *parsedConstraints << 27 >> 31;
  if ( !strcmp_(v10, ((_DWORD)(uintptr_t)(aAllowedInstanc))) )
    return *parsedConstraints << 22 >> 31;
  if ( !strcmp_(v11, ((_DWORD)(uintptr_t)(aAllowedInteg_0))) )
    return *parsedConstraints << 25 >> 31;
  if ( !strcmp_(v12, ((_DWORD)(uintptr_t)(aAllowedFloats))) )
    return *parsedConstraints << 26 >> 31;
  if ( !strcmp_(v13, ((_DWORD)(uintptr_t)(aAllowedNumbers))) )
...
int  Rules_MarkConstraintAttributeParsed(_BYTE *parsedConstraints, int constraintName)
{
  ...
  result = strcmp_(constraintName, ((_DWORD)(uintptr_t)(aRange_0)));
  if ( result )
  {
    result = strcmp_(v4, ((_DWORD)(uintptr_t)(aType_0)));
    if ( result )
    {
      result = strcmp_(v5, ((_DWORD)(uintptr_t)(aCardinality)));
      if ( result )
      {
        result = strcmp_(v6, ((_DWORD)(uintptr_t)(aAllowedSymbols)));
        if ( result )
        {
          result = strcmp_(v7, ((_DWORD)(uintptr_t)(aAllowedStrings)));
          if ( result )
          {
            result = strcmp_(v8, ((_DWORD)(uintptr_t)(aAllowedLexemes)));
            if ( result )
            {
              result = strcmp_(v9, ((_DWORD)(uintptr_t)(aAllowedInteg_0)));
              if ( result )
              {
                result = strcmp_(v10, ((_DWORD)(uintptr_t)(aAllowedFloats)));
                if ( result )
                {
                  result = strcmp_(v11, ((_DWORD)(uintptr_t)(aAllowedNumbers)));
                  if ( result )
                  {
                    result = strcmp_(v12, ((_DWORD)(uintptr_t)(aAllowedValues)));
                    if ( !result )
...
LABEL_9:
  ...
  theList = ((int*)(Rules_ClonePatternPositionConstraintList((int *)(uintptr_t)thePattern[14])));
  tempList = theList;
  if ( !theList )
  {
LABEL_17:
...
signed int  Rules_CEBindPatternAddressVariable(int thePattern, int *multifieldHeader, int patternHead)
{
  ...
  if ( *(_DWORD *)(uintptr_t)thePattern == 80 )
  {
    ...
    *(_DWORD *)(uintptr_t)(thePattern + 16) = ((_DWORD)(uintptr_t)(theConstraints));
    *theConstraints &= ~1u;

...
/* Legacy CRT/Win32-era import declarations without manifest definitions (281); typed against compatibility/decomp_runtime_stubs.cpp or explicit native call contracts. */

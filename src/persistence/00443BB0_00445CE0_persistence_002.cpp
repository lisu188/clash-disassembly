        ...
        double a6)
{
  ...
  else
  {
    ...
    v11 = a1;
    digOutcome = (int)(intptr_t)(((void)a4, Temple_Random((_DWORD *)(uintptr_t)(unsigned int)(int)(intptr_t)outcomeTablePtr, v11, v6, (DWORD)(intptr_t)stackTileRecord)));
  ...
  ((void)a6, Rules_RetractTreasureFact(*stackTileRecord, stackTileRecord[1]));
  Temple_ProcessGift(*v16, (short int*)(intptr_t)((int)(intptr_t)stackTileRecord), stackTileRecord[1], *stackTileRecord, a6);
  return 1;
}
...
signed int  UnitStack_TryHide(int unitStackIndex, unsigned __int16 neighborStackIndex, DWORD a3, double a4)
{
  ...
  if ( UnitStack_GetMaxOrderTier((intptr_t)stackRecord) < 2 )
  {
    if ( *(_DWORD *)(uintptr_t)(PLAYER_DATA_STRIDE * *((unsigned __int8 *)stackRecord + 4) + gameData + PLAYER_CONTROLLER_MODE_TABLE_OFFSET) )
    {
      ...
      UI_ShowInfoWindow((const char*)(intptr_t)(lowRankMessageTable[(unsigned __int8)g_LanguageIndex]), 1u, v6, a3, (int)(intptr_t)noSpotMessageTable, (int)(intptr_t)&g_UnitHideFailedLowRankText[3]);
      return 0;
    }
    return 0;
  }
...
LABEL_16:
  ...
  if ( spotBlocked )
  {
    ...
    UI_ShowInfoWindow((const char*)(intptr_t)(noSpotMessageTable[(unsigned __int8)g_LanguageIndex]), 0, v10, 0, (int)(intptr_t)&spotBlocked, (int)(intptr_t)&g_UnitHideFailedNoSpotText[3]);
    return 0;
  }
  else
  {
...
int  SaveSlotDialog_RepaintRow(int a1)
{
  ...
  UI_DrawTextFmt(rowBottomY, 244, 410, 22 * rowIndex + 137, 3, (const char*)(intptr_t)((int)(intptr_t)labelBuffer));
...
int  SaveSlotDialog_Run(int a1, char a2, DWORD a3, double a4)
{
  ...
  int (*previousRenderHook)(int, char, DWORD); // [esp+E8h] [ebp-24h]
  ...
  if ( spriteSet )
    spriteSet = DLXSpriteSet_Load(spriteSet, (const void*)(intptr_t)(a2));
  ...
  v38[3] = (_DWORD)(uintptr_t)(&dialogSpriteSet);
  *(_DWORD *)((char *)&v38[16] + 1) = (_DWORD)(uintptr_t)(&dialogSpriteSet);
  if ( g_SaveSlotDialogIsSaveMode )
    v13 = -1;
  else
    v13 = 4;
      ...
      if ( poppedKey != -1 )
      {
        ...
        if ( typedChar )
        {
          if ( strlen(g_SaveSlotNameEditBuffer) < 0x10 )
          {
            ...
            if ( (unsigned __int16)Render_LoadResourceSprite_v3((_BYTE*)(v39)) < 0x97u )
            {
        ...
        if ( hoveredRow <= 9 )
        {
          ...
          if ( hoveredRow != g_SaveSlotDialogSelectedRow )
          {
            ...
            if ( g_SaveSlotDialogIsSaveMode )
            {
              ...
              if ( !strcmp_(v19, (_DWORD)(uintptr_t)(asc_4F94C2)) )
        ...
        int windowTop)
{
  ...
  int (*previousRenderHook)(int, char, DWORD); // [esp+6Ch] [ebp-30h]
  ...
  do
  {
    ...
    if ( (*(_BYTE *)(uintptr_t)(buildingRecordOffset + gameData + BUILDING_PLAGUE_STATE_TABLE_OFFSET) & 7) == 5 )
    {
      ...
      if ( result == g_CurrentPlayerIndex )
      {
        ...
        sprintf_((char*)(messageBuffer), a2, gameData + buildingRecordOffset + BUILDING_TABLE_OFFSET + 5);
...
int  UI_ShowTechnologyLevelUpIfChanged(int a1, DWORD a2)
{
  ...
  if ( *(_BYTE *)(uintptr_t)(PLAYER_DATA(g_CurrentPlayerIndex) + PLAYER_TECH_LEVEL_OFFSET) != *(_BYTE *)(uintptr_t)(PLAYER_DATA(g_CurrentPlayerIndex) + PLAYER_LAST_SHOWN_TECH_LEVEL_OFFSET) )
  {
    ...
    UI_ShowInfoWindow((const char*)(intptr_t)(noticeTextTable[(unsigned __int8)g_LanguageIndex]), 0, a1, a2, (int)(intptr_t)&noticeTextTable[3], (int)(intptr_t)&g_TechLevelUpNoticeText[3]);
...
int  UI_CheatEditRepaint(DWORD backdropSurface, int a2)
{
  ...
  UI_DrawTextFmt(a2, 200, 440, 260, 3, (const char*)(intptr_t)((int)(intptr_t)g_CheatEntryTextBuffer));
  UI_SetTextCursorPosition(-1);
...
char  Building_ShowConstructionFinishedDialog(int building, int a2, char spriteSetName, DWORD a4)
{
  ...
  int (*previousRenderHook)(int, char, DWORD); // [esp+58h] [ebp-2Ch]
  ...
  if ( spriteSetAlloc )
    spriteSetAlloc = DLXSpriteSet_Load(spriteSetAlloc, (const void*)(intptr_t)(spriteSetName));
  ...
  UI_DrawTextFmt((int)(intptr_t)g_CheatEntryTextBuffer, 70, 569, panelLeft + 60, 6, (const char*)(intptr_t)(completionText));
  v21 = -56;

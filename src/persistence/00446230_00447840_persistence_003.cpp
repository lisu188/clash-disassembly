...
#include "00446230_00447840_persistence_003_local.h"
...
int  Demo_ShowNumberedTextScreen(char spriteSetName, DWORD textScreenNumber)
{
  ...
  int (*previousRenderHook)(int, char, DWORD); // [esp+70h] [ebp-1Ch]
  ...
  sprintf_((char*)(resourcePathBuffer), "demo\\tekst%02d.s32", v4 + 1);
  spriteSet = (_DWORD *)(uintptr_t)Mem_Alloc(4112, v5, spriteSetName, textScreenNumber);
  if ( spriteSet )
    spriteSet = DLXSpriteSet_Load(spriteSet, (const void*)(intptr_t)(spriteSetName));
  ...
  Time_Now(v15, 1);
  Render_BlitSurface((_DWORD*)(&g_MainRenderDevice), v16, 0, (DWORD)(intptr_t)backdropSurface);
...
CLASH95_TEST_VISIBLE void QueenMarriageProposal_RebuildButtonWidgets(
        ...
        int cancel_left)
{
  static const char proposal_button_sound[] CLASH95_LOCAL_DATA_SYMBOL("proposal_button_sound.5", "QueenMarriageProposal_RebuildButtonWidgets.proposal_button_sound") = "male";
...
int  Queen_ShowWhimDecisionDialog(int text, int requiredAmount, int a3, int a4, DWORD allocContext)
{
  ...
  int (*previousRenderHook)(int, char, DWORD); // [esp+ECh] [ebp-24h]
  ...
  UI_DrawTextFmt(deviceVtable, panelLeft + 175, panelLeft + 525, panelTop + 65, 6, (const char*)(intptr_t)(messageText));
  Render_ReleaseSurface(18, backdropSurface);
  UI_DrawText(panelLeft + 198, panelTop + 12, (int)(intptr_t)aD_6);
  UI_DrawTextFmt(playerAmount, panelLeft + 126, v12, panelTop + 207, 3, (const char*)(intptr_t)((int)(intptr_t)aD_7));
  ...
  widgetTable[3] = (_DWORD)(uintptr_t)(&whimSpriteSet);
  *(_DWORD *)((char *)&widgetTable[13] + 1) = panelLeft + 451;
  *(_DWORD *)((char *)&widgetTable[14] + 1) = panelTop + 175;
  *(_DWORD *)((char *)&widgetTable[16] + 1) = (_DWORD)(uintptr_t)(&whimSpriteSet);
...
CLASH95_TEST_VISIBLE void YesNoWindow_WriteButtonWidgetRecord(
        ...
        int action_callback)
{
  static const char yesno_button_sound[] CLASH95_LOCAL_DATA_SYMBOL("yesno_button_sound.4", "YesNoWindow_WriteButtonWidgetRecord.yesno_button_sound") = "male";
...
int  YesNoWindow(int text, _BYTE *imageData, int a3, char a4, DWORD allocContext)
{
  ...
  int (*previousRenderHook)(int, char, DWORD); // [esp+C8h] [ebp-24h]
  ...
  UI_DrawTextFmt(deviceVtable, panelLeft + 30, panelLeft + 260, panelTop + 15, 3, (const char*)(intptr_t)(promptText));
  if ( Diagnostics_IsWorldMapClickTraceEnabled() )
...
int  UI_ShowSimpleTextInfoWindow(int a1, int a2, char a3, DWORD context)
{
  ...
  int (*previousRenderHook)(int, char, DWORD); // [esp+24h] [ebp-30h]
  ...
  (*(void (__fastcall **)(int, int, int, int, int, int, int, _DWORD, _DWORD))(uintptr_t)(deviceVtable + 52))(
    ...
    0,
    0);
  UI_DrawTextFmt(panelLeft + 25, panelLeft + 25, panelLeft + 250, panelTop + 34, 3, (const char*)(intptr_t)(messageText));
...
int  Queen_ShowMarriageProposalDialog(int a1, char a2, DWORD logContext)
{
  ...
  int (*previousRenderHook)(int, char, DWORD); // [esp+F0h] [ebp-24h]
  ...
  Diagnostics_TraceWorldMapActionEvent(
    ...
    0);
  UI_DrawTextFmt((int)(intptr_t)widgetTable, panelLeft + 175, panelLeft + 525, panelTop + 55, 6, (const char*)(intptr_t)(proposalTextTable[(unsigned __int8)g_LanguageIndex]));
  Diagnostics_TraceWorldMapActionEvent(
...
int  Queen_ShowMessageDialog(int message, int a2, char a3, DWORD a4)
{
  ...
  int (*previousRenderHook)(int, char, DWORD); // [esp+40h] [ebp-2Ch]
  ...
  (*(void (__fastcall **)(int, int, int, int, int, int, int, _DWORD, _DWORD))(uintptr_t)(deviceVtable + 52))(
    ...
    0,
    0);
  UI_DrawTextFmt(150, panelLeft + 175, panelLeft + 525, 205, 6, (const char*)(intptr_t)(messageText));
  Render_Present((int)(intptr_t)g_RenderState);
...
{
  static const char aMainMenuButtonClickSound[] CLASH95_LOCAL_DATA_SYMBOL("aMainMenuButtonClickSound.3", "MainMenu_RebuildButtonWidgetTemplate.aMainMenuButtonClickSound") = "menduze";
...
{
  static const char aCampaignMenuButtonClickSound[] CLASH95_LOCAL_DATA_SYMBOL("aCampaignMenuButtonClickSound.2", "CampaignMenu_RebuildButtonWidgetTemplate.aCampaignMenuButtonClickSound") = "menduze";
...
{
  static const char aLoadMenuButtonClickSound[] CLASH95_LOCAL_DATA_SYMBOL("aLoadMenuButtonClickSound.1", "LoadMenu_RebuildButtonWidgetTemplate.aLoadMenuButtonClickSound") = "menmale";
...
CLASH95_TEST_VISIBLE void Options_WriteSliderThumbRecord(
        unsigned char *record, int track_min, int track_max, int track_cross,
        int value, int draw_arg, int apply_callback)
        CLASH95_LOCAL_SYMBOL(Options_WriteSliderThumbRecord);
...
{
  static const char aOptionsMenuButtonClickSound[] CLASH95_LOCAL_DATA_SYMBOL("aOptionsMenuButtonClickSound.0", "Options_RebuildMainMenuWidgetTemplates.aOptionsMenuButtonClickSound") = "menmale";
...
{
  int (*previous_render_hook)(int, char, DWORD); // edi

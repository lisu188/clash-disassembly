...
int  Audio_PlayArtifactSound(int result)
{
  ...
  if ( g_UnitSoundsEnabled )
  {
    sprintf_((char*)(soundPathBuffer), "sfx\\artefakt\\%d.wav", result);
    return CSS_PlaySound((int)(intptr_t)soundPathBuffer, 64, 0, 0);
  }
  return result;
}
...
LABEL_16:
    ...
    if ( foundFriendlyUnitNearby )
    {
      ...
      (void)a4; /* The extra C double used SSE; the final integer remained tileColumn. */
      Unit_Create(UNIT_TYPE_PEASANT, g_CurrentPlayerIndex, reinforcementSpawnRow, v12, reinforcementSpawnColumn);
      ...
      Rules_LinkArmyFact((short int*)(intptr_t)(j), armyFactBase, v13, a4, v12, reinforcementSpawnRow);
      Rules_SyncArmyFactStrength((short int*)(intptr_t)(j), v20, v21, v12, reinforcementSpawnRow, a4);
...
void * UI_DrawPortStatusPanel(char a1, DWORD a2)
{
  ...
  if ( g_LanguageIndex == 2 )
    ...
    portLabelText = aPort;
  UI_DrawTextFmt((int)(intptr_t)arrivedTexts, panelLeft + 10, panelLeft + 235, panelTop + 5, 3, (const char*)(intptr_t)((int)(intptr_t)portLabelText));
  ...
  if ( PORT_REINFORCEMENT_READY_FLAG )
  {
    UI_DrawTextFmt((int)(intptr_t)arrivedTexts, panelLeft + 122, panelLeft + 200, panelTop + 54, 6, (const char*)(intptr_t)(arrivedTexts[(unsigned __int8)g_LanguageIndex]));
    Render_ReleaseSurface(15, panelSurface);
    UI_DrawTextFmt((int)(intptr_t)arrivedTexts, panelLeft + 42, panelLeft + 85, panelTop + 29, 1, (const char*)(intptr_t)((int)(intptr_t)aD_36));
  }
  else
  {
    UI_DrawTextFmt(
      ...
      panelTop + 40,
      6,
      (const char*)(intptr_t)(emptyTexts[(unsigned __int8)g_LanguageIndex]));
  }

...
signed int  Prisoner_SetInCastles(int a1, char a2, DWORD a3)
{
  ...
  for ( queued_index = 0; queued_index < 10; ++queued_index )
  {
    ...
    *(_BYTE *)(uintptr_t)queued_prisoner = -1;
    ...
    sprintf_((char*)(&g_PrisonerIntakeMessageBuffer), message_format, building + 5);
    result = UI_ShowInfoWindow(
               (const char*)(intptr_t)((int)(intptr_t)&g_PrisonerIntakeMessageBuffer),
               0,
               0,
               building_offset,
...
int  Prisoner_Behead(int buildingRecord, int prisonerRecord, char slotIndex, DWORD a4)
{
  ...
  if ( *(_DWORD *)(uintptr_t)(PLAYER_DATA_STRIDE * *(unsigned __int8 *)(uintptr_t)(v5 + 2) + gameData + 140051) )
  {
    ...
    sprintf_((char*)(messageBuffer), formatString, v7 + 5);
...
unsigned int  Prisoner_Torture(int buildingRecord, int prisonerSlot, int prisonerRecord, char slotIndex, DWORD context)
{
  ...
  switch ( result )
  {
    ...
    case 5u:
      ...
      sprintf_((char*)(&g_InfoWindowFormatBuffer), (const char *)revealFormatArg, v13 + 5);
    ...
    case 6u:
      ...
      sprintf_((char*)(&g_InfoWindowFormatBuffer), (const char *)revealTextTablePtr, v18 + 5);
      return UI_ShowInfoWindow((const char *)&g_InfoWindowFormatBuffer, 0, v15, context, (int)(intptr_t)revealFormatArg, (int)(intptr_t)revealTextTablePtr);
    case 2u:
    case 7u:
      ...
      sprintf_((char*)(&g_InfoWindowFormatBuffer), (const char *)(uintptr_t)localizedEnemyStackTexts[(unsigned __int8)g_LanguageIndex], v21 + 5);
      return UI_ShowInfoWindow((const char *)&g_InfoWindowFormatBuffer, 0, v15, context, (int)(intptr_t)revealFormatArg, (int)(intptr_t)revealTextTablePtr);
    case 3u:
      ...
      sprintf_((char*)(&g_InfoWindowFormatBuffer), (const char *)(uintptr_t)localizedNoConfessionTexts[(unsigned __int8)g_LanguageIndex], v23 + 5);
      return UI_ShowInfoWindow((const char *)&g_InfoWindowFormatBuffer, 0, v15, context, (int)(intptr_t)revealFormatArg, (int)(intptr_t)revealTextTablePtr);
    case 4u:
      ...
      sprintf_((char*)(&g_InfoWindowFormatBuffer), (const char *)(uintptr_t)localizedResistanceTexts[(unsigned __int8)g_LanguageIndex], v24 + 5);
      return UI_ShowInfoWindow((const char *)&g_InfoWindowFormatBuffer, 0, v15, context, (int)(intptr_t)revealFormatArg, (int)(intptr_t)revealTextTablePtr);
    default:
      return result;
  }
...
unsigned int  Prisoner_Pay(int a1, int prisonerSlot, DWORD a3, double a4)
{
  ...
  if ( *(_DWORD *)(uintptr_t)(gameData + result + 140051) )
  {
    ...
    sprintf_((char*)(&g_InfoWindowFormatBuffer), defectionFormat, v9 + 5);
      ...
      if ( result != -1 )
      {
        ...
        if ( prisonerCursor[447] == 10 )
        {
          ...
          if ( *(_DWORD *)(uintptr_t)(gameData + result + 140051) )
          {
            ...
            a4 = sprintf_((char*)(messageBuffer), (const char *)(uintptr_t)exhaustionTextTable[(unsigned __int8)g_LanguageIndex], buildingNamePtr);
  ...
  do
  {
    ...
    if ( result != -1 )
    {
      ...
      result = UI_DrawTextFmt(
                 ...
                 461,
                 3,
                 (const char*)(intptr_t)((int)(intptr_t)aD_79));
    }
    ++rowIndex;
...
int  Queen_DrawRelationshipPanel(DWORD a1, int a2)
{
  ...
  return UI_DrawTextFmt(
           ...
           215,
           6,
           (const char*)(intptr_t)((int)(intptr_t)(&g_QueenRelationshipStateTexts[3 * queenRelationshipState])[(unsigned __int8)g_LanguageIndex]));
}
// 511130: using guessed type char g_LanguageIndex;
// 511230: using guessed type _UNKNOWN *g_RenderDevice;
...
int  Building_ShowPrisonerManagementPanel(int buildingRecord, void *a2, DWORD a3)
{
  ...
  if ( spriteSet )
    spriteSet = DLXSpriteSet_Load(spriteSet, (const void*)(intptr_t)((char)(intptr_t)a2));
  ...
  if ( *(_DWORD *)(uintptr_t)(gameData + 141447) )
  {
    ...
    (*(void (__fastcall **)(int, int, int, int, int, int, int, _DWORD, _DWORD))(uintptr_t)(j + 52))(
      ...
      0,
      0);
    UI_DrawTextFmt(j, 254, 380, 30, 3, (const char*)(intptr_t)(gameData + 141451));
  }
  if ( *(_DWORD *)(uintptr_t)(gameData + 142870) )
  {
    ...
    (*(void (__fastcall **)(int, int, int, int, int, int, int, _DWORD, _DWORD))(uintptr_t)(*((_DWORD *)g_RenderDevice + 46) + 52))(
      ...
      0,
      0);
    UI_DrawTextFmt(j, 420, 546, 30, 3, (const char*)(intptr_t)(gameData + 142874));
  }
  if ( *(_DWORD *)(uintptr_t)(gameData + 144293) )
  {
    ...
    (*(void (__fastcall **)(int, int, int, int, int, int, int, _DWORD, _DWORD))(uintptr_t)(*((_DWORD *)g_RenderDevice + 46) + 52))(
      ...
      0,
      0);
    UI_DrawTextFmt(j, 172, 298, 75, 3, (const char*)(intptr_t)(gameData + 144297));
  }
  if ( *(_DWORD *)(uintptr_t)(gameData + 145716) )
  {
    ...
    (*(void (__fastcall **)(int, int, int, int, int, int, int, _DWORD, _DWORD))(uintptr_t)(player5RenderMethods + 52))(
      ...
      0,
      0);
    UI_DrawTextFmt(player5RenderMethods, 336, 462, 75, 3, (const char*)(intptr_t)(gameData + 145720));
  }
  barIndex = 0;
  maxPopulation = 0;
  zeroBaseline = 0;

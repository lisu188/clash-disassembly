...
/* Public surface of 'state': functions defined here and referenced from another subsystem (20). */
...
extern CLASH95_INTERNAL const UnitTypeRuntimeCoreMetadataRecord *UnitSlot_BorrowTypeMetadata(void);

...
#include "00000000_00000000_prelude_helpers_local.h"
...
{
  static int initialized CLASH95_LOCAL_DATA_SYMBOL("initialized.1", "Render_InitRecoveredVtableStorage.initialized");
...
{
  static int initialized CLASH95_LOCAL_DATA_SYMBOL("initialized.0", "Rules_EnsureObjectPatternVTable.initialized");

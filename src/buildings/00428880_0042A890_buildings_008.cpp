        ...
        __int64 a16)
{
  ...
  {
    *(_DWORD *)(uintptr_t)(g_MapData + 808) = (target_row + (unsigned __int16)shooter_unit[2]) / 2 - 3;
    *(_DWORD *)(uintptr_t)(g_MapData + 812) = (target_col + (unsigned __int16)shooter_unit[3]) / 2 - 3;
    if ( *(int *)(uintptr_t)(g_MapData + 808) < 0 )
      *(_DWORD *)(uintptr_t)(g_MapData + 808) = 0;
    mapRowCount = *(_DWORD *)(uintptr_t)(g_MapData + 804);
    if ( *(_DWORD *)(uintptr_t)(g_MapData + 808) + 7 > mapRowCount )
      *(_DWORD *)(uintptr_t)(g_MapData + 808) = mapRowCount - 7;
    if ( *(int *)(uintptr_t)(g_MapData + 812) < 0 )
      *(_DWORD *)(uintptr_t)(g_MapData + 812) = 0;
    mapColCount = *(_DWORD *)(uintptr_t)(g_MapData + 800);
    if ( *(_DWORD *)(uintptr_t)(g_MapData + 812) + 7 > mapColCount )
      *(_DWORD *)(uintptr_t)(g_MapData + 812) = mapColCount - 7;
  ...
  *((_BYTE *)shooter_unit + 3) = Facing_DirectionFromDelta8(target_row - (unsigned __int16)shooter_unit[2], target_col - (unsigned __int16)shooter_unit[3]);
  ...
  shooterSpriteSet = (_DWORD *)(uintptr_t)Mem_Alloc(4112, v17, shooter_owner, (DWORD)(intptr_t)v111);
  if ( shooterSpriteSet )
    shooterSpriteSet = DLXSpriteSet_Load(shooterSpriteSet, (const void*)(intptr_t)(shooter_owner));
  g_ActiveUnitAnimSpriteSet = (int)(intptr_t)shooterSpriteSet;
  target_owner = 0;
  ...
  if ( target_unit_index != -1 )
  {
    ...
    targetSpriteSet = (_DWORD *)(uintptr_t)Mem_Alloc(4112, v20, target_owner, (DWORD)(intptr_t)v111);
    if ( targetSpriteSet )
      targetSpriteSet = DLXSpriteSet_Load(targetSpriteSet, (const void*)(intptr_t)(target_owner));
    g_UnitBattleAnimatingUnitSpriteSet = (int)(intptr_t)targetSpriteSet;
  }
  ...
  {
    projPaletteSpriteSet = (_DWORD *)(uintptr_t)Mem_Alloc(4112, v23, target_owner, (DWORD)(intptr_t)v111);
    if ( projPaletteSpriteSet )
      projPaletteSpriteSet = DLXSpriteSet_Load(projPaletteSpriteSet, (const void*)(intptr_t)(target_owner));
    projectile_sprite_set = (int)(intptr_t)projPaletteSpriteSet;
  }
  v25 = projectile_sprite_set;
  Debug_Log(-1, projectile_sprite_set, (DWORD)(intptr_t)v111, (int)(intptr_t)aLoaded);
  ...
  if ( sprite_frame_base != -1 )
  {
    ...
    proj_px_y = *(_DWORD *)((char *)&a7 + 6) + (((unsigned __int16)shooter_unit[3] - *(_DWORD *)(uintptr_t)(g_MapData + 812)) << 6) + 16 - spriteVerticalOffset;
    source_px_y = proj_px_y;
    target_px_x = ((target_row - *(_DWORD *)(uintptr_t)(g_MapData + 808)) << 6) + 64 - projHalfHeight;
    target_px_y = ((target_col - *(_DWORD *)(uintptr_t)(g_MapData + 812)) << 6) + 48 - SpriteWidth / 2;
    ...
    {
      UnitBattle_UpdateIdleAnimatedUnits();
      DD_Pump((int)(intptr_t)g_RenderState, v44);
      ...
      Render_FillRect((_DWORD *)(uintptr_t)g_PrimaryRenderSurface, 0, v62, (unsigned __int16)proj_px_x, proj_px_x + v61 + 1, v107, proj_px_x, proj_px_y);
...
LABEL_55:
        battleProjectileSpriteSet = DLXSpriteSet_Load(battleProjectileSpriteSet, (const void*)(intptr_t)(v25));
    }
    else
    {
      if ( v75 != 24 )
...
LABEL_57:
        ...
        {
          v78 = (_DWORD *)(uintptr_t)Mem_Alloc(4112, v74, v25, (DWORD)(intptr_t)v111);
          if ( v78 )
            v78 = DLXSpriteSet_Load(v78, (const void*)(intptr_t)(v25));
          g_UnitBattleProjectileSpriteSet = (int)(intptr_t)v78;
        }
    ...
    g_UnitBattleProjectileSpriteSet = (int)(intptr_t)battleProjectileSpriteSet;
    goto LABEL_57;
  }
LABEL_62:
  if ( target_unit )
  ...
  if ( v105 )
    nfree_(v105);
  result = RenderState_SelectCursorDescriptor((int)(intptr_t)g_RenderState, (int)(intptr_t)&g_CursorDesc_ActionBusy);
...
int  UnitBattle_CalcShotTargetHealthAfterHit(int shooter_index, int target_index)
{
  ...
  * (*(unsigned __int16 *)(uintptr_t)(shooter_record + 4) - (unsigned __int16)target_unit[2])
  + (*(unsigned __int16 *)(uintptr_t)(shooter_record + 6) - (unsigned __int16)target_unit[3])
  * (*(unsigned __int16 *)(uintptr_t)(shooter_record + 6) - (unsigned __int16)target_unit[3]));
  crowd_scale = UnitBattle_GetTargetCrowdingScale((int)(intptr_t)target_unit);
...
int  UnitBattle_Shot(int shooter_index, int target_index)
{
  ...
  if ( (signed __int8)target_unit[9] <= 0 )
  {
    ...
    *(_BYTE *)(uintptr_t)(40 * target_row + g_MapData + 2 * target_col + 2334) = UnitBattle_GetCorpseSpriteIndex((__int16 *)target_unit);
...
int  UnitBattle_AttackWall(int unitSlot, DWORD wallRow, int a3, int wallCol)
{
  ...
  if ( rowDist <= 0 )
    rowDist = wallRow - *(unsigned __int16 *)(uintptr_t)(unitRecord + 4);
  if ( rowDist > 1 )
    goto LABEL_18;
  colDist = *(unsigned __int16 *)(uintptr_t)(unitRecord + 6) - wallCol;
  if ( colDist <= 0 )
    colDist = wallCol - *(unsigned __int16 *)(uintptr_t)(unitRecord + 6);
  if ( colDist )
  {
LABEL_18:
    result = (int)(intptr_t)UnitBattle_MoveTrackNearWall(unitSlot, wallRow, wallCol, wallRow);
    if ( !result )
      return result;
    *(_DWORD *)(uintptr_t)(unitRecord + 23) = result;
    UnitBattle_Move(unitSlot, 0, 0, 0);
    moveTrackPtr = *(_DWORD *)(uintptr_t)(unitRecord + 23);
    if ( moveTrackPtr )
    {
      nfree_(moveTrackPtr);
    ...
    rowDistAfterMove = *(unsigned __int16 *)(uintptr_t)(unitRecord + 4) - wallRow;
    if ( rowDistAfterMove <= 0 )
      rowDistAfterMove = wallRow - *(unsigned __int16 *)(uintptr_t)(unitRecord + 4);
    if ( rowDistAfterMove > 1 )
      return 0;
    if ( *(unsigned __int16 *)(uintptr_t)(unitRecord + 6) - wallCol > 0 )
      return 0;
    if ( wallCol != *(unsigned __int16 *)(uintptr_t)(unitRecord + 6) )
      return 0;
  }
  ...
  wall_hp_before = *(unsigned __int8 *)(uintptr_t)(wallTileBase + 3134);
  wall_kind = *(_DWORD *)(uintptr_t)(g_MapData + 820);
  wall_factor = (unsigned __int16)g_WallKindDefenseFactor[2 * wall_kind];
  effective_wall_attack = Unit_CalcEffectivenessD((char *)(uintptr_t)unitRecord, 0);
  wall_damage = wall_factor * effective_wall_attack / 256;
  *(_BYTE *)(uintptr_t)(wallTileBase + 3134) -= wall_damage;
  wall_hp_after = *(unsigned __int8 *)(uintptr_t)(wallTileBase + 3134);
  wallTilePtr = wallTileBase;
  if ( *(char *)(uintptr_t)(wallTilePtr + 3134) <= 0 )
  {
    *(_BYTE *)(uintptr_t)(wallTilePtr + 3134) = 0;
    if ( wallCol == *(_DWORD *)(uintptr_t)(g_MapData + 828) )
      *(_DWORD *)(uintptr_t)(g_MapData + 832) = 0;
    wall_hp_after = *(unsigned __int8 *)(uintptr_t)(wallTilePtr + 3134);
  }
  if ( Diagnostics_IsWorldMapClickTraceEnabled() )
    fprintf(
      ...
      unitSlot,
      *(__int16 *)(uintptr_t)unitRecord,
      (unsigned long)wallRow,
      wallCol,
      unit_ap_before,
      *(unsigned __int8 *)(uintptr_t)(unitRecord + 8),
      wall_hp_before,
      wall_hp_after,
      wall_kind,
      wall_factor,
      ...
      *(_DWORD *)(uintptr_t)(g_MapData + 832),
...
int  UnitBattle_ShotWall(int unitSlot, int targetRow)
{
  ...
  wallHpAfter = *(signed __int8 *)(uintptr_t)(wallRowBase + targetCol + 3134) - ((effectiveDamage * (unsigned __int16)v12) >> 8);
  *(_BYTE *)(uintptr_t)(wallRowBase + targetCol + 3134) = wallHpAfter;
  if ( wallHpAfter <= 0 )
  {
    *(_BYTE *)(uintptr_t)(wallRowBase + targetCol + 3134) = 0;
    if ( targetCol == *(_DWORD *)(uintptr_t)(g_MapData + 828) )
      *(_DWORD *)(uintptr_t)(g_MapData + 832) = 0;
  }
  UnitBattle_RedrawTile(targetRow, targetCol);
  if ( gateSpriteBefore != g_BattleWallGateLastSpriteChar )
...
int  BuildCursor_DrawPlacementOverlay(__int64 result)
{
  ...
  tilePos64 = result;
  screenX = (((_DWORD)result - *(_DWORD *)(uintptr_t)(gameData + MAP_VIEW_LEFT_OFFSET)) << 6) + 32;
  screenY = ((HIDWORD(result) - *(_DWORD *)(uintptr_t)(gameData + MAP_VIEW_TOP_OFFSET)) << 6) + 16;
  if ( *(_BYTE *)(uintptr_t)(gameData + MAP_THEME_INDEX_OFFSET) == 1 )
    overlayColor = 215;
  else
    overlayColor = 76;
  ...
  else
  {
    if ( result == g_BuildPlacementTileXY )
    {
      if ( BuildCursor_IsPlacementValid(result, SHIDWORD(result), g_BuildCursorBuildingType, g_SelectedUnitIndex) )
      {
        ...
        (*(void (__fastcall **)(_DWORD, _DWORD, _DWORD, _DWORD))(uintptr_t)(*((_DWORD *)g_RenderDevice + 46) + 20))(
          (unsigned __int16)(screenX + 63),
          (unsigned __int16)screenX,
          (unsigned __int16)screenY,
          overlayColor);
        LODWORD(result) = (*(int (__fastcall **)(int, int, _DWORD, _DWORD))(uintptr_t)(*((_DWORD *)g_RenderDevice + 46) + 20))(
                            screenX,
                            screenX,
                            (unsigned __int16)(screenY + 63),
                            overlayColor);
    ...
    if ( result == __PAIR64__(HIDWORD(g_BuildPlacementTileXY), (int)g_BuildPlacementTileXY + 1) )
    {
      if ( BuildCursor_IsPlacementValid(result - 1, SHIDWORD(result), g_BuildCursorBuildingType, g_SelectedUnitIndex) )
      {
        ...
        (*(void (__fastcall **)(int, _DWORD, _DWORD, _DWORD))(uintptr_t)(*((_DWORD *)g_RenderDevice + 46) + 20))(
          v4,
          (unsigned __int16)screenX,
          (unsigned __int16)screenY,
          overlayColor);
...
LABEL_26:
        ...
        LODWORD(result) = (*(int (__fastcall **)(int, int, int, int, int, int, int, _DWORD, _DWORD))(uintptr_t)(*((_DWORD *)g_RenderDevice + 46) + 52))(
                            screenY,
                            SpriteForChar,
                            -1,
                            -1,
...
/* Original [0x5146C0,0x514802): six packed placement-mode widgets.
 * Copy fixed bytes once, then relocate only original 32-bit pointer fields. */
CLASH95_INTERNAL void BuildCursor_EnsureWidgetTable(void)
{
  static const _BYTE initial[BUILD_CURSOR_WIDGET_TABLE_BYTES] = {
    ...
    ,
  };
  static const char text_4eedfe[] = "\x44\x72\x6f\x67\x61";
  static const char text_4eee04[] = "\x52\x6f\x61\x64";
  static const char text_4eee09[] = "\x6d\x61\x6c\x65";
  static const char text_4eee0e[] = "\x50\x75\x92\x61\x70\x6b\x61";
  static const char text_4eee16[] = "\x54\x72\x61\x70";
  static const char text_4eee1b[] = "\x6d\x61\x6c\x65";
  static const char text_4eee20[] = "\x4b\x6f\x70\x61\x6e\x69\x65\x20\x73\x6b\x61\x72\x62\xa2\x77";
  static const char text_4eee30[] = "\x44\x69\x67\x20\x66\x6f\x72\x20\x74\x72\x65\x61\x73\x75\x72\x65";
  static const char text_4eee41[] = "\x6d\x61\x6c\x65";
  static const char text_4eee46[] = "\x57\x69\x65\xa7\x61";
  static const char text_4eee4c[] = "\x4b\x65\x65\x70";
  static const char text_4eee51[] = "\x6d\x61\x6c\x65";
  static const char text_4eee56[] = "\x54\x77\x69\x65\x72\x64\x7a\x61";
  static const char text_4eee5f[] = "\x46\x6f\x72\x74\x72\x65\x73\x73";
  static const char text_4eee68[] = "\x6d\x61\x6c\x65";
  static const char text_4eee6d[] = "\x5a\x61\x6d\x65\x6b";
  static const char text_4eee73[] = "\x43\x61\x73\x74\x6c\x65";
  static const char text_4eee7a[] = "\x6d\x61\x6c\x65";
  _DWORD pointer_value;

  if (g_BuildCursorWidgetsInitialized)
    return;
  memcpy(g_BuildBuildingActionWidgetTable, initial, sizeof(initial));
  pointer_value = (_DWORD)(uintptr_t)&g_ActionButtonSpriteSet;
  memcpy(g_BuildBuildingActionWidgetTable + 12, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&UI_DrawWidgetIcon;
  memcpy(g_BuildBuildingActionWidgetTable + 28, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&BuildCursor_RequestExit;
  memcpy(g_BuildBuildingActionWidgetTable + 32, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eedfe;
  memcpy(g_BuildBuildingActionWidgetTable + 36, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee04;
  memcpy(g_BuildBuildingActionWidgetTable + 40, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee09;
  memcpy(g_BuildBuildingActionWidgetTable + 49, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&g_ActionButtonSpriteSet;
  memcpy(g_BuildBuildingActionWidgetTable + 65, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&UI_DrawWidgetIcon;
  memcpy(g_BuildBuildingActionWidgetTable + 81, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&BuildCursor_RequestExit;
  memcpy(g_BuildBuildingActionWidgetTable + 85, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee0e;
  memcpy(g_BuildBuildingActionWidgetTable + 89, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee16;
  memcpy(g_BuildBuildingActionWidgetTable + 93, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee1b;
  memcpy(g_BuildBuildingActionWidgetTable + 102, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&g_ActionButtonSpriteSet;
  memcpy(g_BuildBuildingActionWidgetTable + 118, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&UI_DrawWidgetIcon;
  memcpy(g_BuildBuildingActionWidgetTable + 134, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&BuildCursor_RequestExit;
  memcpy(g_BuildBuildingActionWidgetTable + 138, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee20;
  memcpy(g_BuildBuildingActionWidgetTable + 142, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee30;
  memcpy(g_BuildBuildingActionWidgetTable + 146, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee41;
  memcpy(g_BuildBuildingActionWidgetTable + 155, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&g_ActionButtonSpriteSet;
  memcpy(g_BuildBuildingActionWidgetTable + 171, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&UI_DrawWidgetIcon;
  memcpy(g_BuildBuildingActionWidgetTable + 187, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&BuildCursor_RequestExit;
  memcpy(g_BuildBuildingActionWidgetTable + 191, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee46;
  memcpy(g_BuildBuildingActionWidgetTable + 195, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee4c;
  memcpy(g_BuildBuildingActionWidgetTable + 199, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee51;
  memcpy(g_BuildBuildingActionWidgetTable + 208, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&g_ActionButtonSpriteSet;
  memcpy(g_BuildBuildingActionWidgetTable + 224, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&UI_DrawWidgetIcon;
  memcpy(g_BuildBuildingActionWidgetTable + 240, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&BuildCursor_RequestExit;
  memcpy(g_BuildBuildingActionWidgetTable + 244, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee56;
  memcpy(g_BuildBuildingActionWidgetTable + 248, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee5f;
  memcpy(g_BuildBuildingActionWidgetTable + 252, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee68;
  memcpy(g_BuildBuildingActionWidgetTable + 261, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&g_ActionButtonSpriteSet;
  memcpy(g_BuildBuildingActionWidgetTable + 277, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&UI_DrawWidgetIcon;
  memcpy(g_BuildBuildingActionWidgetTable + 293, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)&BuildCursor_RequestExit;
  memcpy(g_BuildBuildingActionWidgetTable + 297, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee6d;
  memcpy(g_BuildBuildingActionWidgetTable + 301, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee73;
  memcpy(g_BuildBuildingActionWidgetTable + 305, &pointer_value, sizeof(pointer_value));
  pointer_value = (_DWORD)(uintptr_t)text_4eee7a;
  memcpy(g_BuildBuildingActionWidgetTable + 314, &pointer_value, sizeof(pointer_value));
  g_BuildCursorWidgetsInitialized = 1;
}
...
int  BuildBuilding(int buildingType, int a2, char a3, double a4)
{
  ...
  *(_DWORD *)((char *)&g_BuildBuildingActionWidgetHandlerBase + widgetSlotOffset) = (_DWORD)(uintptr_t)&BuildCursor_HandleCancelButtonPress;
  v8 = gameData;
  g_WorldMapTileOverlayDrawHook = (int (__fastcall *)(_DWORD, _DWORD))BuildCursor_DrawPlacementOverlay;
  LODWORD(g_BuildPlacementTileXY) = *(_DWORD *)(uintptr_t)(gameData + MAP_VIEW_LEFT_OFFSET)
                        + ((cursorPixelX - 32 - (__CFSHL__((cursorPixelX - 32) >> 31, 6) + ((cursorPixelX - 32) >> 31 << 6))) >> 6);
  HIDWORD(g_BuildPlacementTileXY) = *(_DWORD *)(uintptr_t)(gameData + MAP_VIEW_TOP_OFFSET)
  ...
  {
    DD_Pump((int)(intptr_t)&g_RenderState, v8, (char)(intptr_t)BuildCursor_DrawPlacementOverlay);
    WorldMap_RedrawFrame(v8);
    if ( !UIWidgetTable_PollHoverAndActions((_DWORD*)(intptr_t)((int)(intptr_t)&g_BuildBuildingActionWidgetTable), buildingType) && UI_TrySelectFriendlyStackUnderCursor() )
    {
      Render_Begin((int)(intptr_t)&g_RenderState, 0, (char)(intptr_t)BuildCursor_DrawPlacementOverlay);
      break;
    }
    ...
    if ( DD_IsFlipping((int)(intptr_t)&g_RenderState) )
    {
      if ( buildingType == 3 )
      {
        ...
        if ( Trap_New(g_BuildPlacementTileXY, SHIDWORD(g_BuildPlacementTileXY), v16, g_SelectedUnitIndex, a4) == 1 )
        {
          ...
          completionStrings[0] = (int)(intptr_t)g_BuildBuildingCompletionMessageStrings[0];
          completionStrings[1] = (int)(intptr_t)g_BuildBuildingCompletionMessageStrings[1];
          completionStrings[2] = (int)(intptr_t)g_BuildBuildingCompletionMessageStrings[2];
          UI_ShowInfoWindow((const char*)(intptr_t)(completionStrings[(unsigned __int8)g_LanguageIndex]), 0, v21, 3u, (int)(intptr_t)&completionStrings[3], (int)(intptr_t)&g_BuildBuildingCompletionMessageStrings[3]);
          Render_Begin((int)(intptr_t)&g_RenderState, 0, (char)(intptr_t)&completionStrings[3]);
          g_BuildPlacementLoopDone = 1;
          break;
        }
      }
      else
      {
        ...
        if ( ((BOOL (__cdecl *)(__int64, int, int, double, char *, int))Building_New)(
               ...
               0) == 1 )
        {
          Audio_PlaySoundEffectByName((char*)(intptr_t)((int)(intptr_t)aStruktur_2), 64);
          Render_Begin((int)(intptr_t)&g_RenderState, 0, (char)(intptr_t)BuildCursor_DrawPlacementOverlay);
          g_BuildPlacementLoopDone = 1;
          break;
        }
...
int  UI_DrawNoticeBoxSmall(DWORD renderState, int a2 CLASH95_UNUSED)
{
  ...
  g_RenderDevice = (_UNKNOWN*)(&g_MainRenderDevice);
  Render_SaveBackbuffer((int)(intptr_t)&g_MainRenderDevice);
  Render_FillRect((_DWORD *)(uintptr_t)g_PrimaryRenderSurface, 0, 198, 208, 0x104u, 0xDAu, 0xD0u, 0xC6u);
  Render_ReleaseSurface(5, renderState);
  tax_rate = *(_BYTE *)(uintptr_t)(g_BuildingEconomyDialogBuilding + 436) & 0x3F;
  UI_DrawTextFmt(208, 208, 260, 198, 3, aD_D, tax_rate / 10, tax_rate % 10);
  if ( (__int16)(16 * *(_WORD *)(uintptr_t)(g_BuildingEconomyDialogBuilding + 432)) >> 4 <= 0
    || (*(_BYTE *)(uintptr_t)(g_BuildingEconomyDialogBuilding + 435) & 7) != 0 )
  {
    if ( (__int16)(16 * *(_WORD *)(uintptr_t)(g_BuildingEconomyDialogBuilding + 432)) >> 4
      || (*(_BYTE *)(uintptr_t)(g_BuildingEconomyDialogBuilding + 435) & 7) != 0 )
      spriteIndex = 4;
    else
      spriteIndex = 3;
...
int  UI_DrawConfirmTop(DWORD renderState, int a2 CLASH95_UNUSED)
{
  ...
  Render_ReleaseSurface(5, renderState);
  Render_SaveBackbuffer((int)(intptr_t)&g_MainRenderDevice);
  Render_FillRect((_DWORD *)(uintptr_t)g_PrimaryRenderSurface, 0, 360, 548, 0x259u, 0x17Cu, 0x224u, 0x168u);

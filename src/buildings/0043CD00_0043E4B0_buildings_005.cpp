...
#include "0043CD00_0043E4B0_buildings_005_local.h"
...
{
  *result = 0;
  result[1] = (_DWORD)(uintptr_t)(&g_WCIsvListBaseRoot_Vtable);
  return result;
}
...
int  WCIsvListBase_dtorRoot(int result, char dtorFlags)
{
  ...
  if ( (dtorFlags & 4) != 0 )
  {
    _wcpp_4_dtor_array_store__(result, (_DWORD)(uintptr_t)(&g_WCIsvListBaseRoot_DtorArrayTag));
    j_j__nfree_();
    return v3;
  }
...
_DWORD * WCIsvListBase_ctorVariant124(_DWORD *result)
{
  *result = 0;
  ...
  result[4] = 0;
  result[5] = 0;
  result[1] = (_DWORD)(uintptr_t)(&g_WCIsvListBaseDtor_Vtable);
  result[1] = (_DWORD)(uintptr_t)(&g_WCIsvListBaseDestroyElements_Vtable);
  result[1] = (_DWORD)(uintptr_t)(&g_WCIsvListBaseVariant124_Vtable);
  return result;
}
// 50F0E4: using guessed type int (*off_50F0E4)();
...
int  WCIsvListBase_dtorVariant124(WCIsvListBase *a1, char dtorFlags)
{
  ...
  if ( (dtorFlags & 4) != 0 )
  {
    _wcpp_4_dtor_array_store__((_DWORD)(uintptr_t)(a1), (_DWORD)(uintptr_t)(&g_WCIsvListBaseVariant124_DtorArrayTag));
    j_j__nfree_();
    return v4;
  }
  else
...
int  WCIsvListBase_ctorVariant124AndCopy(_DWORD *dest, _DWORD *source)
{
  ...
  *dest = 0;
  dest[1] = (_DWORD)(uintptr_t)(&g_WCIsvListBaseRoot_Vtable);
  dest[2] = 0;
  dest[3] = 0;
  dest[4] = 0;
  dest[5] = 0;
  dest[1] = (_DWORD)(uintptr_t)(&g_WCIsvListBaseDtor_Vtable);
  dest[1] = (_DWORD)(uintptr_t)(&g_WCIsvListBaseDestroyElements_Vtable);
  dest[1] = (_DWORD)(uintptr_t)(&g_WCIsvListBaseVariant124_Vtable);
...
_DWORD * WCIsvListBase_ctorVariant134(_DWORD *result)
{
  *result = 0;
  ...
  result[1] = (_DWORD)(uintptr_t)(&g_WCIsvListBaseDtor_Vtable);
  result[1] = (_DWORD)(uintptr_t)(&g_WCIsvListBaseVariant124_Vtable);
  result[1] = (_DWORD)(uintptr_t)(&g_WCIsvListBaseVariant134_Vtable);
  return result;
}
// 50F0E4: using guessed type int (*off_50F0E4)();
// 50F0F4: using guessed type _DWORD (*off_50F0F4)(WCIsvListBase * this);
...
int  WCIsvListBase_dtorVariant134(WCIsvListBase *a1, char dtorFlags)
{
  ...
  if ( (dtorFlags & 4) != 0 )
  {
    _wcpp_4_dtor_array_store__((_DWORD)(uintptr_t)(a1), (_DWORD)(uintptr_t)(&g_WCIsvListBaseVariant134_DtorArrayTag));
    j_j__nfree_();
    return v4;
  }
  else
...
//----- (0043D100) --------------------------------------------------------
_DWORD *WCIsvListBase_vtblDtor(WCIsvListBase *this_)
{
  WCCompatListBase *list;

  list = WCCompat_ListFromBase(this_);
  list->vtable = (int)(uintptr_t)g_WCIsvListBaseFreeOnly_Vtable;
  WCIsvListBase_dtor(this_);
  return (_DWORD *)this_;
}

//----- (0043D100) --------------------------------------------------------
_DWORD * WCIsvListBase_dtorVariant104(WCIsvListBase *this_)
{
  return WCIsvListBase_vtblDtor(this_);
}
...
void WCIsvListBase_base_destroy(WCIsvListBase *this_)
{
  int link_handle;

  for ( link_handle = WCIsvListBase_base_sget((int)(uintptr_t)this_); link_handle; link_handle = WCIsvListBase_base_sget((int)(uintptr_t)this_) )
    WCIsvListBase_ReleaseLinkNode((int)(uintptr_t)this_, link_handle, 8);
}

_DWORD WCIsvListBase_dtor(WCIsvListBase *this_)
{
  WCCompatListBase *list;
  ...
  if ( list->tail_link )
    Noop_WCIsvListErrorHook((int)(uintptr_t)this_);
  return (unsigned int)(uintptr_t)this_;
}
...
//----- (0043D1E0) --------------------------------------------------------
int  WCIsvListBase_DestroyElementsAndDtor(WCIsvListBase *this_, int listHandle)
{
  WCCompatListBase *list;
  ...
  if ( list->tail_link )
  {
    ...
    WCIsvListBase_base_destroy(this_);
  }
  list->vtable = (int)(uintptr_t)g_WCIsvListBaseFreeOnly_Vtable;
  return WCIsvListBase_dtor(this_);
}
...
int  WCIsvListBase_CopyCtor(_DWORD *dest, _DWORD *source)
{
  ...
  *dest = 0;
  ...
  WCIsvListBase_CopyAppendAll(dest, source, (int)(intptr_t)dest);
  result = v2;
  *(_DWORD *)(uintptr_t)(v2 + 4) = (_DWORD)(uintptr_t)(&g_WCIsvListBaseVariant134_Vtable);
  return result;
}
  ...
  do
  {
    ...
    do
    {
      ...
      if ( bucketHasEntry )
      {
        ...
        {
          result = Battle_PlaceUnitAtNextOpenDeploymentTile(BattleDeploymentBucketReadPointer(bestEntryOffset), (_DWORD*)(&columnCursor), placementSideCopy, &rowCursor);
...
int  Building_ShowGateDoorDialog_v1(int buildingPtr, int stringBuffer, DWORD renderContext)
{
  ...
  if ( spriteSet )
    spriteSet = DLXSpriteSet_Load(spriteSet, (const void*)(intptr_t)((char)(intptr_t)spriteSet));
  ...
  UI_DrawTextFmt(renderSurface, 193, 439, 80, 3, (const char*)(intptr_t)((int)(intptr_t)aS_6));
...
int  Building_ShowGateDoorDialog_v2(int buildingPtr, int a2, DWORD renderContext)
{
  ...
  g_RenderDevice = (_UNKNOWN *)(uintptr_t)g_PrimaryRenderSurface;
  Render_ReleaseSurface(8, renderContext);
  UI_DrawTextFmt(renderSurface, 193, 439, 80, 3, (const char*)(intptr_t)((int)(intptr_t)aS_7));
  Render_ReleaseSurface(10, renderContext);
  UI_DrawFormattedTokenLine(95, v15, v16, 140);
...
int  Building_ShowGateDoorDialog_v3(int buildingPtr, int objectArray, DWORD renderContext)
{
  ...
  g_RenderDevice = (_UNKNOWN *)(uintptr_t)g_PrimaryRenderSurface;
  Render_ReleaseSurface(8, renderContext);
  UI_DrawTextFmt(renderSurface, 193, 439, 80, 3, (const char*)(intptr_t)((int)(intptr_t)aS_8));
  Render_ReleaseSurface(10, renderContext);
  UI_DrawFormattedTokenLine(95, v15, v16, 140);
...
int  Building_ShowGateDoorDialog_v4(int buildingPtr, int ctorArrayBuffer, DWORD renderContext)
{
  ...
  g_RenderDevice = (_UNKNOWN *)(uintptr_t)g_PrimaryRenderSurface;
  Render_ReleaseSurface(8, renderContext);
  UI_DrawTextFmt(renderSurface, 193, 439, 80, 3, (const char*)(intptr_t)((int)(intptr_t)aS_9));
  Render_ReleaseSurface(10, renderContext);
  UI_DrawFormattedTokenLine(95, v15, v16, 140);
...
signed int  Building_UnitsLeave(unsigned __int8 *building, int *exitSlots, double gameTime)
{
  ...
  Unit_Create((unit_type)(unsigned int)(0xFFFFFFFF), building[2], spawnX, facing, spawnY);

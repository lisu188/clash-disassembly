...
//----- (00434760) --------------------------------------------------------
unsigned int __thiscall CastleProduction_AnimateSelectedUnitPortrait(void *this_)
{
  unsigned int result; // eax
  unsigned int v2; // edx
  int v3; // ecx

  result = Time_Now((int)(intptr_t)this_, g_CastleProductionPortraitAnimLastTickMs + 10);
  if ( v2 <= result )
  {
...
void * CastleProduction_RedrawSelectedUnitPanel(int a1, int a2, DWORD renderContext, int a4, int a5)
{
  ...
  while ( stripUnitIndex <= g_CastleProductionSelectedAvailableUnitIndex + 2 )
  {
    ...
    {
      if ( Building_HasUnitLicence(g_CastleProductionBuildingPtr, (unit_type)(unsigned int)(unitType)) )
      {
  ...
  UI_DrawTextFmt(69, 229, 260, v27, 2, (const char*)(intptr_t)((int)(intptr_t)a0_3));
...
void * CastleProduction_TickLicenceGridAnimations(int a1, DWORD gameContext)
{
  ...
  if ( v3 <= (unsigned int)(intptr_t)result )
  {
    ...
    if ( (g_LicenceGridAddAnimSlotIndex != -1 || g_CastleLicenceRemovalSlotIndex != -1) && ++g_CastleProductionLicenceTransitionFrame == 8 )
    {
      ...
      {
        Building_RemoveUnitLicence(g_CastleProductionBuildingPtr, (unit_type)(unsigned int)(*(char *)(uintptr_t)(g_CastleLicenceRemovalSlotIndex + g_CastleProductionBuildingPtr + 402)), gameContext);
...
int  CastleProduction_DrawProductionStatus(DWORD renderContext)
{
  ...
  if ( BUILDING_ACTIVE_PRODUCTION_LICENCE_SLOT_INDEX(g_CastleProductionBuildingPtr) != -1 )
  {
    if ( Building_CountGarrison(g_CastleProductionBuildingPtr) < 12 || BUILDING_PRODUCTION_TURNS_REMAINING(g_CastleProductionBuildingPtr) > 1 )
    {
      ...
      v11 = turnLabelText;
      UI_DrawTextFmt((int)(intptr_t)v6, 401, 593, 297, 3, (const char*)(intptr_t)(statusHeader_Strings[(unsigned __int8)g_LanguageIndex]));
      statusLine1 = statusLine1_Strings[(unsigned __int8)g_LanguageIndex];
      UI_DrawTextFmt(statusLine1, 401, 593, 317, 3, (const char*)(intptr_t)(statusLine1));
      turnsRemaining = BUILDING_PRODUCTION_TURNS_REMAINING(g_CastleProductionBuildingPtr);
      if ( turnsRemaining == 1 )
      {
        return UI_DrawTextFmt(statusLine1, 401, 593, 337, 3, (const char*)(intptr_t)(statusDetailB_Strings[(unsigned __int8)g_LanguageIndex]));
      }
      else if ( turnsRemaining < 2 || turnsRemaining > 4 )
      {
        return UI_DrawTextFmt(statusLine1, 401, 593, 337, 3, (const char*)(intptr_t)(statusDetailA_Strings[(unsigned __int8)g_LanguageIndex]));
      }
      else
      {
        return UI_DrawTextFmt(statusLine1, 401, 593, 337, 3, (const char*)(intptr_t)(statusDetailC_Strings[(unsigned __int8)g_LanguageIndex]));
      }
    }
    else
    {
      ...
      UI_DrawTextFmt((int)(intptr_t)statusLine1_Strings, 401, 593, 307, 3, (const char*)(intptr_t)(statusHeaderFull_Strings[(unsigned __int8)g_LanguageIndex]));
      return UI_DrawTextFmt((int)(intptr_t)statusLine1_Strings, 401, 593, 327, 3, (const char*)(intptr_t)(v6[(unsigned __int8)g_LanguageIndex]));
    }
  }
  return result;
}
...
int  UI_DrawActionBox(int drawContext)
{
  ...
  result = UI_DrawTextFmt(drawContext, 285, 349, 430, 3, (const char*)(intptr_t)((int)(intptr_t)aD_38));
  g_RenderDevice = (_UNKNOWN*)(savedRenderDevice);
  return result;
}
// 511230: using guessed type _UNKNOWN *g_RenderDevice;
...
//----- (004359B0) --------------------------------------------------------
BOOL __thiscall CastleProduction_RebuildAvailableUnitList(void *this_)
{
  int out_index; // ebx
  ...
  do
  {
    ...
    unitType = (unit_type)((unsigned int)unitType + 1);
  }
...
int  BuildingTransferDialog_DrawSourceRemainingValue(DWORD renderContext, int drawContext)
{
  ...
  result = UI_DrawTextFmt(drawContext, 347, 445, 48, 3, (const char*)(intptr_t)((int)(intptr_t)aD_39));
  g_RenderDevice = (_UNKNOWN*)(savedRenderDevice);
  return result;
}
...
int  BuildingTransferDialog_DrawTransferAmountValue(DWORD renderContext, int drawContext)
{
  ...
  result = UI_DrawTextFmt(drawContext, 548, 601, 272, 3, (const char*)(intptr_t)((int)(intptr_t)aD_40));
  g_RenderDevice = (_UNKNOWN*)(savedRenderDevice);
  return result;
}

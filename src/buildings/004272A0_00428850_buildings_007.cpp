...
signed int  UnitBattle_Attack(int attacker_index, int defender_index, int charge_mode)
{
  ...
  if ( delta_x > 1 || delta_y > 1 )
  {
    ...
    *(_DWORD *)((char *)attacker_unit + 23) = (_DWORD)(uintptr_t)(move_track);
  ...
  *(unsigned char *)((char *)attacker_unit + 22) &= 0xFEu;
  ...
  UnitBattle_CalcMeleeExchange(attacker_index, defender_index, &defender_remaining, (_DWORD*)(&attacker_remaining), charge_mode);

...
#include "00422100_00422AC0_buildings_004_local.h"
...
{
  static const char sound_large[] CLASH95_LOCAL_DATA_SYMBOL("sound_large.41", "BuildingGarrisonDialog_EnsureActionWidgets.sound_large") = "duze";
  static const char text_back_pl[] CLASH95_LOCAL_DATA_SYMBOL("text_back_pl.44", "BuildingGarrisonDialog_EnsureActionWidgets.text_back_pl") = "Koniec";
  static const char text_back_en[] CLASH95_LOCAL_DATA_SYMBOL("text_back_en.43", "BuildingGarrisonDialog_EnsureActionWidgets.text_back_en") = "Back";
  static const char text_back_de[] CLASH95_LOCAL_DATA_SYMBOL("text_back_de.42", "BuildingGarrisonDialog_EnsureActionWidgets.text_back_de") = "Zuruck";
  static const char text_production_pl[] CLASH95_LOCAL_DATA_SYMBOL("text_production_pl.40", "BuildingGarrisonDialog_EnsureActionWidgets.text_production_pl") = "Produkcja";
  static const char text_production_en[] CLASH95_LOCAL_DATA_SYMBOL("text_production_en.39", "BuildingGarrisonDialog_EnsureActionWidgets.text_production_en") = "Production";
  static const char text_production_de[] CLASH95_LOCAL_DATA_SYMBOL("text_production_de.38", "BuildingGarrisonDialog_EnsureActionWidgets.text_production_de") = "Produzieren";
  static const char text_cure_pl[] CLASH95_LOCAL_DATA_SYMBOL("text_cure_pl.37", "BuildingGarrisonDialog_EnsureActionWidgets.text_cure_pl") = "Leczenie";
  static const char text_cure_en[] CLASH95_LOCAL_DATA_SYMBOL("text_cure_en.36", "BuildingGarrisonDialog_EnsureActionWidgets.text_cure_en") = "Cure";
  static const char text_cure_de[] CLASH95_LOCAL_DATA_SYMBOL("text_cure_de.35", "BuildingGarrisonDialog_EnsureActionWidgets.text_cure_de") = "Heilung";
  static const char text_training_pl[] CLASH95_LOCAL_DATA_SYMBOL("text_training_pl.34", "BuildingGarrisonDialog_EnsureActionWidgets.text_training_pl") = "Trening";
  static const char text_training_en[] CLASH95_LOCAL_DATA_SYMBOL("text_training_en.33", "BuildingGarrisonDialog_EnsureActionWidgets.text_training_en") = "Training";
  static const char text_training_de[] CLASH95_LOCAL_DATA_SYMBOL("text_training_de.32", "BuildingGarrisonDialog_EnsureActionWidgets.text_training_de") = "Training";
  static const char text_leave_pl[] CLASH95_LOCAL_DATA_SYMBOL("text_leave_pl.31", "BuildingGarrisonDialog_EnsureActionWidgets.text_leave_pl") = "Opusc koszary";
  static const char text_leave_en[] CLASH95_LOCAL_DATA_SYMBOL("text_leave_en.30", "BuildingGarrisonDialog_EnsureActionWidgets.text_leave_en") = "Leave barracks";
  static const char text_leave_de[] CLASH95_LOCAL_DATA_SYMBOL("text_leave_de.29", "BuildingGarrisonDialog_EnsureActionWidgets.text_leave_de") = "Kaserne verlassen";
  int addon_flags;
  ...
  BuildingGarrisonDialog_WriteActionWidgetRecord(
    ...
    0,
    1,
    (void*)(BuildingGarrisonDialog_RequestClose),
    text_back_pl,
    text_back_en,
    text_back_de,
    sound_large);
  BuildingGarrisonDialog_WriteActionWidgetRecord(
    ...
    2,
    3,
    (void*)(BuildingGarrisonDialog_ShowProductionDialog),
    text_production_pl,
    text_production_en,
    text_production_de,
    sound_large);
  BuildingGarrisonDialog_WriteActionWidgetRecord(
    ...
    4,
    5,
    (void*)(BuildingGarrisonDialog_ToggleRepairSelectedUnits),
    text_cure_pl,
    text_cure_en,
    text_cure_de,
    sound_large);
  BuildingGarrisonDialog_WriteActionWidgetRecord(
    ...
    6,
    7,
    (void*)(BuildingGarrisonDialog_ToggleTrainingSelectedUnits),
    text_training_pl,
    text_training_en,
    text_training_de,
    sound_large);
  BuildingGarrisonDialog_WriteActionWidgetRecord(
    ...
    8,
    9,
    (void*)(BuildingGarrisonDialog_BeginSelectedUnitsExit),
    text_leave_pl,
    text_leave_en,
    text_leave_de,
    sound_large);
...
CLASH95_LOCAL int BuildingGarrisonDialog_Run(int building_record, int callback_context, DWORD runtime_context)
{
  static const char castle_chr_dw12_s32[] CLASH95_LOCAL_DATA_SYMBOL("castle_chr_dw12_s32.28", "BuildingGarrisonDialog_Run.castle_chr_dw12_s32") = "castle.chr\\dw_12.s32";
  static const char castle_pog_dw12_s32[] CLASH95_LOCAL_DATA_SYMBOL("castle_pog_dw12_s32.27", "BuildingGarrisonDialog_Run.castle_pog_dw12_s32") = "castle.pog\\dw_12.s32";
      ...
      if ( selected_count < 10 || g_BuildingGarrisonDialogSelectedSlots[slot_index] )
      {
        ...
        if ( Diagnostics_IsWorldMapClickTraceEnabled() )
          fprintf(
            ...
            g_BuildingGarrisonDialogSelectedSlots[slot_index],
            selected_count);
        Audio_PlaySoundEffectByName((char*)("marker"), 64);
...
CLASH95_LOCAL void Diagnostics_ResetFrameDumpOnCastleReturn(void)
{
  static int checked CLASH95_LOCAL_DATA_SYMBOL("checked.26", "Diagnostics_ResetFrameDumpOnCastleReturn.checked");
  static int enabled CLASH95_LOCAL_DATA_SYMBOL("enabled.25", "Diagnostics_ResetFrameDumpOnCastleReturn.enabled");
  const char *value;
...
CLASH95_LOCAL void Diagnostics_ResetFrameDumpOnCastleEnter(void)
{
  static int checked CLASH95_LOCAL_DATA_SYMBOL("checked.24", "Diagnostics_ResetFrameDumpOnCastleEnter.checked");
  static int enabled CLASH95_LOCAL_DATA_SYMBOL("enabled.23", "Diagnostics_ResetFrameDumpOnCastleEnter.enabled");
  const char *value;
...
{
  static int checked CLASH95_LOCAL_DATA_SYMBOL("checked.22", "Diagnostics_ResetFrameDumpOnEconomyEnter.checked");
  static int enabled CLASH95_LOCAL_DATA_SYMBOL("enabled.21", "Diagnostics_ResetFrameDumpOnEconomyEnter.enabled");
  const char *value;
...
CLASH95_LOCAL void Diagnostics_ResetFrameDumpOnBarracksEnter(void)
{
  static int checked CLASH95_LOCAL_DATA_SYMBOL("checked.20", "Diagnostics_ResetFrameDumpOnBarracksEnter.checked");
  static int enabled CLASH95_LOCAL_DATA_SYMBOL("enabled.19", "Diagnostics_ResetFrameDumpOnBarracksEnter.enabled");
  const char *value;
...
CLASH95_LOCAL void Diagnostics_ResetFrameDumpOnBarracksDetail(void)
{
  static int checked CLASH95_LOCAL_DATA_SYMBOL("checked.18", "Diagnostics_ResetFrameDumpOnBarracksDetail.checked");
  static int enabled CLASH95_LOCAL_DATA_SYMBOL("enabled.17", "Diagnostics_ResetFrameDumpOnBarracksDetail.enabled");
  const char *value;
...
{
  static int checked CLASH95_LOCAL_DATA_SYMBOL("checked.16", "Diagnostics_ResetFrameDumpOnBattleEnter.checked");
  static int enabled CLASH95_LOCAL_DATA_SYMBOL("enabled.15", "Diagnostics_ResetFrameDumpOnBattleEnter.enabled");
  const char *value;
...
{
  static int checked CLASH95_LOCAL_DATA_SYMBOL("checked.14", "Diagnostics_PrimeBattleSafeCursorOnTurnLoop.checked");
  static int enabled CLASH95_LOCAL_DATA_SYMBOL("enabled.13", "Diagnostics_PrimeBattleSafeCursorOnTurnLoop.enabled");
  const char *value;
...
{
  static int checked CLASH95_LOCAL_DATA_SYMBOL("checked.12", "Diagnostics_IsBattleTileDrawTraceEnabled.checked");
  static int enabled CLASH95_LOCAL_DATA_SYMBOL("enabled.11", "Diagnostics_IsBattleTileDrawTraceEnabled.enabled");
  const char *value;
...
{
  static int checked CLASH95_LOCAL_DATA_SYMBOL("checked.10", "Diagnostics_IsWorldMapClickTraceEnabled.checked");
  static int enabled CLASH95_LOCAL_DATA_SYMBOL("enabled.9", "Diagnostics_IsWorldMapClickTraceEnabled.enabled");
  const char *value;
...
CLASH95_TEST_VISIBLE int Diagnostics_IsWorldMapActionVerbose(void)
{
  static int checked CLASH95_LOCAL_DATA_SYMBOL("checked.8", "Diagnostics_IsWorldMapActionVerbose.checked");
  static int enabled CLASH95_LOCAL_DATA_SYMBOL("enabled.7", "Diagnostics_IsWorldMapActionVerbose.enabled");
  const char *value;
...
CLASH95_TEST_VISIBLE int Diagnostics_ShouldTraceWorldMapActionStage(const char *stage)
{
  static unsigned int battle_input_loop_count CLASH95_LOCAL_DATA_SYMBOL("battle_input_loop_count.6", "Diagnostics_ShouldTraceWorldMapActionStage.battle_input_loop_count");
  static unsigned int battle_move_preview_count CLASH95_LOCAL_DATA_SYMBOL("battle_move_preview_count.5", "Diagnostics_ShouldTraceWorldMapActionStage.battle_move_preview_count");
...
CLASH95_INTERNAL void Diagnostics_TraceWorldMapCursorSample(
        ...
        int selected_unit_index)
{
  static int initialized CLASH95_LOCAL_DATA_SYMBOL("initialized.4", "Diagnostics_TraceWorldMapCursorSample.initialized");
  static int last_cursor_x CLASH95_LOCAL_DATA_SYMBOL("last_cursor_x.3", "Diagnostics_TraceWorldMapCursorSample.last_cursor_x");
  static int last_cursor_y CLASH95_LOCAL_DATA_SYMBOL("last_cursor_y.2", "Diagnostics_TraceWorldMapCursorSample.last_cursor_y");
  static int last_flipping CLASH95_LOCAL_DATA_SYMBOL("last_flipping.1", "Diagnostics_TraceWorldMapCursorSample.last_flipping");
  static int last_lost CLASH95_LOCAL_DATA_SYMBOL("last_lost.0", "Diagnostics_TraceWorldMapCursorSample.last_lost");
  int cursor_x;
  int cursor_y;
  int flipping;
  int lost;
...
int * Castle_OpenManagementScreen(DWORD buildingIndex, char a2)
{
  ...
  int (*savedRenderHook)(int, char, DWORD); // [esp+18h] [ebp-20h]
  ...
  g_RenderHook = Compat_CastleRenderHook;
  ...
  while ( !Input_IsKeyPressed(1) && !g_CastleScreenExitRequested )
  {
    ...
    if ( DD_IsFlipping((int)(intptr_t)g_RenderState) && castle_panel_callback )
    {
      ...
      g_RenderHook = (int (*)(int, char, DWORD))v22;

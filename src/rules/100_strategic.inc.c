...
LABEL_2:
  ...
  v7 = 0;
LABEL_10:
  if ( (unsigned int)*(__int16 *)(gameData + 725 * v7 + 147180) <= 0x28
    && *(unsigned __int8 *)(725 * v7 + gameData + 147178) == a1 )
  {
...
LABEL_2:
    ...
    || *(unsigned __int8 *)(v7 + 509676) != v4 )
  {
    ...
    v8 = 0;
LABEL_10:
    if ( (unsigned int)*(__int16 *)(725 * v8 + gameData + 147174 + 6) > 0x28
      || *(unsigned __int8 *)(gameData + 725 * v8 + 147178) != v4
...
int  Player_CheckForDefeatAndHandleElimination(int a1, DWORD a2)
{
  ...
  v3 = 0;
LABEL_2:
  if ( (unsigned int)*(__int16 *)(gameData + 725 * v3 + 147180) <= 0x28 )
  {
    v4 = *(unsigned __int8 *)(gameData + 725 * v3 + 147178);
    if ( v4 == a1 )
      return a1 ^ v4;
  }
  while ( ++v3 < 500 )
...
signed int  Player_CheckSoleSurvivorAndShowVictoryBanner(int a1)
{
  ...
  while ( !*(_DWORD *)(gameData + v2 + 140024) || v2 == v3 )
  {
    ...
    if ( v2 >= 7115 )
    {
      Render_Pump();
      Audio_StopMainMusic();
      Palette_FadeOutToBlack((int *)&unk_51D4C0, v4);
      g_RenderDevice = &unk_51D4C0;
      (*(void (**)(void))(dword_51D578 + 56))();
...
int  Options_RunInGameSettingsDialog(int a1, char a2, DWORD a3)
{
  ...
  dword_544540 = (int)v4;
  v5 = Render_SetResourceHandle((int)&unk_51D4C0, 1);
  ...
  *(_WORD *)v8 = *(_WORD *)v9;
  ...
  g_RenderDevice = &unk_51D4C0;
  SpriteForChar = DLX_GetSpriteForChar(dword_544540, (unsigned __int8)g_LanguageIndex);
  ...
  *(_BYTE *)(gameData + 147172) = (unsigned __int16)(16 * g_OptionsInGameSoundVolumeRaw
  ...
  g_RenderHook = v25;
  Render_SetResourceHandle((int)&unk_51D4C0, v5);
  WorldMap_RedrawViewport(1);
  return DLXSpriteSet_ReleaseAndClear(&dword_544540);
}
...
int  Cheat_KillUnitOrBuildingUnderCursor(DWORD a1, double a2)
{
  ...
  {
    if ( v3 > 0x1F4 || (unsigned int)*(__int16 *)(gameData + 725 * v3 + 147180) > 0x28 )
    {
...
int  Cheat_ShowDeveloperTeamImage(DWORD a1)
{
  ...
  (*(void (**)(void))(v7[46] + 36))();
  Palette_FadeInFromBlack((int *)&unk_51D4C0, v5, 20);
...
LABEL_2:
  ...
  dword_544554 = (int)Rules_Log(v21, 0, v11);
  v13 = 0;
  v14 = 0;
LABEL_11:
  v15 = UNIT_RECORD(v14);
  ...
  dword_544558 = (int)Rules_Log(v21, 0, v17);
  ...
  Diagnostics_TraceWorldMapActionEvent("ai_turn_after_agenda", g_SelectedUnitIndex, g_CurrentPlayerIndex, dword_54454C, dword_544558);
  Rules_RetractFact(dword_54454C, 0.0);
  Rules_RetractFact(dword_544550, 0.0);
  Rules_RetractFact(dword_544554, 0.0);
  Diagnostics_TraceWorldMapActionEvent("ai_turn_before_cleanup_last_fact", g_SelectedUnitIndex, g_CurrentPlayerIndex, dword_544558, 0);
  return Rules_RetractFact(dword_544558, 0.0);
}
...
signed int Rules_RegisterStrategicActionHostFunctions()
{
  ...
  Rules_RegisterHostFunction(aSwiatynia, 105, (int)aSwiatynia00, (int)&loc_452753, (int)a22i_1);
  Rules_RegisterHostFunction(aKop_skarb, 105, (int)aKop_skarb00, (int)&loc_45279F, (int)a11i);
  ...
  Rules_RegisterHostFunction(aJest_droga, 98, (int)aJest_droga00, (int)&loc_4528AB, (int)a33i);
  Rules_RegisterHostFunction(aJest_droga_w_0, 98, (int)aJest_droga_w_p, (int)&loc_452907, (int)a33i);
  Rules_RegisterHostFunction(aJest_droga_w_2, 98, (int)aJest_droga_w_1, (int)&loc_452963, (int)a33i);
  Rules_RegisterHostFunction(aJest_droga_d_0, 98, (int)aJest_droga_do_, (int)&loc_4529BF, (int)a33i);
  Rules_RegisterHostFunction(aJest_droga_d_2, 98, (int)aJest_droga_d_1, (int)&loc_452A1B, (int)a33i);
  Rules_RegisterHostFunction(aJest_droga_d_4, 98, (int)aJest_droga_d_3, (int)&loc_452A77, (int)a33i);
  Rules_RegisterHostFunction(aOddzial_w_za_1, 98, (int)aOddzial_w_za_0, (int)&loc_452AD3, (int)a33i);
  Rules_RegisterHostFunction(aBudowla_w_za_0, 98, (int)aBudowla_w_zasi, (int)&loc_452B2F, (int)a33i);
  Rules_RegisterHostFunction(aOdleglosc_od_0, 105, (int)aOdleglosc_od_o, (int)&loc_452B8B, (int)a33i);
  Rules_RegisterHostFunction(aSwiatynia_w__0, 98, (int)aSwiatynia_w_za, (int)&loc_452BE7, (int)a33i);
  Rules_RegisterHostFunction(aSwiatynia_ok, 98, (int)aSwiatynia_ok00, (int)&loc_452C43, (int)a33i);
  Rules_RegisterHostFunction(aMaszeruj, 105, (int)aMaszeruj00, (int)&loc_452C9F, (int)a33i);
  Rules_RegisterHostFunction(aMaszeruj_do__0, 105, (int)aMaszeruj_do_sw, (int)&loc_452CFB, (int)a33i);
  Rules_RegisterHostFunction(aMaszeruj_bli_0, 105, (int)aMaszeruj_blisk, (int)&loc_452D57, (int)a33i);
  Rules_RegisterHostFunction(aAtakuj_oddzi_0, 105, (int)aAtakuj_oddzial, (int)&loc_452DB3, (int)a22i_1);
  Rules_RegisterHostFunction(aPrzejmuj_odd_0, 105, (int)aPrzejmuj_oddzi, (int)&loc_452DFF, (int)a22i_1);
  Rules_RegisterHostFunction(aUkryj_oddzial, 105, (int)aUkryj_oddzial0, (int)&loc_452E4B, (int)a33i);
  Rules_RegisterHostFunction(aJest_armia, 98, (int)aJest_armia00, (int)&loc_452EA7, (int)a11i);
  Rules_RegisterHostFunction(aLiczba_jedno_0, 105, (int)aLiczba_jednost, (int)&loc_452EE3, (int)a11i);
  Rules_RegisterHostFunction(aAtakuj_budow_0, 105, (int)aAtakuj_budowle, (int)&loc_452F1F, (int)a22i_1);
  Rules_RegisterHostFunction(aJest_brod, 98, (int)aJest_brod00, (int)&loc_452F6B, (int)a11i);
  Rules_RegisterHostFunction(aBuduj_droge, 98, (int)aBuduj_droge00, (int)&loc_452FA7, (int)a11i);
  Rules_RegisterHostFunction(aBuduj_pulapke, 105, (int)aBuduj_pulapke0, (int)&loc_452FE3, (int)a33i);
  return Rules_RegisterHostFunction(aUnit_canmove, 105, (int)aUnit_canmove00, (int)&loc_45303F, (int)a11i);
}
// 47C181: using guessed type _DWORD __stdcall sub_47C181(_DWORD);
...
signed int  Rules_QueuePathToTile(int a1, int a2, int a3, DWORD a4)
{
  ...
  if ( *(_DWORD *)(gameData + 725 * a1 + 147490) )
  {
    v10 = *(_DWORD *)(gameData + 147174 + 725 * a1 + 320);
  ...
  v6 = Unit_MoveTrack(
         a1,
         *(__int16 *)(gameData + 725 * a1 + 147174),
         v5,
         *(__int16 *)(gameData + 725 * a1 + 147176),
         a4,
         a3);
  Pathing_DisableBridgeCrossings(v7, (char)v6, a4);
  if ( !v8 )
    return 0;
  if ( *(_DWORD *)(725 * a1 + gameData + 147490) )
    *(_DWORD *)(gameData + 725 * a1 + 147490) = 0;
  qmemcpy((void *)(gameData + 147174 + 725 * a1 + 316), v6, 0x194u);
  j__nfree_();
  return 1;
}
...
signed int  Rules_QueuePathNearTile(int a1, int a2, int a3, DWORD a4)
{
  ...
  if ( *(_DWORD *)(gameData + 147174 + 725 * v6 + 316) )
  {
    v13 = *(_DWORD *)(725 * v5 + gameData + 147174 + 320);
  ...
  if ( v11 )
  {
    if ( *(_DWORD *)(gameData + 725 * v10 + 147490) )
      *(_DWORD *)(gameData + 725 * v10 + 147490) = 0;
    qmemcpy((void *)(gameData + 147174 + 725 * v10 + 316), v8, 0x194u);
    j__nfree_();
    return 1;
  }
  return 0;
...
signed int  Rules_QueuePathNearCastle(int a1, int a2, int a3, DWORD a4)
{
  ...
  if ( *(_DWORD *)(gameData + 725 * a1 + 147490) )
  {
    v11 = *(_DWORD *)(gameData + 147174 + 725 * a1 + 320);
  ...
  if ( v9 )
  {
    if ( *(_DWORD *)(gameData + 725 * v8 + 147490) )
      *(_DWORD *)(gameData + 725 * v8 + 147490) = 0;
    qmemcpy((void *)(725 * v8 + gameData + 147174 + 316), v6, 0x194u);
    j__nfree_();
    return 1;
  }
  return 0;
...
signed int  Rules_QueuePathToPort(int a1, int a2, int a3, DWORD a4)
{
  ...
  if ( *(_DWORD *)(gameData + 725 * a1 + 147490) )
  {
    a3 = *(_DWORD *)(gameData + 147174 + 725 * a1 + 320);
  ...
  if ( !v9 )
    return 0;
  if ( *(_DWORD *)(gameData + 147174 + 725 * v8 + 316) )
    *(_DWORD *)(gameData + 725 * v8 + 147490) = 0;
  qmemcpy((void *)(725 * v8 + gameData + 147174 + 316), v6, 0x194u);
  j__nfree_();
  return 1;
...
signed int  Move_IsAtTargetOrCanStay(int a1, int a2, int a3)
{
  ...
  if ( *(_DWORD *)(gameData + 725 * a1 + 147490) )
  {
    v5 = *(_DWORD *)(725 * a1 + gameData + 147174 + 320);
  ...
  if ( result )
  {
    if ( *(_DWORD *)(gameData + 147174 + 725 * v4 + 316) )
      *(_DWORD *)(gameData + 725 * v4 + 147490) = 0;
    qmemcpy((void *)(725 * v4 + gameData + 147174 + 316), (const void *)result, 0x194u);
    j__nfree_();
    return 1;
  }
  return result;
...
signed int  Move_TryApproachTarget(int a1, DWORD a2, int a3)
{
  ...
  if ( *(_DWORD *)(gameData + 725 * a1 + 147490)
    && (v11 = *(_DWORD *)(725 * a1 + gameData + 147174 + 320), (int)abs32(a2 - (unsigned __int8)v11) <= 2)
    && (int)abs32(a3 - BYTE1(v11)) <= 2 )
  {
    v6 = UnitStack_GetMinCurrentActionPoints(725 * a1 + gameData + 147174);
    return v6 >= v7;
  }
  else
  {
    ...
    if ( result )
    {
      ...
      if ( UnitStack_GetMinCurrentActionPoints(725 * v4 + gameData + 147174) < v9 )
      {
        j__nfree_();
        return 0;
      }
      else
      {
        if ( *(_DWORD *)(v8 + gameData + 147490) )
          *(_DWORD *)(725 * v10 + gameData + 147174 + 316) = 0;
        qmemcpy((void *)(725 * v10 + gameData + 147174 + 316), v5, 0x194u);
        j__nfree_();
        return 1;
      }
    }
...
signed int  Rules_QueuePathIntoArmyRange(int a1, int a2, int a3, DWORD a4)
{
  ...
  if ( *(_DWORD *)(gameData + 725 * v6 + 147490)
    && (a4 = 725 * v5, v15 = *(_DWORD *)(gameData + 147174 + 725 * v5 + 320), (int)abs32(a2 - (unsigned __int8)v15) <= 1)
    && (int)abs32(a3 - BYTE1(v15)) <= 1 )
  {
    v10 = UnitStack_GetMinCurrentActionPoints(a4 + gameData + 147174);
    return v10 >= v11;
  }
  else
  {
    ...
    if ( result )
    {
      ...
      if ( UnitStack_GetMinCurrentActionPoints(725 * v8 + gameData + 147174) < v13 )
      {
        j__nfree_();
        return 0;
      }
      else
      {
        if ( *(_DWORD *)(v12 + gameData + 147490) )
          *(_DWORD *)(gameData + 725 * v14 + 147490) = 0;
        qmemcpy((void *)(gameData + 147174 + 725 * v14 + 316), v9, 0x194u);
        j__nfree_();
        return 1;
      }
    }
...
signed int  Rules_GetPathDistanceToObject(int a1, int a2, int a3, DWORD a4)
{
  ...
  {
    a4 = gameData;
    v12 = *(_DWORD *)(725 * a1 + gameData + 147174 + 320);
    if ( (int)abs32(v5 - (unsigned __int8)v12) <= 1 && (int)abs32(a3 - BYTE1(v12)) <= 1 )
      return *(_DWORD *)(725 * a1 + gameData + 147490);
  }
...
BOOL  Rules_IsTempleWithinArmyRange(int a1, int a2, int a3)
{
  ...
  if ( *(_DWORD *)(gameData + 725 * a1 + 147490) )
  {
    v8 = *(_DWORD *)(gameData + 147174 + 725 * a1 + 320);
  ...
  if ( !*(_DWORD *)(gameData + 725 * a1 + 147490) )
  {
    ...
    if ( Track )
    {
      qmemcpy((void *)(725 * a1 + gameData + 147174 + 316), Track, 0x194u);
      j__nfree_();
    }
  }
  result = 0;
  if ( *(_DWORD *)(725 * a1 + gameData + 147174 + 316) )
  {
    v6 = UnitStack_GetMinCurrentActionPoints(gameData + 147174 + 725 * a1);
    if ( v6 >= v7 )
      return 1;
  }
  return result;
...
signed int  Rules_MarchToTemple(unsigned int a1, int a2, int a3, double a4)
{
  ...
  if ( *(_DWORD *)(gameData + 725 * a1 + 147490) )
  {
    v15 = *(_DWORD *)(gameData + 147174 + 725 * a1 + 320);
  ...
  if ( !*(_DWORD *)(gameData + 725 * a1 + 147490) )
  {
    ...
    if ( Track )
    {
      qmemcpy((void *)(gameData + 147174 + 725 * a1 + 316), Track, 0x194u);
      j__nfree_();
    }
  }
  if ( !*(_DWORD *)(gameData + 725 * a1 + 147490) )
...
signed int  Rules_MarchNearTile(DWORD a1, int a2, int a3, double a4)
{
  ...
  if ( *(_DWORD *)(gameData + 725 * v6 + 147490) )
  {
    v16 = *(_DWORD *)(gameData + 147174 + 725 * a1 + 320);
  ...
  if ( !*(_DWORD *)(gameData + 725 * a1 + 147490) )
  {
    ...
    if ( v7 )
    {
      qmemcpy((void *)(gameData + 147174 + 725 * a1 + 316), v7, 0x194u);
      j__nfree_();
    }
  }
  if ( !*(_DWORD *)(gameData + 725 * a1 + 147490) )
  ...
  {
    v13 = 725 * a1;
    if ( v10 == *(__int16 *)(gameData + v13 + 147174) && v11 == *(__int16 *)(gameData + v13 + 147176) )
    {
      v15[1] = 1;
      v15[2] = Rules_AddIntegerValue(0);
...
signed int  Rules_HostUnitMoveAndHide(unsigned int a1, unsigned int a2, DWORD a3, double a4)
{
  ...
  result = (signed int)Unit_MoveTrack(
                         a3,
                         *(__int16 *)(gameData + 725 * a3 + 147174),
                         a1,
                         *(__int16 *)(gameData + 725 * a3 + 147176),
                         a3,
                         a2);
  v7 = result;
  if ( result )
  {
    if ( *(_DWORD *)(v5 + gameData + 147490) )
      *(_DWORD *)(gameData + 725 * a3 + 147490) = 0;
    qmemcpy((void *)(725 * a3 + gameData + 147174 + 316), (const void *)result, 0x194u);
    j__nfree_();
...
signed int  Rules_IsQueuedPathTargetBridgeCrossing(int a1)
{
  ...
  result = Map_GetBridgeCrossingCostOrZero(
             (unsigned __int8)*(_DWORD *)(v2 + 725 * a1 + 4 * (*(_DWORD *)(v2 + 725 * a1 + 316) - 1) + 320),
             (unsigned __int8)BYTE1(*(_DWORD *)(v2 + 725 * a1 + 4 * (*(_DWORD *)(v2 + 725 * a1 + 316) - 1) + 320)));
  if ( result )
    return 1;
  return result;
}
...
int  Rules_BuildTrapNearTile(DWORD a1, int a2, DWORD a3, double a4)
{
  ...
  if ( result )
  {
    if ( *(_DWORD *)(gameData + 147174 + 725 * a3 + 316) )
      *(_DWORD *)(725 * a3 + gameData + 147174 + 316) = 0;
    qmemcpy((void *)(725 * a3 + gameData + 147174 + 316), (const void *)result, 0x194u);
    j__nfree_();
    UnitStack_ExecuteQueuedPath(a3, v9, v8, a3, a4);
    v10 = (int)(*(__int16 *)(725 * a3 + gameData + 147174) - a1);
    if ( (int)((HIDWORD(v10) ^ v10) - HIDWORD(v10)) >= 2 )
      return 0;
    v11 = *(__int16 *)(725 * a3 + gameData + 147176) - a2;
...
{
  CRT_ProbeStackFrame(36);
  Rules_RegisterHostFunction(aLeczenie, 118, (int)aLeczenie, (int)&loc_456706, (int)a11i_3);
  Rules_RegisterHostFunction(aSzkolenie, 118, (int)aSzkolenie, (int)&loc_456736, (int)a11i_3);
  Rules_RegisterHostFunction(aPalBudowle, 118, (int)aPalbudowle, (int)&loc_456766, (int)a11i_3);
  Rules_RegisterHostFunction(aUpgradeWall, 118, (int)aUpgradewall, (int)&loc_456796, (int)a11i_3);
  Rules_RegisterHostFunction(aZmienPodatek, 118, (int)aZmienpodatek, (int)&loc_4567C6, (int)a22iif);
  Rules_RegisterHostFunction(aRemoveLicence, 118, (int)aRemovelicence, (int)&loc_456806, (int)a22i);
  Rules_RegisterHostFunction(aZacznijLeczeni, 118, (int)aZacznijleczeni, (int)&loc_456842, (int)a22i);
  Rules_RegisterHostFunction(aZacznijSzkolen, 118, (int)aZacznijszkolen, (int)&loc_45687E, (int)a22i);
  Rules_RegisterHostFunction(aZacznijProdukc, 118, (int)aZacznijprodukc, (int)&loc_4568BA, (int)a22i);
  Rules_RegisterHostFunction(aKupSzkola, 98, (int)aKupszkola, (int)&loc_45696E, (int)a11i_3);
  Rules_RegisterHostFunction(aKupKuznia, 98, (int)aKupkuznia, (int)&loc_4569A4, (int)a11i_3);
  Rules_RegisterHostFunction(aIsLicence, 98, (int)aIslicence, (int)&loc_45692C, (int)a22i);
  Rules_RegisterHostFunction(aBuyLicence, 98, (int)aBuylicence, (int)&loc_456B0D, (int)a22i);
  Rules_RegisterHostFunction(aKupSzpital, 98, (int)aKupszpital, (int)&loc_456B85, (int)a11i_3);
  Rules_RegisterHostFunction(aBudujZamek, 98, (int)aBudujzamek, (int)&loc_456AA8, (int)a55iiiiis);
  Rules_RegisterHostFunction(aKupKoszary, 98, (int)aKupkoszary, (int)&loc_456B4F, (int)a11i_3);
  Rules_RegisterHostFunction(aKupWarsztat, 98, (int)aKupwarsztat, (int)&loc_456C5D, (int)a11i_3);
  Rules_RegisterHostFunction(aIsProduction, 98, (int)aIsproduction, (int)&loc_456CC9, (int)a11i_3);
  Rules_RegisterHostFunction(aCzyMinimalny, 98, (int)aCzyminimalny, (int)&loc_456D35, (int)a44i);
  Rules_RegisterHostFunction(aCanBuyLicence, 98, (int)aCanbuylicence, (int)&loc_456D8F, (int)a22i);
  Rules_RegisterHostFunction(aIsProductionAn, 98, (int)aIsproductionan, (int)&loc_456EB5, (int)a22i);
  Rules_RegisterHostFunction(aMaxIloscOddzia, 98, (int)aMaxiloscoddzia, (int)&loc_456F87, (int)a11i_3);
  Rules_RegisterHostFunction(aJednostkiDoSzk, 98, (int)aJednostkidoszk, (int)&loc_456F51, (int)a11i_3);
  Rules_RegisterHostFunction(aJednostkiDoSzp, 98, (int)aJednostkidoszp, (int)&loc_456FFF, (int)a11i_3);
  Rules_RegisterHostFunction(aJestJednostkaW, 98, (int)aJestjednostkaw, (int)&loc_456FBD, (int)a22i);
  Rules_RegisterHostFunction(aPodatek, 105, (int)aPodatek, (int)&loc_4568F6, (int)a11i_3);
  Rules_RegisterHostFunction(aPieniadze, 105, (int)aPieniadze, (int)&loc_4569DA, (int)a11i_3);
  Rules_RegisterHostFunction(aSilaMurow, 105, (int)aSilamurow, (int)&loc_456A10, (int)a11i_3);
  Rules_RegisterHostFunction(aSilaZamku, 105, (int)aSilazamku, (int)&loc_456A46, (int)a11i_3);
  Rules_RegisterHostFunction(aNumerTury, 105, (int)aNumertury, (int)&loc_456A7C, (int)a00i_0);
  Rules_RegisterHostFunction(aPoziomTech, 105, (int)aPoziomtech, (int)&loc_456BBB, (int)a11i_3);
  Rules_RegisterHostFunction(aZadowolenie, 105, (int)aZadowolenie, (int)&loc_456C93, (int)a11i_3);
  Rules_RegisterHostFunction(aTypBudowli, 105, (int)aTypbudowli, (int)&loc_456BF1, (int)a11i_3);
  Rules_RegisterHostFunction(aSilaGracza, 105, (int)aSilagracza, (int)&loc_456C27, (int)a11i_3);
  Rules_RegisterHostFunction(aIloscChlopow, 105, (int)aIloscchlopow, (int)&loc_456CFF, (int)a11i_3);
  Rules_RegisterHostFunction(aLicencjaIndex, 105, (int)aLicencjaindex, (int)&loc_456DD1, (int)a22i);
  Rules_RegisterHostFunction(aLicencjaInd, 105, (int)aLicencjaind, (int)&loc_456E13, (int)a11i_3);
  Rules_RegisterHostFunction(aIloscOddzialow, 105, (int)aIloscoddzialow, (int)&loc_456E7F, (int)a11i_3);
  Rules_RegisterHostFunction(aCanUpgradeWall, 105, (int)aCanupgradewall, (int)&loc_456E49, (int)a11i_3);
  Rules_RegisterHostFunction(aWyprowadzChlop, 105, (int)aWyprowadzchlop, (int)&loc_456EF7, (int)a44i);
  Rules_RegisterHostFunction(aWyprowadzenieO, 105, (int)aWyprowadzenieo, (int)&loc_457035, (int)a22i);
  Rules_RegisterHostFunction(aWyprowadzeni_1, 105, (int)aWyprowadzeni_0, (int)&loc_457077, (int)a11i_3);
  return Rules_RegisterHostFunction(aNazwaZamku, 115, (int)aNazwazamku, (int)&loc_4570AD, (int)a11i_3);
}
// 47C181: using guessed type _DWORD __stdcall sub_47C181(_DWORD);
...
{
  CRT_ProbeStackFrame(36);
  Rules_RegisterHostFunction(aWejdzDoZamku, 98, (int)aWejdzdozamku, (int)&loc_457351, (int)a22i_0);
  Rules_RegisterHostFunction(aDolaczDoOddzia, 98, (int)aDolaczdoarmii, (int)&loc_457393, (int)a22i_0);
  Rules_RegisterHostFunction(aPrzegrupujOddz, 98, (int)aPrzegrupujarmi, (int)&loc_4573D5, (int)a22i_0);
  Rules_RegisterHostFunction(aPrzegrupujZame, 98, (int)aPrzegrupujzame, (int)&loc_457417, (int)a22i_0);
  Rules_RegisterHostFunction(aLiczbaWolnychM, 105, (int)aLiczbawolnychm, (int)&loc_45751F, (int)a11i_0);
  Rules_RegisterHostFunction(aZnajdzDrogeWPo, 98, (int)aZnajdzdrogewpo, (int)&loc_45758B, (int)a22i_0);
  Rules_RegisterHostFunction(aMocPrzeciwnika, 105, (int)aMocprzeciwnika, (int)&loc_457555, (int)a11i_0);
  Rules_RegisterHostFunction(aStanOsobArmii, 105, (int)aStanosobarmii, (int)&loc_457459, (int)a22i_0);
  Rules_RegisterHostFunction(aArmiaMaJednost, 98, (int)aArmiamajednost, (int)&loc_45749B, (int)a22i_0);
  Rules_RegisterHostFunction(aArmiaTylkoJedn, 98, (int)aArmiatylkojedn, (int)&Rules_HostArmyHasOnlyUnitType, (int)a22i_0);
  Rules_RegisterHostFunction(aMaJednostkiDoL, 98, (int)aMajednostkidol, (int)&loc_4575CD, (int)a11i_0);
  Rules_RegisterHostFunction(aZnajdzZamekDoL, 98, (int)aZnajdzzamekdol, (int)&loc_457603, (int)a11i_0);
  Rules_RegisterHostFunction(aIdzDoLeczenia, 98, (int)aIdzdoleczenia, (int)&loc_457639, (int)a11i_0);
  Rules_RegisterHostFunction(aJestZarazaWZam, 98, (int)aJestzarazawzam, (int)&loc_45766F, (int)a11i_0);
  Rules_RegisterHostFunction(aJestZarazaWOdd, 98, (int)aJestzarazawodd, (int)&loc_4576A5, (int)a11i_0);
  Rules_RegisterHostFunction(aOdlaczJednostk, 98, (int)aOdlaczjednostk, (int)&loc_4576DB, (int)a11i_0);
  Rules_RegisterHostFunction(aOdlaczJednos_0, 98, (int)aOdlaczjednos_0, (int)&loc_457711, (int)a22i_0);
  Rules_RegisterHostFunction(aMaszerujWzdluz, 98, (int)aMaszerujwzdluz, (int)&loc_457753, (int)a11i_0);
  return Rules_RegisterHostFunction(aZnajdzNajlepsz, 105, (int)aZnajdz_najleps, (int)&loc_457789, (int)a55i);
}
// 47C181: using guessed type _DWORD __stdcall sub_47C181(_DWORD);
...
signed int  UnitStack_HasUnitsNeedingHealing(int a1)
{
  ...
  v1 = 0;
  v2 = (__int16 *)(gameData + 147174 + 725 * a1 + 6);
  for ( i = 0; i < 10; ++i )
  {
    v4 = *v2;
    if ( v4 == -1 )
...
LABEL_2:
  ...
  if ( v5 < 4 && *(__int16 *)(v4 + 16) != -1 && (*(_DWORD *)(v11 + 416) & 1) == 1 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( v2 == -1 )
      {
        qmemcpy((void *)(725 * a1 + gameData + 147174 + 316), v6, 0x194u);
        v8 = HIWORD(v13);
      }
      else
      {
        if ( HIWORD(v13) >= v12 )
          goto LABEL_9;
        j__nfree_();
        qmemcpy((void *)(v9 + gameData + 147174 + 316), v7, 0x194u);
        v8 = HIWORD(v13);
      }
      v2 = v3;
      v12 = v8;
...
BOOL  UnitStack_ExecuteHealingPathAndCheckArrival(unsigned int a1, char a2, DWORD a3, double a4)
{
  ...
  return *(__int16 *)(gameData + 725 * v4 + 147180) == -1;
}
...
const void * UnitStack_MoveToBuildingAndCheckArrival(unsigned int a1, int a2, double a3)
{
  ...
  if ( !*(_DWORD *)(gameData + 725 * a1 + 147490)
    || (v7 = *(_DWORD *)(gameData + 147174 + 725 * a1 + 320), (int)abs32(v4 - (unsigned __int8)v7) >= 3)
    ...
    || __PAIR64__(v5, v4) == __PAIR64__(BYTE1(v7), (unsigned __int8)v7) )
  {
    ...
    if ( !result )
      return result;
    qmemcpy((void *)(gameData + 147174 + 725 * a1 + 316), result, 0x194u);
    j__nfree_();
  }
  UnitStack_ExecuteQueuedPath(a1, 1, a1, v5, a3);
  return (const void *)(*(__int16 *)(gameData + 725 * a1 + 147180) == -1);
}
...
int  UnitStack_QueuePathNearBuilding(int a1, int a2, char a3, DWORD a4)
{
  ...
  if ( result )
  {
    qmemcpy((void *)(725 * v5 + gameData + 147174 + 316), (const void *)result, 0x194u);
    j__nfree_();
    return 1;
  }
  return result;
  ...
  for ( i = 200 * (v2 - 1); v4 <= v9; i += 200 )
  {
    ...
    for ( j = 2 * v10; v5 <= v13; j += 2 )
    {
      if ( v4 >= 0
        ...
        && (unsigned int)*(__int16 *)(gameData + 147174 + 725 * *(unsigned __int16 *)(j + gameData + i + 556374) + 6) <= 0x28 )
      {
        v7 = 725 * *(unsigned __int16 *)(j + gameData + i + 556374);
        if ( *(_BYTE *)(gameData + v7 + 147178) != *(_BYTE *)(gameData + v12 + 509676)
          && UnitStack_CalcArmyFactStrength(gameData + 147174 + v7) > v14 )
        {
          v14 = UnitStack_CalcArmyFactStrength(v7 + gameData + 147174);
        }
      }
      ++v5;
    }
...
{
  return UnitStack_HasPlague(725 * a1 + gameData + 147174);
}
// 5202E4: using guessed type int gameData;
...
BOOL  Unit_ExecuteQueuedPathAndCheckFinished(unsigned int a1, char a2, DWORD a3, double a4)
{
  ...
  UnitStack_ExecuteQueuedPath(a1, 1, a2, a3, a4);
  return *(_DWORD *)(gameData + 725 * v4 + 147490) == 0;
}
...
BOOL  UnitStack_DetachWeakUnitsToAdjacentTile(int a1, int a2, int a3, double a4)
{
  ...
  v13 = a1;
  v4 = 0;
  v16 = (__int16 *)(725 * a1 + gameData + 147174);
  v5 = v16 + 3;
  v6 = 0;
  for ( i = 0; i < 10; ++i )
  {
...
BOOL  UnitStack_DetachUnitTypeToAdjacentTile(int a1, unit_type a2, int a3, int a4, double a5)
{
  ...
  v16 = a2;
  v5 = 0;
  v19 = (__int16 *)(725 * a1 + gameData + 147174);
  v6 = v19 + 3;
  v7 = 0;
  for ( i = 0; i < 10; ++i )
  {
...
signed int  UnitStack_HasUnitType(int a1, unit_type a2)
{
  ...
  v3 = 0;
  for ( i = (__int16 *)(gameData + 147174 + 725 * a1 + 6); ; i = (__int16 *)((char *)i + 31) )
  {
    v5 = *i;
    if ( v5 == -1 )
      return 0;
...
int  UnitStack_RegroupWithOtherStackByHealth(int a1, int a2, char a3, DWORD a4, double a5)
{
  ...
  v7 = *(__int16 *)(gameData + 725 * v5 + 147174) - *(__int16 *)(gameData + 725 * v36 + 147174);
  if ( (int)abs32(v7) > 1
    || (v8 = *(__int16 *)(gameData + 725 * v5 + 147176) - *(__int16 *)(725 * v36 + gameData + 147176),
        (int)((HIDWORD(v8) ^ v8) - HIDWORD(v8)) > 1) )
  {
    result = (int)Unit_MoveTrackNearTile(
                    v35,
                    *(__int16 *)(gameData + 725 * v36 + 147174),
                    v6,
                    *(__int16 *)(gameData + 725 * v36 + 147176),
                    v7);
    if ( !result )
      return result;
    qmemcpy((void *)(725 * v35 + gameData + 147174 + 316), (const void *)result, 0x194u);
    j__nfree_();
    UnitStack_ExecuteQueuedPath(v35, 1, -43 * v35, v7, a5);
  }
  v10 = *(__int16 *)(gameData + 725 * v35 + 147174) - *(__int16 *)(gameData + 725 * v36 + 147174);
  if ( (int)abs32(v10) > 1
    || (v13 = *(__int16 *)(725 * v35 + gameData + 147176) - *(__int16 *)(725 * v36 + gameData + 147176),
        (int)((HIDWORD(v13) ^ v13) - HIDWORD(v13)) > 1) )
  {
    result = (int)Unit_MoveTrackNearTile(
                    v36,
                    *(__int16 *)(gameData + 725 * v35 + 147174),
                    v6,
                    *(__int16 *)(gameData + 725 * v35 + 147176),
                    v10);
    if ( !result )
      return result;
    qmemcpy((void *)(gameData + 147174 + 725 * v36 + 316), (const void *)result, 0x194u);
    j__nfree_();
    UnitStack_ExecuteQueuedPath(v36, 1, -111 * v36, v10, a5);
  }
  v11 = 725 * v35;
  v12 = *(__int16 *)(gameData + 725 * v35 + 147174) - *(__int16 *)(gameData + 725 * v36 + 147174);
  if ( (int)((HIDWORD(v12) ^ v12) - HIDWORD(v12)) > 1 )
    return 0;
  v14 = *(__int16 *)(gameData + v11 + 147176) - *(__int16 *)(725 * v36 + gameData + 147176);
  if ( (int)((HIDWORD(v14) ^ v14) - HIDWORD(v14)) > 1 )
    return 0;
  v15 = 0;
  v44 = 0;
  v16 = gameData + 147174 + v11;
  v17 = v32;
  v18 = (__int16 *)(v16 + 6);
  do
  {
  ...
  while ( v15 < 10 );
  v19 = (__int16 *)(gameData + 147174 + 725 * v36 + 6);
  v20 = 0;
  v21 = &v32[31 * v44];
  do
  {
  ...
  v23 = v32;
  v24 = 0;
  v25 = (_WORD *)(725 * v35 + gameData + 147174 + 6);
  do
  {
    if ( v24 >= v40 )
    {
  ...
  v37 = v44 - v40;
  v26 = 0;
  v27 = (_WORD *)(725 * v36 + gameData + 147174 + 6);
  v28 = &v32[31 * v40];
  do
  {
    if ( v26 >= v37 )
...
signed int  UnitStack_RegroupWithBuildingGarrisonByHealth(int a1, int a2, char a3, DWORD a4, double a5)
{
  ...
  v7 = *(unsigned __int8 *)(gameData + v5 + 509674) - *(__int16 *)(gameData + 725 * v6 + 147174);
  if ( (int)((HIDWORD(v7) ^ v7) - HIDWORD(v7)) > 1
    || (v8 = *(unsigned __int8 *)(v5 + gameData + 509675) - *(__int16 *)(725 * v6 + gameData + 147176),
        (int)((HIDWORD(v8) ^ v8) - HIDWORD(v8)) > 1) )
  {
    v9 = *(unsigned __int8 *)(gameData + 467 * v46 + 509674) + 1 - *(__int16 *)(725 * v47 + gameData + 147174);
    if ( (int)((HIDWORD(v9) ^ v9) - HIDWORD(v9)) > 1
      || (v34 = *(unsigned __int8 *)(gameData + 467 * v46 + 509675) - *(__int16 *)(725 * v47 + gameData + 147176),
          (int)((HIDWORD(v34) ^ v34) - HIDWORD(v34)) > 1) )
    {
      v10 = *(unsigned __int8 *)(gameData + 467 * v46 + 509674) + 1 - *(__int16 *)(gameData + 725 * v47 + 147174);
      if ( (int)((HIDWORD(v10) ^ v10) - HIDWORD(v10)) > 1
        || (v35 = *(unsigned __int8 *)(467 * v46 + gameData + 509675) + 1 - *(__int16 *)(725 * v47 + gameData + 147176),
            (int)((HIDWORD(v35) ^ v35) - HIDWORD(v35)) > 1) )
      {
        v11 = 725 * v47;
        v12 = *(unsigned __int8 *)(gameData + 467 * v46 + 509674) - *(__int16 *)(gameData + 725 * v47 + 147174);
        if ( (int)abs32(v12) > 1
              ...
              (int)((HIDWORD(v36) ^ v36) - HIDWORD(v36)) > 1) )
        {
          ...
          if ( !v13 )
            return 0;
          qmemcpy((void *)(gameData + 147174 + 725 * v47 + 316), v13, 0x194u);
          j__nfree_();
  ...
  v15 = *(unsigned __int8 *)(gameData + 467 * v46 + 509674) - *(__int16 *)(gameData + 725 * v47 + 147174);
  if ( (int)((HIDWORD(v15) ^ v15) - HIDWORD(v15)) > 1
    || (v37 = *(unsigned __int8 *)(467 * v46 + gameData + 509675) - *(__int16 *)(725 * v47 + gameData + 147176),
        (int)((HIDWORD(v37) ^ v37) - HIDWORD(v37)) > 1) )
  {
    v16 = *(unsigned __int8 *)(gameData + 467 * v46 + 509674) + 1 - *(__int16 *)(725 * v47 + gameData + 147174);
    if ( (int)((HIDWORD(v16) ^ v16) - HIDWORD(v16)) > 1
      || (v38 = *(unsigned __int8 *)(467 * v46 + gameData + 509675) - *(__int16 *)(725 * v47 + gameData + 147176),
          (int)((HIDWORD(v38) ^ v38) - HIDWORD(v38)) > 1) )
    {
      v17 = *(unsigned __int8 *)(gameData + 467 * v46 + 509674) + 1 - *(__int16 *)(gameData + 725 * v47 + 147174);
      if ( (int)((HIDWORD(v17) ^ v17) - HIDWORD(v17)) > 1
        || (v39 = *(unsigned __int8 *)(gameData + 467 * v46 + 509675) + 1 - *(__int16 *)(725 * v47 + gameData + 147176),
            (int)((HIDWORD(v39) ^ v39) - HIDWORD(v39)) > 1) )
      {
        v18 = *(unsigned __int8 *)(gameData + 467 * v46 + 509674) - *(__int16 *)(gameData + 725 * v47 + 147174);
        if ( (int)((HIDWORD(v18) ^ v18) - HIDWORD(v18)) > 1 )
          return 0;
        v19 = *(unsigned __int8 *)(467 * v46 + gameData + 509675) + 1 - *(__int16 *)(725 * v47 + gameData + 147176);
  ...
  v20 = 0;
  v21 = v43;
  v22 = (__int16 *)(gameData + 147174 + 725 * v47 + 6);
  do
  {
    if ( *v22 == -1 )
      break;
  ...
  v27 = v43;
  v28 = 0;
  v29 = (_WORD *)(725 * v47 + gameData + 147174 + 6);
  do
  {
    if ( v28 >= v52 )
    {
  ...
  if ( a4 >= 0 && a4 < *(_DWORD *)(gameData + 140000) && a3 >= 0 && a3 < *(_DWORD *)(gameData + 140004) )
  {
    if ( *(unsigned __int16 *)(TILE_INDEX(a4, a3)) > 0x1F4u
      || (unsigned int)*(__int16 *)(gameData
                                  + 725 * *(unsigned __int16 *)(TILE_INDEX(a4, a3))
                                  + 147180) > 0x28 )
    {
    ...
    if ( (a1 == -1 || v12 == a1)
      && (a2 == -1
       ...
       && (v12 != 2 || *(unsigned __int8 *)(gameData + 725 * v11 + 147178) == a2)) )
    {
...
int  WorldMap_DrawMission01ShrineMarker(int result, int a2, int a3, int a4)
{
  ...
  if ( result == 16 && a2 == 11 )
  {
    ...
    SpriteForChar = DLX_GetSpriteForChar(dword_5202C0, 730);
...
int  WorldMap_DrawMission07TreasureMarker(int result, int a2)
{
  ...
  {
    DLX_GetSpriteForChar(dword_5202C0, 962);
  ...
  else if ( v2 == 14 && a2 == 68 )
  {
    ...
    if ( result )
    {
      DLX_GetSpriteForChar(dword_5202C0, 961);
      return (*(int (__stdcall **)(int, int, int, int, int, _DWORD, _DWORD))(*((_DWORD *)g_RenderDevice + 46) + 52))(
               -1,
               -1,
               -1,
...
int  WorldMap_DrawMission11ShrineMarker(int result, int a2, int a3, int a4)
{
  ...
  if ( result == 2 && a2 == 44 )
  {
    v6 = Time_Now(a3, 44);
    v11 = ((50 * Math_SinDegreesQ16(2 * v6 - 90)) >> 16) + 50;
    SpriteForChar = DLX_GetSpriteForChar(dword_5202C0, 738);
...
BOOL  Mission_CheckObjectiveComplete(DWORD a1, double a2)
{
  ...
  switch ( ACTIVE_MISSION_INDEX )
  {
    case 0:
      v2 = 0;
LABEL_6:
      if ( (unsigned int)*(__int16 *)(gameData + 725 * v2 + 147180) <= 0x28
        && *(_BYTE *)(gameData + 725 * v2 + 147178) == 1 )
      {
        if ( mission0_last_blocker_index != v2 || mission0_last_blocker_turn != GAME_TURN_COUNTER )
        {
          ...
          Diagnostics_TraceWorldMapActionEvent(
            ...
            v2,
            *(__int16 *)(gameData + 725 * v2 + 147174),
            *(__int16 *)(gameData + 725 * v2 + 147176),
            Unit_GetSquadCount(gameData + 147174 + 725 * v2));
        }
        return 0;
      }
      while ( ++v2 < 500 )
...
LABEL_42:
          if ( (unsigned int)*(__int16 *)(gameData + 725 * v10 + 147180) > 0x28
            || *(_BYTE *)(gameData + 725 * v10 + 147178) != 3 )
          {
            while ( ++v10 < 500 )
            {
              if ( v10 >= 0 )
          ...
          Mission_TraceObjectiveBlocked(5, v10, *(_BYTE *)(gameData + 725 * v10 + 147178), Unit_GetSquadCount(gameData + 147174 + 725 * v10));
          return 0;
        }
...
LABEL_18:
      ...
      v6 = 0;
LABEL_27:
      if ( (unsigned int)*(__int16 *)(725 * v6 + gameData + 147174 + 6) <= 0x28 )
      {
        v7 = *(unsigned __int8 *)(gameData + 725 * v6 + 147178);
        if ( v7 == 1 || v7 == 2 )
        {
          Mission_TraceObjectiveBlocked(5, v6, v7, Unit_GetSquadCount(gameData + 147174 + 725 * v6));
          return 0;
        }
      }
      while ( ++v6 < 500 )
    ...
    case 7:
      ...
      while ( 1 )
      {
        if ( (unsigned int)*(__int16 *)(gameData + 725 * v13 + 147180) <= 0x28 )
        {
          v14 = 725 * v13;
          ...
          if ( *(_BYTE *)(v15 + 147178) )
          {
            if ( Map_IsTileVisibleToPlayer(*(__int16 *)(v15 + 147174), *(__int16 *)(v15 + 147176), 0) )
            {
              ...
              UI_StartTileBlinkFlash(*(__int16 *)(v14 + gameData + 147174), *(__int16 *)(v14 + gameData + 147176), v16);
    ...
    case 0xA:
      v21 = 0;
LABEL_75:
      if ( (unsigned int)*(__int16 *)(gameData + 725 * v21 + 147180) <= 0x28
        && *(_BYTE *)(gameData + 725 * v21 + 147178) == 2 )
      {
        Mission_TraceObjectiveBlocked(
          10,
          v21,
          *(__int16 *)(gameData + 725 * v21 + 147174),
          *(__int16 *)(gameData + 725 * v21 + 147176));
        return 0;
      }
      while ( ++v21 < 500 )
      {
...
LABEL_86:
      ...
      v24 = 0;
LABEL_94:
      if ( (unsigned int)*(__int16 *)(gameData + 725 * v24 + 147180) <= 0x28
        && *(_BYTE *)(gameData + 725 * v24 + 147178) == 4 )
      {
        Mission_TraceObjectiveBlocked(
          15,
          v24,
          *(__int16 *)(gameData + 725 * v24 + 147174),
          *(__int16 *)(gameData + 725 * v24 + 147176));
        return 0;
      }
      while ( ++v24 < 500 )
      {
    ...
    case 0x11:
      ...
      v26 = 0;
LABEL_105:
      if ( (unsigned int)*(__int16 *)(gameData + 725 * v26 + 147180) <= 0x28 )
      {
        v27 = 725 * v26;
        ...
        if ( *(_BYTE *)(v28 + 147178) != 1 )
        {
          if ( Map_IsTileVisibleToPlayer(*(__int16 *)(v28 + 147174), *(__int16 *)(v28 + 147176), 1) )
          {
            ...
            Audio_PlayArtifactSound(0);
            UI_StartTileBlinkFlash(*(__int16 *)(v27 + gameData + 147174), *(__int16 *)(v27 + gameData + 147176), v29);
...
int Mission_CheckFailureCondition()
{
  ...
  switch ( ACTIVE_MISSION_INDEX )
  {
    ...
    case 8:
      ...
      v2 = 0;
LABEL_7:
      if ( (unsigned int)*(__int16 *)(gameData + 725 * v2 + 147180) <= 0x28 && !*(_BYTE *)(gameData + 725 * v2 + 147178) )
      {
        for ( i = 0; i < 10; ++i )
        {
...
LABEL_34:
  if ( (unsigned int)*(__int16 *)(gameData + 725 * v10 + 147180) <= 0x28
    && *(_BYTE *)(gameData + 725 * v10 + 147178) == 1 )
  {
    for ( k = 0; k < 10; ++k )
    {
    ...
    *(_DWORD *)(a1 + 52) = v18;
    ...
    if ( dword_544D10 )
    {
        ...
        || v18 != *(_DWORD *)(a1 + 4) )
      {
        ...
        g_RenderDevice = v22;
        return Render_SetResourceHandle((int)&unk_51D4C0, v19);
      }
    }
  }
  return result;
...
static int Compat_RenderClearPresentedRect(int render_state)
{
  ...
  if ( !dword_544D10 )
    return dword_544D10;
  dword_544D10 = 0;
  resource_handle = Render_SetResourceHandle((int)&unk_51D4C0, 0);
...
int  Render_Present(int a1)
{
  ...
  if ( !dword_544D10 )
  {
    v3 = Render_SetResourceHandle((int)&unk_51D4C0, 0);
    dword_544D10 = 1;
    v5 = g_RenderDevice;
    Render_FillRect(
      0,
...
int  Device_UpdateRect(_DWORD *a1, int a2, int a3)
{
  ...
  else
  {
    ...
    if ( g_DemoScript_TriggerTickTable[0] != -1 )
    {
      ...
      Demo_ShowNumberedTextScreen(v5, dword_544CD0);
    }
LABEL_8:

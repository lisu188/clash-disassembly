...
- The retained executable-regeneration slice also moved this batch:
  ...
  - the surviving retained blocker is no longer the old `sub_40D330` / `sub_44C2A0` helper band, `mapK2`, `mapK3`, `mapK4`, `mapK5`, `mapK6`, `mapK7`, `mapK8`, `mapK9`, `mapK10`, `mapP3`, case `13` / `p_mapa4l.map`, case `14` / `p_mapa5l.map`, case `15` / `p_mapa6l.map`, case `16` / `p_mapa7j.map`, or case `17` / `p_mapa8j.map`; it is the remaining `Scenario_LoadMissionByIndex` case recovery itself, starting with case `18` / `p_mapa9j.map`
- The next executable-regeneration frontier remains split, not singular:
  ...
  - the next retained class/runtime target is no longer the slot/parser export band, the low-risk file/runtime wrapper band, the x87 math band, the earlier `PlayGame_Dispatch` UI/data/runtime band, the bare mission-loader `JUMPOUT`, the `sub_40D330` / `sub_44C2A0` helper gap, `mapK2`, `mapK3`, `mapK4`, `mapK5`, `mapK6`, `mapK7`, `mapK8`, `mapK9`, `mapK10`, `mapP3`, case `13` / `p_mapa4l.map`, case `14` / `p_mapa5l.map`, case `15` / `p_mapa6l.map`, case `16` / `p_mapa7j.map`, or case `17` / `p_mapa8j.map`; it is the next remaining `Scenario_LoadMissionByIndex` case slice, starting with case `18` / `p_mapa9j.map`

...
- Current frontier notes:
  ...
  - `mapK2`, `mapK3`, `mapK4`, and `mapK5` were also confirmed and recovered as pure recovered-C mission setup; the next honest class/runtime widening is still not a signal to move behavior into `src_cpp`, and the live retained blocker is now the remaining mission-case recovery starting with `mapK6`

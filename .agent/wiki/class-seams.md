...
- Current frontier notes:
  ...
  - `sub_4B0940` and `sub_499990` now link in retained probes, and `sub_4996D0` is now reduced past the earlier AST / locale helper blockers down to `unk_508D50` plus nearby `JUMPOUT` scars

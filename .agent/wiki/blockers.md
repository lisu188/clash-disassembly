...
- The retained broader startup-prelude executable-regeneration slice is still blocked separately:
  - `sub_451E46` now narrows past the local bload header/data, allocator-callback, and `dbl_502FDC` data gaps, but it still fails on the wider unresolved runtime band (`unk_508D50`, `unknown_libname_7`, `unknown_libname_8`, `sub_496643`, `ftime_`, `system_`, `JUMPOUT`, `AST_FreeNode`, and parser helpers such as `Lexer_ParseSlotConstraint`)

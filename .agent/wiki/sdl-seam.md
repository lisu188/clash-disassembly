...
- Current evidence:
  ...
  - the old retained `sub_40D330` / `sub_44C2A0` gap plus the next retained `mapK2`, `mapK3`, `mapK4`, `mapK5`, `mapK6`, `mapK7`, `mapK8`, `mapK9`, `mapK10`, `mapP3`, and case `13` / `p_mapa4l.map` were resolved entirely in recovered C without touching `platform_sdl_runtime.c`
- Next likely SDL-facing work is still later input/present fidelity, not the current mission-loader or class/bload blocker; the next retained blocker is case `14` / `p_mapa5l.map`, still below SDL.

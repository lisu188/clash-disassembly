...
| `sprite_vertical_offset` | high | Per-type sprite Y-anchor/overhang offset. | Rendering subtracts `byte_512577` from the sprite Y origin, and redraw helpers use non-zero values to invalidate neighboring tiles for overhanging sprites. | `clash95.c:23969-24017`, `clash95.c:27713-27722`, `clash95.c:40229-40243`, `clash95.c:45932-45960` | layout stat | large or overhanging sprites |
